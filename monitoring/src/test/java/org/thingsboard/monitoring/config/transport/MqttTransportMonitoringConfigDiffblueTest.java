...
class MqttTransportMonitoringConfigDiffblueTest {
  /**
   * Test {@link MqttTransportMonitoringConfig#equals(Object)}, and {@link
   * MqttTransportMonitoringConfig#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean MqttTransportMonitoringConfig.equals(Object)",
    "int MqttTransportMonitoringConfig.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    MqttTransportMonitoringConfig mqttTransportMonitoringConfig =
        new MqttTransportMonitoringConfig();
    MqttTransportMonitoringConfig mqttTransportMonitoringConfig2 =
        new MqttTransportMonitoringConfig();

    // Act and Assert
    assertEquals(mqttTransportMonitoringConfig, mqttTransportMonitoringConfig2);
    assertEquals(
        mqttTransportMonitoringConfig.hashCode(), mqttTransportMonitoringConfig2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link MqttTransportMonitoringConfig#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(
        new MqttTransportMonitoringConfig(), "Different type to MqttTransportMonitoringConfig");
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Integer MqttTransportMonitoringConfig.getQos()",
    "TransportType MqttTransportMonitoringConfig.getTransportType()",
    "void MqttTransportMonitoringConfig.setQos(Integer)",
    "String MqttTransportMonitoringConfig.toString()"
  })
