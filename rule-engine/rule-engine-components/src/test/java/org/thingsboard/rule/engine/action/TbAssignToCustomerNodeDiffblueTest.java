...
class TbAssignToCustomerNodeDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link TbAssignToCustomerNode#loadCustomerNodeActionConfig(TbNodeConfiguration)}
   */
  @Test
  ...
  void testLoadCustomerNodeActionConfig_whenPOJONodeWithVIsNull_thenReturnNull() throws TbNodeException {
    ...
    // Act and Assert
    assertNull(tbAssignToCustomerNode.loadCustomerNodeActionConfig(new TbNodeConfiguration(new POJONode(null))));
  }

  /**
   * Test new {@link TbAssignToCustomerNode} (default constructor).
   * <p>
   * Method under test: default or parameterless constructor of {@link TbAssignToCustomerNode}
   */
  @Test
