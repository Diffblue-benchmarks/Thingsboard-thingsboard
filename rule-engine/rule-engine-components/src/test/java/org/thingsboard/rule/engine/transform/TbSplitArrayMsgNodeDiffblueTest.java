...
class TbSplitArrayMsgNodeDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test onMsg(TbContext, TbMsg); given '42'; when TbMsg getData() return '42'; then calls tellFailure(TbMsg, Throwable)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbSplitArrayMsgNode.onMsg(TbContext, TbMsg)"})
  void testOnMsg_given42_whenTbMsgGetDataReturn42_thenCallsTellFailure()
  ...
  @Test
  @DisplayName(
      "Test onMsg(TbContext, TbMsg); when TbContext tellFailure(TbMsg, Throwable) throw RuntimeException()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbSplitArrayMsgNode.onMsg(TbContext, TbMsg)"})
  void testOnMsg_whenTbContextTellFailureThrowRuntimeException()
      throws InterruptedException, ExecutionException, TbNodeException {
    // Arrange
    TbSplitArrayMsgNode tbSplitArrayMsgNode = new TbSplitArrayMsgNode();
  ...
  @Test
  @DisplayName(
      "Test onMsg(TbContext, TbMsg); when TbMsg getData() throw RuntimeException(); then throw RuntimeException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbSplitArrayMsgNode.onMsg(TbContext, TbMsg)"})
  void testOnMsg_whenTbMsgGetDataThrowRuntimeException_thenThrowRuntimeException()
      throws InterruptedException, ExecutionException, TbNodeException {
    // Arrange
    TbSplitArrayMsgNode tbSplitArrayMsgNode = new TbSplitArrayMsgNode();
    TbContext ctx = mock(TbContext.class);
