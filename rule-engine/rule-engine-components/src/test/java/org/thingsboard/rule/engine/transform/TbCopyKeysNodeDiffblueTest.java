...
class TbCopyKeysNodeDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test onMsg(TbContext, TbMsg); given '42'; when TbMsg getData() return '42'; then calls tellSuccess(TbMsg)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbCopyKeysNode.onMsg(TbContext, TbMsg)"})
  void testOnMsg_given42_whenTbMsgGetDataReturn42_thenCallsTellSuccess()
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbCopyKeysNode.onMsg(TbContext, TbMsg)"})
  void testOnMsg_givenTbMsgMetaDataValueEmptyStringIsEmptyString_thenCallsTellSuccess2()
      throws InterruptedException, ExecutionException, TbNodeException {
    // Arrange
    TbCopyKeysNode tbCopyKeysNode = new TbCopyKeysNode();
