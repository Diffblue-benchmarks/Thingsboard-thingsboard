...
class PersistedDeviceStateDiffblueTest {
  /**
   * Test {@link PersistedDeviceState#equals(Object)}, and
   * {@link PersistedDeviceState#hashCode()}.
   * <ul>
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, persistedDeviceState2.hashCode());
  }
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    ...
    alarmStates.put("foo", persistedAlarmState);
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    ...
    HashMap<String, PersistedAlarmState> alarmStates = new HashMap<>();
    alarmStates.computeIfPresent("foo", mock(BiFunction.class));
    alarmStates.put("foo", persistedAlarmState);
