...
class EntitiesFieldsAsyncLoaderDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link EntitiesFieldsAsyncLoader#findAsync(TbContext, EntityId)}
   */
  @Test
  ...
  void testFindAsync_thenCallsGetCustomerService() {
    ...
    // Act and Assert
    assertThrows(NoSuchElementException.class, () -> EntitiesFieldsAsyncLoader.findAsync(ctx,
