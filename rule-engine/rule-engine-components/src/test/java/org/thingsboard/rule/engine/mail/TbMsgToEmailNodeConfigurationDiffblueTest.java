...
class TbMsgToEmailNodeConfigurationDiffblueTest {
  ...
  void testDefaultConfiguration() {
    ...
    assertEquals(Boolean.FALSE.toString(), actualDefaultConfigurationResult.getMailBodyType());
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(
        tbMsgToEmailNodeConfiguration.hashCode(), tbMsgToEmailNodeConfiguration2.hashCode());
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual8() {
    ...
    TbMsgToEmailNodeConfiguration tbMsgToEmailNodeConfiguration =
        new TbMsgToEmailNodeConfiguration();
    tbMsgToEmailNodeConfiguration.setIsHtmlTemplate("<html><body>HTML Content</body></html>");

    TbMsgToEmailNodeConfiguration tbMsgToEmailNodeConfiguration2 =
        new TbMsgToEmailNodeConfiguration();
    tbMsgToEmailNodeConfiguration2.setIsHtmlTemplate("<html><body>HTML Content</body></html>");
  ...
  void testGettersAndSetters() {
    ...
    actualTbMsgToEmailNodeConfiguration.setIsHtmlTemplate("<html><body>HTML Content</body></html>");
    ...
    // Assert
    assertEquals("<html><body>HTML Content</body></html>", actualIsHtmlTemplate);
    ...
    assertEquals(
        "TbMsgToEmailNodeConfiguration(fromTemplate=jane.doe@example.org, toTemplate=To Template, ccTemplate=Cc"
            ...
            + " bodyTemplate=Not all who wander are lost, isHtmlTemplate=<html><body>HTML Content</body></html>,"
            + " mailBodyType=Not all who wander are lost)",
