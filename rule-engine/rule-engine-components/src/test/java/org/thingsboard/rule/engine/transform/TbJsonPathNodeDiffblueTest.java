...
class TbJsonPathNodeDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link TbJsonPathNode} (default constructor).
  ...
  @Test
  @DisplayName(
      "Test onMsg(TbContext, TbMsg); given TbJsonPathNode (default constructor); when TbMsg getData() throw PathNotFoundException()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbJsonPathNode.onMsg(TbContext, TbMsg)"})
  void testOnMsg_givenTbJsonPathNode_whenTbMsgGetDataThrowPathNotFoundException()
    ...
    when(msg.getData()).thenThrow(new PathNotFoundException());
