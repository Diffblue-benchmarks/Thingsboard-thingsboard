...
class TbClearAlarmNodeConfigurationDiffblueTest {
  ...
  void testDefaultConfiguration() {
    ...
    // Act
    TbClearAlarmNodeConfiguration actualDefaultConfigurationResult =
        tbClearAlarmNodeConfiguration.defaultConfiguration();

    // Assert
    assertEquals(tbClearAlarmNodeConfiguration, actualDefaultConfigurationResult);
  }
