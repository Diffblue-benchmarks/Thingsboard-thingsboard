...
class TbMsgCountNodeConfigurationDiffblueTest {
   ...
   *
   * <p>Method under test: {@link TbMsgCountNodeConfiguration#defaultConfiguration()}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "TbMsgCountNodeConfiguration TbMsgCountNodeConfiguration.defaultConfiguration()"
  })
  void testDefaultConfiguration() {
    // Arrange and Act
    TbMsgCountNodeConfiguration actualDefaultConfigurationResult =
        new TbMsgCountNodeConfiguration().defaultConfiguration();
  ...
  /**
   * Test {@link TbMsgCountNodeConfiguration#equals(Object)}, and {@link
   * TbMsgCountNodeConfiguration#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean TbMsgCountNodeConfiguration.equals(Object)",
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(tbMsgCountNodeConfiguration.hashCode(), tbMsgCountNodeConfiguration2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link TbMsgCountNodeConfiguration#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(
        new TbMsgCountNodeConfiguration(), "Different type to TbMsgCountNodeConfiguration");
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void TbMsgCountNodeConfiguration.<init>()",
    "int TbMsgCountNodeConfiguration.getInterval()",
    "String TbMsgCountNodeConfiguration.getTelemetryPrefix()",
    "void TbMsgCountNodeConfiguration.setInterval(int)",
    "void TbMsgCountNodeConfiguration.setTelemetryPrefix(String)",
    "String TbMsgCountNodeConfiguration.toString()"
  })
  void testGettersAndSetters() {
    // Arrange and Act
    TbMsgCountNodeConfiguration actualTbMsgCountNodeConfiguration =
        new TbMsgCountNodeConfiguration();
    ...
    // Assert
    assertEquals(
        "TbMsgCountNodeConfiguration(telemetryPrefix=Telemetry Prefix, interval=42)",
