...
class TbAbstractGetEntityDataNodeDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test upgradeToUseFetchToAndDataToFetch(JsonNode); given 'attrMapping'; then throw TbNodeException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.thingsboard.server.common.data.util.TbPair TbAbstractGetEntityDataNode.upgradeToUseFetchToAndDataToFetch(JsonNode)"
  })
  void testUpgradeToUseFetchToAndDataToFetch_givenAttrMapping_thenThrowTbNodeException()
      throws TbNodeException {
    // Arrange
    TbGetCustomerAttributeNode tbGetCustomerAttributeNode = new TbGetCustomerAttributeNode();
    ...
    oldConfiguration.put("attrMapping", (JsonNode) null);
