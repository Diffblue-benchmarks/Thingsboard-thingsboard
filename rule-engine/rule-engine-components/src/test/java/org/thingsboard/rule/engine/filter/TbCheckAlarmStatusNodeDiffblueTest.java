...
class TbCheckAlarmStatusNodeDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test onMsg(TbContext, TbMsg); given 'null'; when TbContext getTenantId() throw IllegalArgumentException()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbCheckAlarmStatusNode.onMsg(TbContext, TbMsg)"})
  void testOnMsg_givenNull_whenTbContextGetTenantIdThrowIllegalArgumentException()
      throws TbNodeException {
    // Arrange
    TbCheckAlarmStatusNode tbCheckAlarmStatusNode = new TbCheckAlarmStatusNode();
