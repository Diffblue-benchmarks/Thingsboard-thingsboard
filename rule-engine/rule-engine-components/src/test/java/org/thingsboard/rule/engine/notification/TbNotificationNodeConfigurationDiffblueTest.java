...
class TbNotificationNodeConfigurationDiffblueTest {
   ...
   * <p>
   * Method under test:
   * {@link TbNotificationNodeConfiguration#defaultConfiguration()}
   */
  @Test
  ...
  /**
   * Test {@link TbNotificationNodeConfiguration#equals(Object)}, and
   * {@link TbNotificationNodeConfiguration#hashCode()}.
   * <ul>
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, tbNotificationNodeConfiguration2.hashCode());
  }
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual6() {
    // Arrange
    TbNotificationNodeConfiguration tbNotificationNodeConfiguration = new TbNotificationNodeConfiguration();
    tbNotificationNodeConfiguration.setTemplateId(mock(NotificationTemplateId.class));
   ...
   * {@link TbNotificationNodeConfiguration}
   *   <li>{@link TbNotificationNodeConfiguration#setTargets(List)}
   *   <li>
   * {@link TbNotificationNodeConfiguration#setTemplateId(NotificationTemplateId)}
