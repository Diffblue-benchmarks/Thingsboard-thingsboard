...
class TbAbstractExternalNodeDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test tellFailure(TbContext, TbMsg, Throwable); given TbAwsLambdaNode; then calls tellNext(TbMsg, String)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbAbstractExternalNode.tellFailure(TbContext, TbMsg, Throwable)"})
  void testTellFailure_givenTbAwsLambdaNode_thenCallsTellNext() {
    ...
    // Act
    tbAwsLambdaNode.tellFailure(ctx, mock(TbMsg.class), null);
