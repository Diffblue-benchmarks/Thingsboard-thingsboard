...
public class JpaAttributeDaoDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Optional JpaAttributeDao.find(TenantId, EntityId, AttributeScope, String)"})
  public void testFindWithTenantIdEntityIdAttributeScopeAttributeKey3() {
    // Arrange
    AttributeKvCompositeKey id = new AttributeKvCompositeKey();
    id.setAttributeKey(1);
    id.setAttributeType(1);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List JpaAttributeDao.find(TenantId, EntityId, AttributeScope, Collection)"})
  public void testFindWithTenantIdEntityIdAttributeScopeAttributeKeys5() {
    // Arrange
    when(keyDictionaryDao.getOrSaveKeyId(Mockito.<String>any()))
        .thenThrow(new EmptyResultDataAccessException(3));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List JpaAttributeDao.find(TenantId, EntityId, AttributeScope, Collection)"})
  public void testFindWithTenantIdEntityIdAttributeScopeAttributeKeys6() {
    // Arrange
    AttributeKvCompositeKey id = new AttributeKvCompositeKey();
    id.setAttributeKey(1);
    id.setAttributeType(1);
   ...
   *
   * <ul>
   *   <li>Given {@link JpaAttributeDao} (default constructor).
  ...
  public void testFindAllKeysByDeviceProfileId_givenJpaAttributeDao_thenCallsGetId() {
    // Arrange
    JpaAttributeDao jpaAttributeDao = new JpaAttributeDao();

    TenantId tenantId = mock(TenantId.class);
    when(tenantId.getId()).thenThrow(new EmptyResultDataAccessException(3));

    // Act and Assert
    assertThrows(
        EmptyResultDataAccessException.class,
        () -> jpaAttributeDao.findAllKeysByDeviceProfileId(tenantId, null));
  ...
  public void testFindAllKeysByDeviceProfileId_givenNull_uuid() {
    ...
    // Act
    List<String> actualFindAllKeysByDeviceProfileIdResult =
        jpaAttributeDao.findAllKeysByDeviceProfileId(ModelConstants.SYSTEM_TENANT, deviceProfileId);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List JpaAttributeDao.removeAllByEntityId(TenantId, EntityId)"})
  public void testRemoveAllByEntityId_thenThrowEmptyResultDataAccessException()
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List JpaAttributeDao.removeAllByEntityId(TenantId, EntityId)"})
  public void testRemoveAllByEntityId_whenNull_customer_id_thenReturnEmpty()
      throws DataAccessException {
    // Arrange
    when(jdbcTemplate.queryForList(Mockito.<String>any(), isA(Object[].class)))
        .thenReturn(new ArrayList<>());
