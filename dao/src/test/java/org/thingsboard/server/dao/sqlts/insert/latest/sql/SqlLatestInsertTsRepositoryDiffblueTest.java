...
public class SqlLatestInsertTsRepositoryDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link SqlLatestInsertTsRepository} (default constructor).
  ...
  public void testSetOnBatchUpdateValues_givenSqlLatestInsertTsRepository_thenCallsSetNull()
      throws SQLException {
    // Arrange
  ...
  public void testSetOnInsertOrUpdateValues_thenThrowSQLException() throws SQLException {
    // Arrange
    SqlLatestInsertTsRepository sqlLatestInsertTsRepository = new SqlLatestInsertTsRepository();
