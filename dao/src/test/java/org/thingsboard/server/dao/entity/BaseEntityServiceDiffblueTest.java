...
public class BaseEntityServiceDiffblueTest {
  ...
  public void testCountEntitiesByQuery3() {
    // Arrange
  ...
  public void testCountEntitiesByQuery_givenNull_uuid_thenCallsGetId() {
    // Arrange
    TenantId tenantId = mock(TenantId.class);
    ...
    assertThrows(
        IncorrectParameterException.class,
        () -> baseEntityService.countEntitiesByQuery(tenantId, customerId, query));
   ...
   *   <li>Then calls {@link EntityFilter#getType()}.
   * </ul>
   *
   * <p>Method under test: {@link BaseEntityService#countEntitiesByQuery(TenantId, CustomerId,
   * EntityCountQuery)}
  ...
  public void testCountEntitiesByQuery_whenEntityFilterGetTypeReturnNull_thenCallsGetType() {
    // Arrange
    EntityFilter entityFilter = mock(EntityFilter.class);
   ...
   *
   * <ul>
   *   <li>Given {@link BaseEntityService} (default constructor).
   *   <li>Then calls {@link CustomerId#getId()}.
   * </ul>
   *
   * <p>Method under test: {@link BaseEntityService#findEntityDataByQuery(TenantId, CustomerId,
  ...
  public void testFindEntityDataByQuery_givenBaseEntityService_thenCallsGetId() {
    // Arrange
