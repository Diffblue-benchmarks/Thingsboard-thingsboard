...
public class TimescaleTsKvEntityDiffblueTest {
  /**
   * Test {@link TimescaleTsKvEntity#equals(Object)}, and
   * {@link TimescaleTsKvEntity#hashCode()}.
   * <ul>
  ...
  /**
   * Test
   * {@link TimescaleTsKvEntity#TimescaleTsKvEntity(Long, Long, Long, Double, Long, Long, String, String, Long)}.
   * <ul>
  ...
  public void testNewTimescaleTsKvEntity_whenAvg_thenReturnToDataToTsValueCountLongValueIsOne() {
    // Arrange and Act
    TimescaleTsKvEntity actualTimescaleTsKvEntity = new TimescaleTsKvEntity(1L, 42L, null, null, 0L, 1L, null, "AVG",
        42L);
  ...
  public void testNewTimescaleTsKvEntity_whenAvg_thenToDataKvReturnDoubleDataEntry2() {
    // Arrange, Act and Assert
    TsKvEntry toDataResult = (new TimescaleTsKvEntity(1L, 42L, null, 10.0d, 0L, 0L, null, "AVG", 42L)).toData();
    assertTrue(toDataResult instanceof AggTsKvEntry);
    assertTrue(((AggTsKvEntry) toDataResult).getKv() instanceof DoubleDataEntry);
  }
   ...
   */
  @Test
  public void testNewTimescaleTsKvEntity_whenEmptyString_thenToDataKvReturnDoubleDataEntry() {
    // Arrange, Act and Assert
  ...
  /**
   * Test
   * {@link TimescaleTsKvEntity#TimescaleTsKvEntity(Long, Long, Long, Long, Long, Long, Long, Long)}.
   * <ul>
   ...
   */
  @Test
  public void testNewTimescaleTsKvEntity_whenFortyTwo() {
    // Arrange, Act and Assert
  ...
  public void testNewTimescaleTsKvEntity_whenMax_thenReturnDoubleValueIsNull() {
    // Arrange and Act
    TimescaleTsKvEntity actualTimescaleTsKvEntity = new TimescaleTsKvEntity(1L, 42L, null, null, 0L, 0L, null, "MAX",
        42L);
  ...
  public void testNewTimescaleTsKvEntity_whenMin_thenReturnDoubleValueIsNull() {
    // Arrange and Act
    TimescaleTsKvEntity actualTimescaleTsKvEntity = new TimescaleTsKvEntity(1L, 42L, null, null, 0L, 0L, null, "MIN",
        42L);
  ...
  public void testNewTimescaleTsKvEntity_whenMin_thenReturnDoubleValueIsNull2() {
    // Arrange and Act
    TimescaleTsKvEntity actualTimescaleTsKvEntity = new TimescaleTsKvEntity(1L, 42L, null, null, 0L, 1L, null, "MIN",
        42L);
  ...
  public void testNewTimescaleTsKvEntity_whenMin_thenReturnDoubleValueIsNull3() {
    // Arrange and Act
    TimescaleTsKvEntity actualTimescaleTsKvEntity = new TimescaleTsKvEntity(1L, 42L, null, null, 1L, 0L, null, "MIN",
        42L);
  ...
  public void testNewTimescaleTsKvEntity_whenSum_thenReturnDoubleValueIsNull() {
    // Arrange and Act
    TimescaleTsKvEntity actualTimescaleTsKvEntity = new TimescaleTsKvEntity(1L, 42L, null, null, 0L, 0L, null, "SUM",
        42L);
   ...
   */
  @Test
  public void testNewTimescaleTsKvEntity_whenZero() {
    // Arrange, Act and Assert
   ...
   */
  @Test
  public void testNewTimescaleTsKvEntity_whenZero2() {
    // Arrange, Act and Assert
   ...
   * <ul>
   *   <li>When zero.</li>
   *   <li>Then return toData Kv ValueAsString is {@code 6}.</li>
   * </ul>
   * <p>
   * Method under test:
   * {@link TimescaleTsKvEntity#TimescaleTsKvEntity(Long, Long, Long, Long, Long, Long, Long, Long)}
   */
  @Test
  public void testNewTimescaleTsKvEntity_whenZero_thenReturnToDataKvValueAsStringIs6() {
    // Arrange and Act
    ...
    TsKvEntry toDataResult = actualTimescaleTsKvEntity.toData();
    assertTrue(toDataResult instanceof BasicTsKvEntry);
    KvEntry kv = ((BasicTsKvEntry) toDataResult).getKv();
    assertTrue(kv instanceof LongDataEntry);
    assertEquals("6", kv.getValueAsString());
    assertEquals("6", toDataResult.getValueAsString());
    assertEquals("6", toDataResult.toTsValue().getValue());
    Optional<Long> longValue = toDataResult.getLongValue();
    assertEquals(6L, longValue.get().longValue());
   ...
   * <ul>
   *   <li>Given {@link TimescaleTsKvEntity#TimescaleTsKvEntity()} BooleanValue is
   * {@code true}.</li>
   ...
   * Test {@link TimescaleTsKvEntity#isNotEmpty()}.
   * <ul>
   *   <li>Given {@link TimescaleTsKvEntity#TimescaleTsKvEntity()} DoubleValue is
   * ten.</li>
   *   <li>Then return {@code true}.</li>
   * </ul>
   * <p>
   ...
   * Test {@link TimescaleTsKvEntity#isNotEmpty()}.
   * <ul>
   *   <li>Given {@link TimescaleTsKvEntity#TimescaleTsKvEntity()} JsonValue is
   * {@code foo}.</li>
   *   <li>Then return {@code true}.</li>
   * </ul>
   * <p>
   ...
   * Test {@link TimescaleTsKvEntity#isNotEmpty()}.
   * <ul>
   *   <li>Given {@link TimescaleTsKvEntity#TimescaleTsKvEntity()} LongValue is
   * one.</li>
   *   <li>Then return {@code true}.</li>
   * </ul>
   * <p>
   ...
   * Test {@link TimescaleTsKvEntity#isNotEmpty()}.
   * <ul>
   *   <li>Given {@link TimescaleTsKvEntity#TimescaleTsKvEntity()} StrValue is
   * {@code foo}.</li>
   *   <li>Then return {@code true}.</li>
   * </ul>
   * <p>
