...
public class AlarmCommentEntityDiffblueTest {
  ...
  public void testNewAlarmCommentEntity_givenOne_thenReturnCreatedTimeIsOne() {
    // Arrange
   ...
   *
   * <ul>
   *   <li>Then return toData is {@link AlarmComment#AlarmComment(AlarmCommentId)} with id is {@link
   *       AlarmCommentId#AlarmCommentId(UUID)}.
   * </ul>
   *
   * <p>Method under test: {@link AlarmCommentEntity#AlarmCommentEntity(AlarmComment)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void AlarmCommentEntity.<init>(AlarmComment)"})
  public void testNewAlarmCommentEntity_thenReturnToDataIsAlarmCommentWithIdIsAlarmCommentId() {
    // Arrange
    AlarmComment alarmComment = new AlarmComment(new AlarmCommentId(ModelConstants.NULL_UUID));
    alarmComment.setUserId(null);
    alarmComment.setType(AlarmCommentType.SYSTEM);
    alarmComment.setAlarmId(new AlarmId(ModelConstants.NULL_UUID));

    // Act and Assert
    assertEquals(alarmComment, new AlarmCommentEntity(alarmComment).toData());
  }
   ...
   *
   * <ul>
   *   <li>Then return toData UserId is {@link UserId#UserId(UUID)} with id is {@link
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void AlarmCommentEntity.<init>(AlarmComment)"})
  public void testNewAlarmCommentEntity_thenReturnToDataUserIdIsUserIdWithIdIsNull_uuid() {
    // Arrange
    ...
    // Act and Assert
    assertEquals(userId, new AlarmCommentEntity(alarmComment).toData().getUserId());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void AlarmCommentEntity.<init>(AlarmComment)"})
  public void testNewAlarmCommentEntity_thenReturnTypeIsNull() {
    // Arrange
    AlarmComment alarmComment = new AlarmComment();
    alarmComment.setAlarmId(new AlarmId(ModelConstants.NULL_UUID));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void AlarmCommentEntity.<init>(AlarmComment)"})
  public void testNewAlarmCommentEntity_thenReturnTypeIsSystem() {
    // Arrange
    AlarmComment alarmComment = new AlarmComment((AlarmCommentId) null);
    alarmComment.setUserId(null);
    alarmComment.setType(AlarmCommentType.SYSTEM);
