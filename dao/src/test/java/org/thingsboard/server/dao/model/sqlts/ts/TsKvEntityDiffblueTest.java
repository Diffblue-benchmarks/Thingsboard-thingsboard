...
public class TsKvEntityDiffblueTest {
  ...
  public void testNewTsKvEntity_whenMax_thenReturnDoubleValueDoubleValueIsFortyTwo() {
    // Arrange and Act
    TsKvEntity actualTsKvEntity = new TsKvEntity(42L, 1.0d, 1L, 1L, "MAX", 42L);
   ...
   * <ul>
   *   <li>When {@code MIN}.
   *   <li>Then return DoubleValue doubleValue is one.
   * </ul>
   *
   * <p>Method under test: {@link TsKvEntity#TsKvEntity(Long, Double, Long, Long, String, Long)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TsKvEntity.<init>(Long, Double, Long, Long, String, Long)"})
  public void testNewTsKvEntity_whenMin_thenReturnDoubleValueDoubleValueIsOne() {
    // Arrange and Act
    TsKvEntity actualTsKvEntity = new TsKvEntity(42L, 1.0d, 1L, 1L, "MIN", 42L);
    ...
    assertNull(actualTsKvEntity.getEntityId());
    assertEquals(0, actualTsKvEntity.getKey());
    assertEquals(1.0d, actualTsKvEntity.getDoubleValue().doubleValue(), 0.0);
    assertEquals(42L, actualTsKvEntity.getAggValuesLastTs().longValue());
    assertTrue(actualTsKvEntity.isNotEmpty());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TsKvEntity.<init>(Long, Double, Long, Long, String, Long)"})
  public void testNewTsKvEntity_whenTen_thenReturnAggValuesCountLongValueIsZero() {
    // Arrange and Act
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TsKvEntity.<init>(Long, Double, Long, Long, String, Long)"})
  public void testNewTsKvEntity_whenThree_thenReturnDoubleValueIsNull() {
    // Arrange and Act
