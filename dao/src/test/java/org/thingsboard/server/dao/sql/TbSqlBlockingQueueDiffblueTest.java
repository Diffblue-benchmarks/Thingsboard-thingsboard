...
public class TbSqlBlockingQueueDiffblueTest {
  ...
  public void testInit() {
    ...
    TbSqlBlockingQueueParams params = TbSqlBlockingQueueParams.builder()
        ...
        .statsPrintIntervalMs(Long.MAX_VALUE)
        .withResponse(true)
        .build();
    ...
    // Assert
    verify(logExecutor).scheduleAtFixedRate(isA(Runnable.class), eq(9223372036854775807L), eq(9223372036854775807L),
  ...
  public void testInit2() {
    ...
    TbSqlBlockingQueueParams params = TbSqlBlockingQueueParams.builder()
        ...
        .build();
    AtomicInteger aiCounter = new AtomicInteger(1);
    StatsCounter totalCounter = new StatsCounter(aiCounter, new NoopCounter(new Meter.Id("Name", Tags.empty(),
