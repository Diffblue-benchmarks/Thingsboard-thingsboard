...
public class AbstractDeviceEntityDiffblueTest {
   ...
   *   <li>Then return TenantId NullUid.
   * </ul>
   *
  ...
  public void testToDevice_givenDeviceEntityDeviceDataIsInstance_thenReturnTenantIdNullUid() {
    // Arrange
    ...
    assertEquals(firmwareId, actualToDeviceResult.getSoftwareId());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Device AbstractDeviceEntity.toDevice()"})
  public void testToDevice_givenDeviceEntityDeviceDataIsNull_thenReturnTenantIdNullUid() {
    // Arrange
    DeviceEntity deviceEntity = new DeviceEntity();
    deviceEntity.setTenantId(ModelConstants.NULL_UUID);
    deviceEntity.setCustomerId(ModelConstants.NULL_UUID);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Device AbstractDeviceEntity.toDevice()"})
  public void testToDevice_givenDeviceEntity_thenReturnCustomerIdIsNull() {
    // Arrange and Act
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    ...
    when(deviceEntity2.getId()).thenReturn(ModelConstants.NULL_UUID);
