...
public class ImageCacheKeyDiffblueTest {
  ...
  public void testForImageWithTenantIdKey() {
    // Arrange and Act
    ImageCacheKey actualForImageResult =
        ImageCacheKey.forImage(ModelConstants.SYSTEM_TENANT, "Key");
    ...
    assertSame(TenantId.SYS_TENANT_ID, actualForImageResult.getTenantId());
  }
   ...
   *   <li>Then return ResourceKey is empty string.
   * </ul>
   *
   * <p>Method under test: {@link ImageCacheKey#toProto()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"ImageCacheKeyProto ImageCacheKey.toProto()"})
  public void testToProto_givenForPublicImagePublicKey_thenReturnResourceKeyIsEmptyString() {
    // Arrange and Act
    ImageCacheKeyProto actualToProtoResult = ImageCacheKey.forPublicImage("Public Key").toProto();

    // Assert
    assertEquals("", actualToProtoResult.getResourceKey());
    assertEquals("Public Key", actualToProtoResult.getPublicResourceKey());
    assertEquals(12, actualToProtoResult.getSerializedSize());
    assertFalse(actualToProtoResult.hasResourceKey());
    assertTrue(actualToProtoResult.hasPublicResourceKey());
  }
   ...
   *
   * <ul>
   *   <li>Then return PublicResourceKey is empty string.
   * </ul>
   *
   * <p>Method under test: {@link ImageCacheKey#toProto()}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"ImageCacheKeyProto ImageCacheKey.toProto()"})
  public void testToProto_thenReturnPublicResourceKeyIsEmptyString() {
    // Arrange
    ImageCacheKey forImageResult =
        ImageCacheKey.forImage(ModelConstants.SYSTEM_TENANT, "Key", true);

    // Act
    ImageCacheKeyProto actualToProtoResult = forImageResult.toProto();

    // Assert
    assertEquals("", actualToProtoResult.getPublicResourceKey());
    assertEquals("Key", actualToProtoResult.getResourceKey());
    assertEquals(5, actualToProtoResult.getSerializedSize());
    assertFalse(actualToProtoResult.hasPublicResourceKey());
    assertTrue(actualToProtoResult.hasResourceKey());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean ImageCacheKey.isPublic()"})
  public void testIsPublic_thenReturnFalse() {
    // Arrange
    ImageCacheKey forImageResult =
        ImageCacheKey.forImage(ModelConstants.SYSTEM_TENANT, "Key", true);

    // Act and Assert
    assertFalse(forImageResult.isPublic());
  }
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(forPublicImageResult.hashCode(), forPublicImageResult2.hashCode());
  }
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual2() {
    ...
    assertEquals(forImageResult.hashCode(), forImageResult2.hashCode());
  }
  ...
  public void testWithPreview() {
    ...
    // Act
    ImageCacheKey actualWithPreviewResult = forImageResult.withPreview(true);

    // Assert
    assertSame(forImageResult, actualWithPreviewResult);
  }
