...
public class AuditLogServiceImplDiffblueTest {
  ...
  public void testFindAuditLogsByTenantIdAndCustomerId_givenAdded_thenCallsGetId() {
    // Arrange
  ...
  public void testFindAuditLogsByTenantIdAndCustomerId_thenCallsGetId() {
    // Arrange
    PageData<AuditLog> emptyPageDataResult = PageData.emptyPageData();
    when(auditLogDao.findAuditLogsByTenantIdAndCustomerId(
            Mockito.<UUID>any(),
  ...
  public void testFindAuditLogsByTenantIdAndCustomerId_whenSystem_tenant() {
    // Arrange
    PageData<AuditLog> emptyPageDataResult = PageData.emptyPageData();
    when(auditLogDao.findAuditLogsByTenantIdAndCustomerId(
            Mockito.<UUID>any(),
  ...
  public void testFindAuditLogsByTenantIdAndUserId_givenNull_uuid_thenCallsGetId() {
    // Arrange
    PageData<AuditLog> emptyPageDataResult = PageData.emptyPageData();
  ...
  public void testFindAuditLogsByTenantIdAndUserId_thenReturnEmpty_page_data() {
    // Arrange
    PageData<AuditLog> emptyPageDataResult = PageData.emptyPageData();
    when(auditLogDao.findAuditLogsByTenantIdAndUserId(
            Mockito.<UUID>any(),
  ...
  public void testFindAuditLogsByTenantIdAndEntityId_whenSystem_tenant_thenCallsGetId() {
    // Arrange
    PageData<AuditLog> emptyPageDataResult = PageData.emptyPageData();
    when(auditLogDao.findAuditLogsByTenantIdAndEntityId(
            Mockito.<UUID>any(),
  ...
  public void testFindAuditLogsByTenantId_givenAdded_whenArrayListAddAdded_thenCallsGetId() {
    // Arrange
    PageData<AuditLog> emptyPageDataResult = PageData.emptyPageData();
  ...
  public void testFindAuditLogsByTenantId_givenDeleted_whenArrayListAddDeleted_thenCallsGetId() {
    // Arrange
    PageData<AuditLog> emptyPageDataResult = PageData.emptyPageData();
    when(auditLogDao.findAuditLogsByTenantId(
            Mockito.<UUID>any(), Mockito.<List<ActionType>>any(), Mockito.<TimePageLink>any()))
  ...
  public void testFindAuditLogsByTenantId_givenNull_uuid_thenCallsGetId() {
    // Arrange
    PageData<AuditLog> emptyPageDataResult = PageData.emptyPageData();
    when(auditLogDao.findAuditLogsByTenantId(
            Mockito.<UUID>any(), Mockito.<List<ActionType>>any(), Mockito.<TimePageLink>any()))
  ...
  public void testLogEntityAction_givenDashboard_whenArrayList_thenCallsGetEntityType() {
    // Arrange
    when(auditLogLevelFilter.logEnabled(Mockito.<EntityType>any(), Mockito.<ActionType>any()))
        .thenReturn(true);
  ...
  public void testLogEntityAction_whenEmptyString_thenReturnSettableFuture2() {
    // Arrange
    when(auditLogLevelFilter.logEnabled(Mockito.<EntityType>any(), Mockito.<ActionType>any()))
        .thenReturn(true);
    when(dataValidator.validate(
  ...
  public void testLogEntityAction_whenRpc_call_thenReturnSettableFuture2() {
    // Arrange
    when(auditLogLevelFilter.logEnabled(Mockito.<EntityType>any(), Mockito.<ActionType>any()))
        .thenReturn(true);
    when(dataValidator.validate(
