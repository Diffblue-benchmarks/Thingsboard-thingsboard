...
public class DataValidatorDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void DataValidator.validateString(String, String)"})
  public void testValidateString_whenName_thenDoesNotThrow() {
    // Arrange, Act and Assert
    dataValidator.validateString("Exception Prefix", "Name");
  }
  ...
  public void testValidateEmail_whenJaneDoeExampleOrg_thenDoesNotThrow() {
    // Arrange, Act and Assert
    DataValidator.validateEmail("jane.doe@example.org");
  }
   ...
   *
   * <ul>
   *   <li>When {@link TenantEntityWithDataDao}.
   *   <li>Then does not throw.
   * </ul>
   *
   * <p>Method under test: {@link DataValidator#validateMaxSumDataSizePerTenant(TenantId,
  ...
  public void testValidateMaxSumDataSizePerTenant_whenTenantEntityWithDataDao_thenDoesNotThrow() {
    // Arrange, Act and Assert
    dataValidator.validateMaxSumDataSizePerTenant(
        ModelConstants.SYSTEM_TENANT,
        mock(TenantEntityWithDataDao.class),
        0L,
        3L,
        EntityType.TENANT);
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void DataValidator.validateJsonStructure(JsonNode, JsonNode)"})
  public void testValidateJsonStructure_thenDoesNotThrow() {
    // Arrange, Act and Assert
    DataValidator.validateJsonStructure(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void DataValidator.validateJsonStructure(JsonNode, JsonNode)"})
  public void testValidateJsonStructure_whenFalse_thenThrowDataValidationException() {
    // Arrange, Act and Assert
    assertThrows(
        DataValidationException.class,
        () ->
            DataValidator.validateJsonStructure(
                BooleanNode.getFalse(), CustomerServiceImpl.PUBLIC_CUSTOMER_ADDITIONAL_INFO_JSON));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void DataValidator.validateQueueName(String)"})
  public void testValidateQueueName_whenName_thenDoesNotThrow() {
    // Arrange, Act and Assert
    DataValidator.validateQueueName("Name");
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void DataValidator.validateQueueTopic(String)"})
  public void testValidateQueueTopic_whenTopic_thenDoesNotThrow() {
    // Arrange, Act and Assert
    DataValidator.validateQueueTopic("Topic");
  }
  ...
  public void testValidateQueueNameOrTopic_when42_thenDoesNotThrow() {
    // Arrange, Act and Assert
    DataValidator.validateQueueNameOrTopic("42", "Field Name");
  }
