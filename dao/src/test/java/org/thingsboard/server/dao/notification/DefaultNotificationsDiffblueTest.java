...
public class DefaultNotificationsDiffblueTest {
  ...
  public void testDefaultNotificationEqualsAndHashCode_whenOtherIsSame_thenReturnEqual() {
    ...
    DefaultRule rule =
        DefaultRule.builder()
            ...
            .build();
    DefaultNotification buildResult =
        nameResult
            .rule(rule)
  ...
  public void testDefaultNotificationEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    ...
    DefaultRule rule2 =
        DefaultRule.builder()
            ...
            .triggerConfig(mock(NotificationRuleTriggerConfig.class))
            .build();
    DefaultNotification buildResult2 =
        nameResult2
            .rule(rule2)
            .subject("Hello from the Dreaming Spires")
            .text("Text")
  ...
  public void testDefaultNotificationEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    ...
    when(defaultNotificationBuilder.button(Mockito.<String>any()))
        .thenReturn(DefaultNotification.builder());
    DefaultNotificationBuilder nameResult =
  ...
  public void testDefaultNotificationEquals_whenOtherIsDifferent_thenReturnNotEqual3() {
    ...
    when(defaultNotificationBuilder2.button(Mockito.<String>any()))
        .thenReturn(defaultNotificationBuilder);
    DefaultNotificationBuilder nameResult =
        defaultNotificationBuilder2
            .button("Button")
            .color("Color")
            .icon("Icon")
            .link("Link")
  ...
  public void testDefaultNotificationEquals_whenOtherIsDifferent_thenReturnNotEqual4() {
    ...
    when(defaultNotificationBuilder.icon(Mockito.<String>any()))
        .thenReturn(DefaultNotification.builder());
    DefaultNotificationBuilder defaultNotificationBuilder2 = mock(DefaultNotificationBuilder.class);
    when(defaultNotificationBuilder2.color(Mockito.<String>any()))
        .thenReturn(defaultNotificationBuilder);
    DefaultNotificationBuilder defaultNotificationBuilder3 = mock(DefaultNotificationBuilder.class);
    when(defaultNotificationBuilder3.button(Mockito.<String>any()))
        .thenReturn(defaultNotificationBuilder2);
    DefaultNotificationBuilder nameResult =
        defaultNotificationBuilder3
            .button("Button")
            .color("Color")
            .icon("Icon")
            .link("Link")
  ...
  public void testDefaultNotificationEquals_whenOtherIsDifferent_thenReturnNotEqual7() {
    ...
    DefaultRule rule =
        DefaultRule.builder()
            ...
            .build();
    DefaultNotification buildResult =
        nameResult.rule(rule).subject("Name").text("Text").type(NotificationType.GENERAL).build();
    DefaultNotificationBuilder nameResult2 =
        DefaultNotification.builder()
            .button("Button")
            .color("Color")
  ...
  public void testDefaultNotificationEquals_whenOtherIsDifferent_thenReturnNotEqual8() {
    ...
    DefaultRule rule =
        DefaultRule.builder()
            ...
            .build();
    DefaultNotification buildResult =
        nameResult.rule(rule).subject(null).text("Text").type(NotificationType.GENERAL).build();
    DefaultNotificationBuilder nameResult2 =
        DefaultNotification.builder()
            .button("Button")
            .color("Color")
  ...
  public void testDefaultNotificationEquals_whenOtherIsDifferent_thenReturnNotEqual16() {
    ...
    DefaultRule rule2 =
        DefaultRule.builder()
            ...
            .build();
    DefaultNotification buildResult2 =
        nameResult2.rule(rule2).subject(null).text("Text").type(NotificationType.GENERAL).build();
  ...
  public void testDefaultNotificationToRule() {
    ...
    NotificationRule actualToRuleResult =
        defaultNotification.toRule(templateId, new NotificationTargetId(id));
  ...
  public void testDefaultNotification_DefaultNotificationBuilderBuild() {
    ...
    // Act
    DefaultNotification actualBuildResult =
        nameResult
            .rule(rule)
            .subject("Hello from the Dreaming Spires")
            .text("Text")
