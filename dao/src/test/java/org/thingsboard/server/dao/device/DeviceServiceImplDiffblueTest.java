...
public class DeviceServiceImplDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"ListenableFuture DeviceServiceImpl.findDeviceByIdAsync(TenantId, DeviceId)"})
  public void testFindDeviceByIdAsync_thenCallsFindByIdAsync() {
    // Arrange
    JpaDeviceDao deviceDao = mock(JpaDeviceDao.class);
    SettableFuture<Device> createResult = SettableFuture.create();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"ListenableFuture DeviceServiceImpl.findDeviceByIdAsync(TenantId, DeviceId)"})
  public void testFindDeviceByIdAsync_thenCallsFindByIdAsync2() {
    // Arrange
    when(deviceDao.findByIdAsync(Mockito.<TenantId>any(), Mockito.<UUID>any()))
        .thenThrow(new DataValidationException("An error occurred"));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Device DeviceServiceImpl.saveDeviceWithAccessToken(Device, String)"})
  public void testSaveDeviceWithAccessToken2() {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Device DeviceServiceImpl.saveDeviceWithAccessToken(Device, String)"})
  public void testSaveDeviceWithAccessToken_givenSystem_tenant_thenCallsGetId() {
    // Arrange
    JpaDeviceDao deviceDao = new JpaDeviceDao();
    JpaDeviceCredentialsDao deviceCredentialsDao = new JpaDeviceCredentialsDao();
    DeviceCredentialsServiceImpl deviceCredentialsService =
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Device DeviceServiceImpl.saveDevice(Device)"})
  public void testSaveDeviceWithDevice2() {
    // Arrange
    when(deviceDataValidator.validate(
            Mockito.<Device>any(), Mockito.<Function<Device, TenantId>>any()))
        .thenThrow(new DataValidationException("An error occurred"));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Device DeviceServiceImpl.saveDevice(Device, boolean)"})
  public void testSaveDeviceWithDeviceDoValidate_givenSystem_tenant() {
    // Arrange
    JpaDeviceDao deviceDao = new JpaDeviceDao();
    JpaDeviceCredentialsDao deviceCredentialsDao = new JpaDeviceCredentialsDao();
    DeviceCredentialsServiceImpl deviceCredentialsService =
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Device DeviceServiceImpl.saveDevice(Device, boolean)"})
  public void testSaveDeviceWithDeviceDoValidate_thenCallsGetId() {
    // Arrange
    JpaDeviceDao deviceDao = new JpaDeviceDao();
    JpaDeviceCredentialsDao deviceCredentialsDao = new JpaDeviceCredentialsDao();
    DeviceCredentialsServiceImpl deviceCredentialsService =
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Device DeviceServiceImpl.saveDevice(Device)"})
  public void testSaveDeviceWithDevice_givenSystem_tenant_thenCallsGetId() {
    // Arrange
    JpaDeviceDao deviceDao = new JpaDeviceDao();
    JpaDeviceCredentialsDao deviceCredentialsDao = new JpaDeviceCredentialsDao();
    DeviceCredentialsServiceImpl deviceCredentialsService =
  ...
  public void testSaveDeviceWithCredentials2() {
    // Arrange
    when(deviceDataValidator.validate(
            Mockito.<Device>any(), Mockito.<Function<Device, TenantId>>any()))
        .thenThrow(new DataValidationException("An error occurred"));
  ...
  public void testSaveDeviceWithCredentials_givenSystem_tenant_thenCallsGetId() {
    // Arrange
    JpaDeviceDao deviceDao = new JpaDeviceDao();
    JpaDeviceCredentialsDao deviceCredentialsDao = new JpaDeviceCredentialsDao();
    DeviceCredentialsServiceImpl deviceCredentialsService =
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData DeviceServiceImpl.findDevicesByTenantId(TenantId, PageLink)"})
  public void testFindDevicesByTenantId_thenCallsFindDevicesByTenantId() {
    // Arrange
    when(deviceDao.findDevicesByTenantId(Mockito.<UUID>any(), Mockito.<PageLink>any()))
        .thenThrow(new DataValidationException("An error occurred"));
  ...
  public void testFindDeviceInfosByFilter_givenSortOrderGetPropertyReturnNull_thenCallsGetId() {
    // Arrange
    JpaDeviceDao deviceDao = mock(JpaDeviceDao.class);
    PageData<DeviceInfo> emptyPageDataResult = PageData.emptyPageData();
    when(deviceDao.findDeviceInfosByFilter(
  ...
  public void testFindDeviceInfosByFilter_thenReturnEmpty_page_data() {
    // Arrange
    JpaDeviceDao deviceDao = mock(JpaDeviceDao.class);
    PageData<DeviceInfo> emptyPageDataResult = PageData.emptyPageData();
    when(deviceDao.findDeviceInfosByFilter(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData DeviceServiceImpl.findDeviceIdInfos(PageLink)"})
  public void testFindDeviceIdInfos_thenCallsFindDeviceIdInfos() {
    // Arrange
  ...
  public void testFindDevicesByTenantIdAndType_thenCallsFindDevicesByTenantIdAndType() {
    // Arrange
    when(deviceDao.findDevicesByTenantIdAndType(
            Mockito.<UUID>any(), Mockito.<String>any(), Mockito.<PageLink>any()))
        .thenThrow(new DataValidationException("An error occurred"));
  ...
  public void testCountDevicesByTenantIdAndDeviceProfileIdAndEmptyOtaPackage4() {
    // Arrange
    when(deviceDao.countDevicesByTenantIdAndDeviceProfileIdAndEmptyOtaPackage(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<OtaPackageType>any()))
        .thenThrow(new DataValidationException("An error occurred"));
  ...
  public void testFindDevicesByTenantIdAndIdsAsync3() {
    // Arrange
    DeviceDao deviceDao = mock(DeviceDao.class);
    JpaDeviceCredentialsDao deviceCredentialsDao = new JpaDeviceCredentialsDao();
    DeviceCredentialsServiceImpl deviceCredentialsService =
  ...
  public void testFindDevicesByTenantIdAndIdsAsync_givenNull_uuid() {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void DeviceServiceImpl.deleteDevicesByTenantId(TenantId)"})
  public void testDeleteDevicesByTenantId2() {
    // Arrange
    DeviceDao deviceDao = mock(DeviceDao.class);
    JpaDeviceCredentialsDao deviceCredentialsDao = new JpaDeviceCredentialsDao();
    DeviceCredentialsServiceImpl deviceCredentialsService =
  ...
  public void testDeleteByTenantId_givenDataValidationExceptionWithMessageIsAnErrorOccurred() {
    // Arrange
    DeviceDao deviceDao = mock(DeviceDao.class);
    JpaDeviceCredentialsDao deviceCredentialsDao = new JpaDeviceCredentialsDao();
    DeviceCredentialsServiceImpl deviceCredentialsService =
  ...
  public void testFindDevicesByTenantIdAndCustomerId_thenCallsGetId2() {
    // Arrange
    JpaDeviceDao deviceDao = mock(JpaDeviceDao.class);
    PageData<Device> emptyPageDataResult = PageData.emptyPageData();
    when(deviceDao.findDevicesByTenantIdAndCustomerId(
  ...
  public void testFindDevicesByTenantIdAndCustomerIdAndType_thenCallsGetId2() {
    // Arrange
    JpaDeviceDao deviceDao = mock(JpaDeviceDao.class);
    PageData<Device> emptyPageDataResult = PageData.emptyPageData();
    when(deviceDao.findDevicesByTenantIdAndCustomerIdAndType(
  ...
  public void testFindDevicesByTenantIdCustomerIdAndIdsAsync4() {
    // Arrange
    TenantId tenantId = mock(TenantId.class);
    when(tenantId.getId()).thenReturn(ModelConstants.NULL_UUID);
   ...
   *
   * <ul>
   *   <li>Then calls {@link DeviceDao#findDevicesByTenantIdAndCustomerId(UUID, UUID, PageLink)}.
   * </ul>
   *
   * <p>Method under test: {@link DeviceServiceImpl#unassignCustomerDevices(TenantId, CustomerId)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"ListenableFuture DeviceServiceImpl.findDeviceTypesByTenantId(TenantId)"})
  public void testFindDeviceTypesByTenantId_thenCallsFindTenantDeviceTypesAsync() {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Device DeviceServiceImpl.assignDeviceToTenant(TenantId, Device)"})
  public void testAssignDeviceToTenant_thenCallsGetTenantId() {
    // Arrange
  ...
  public void testAssignDeviceToEdge_thenThrowDataValidationException() {
    // Arrange
    DeviceId deviceId = mock(DeviceId.class);
    when(deviceId.getId()).thenThrow(new DataValidationException("An error occurred"));
  ...
  public void testUnassignDeviceFromEdge_thenThrowDataValidationException() {
    // Arrange
    DeviceId deviceId = mock(DeviceId.class);
    when(deviceId.getId()).thenThrow(new DataValidationException("An error occurred"));
  ...
  public void testFindDevicesByTenantIdAndEdgeId_thenCallsFindDevicesByTenantIdAndEdgeId() {
    // Arrange
    JpaDeviceDao deviceDao = mock(JpaDeviceDao.class);
    PageData<Device> emptyPageDataResult = PageData.emptyPageData();
    when(deviceDao.findDevicesByTenantIdAndEdgeId(
  ...
  public void testFindDevicesByTenantIdAndEdgeId_thenCallsFindDevicesByTenantIdAndEdgeId2() {
    // Arrange
    PageData<Device> emptyPageDataResult = PageData.emptyPageData();
    when(deviceDao.findDevicesByTenantIdAndEdgeId(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
  ...
  public void testFindDevicesByTenantIdAndEdgeIdAndType7() {
    // Arrange
    when(deviceDao.findDevicesByTenantIdAndEdgeIdAndType(
            Mockito.<UUID>any(),
            Mockito.<UUID>any(),
