...
public class RelationCacheKeyDiffblueTest {
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual2() {
    // Arrange
    RelationCacheKeyBuilder relationCacheKeyBuilder = mock(RelationCacheKeyBuilder.class);
    when(relationCacheKeyBuilder.typeGroup(Mockito.<RelationTypeGroup>any()))
        .thenReturn(RelationCacheKey.builder());
    RelationCacheKeyBuilder relationCacheKeyBuilder2 = mock(RelationCacheKeyBuilder.class);
    when(relationCacheKeyBuilder2.type(Mockito.<String>any())).thenReturn(relationCacheKeyBuilder);
    RelationCacheKeyBuilder relationCacheKeyBuilder3 = mock(RelationCacheKeyBuilder.class);
    when(relationCacheKeyBuilder3.to(Mockito.<EntityId>any())).thenReturn(relationCacheKeyBuilder2);
    RelationCacheKeyBuilder relationCacheKeyBuilder4 = mock(RelationCacheKeyBuilder.class);
    when(relationCacheKeyBuilder4.from(Mockito.<EntityId>any()))
        .thenReturn(relationCacheKeyBuilder3);
    RelationCacheKeyBuilder relationCacheKeyBuilder5 = mock(RelationCacheKeyBuilder.class);
    when(relationCacheKeyBuilder5.direction(Mockito.<EntitySearchDirection>any()))
        .thenReturn(relationCacheKeyBuilder4);
    RelationCacheKey buildResult =
        relationCacheKeyBuilder5
            .direction(EntitySearchDirection.FROM)
            .from(BaseEntityService.NULL_CUSTOMER_ID)
            .to(BaseEntityService.NULL_CUSTOMER_ID)
            .type("Type")
            .typeGroup(RelationTypeGroup.COMMON)
            .build();
    RelationCacheKeyBuilder relationCacheKeyBuilder6 = mock(RelationCacheKeyBuilder.class);
    when(relationCacheKeyBuilder6.direction(Mockito.<EntitySearchDirection>any()))
        .thenReturn(RelationCacheKey.builder());
    RelationCacheKey buildResult2 =
        relationCacheKeyBuilder6
            .direction(EntitySearchDirection.FROM)
            .from(null)
            .to(null)
            .type(null)
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    // Arrange
    RelationCacheKeyBuilder relationCacheKeyBuilder = mock(RelationCacheKeyBuilder.class);
    when(relationCacheKeyBuilder.from(Mockito.<EntityId>any()))
        .thenReturn(RelationCacheKey.builder());
    RelationCacheKeyBuilder relationCacheKeyBuilder2 = mock(RelationCacheKeyBuilder.class);
    when(relationCacheKeyBuilder2.direction(Mockito.<EntitySearchDirection>any()))
        .thenReturn(relationCacheKeyBuilder);
    RelationCacheKey buildResult =
        relationCacheKeyBuilder2
            .direction(EntitySearchDirection.FROM)
            .from(BaseEntityService.NULL_CUSTOMER_ID)
            .to(BaseEntityService.NULL_CUSTOMER_ID)
            .type("Type")
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual4() {
    // Arrange
    RelationCacheKeyBuilder relationCacheKeyBuilder = mock(RelationCacheKeyBuilder.class);
    when(relationCacheKeyBuilder.to(Mockito.<EntityId>any()))
        .thenReturn(RelationCacheKey.builder());
    RelationCacheKeyBuilder relationCacheKeyBuilder2 = mock(RelationCacheKeyBuilder.class);
    when(relationCacheKeyBuilder2.from(Mockito.<EntityId>any()))
        .thenReturn(relationCacheKeyBuilder);
    RelationCacheKeyBuilder relationCacheKeyBuilder3 = mock(RelationCacheKeyBuilder.class);
    when(relationCacheKeyBuilder3.direction(Mockito.<EntitySearchDirection>any()))
        .thenReturn(relationCacheKeyBuilder2);
    RelationCacheKey buildResult =
        relationCacheKeyBuilder3
            .direction(EntitySearchDirection.FROM)
            .from(BaseEntityService.NULL_CUSTOMER_ID)
            .to(BaseEntityService.NULL_CUSTOMER_ID)
            .type("Type")
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual6() {
    // Arrange
    RelationCacheKeyBuilder builderResult = RelationCacheKey.builder();
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual7() {
    // Arrange
    RelationCacheKeyBuilder relationCacheKeyBuilder = mock(RelationCacheKeyBuilder.class);
    when(relationCacheKeyBuilder.type(Mockito.<String>any()))
        .thenReturn(RelationCacheKey.builder());
    RelationCacheKeyBuilder relationCacheKeyBuilder2 = mock(RelationCacheKeyBuilder.class);
    when(relationCacheKeyBuilder2.to(Mockito.<EntityId>any())).thenReturn(relationCacheKeyBuilder);
    RelationCacheKeyBuilder relationCacheKeyBuilder3 = mock(RelationCacheKeyBuilder.class);
    when(relationCacheKeyBuilder3.from(Mockito.<EntityId>any()))
        .thenReturn(relationCacheKeyBuilder2);
    RelationCacheKeyBuilder relationCacheKeyBuilder4 = mock(RelationCacheKeyBuilder.class);
    when(relationCacheKeyBuilder4.direction(Mockito.<EntitySearchDirection>any()))
        .thenReturn(relationCacheKeyBuilder3);
    RelationCacheKey buildResult =
        relationCacheKeyBuilder4
            .direction(EntitySearchDirection.FROM)
            .from(BaseEntityService.NULL_CUSTOMER_ID)
            .to(BaseEntityService.NULL_CUSTOMER_ID)
            .type("Type")
  ...
  public void testRelationCacheKeyBuilderBuild() {
    // Arrange and Act
    RelationCacheKey actualBuildResult =
        RelationCacheKey.builder()
            .direction(EntitySearchDirection.FROM)
            .from(BaseEntityService.NULL_CUSTOMER_ID)
            .to(BaseEntityService.NULL_CUSTOMER_ID)
