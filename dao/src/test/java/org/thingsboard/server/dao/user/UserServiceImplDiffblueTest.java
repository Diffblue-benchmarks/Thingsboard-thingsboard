...
public class UserServiceImplDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void UserServiceImpl.handleEvictEvent(UserCacheEvictEvent)"})
  public void testHandleEvictEventWithUserCacheEvictEvent4() {
    // Arrange
    doNothing().when(tbTransactionalCache).evict(Mockito.<Collection<UserCacheKey>>any());
    UserCacheEvictEvent event =
        new UserCacheEvictEvent(ModelConstants.SYSTEM_TENANT, "jane.doe@example.org", null);
  ...
  public void testFindUserById_givenNull_uuid_whenUserIdGetIdReturnNull_uuid_thenReturnUser() {
    // Arrange
    User user = new User();
  ...
  public void testFindUserByIdAsync_givenNull_uuid_whenUserIdGetIdReturnNull_uuid() {
    // Arrange
    ...
    ListenableFuture<User> actualFindUserByIdAsyncResult =
        userServiceImpl.findUserByIdAsync(ModelConstants.SYSTEM_TENANT, userId);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"ListenableFuture UserServiceImpl.findUserByIdAsync(TenantId, UserId)"})
  public void testFindUserByIdAsync_thenThrowIncorrectParameterException() {
    // Arrange
    UserId userId = mock(UserId.class);
    when(userId.getId()).thenThrow(new IncorrectParameterException("An error occurred"));
  ...
  public void testSaveUser2() {
    ...
    when(user2.getTenantId()).thenReturn(mock(TenantId.class));
  ...
  public void testSaveUser3() {
    ...
    // Act and Assert
    assertThrows(IncorrectParameterException.class, () -> userServiceImpl.saveUser(null, user));
    verify(user).getEmail();
  ...
  public void testFindUserCredentialsByUserId_givenNull_uuid_whenUserIdGetIdReturnNull_uuid() {
    // Arrange
  ...
  public void testActivateUserCredentials3() {
    // Arrange
    UserCredentials userCredentials = mock(UserCredentials.class);
   ...
   *
   * <ul>
   *   <li>Given {@link UserCredentials} {@link UserCredentials#isEnabled()} return {@code true}.
   * </ul>
   *
   * <p>Method under test: {@link UserServiceImpl#activateUserCredentials(TenantId, String, String)}
   */
  ...
  public void testActivateUserCredentials_givenUserCredentialsIsEnabledReturnTrue() {
    // Arrange
    UserCredentials userCredentials = mock(UserCredentials.class);
   ...
   * <ul>
   *   <li>Given {@code null}.
   *   <li>When {@link UserCredentials} {@link UserCredentials#getPassword()} return {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link UserServiceImpl#replaceUserCredentials(TenantId, UserCredentials)}
   */
  ...
  public void testReplaceUserCredentials_givenNull_whenUserCredentialsGetPasswordReturnNull() {
    // Arrange
    JpaUserCredentialsDao userCredentialsDao = mock(JpaUserCredentialsDao.class);
    when(userCredentialsDao.save(Mockito.<TenantId>any(), Mockito.<UserCredentials>any()))
        .thenReturn(new UserCredentials());
  ...
  public void testReplaceUserCredentials_thenCallsPublishEvent() {
    // Arrange
    JpaUserCredentialsDao userCredentialsDao = mock(JpaUserCredentialsDao.class);
    when(userCredentialsDao.save(Mockito.<TenantId>any(), Mockito.<UserCredentials>any()))
        .thenReturn(new UserCredentials());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData UserServiceImpl.findUsersByTenantId(TenantId, PageLink)"})
  public void testFindUsersByTenantId_givenNull_uuid_thenCallsGetId() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findByTenantId(Mockito.<UUID>any(), Mockito.<PageLink>any()))
        .thenReturn(emptyPageDataResult);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData UserServiceImpl.findUsersByTenantId(TenantId, PageLink)"})
  public void testFindUsersByTenantId_givenSortOrderGetPropertyReturnEmptyString() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findByTenantId(Mockito.<UUID>any(), Mockito.<PageLink>any()))
        .thenReturn(emptyPageDataResult);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData UserServiceImpl.findUsersByTenantId(TenantId, PageLink)"})
  public void testFindUsersByTenantId_givenSortOrderGetPropertyReturnNull_thenCallsGetProperty() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findByTenantId(Mockito.<UUID>any(), Mockito.<PageLink>any()))
        .thenReturn(emptyPageDataResult);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData UserServiceImpl.findTenantAdmins(TenantId, PageLink)"})
  public void testFindTenantAdmins_givenNull_uuid_thenCallsGetId() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findTenantAdmins(Mockito.<UUID>any(), Mockito.<PageLink>any()))
        .thenReturn(emptyPageDataResult);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData UserServiceImpl.findTenantAdmins(TenantId, PageLink)"})
  public void testFindTenantAdmins_givenSortOrderGetPropertyReturnEmptyString() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findTenantAdmins(Mockito.<UUID>any(), Mockito.<PageLink>any()))
        .thenReturn(emptyPageDataResult);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData UserServiceImpl.findTenantAdmins(TenantId, PageLink)"})
  public void testFindTenantAdmins_givenSortOrderGetPropertyReturnNull_thenCallsGetProperty() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findTenantAdmins(Mockito.<UUID>any(), Mockito.<PageLink>any()))
        .thenReturn(emptyPageDataResult);
  ...
  public void testFindTenantAdminsByTenantProfilesIds_givenNull_whenArrayListAddNull() {
    ...
    PageData<User> actualFindTenantAdminsByTenantProfilesIdsResult =
        userServiceImpl.findTenantAdminsByTenantProfilesIds(
            tenantProfilesIds, BaseRelatedEdgesService.FIRST_PAGE);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void UserServiceImpl.deleteTenantAdmins(TenantId)"})
  public void testDeleteTenantAdmins_thenCallsGetId() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findTenantAdmins(Mockito.<UUID>any(), Mockito.<PageLink>any()))
        .thenReturn(emptyPageDataResult);
    ...
    // Act
    userServiceImpl.deleteTenantAdmins(tenantId);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void UserServiceImpl.deleteTenantAdmins(TenantId)"})
  public void testDeleteTenantAdmins_thenThrowIncorrectParameterException() {
    // Arrange
    TenantId tenantId = mock(TenantId.class);
    when(tenantId.getId()).thenThrow(new IncorrectParameterException("An error occurred"));
    ...
    // Act and Assert
    assertThrows(
        IncorrectParameterException.class, () -> userServiceImpl.deleteTenantAdmins(tenantId));
    verify(tenantId).getId();
  }
  ...
  public void testDeleteAllByTenantId() {
    // Arrange
    when(userDao.findByTenantId(Mockito.<UUID>any(), Mockito.<PageLink>any()))
        .thenThrow(new IncorrectParameterException("An error occurred"));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void UserServiceImpl.deleteAllByTenantId(TenantId)"})
  public void testDeleteAllByTenantId_givenNull_uuid_thenCallsGetId() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findByTenantId(Mockito.<UUID>any(), Mockito.<PageLink>any()))
        .thenReturn(emptyPageDataResult);
    ...
    // Act
    userServiceImpl.deleteAllByTenantId(tenantId);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void UserServiceImpl.deleteAllByTenantId(TenantId)"})
  public void testDeleteAllByTenantId_givenUserDao() {
    // Arrange
    TenantId tenantId = mock(TenantId.class);
    when(tenantId.getId()).thenThrow(new IncorrectParameterException("An error occurred"));
    ...
    // Act and Assert
    assertThrows(
        IncorrectParameterException.class, () -> userServiceImpl.deleteAllByTenantId(tenantId));
    verify(tenantId).getId();
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void UserServiceImpl.deleteAllByTenantId(TenantId)"})
  public void testDeleteAllByTenantId_whenSystem_tenant_thenCallsFindByTenantId() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findByTenantId(Mockito.<UUID>any(), Mockito.<PageLink>any()))
        .thenReturn(emptyPageDataResult);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void UserServiceImpl.deleteByTenantId(TenantId)"})
  public void testDeleteByTenantId_givenUserDao() {
    // Arrange
    TenantId tenantId = mock(TenantId.class);
    when(tenantId.getId()).thenThrow(new IncorrectParameterException("An error occurred"));
    ...
    // Act and Assert
    assertThrows(
        IncorrectParameterException.class, () -> userServiceImpl.deleteByTenantId(tenantId));
    verify(tenantId).getId();
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void UserServiceImpl.deleteByTenantId(TenantId)"})
  public void testDeleteByTenantId_whenSystem_tenant_thenCallsFindByTenantId() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findByTenantId(Mockito.<UUID>any(), Mockito.<PageLink>any()))
        .thenReturn(emptyPageDataResult);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData UserServiceImpl.findCustomerUsers(TenantId, CustomerId, PageLink)"})
  public void testFindCustomerUsers2() {
    // Arrange
    PageLink pageLink = mock(PageLink.class);
    when(pageLink.getPageSize()).thenThrow(new IncorrectParameterException("An error occurred"));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData UserServiceImpl.findCustomerUsers(TenantId, CustomerId, PageLink)"})
  public void testFindCustomerUsers3() {
    // Arrange
    SortOrder sortOrder = mock(SortOrder.class);
    when(sortOrder.getProperty()).thenThrow(new IncorrectParameterException("An error occurred"));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData UserServiceImpl.findCustomerUsers(TenantId, CustomerId, PageLink)"})
  public void testFindCustomerUsers4() {
    // Arrange
    TenantId tenantId = mock(TenantId.class);
    when(tenantId.getId()).thenThrow(new IncorrectParameterException("An error occurred"));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData UserServiceImpl.findCustomerUsers(TenantId, CustomerId, PageLink)"})
  public void testFindCustomerUsers_givenBy_created_time_desc() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findCustomerUsers(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData UserServiceImpl.findCustomerUsers(TenantId, CustomerId, PageLink)"})
  public void testFindCustomerUsers_givenNull_uuid_thenCallsGetId() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findCustomerUsers(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
    ...
    // Act
    PageData<User> actualFindCustomerUsersResult =
        userServiceImpl.findCustomerUsers(tenantId, BaseEntityService.NULL_CUSTOMER_ID, pageLink);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData UserServiceImpl.findCustomerUsers(TenantId, CustomerId, PageLink)"})
  public void testFindCustomerUsers_givenSortOrderGetPropertyReturnEmptyString() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findCustomerUsers(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData UserServiceImpl.findCustomerUsers(TenantId, CustomerId, PageLink)"})
  public void testFindCustomerUsers_givenSortOrderGetPropertyReturnNull_thenCallsGetProperty() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findCustomerUsers(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData UserServiceImpl.findCustomerUsers(TenantId, CustomerId, PageLink)"})
  public void testFindCustomerUsers_whenCustomerIdGetIdReturnNull_uuid_thenCallsGetId() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findCustomerUsers(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
    ...
    // Act
    PageData<User> actualFindCustomerUsersResult =
        userServiceImpl.findCustomerUsers(tenantId, customerId, pageLink);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData UserServiceImpl.findUsersByCustomerIds(TenantId, List, PageLink)"})
  public void testFindUsersByCustomerIds4() {
    // Arrange
    TenantId tenantId = mock(TenantId.class);
    when(tenantId.getId()).thenThrow(new IncorrectParameterException("An error occurred"));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData UserServiceImpl.findUsersByCustomerIds(TenantId, List, PageLink)"})
  public void testFindUsersByCustomerIds_givenNull_uuid_thenCallsGetId() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findUsersByCustomerIds(
            Mockito.<UUID>any(), Mockito.<List<CustomerId>>any(), Mockito.<PageLink>any()))
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData UserServiceImpl.findUsersByCustomerIds(TenantId, List, PageLink)"})
  public void testFindUsersByCustomerIds_givenSortOrderGetPropertyReturnEmptyString() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findUsersByCustomerIds(
            Mockito.<UUID>any(), Mockito.<List<CustomerId>>any(), Mockito.<PageLink>any()))
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData UserServiceImpl.findUsersByCustomerIds(TenantId, List, PageLink)"})
  public void testFindUsersByCustomerIds_givenSortOrderGetPropertyReturnNull() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findUsersByCustomerIds(
            Mockito.<UUID>any(), Mockito.<List<CustomerId>>any(), Mockito.<PageLink>any()))
  ...
  public void testDeleteCustomerUsers_givenNull_uuid_whenTenantIdGetIdReturnNull_uuid() {
    // Arrange
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findCustomerUsers(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
    ...
    // Act
    userServiceImpl.deleteCustomerUsers(tenantId, BaseEntityService.NULL_CUSTOMER_ID);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void UserServiceImpl.deleteCustomerUsers(TenantId, CustomerId)"})
  public void testDeleteCustomerUsers_thenCallsGetId() {
    // Arrange
    UserDao userDao = mock(UserDao.class);
    PageData<User> emptyPageDataResult = PageData.emptyPageData();
    when(userDao.findCustomerUsers(
    ...
    // Act
    userServiceImpl.deleteCustomerUsers(tenantId, customerId);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void UserServiceImpl.deleteCustomerUsers(TenantId, CustomerId)"})
  public void testDeleteCustomerUsers_thenThrowIncorrectParameterException() {
    // Arrange
    TenantId tenantId = mock(TenantId.class);
    when(tenantId.getId()).thenThrow(new IncorrectParameterException("An error occurred"));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void UserServiceImpl.setUserCredentialsEnabled(TenantId, UserId, boolean)"})
  public void testSetUserCredentialsEnabled_thenCallsGetId() {
    // Arrange
    JpaUserDao userDao = new JpaUserDao();
    JpaUserCredentialsDao userCredentialsDao = new JpaUserCredentialsDao();
    JpaUserAuthSettingsDao userAuthSettingsDao =
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void UserServiceImpl.setUserCredentialsEnabled(TenantId, UserId, boolean)"})
  public void testSetUserCredentialsEnabled_thenCallsSave2() {
    // Arrange
    when(userCredentialsDao.save(Mockito.<TenantId>any(), Mockito.<UserCredentials>any()))
        .thenReturn(new UserCredentials());
    when(userCredentialsDao.findByUserId(Mockito.<TenantId>any(), Mockito.<UUID>any()))
  ...
  public void testSaveMobileSession2() {
    // Arrange
    when(userSettingsDao.findByTypeAndPath(
            Mockito.<TenantId>any(), Mockito.<UserSettingsType>any(), isA(String[].class)))
        .thenThrow(new IncorrectParameterException("An error occurred"));
   ...
   *
   * <ul>
   *   <li>Then calls {@link JpaUserSettingsDao#findByTypeAndPath(TenantId, UserSettingsType,
   *       String[])}.
   * </ul>
   *
   * <p>Method under test: {@link UserServiceImpl#saveMobileSession(TenantId, UserId, String,
  ...
  public void testSaveMobileSession_thenCallsFindByTypeAndPath()
    ...
    doNothing()
        ...
        .updateUserSettings(
            ...
            Mockito.<UserId>any(),
            Mockito.<UserSettingsType>any(),
            Mockito.<JsonNode>any());

    JpaUserSettingsDao userSettingsDao = mock(JpaUserSettingsDao.class);
    when(userSettingsDao.findByTypeAndPath(
            Mockito.<TenantId>any(), Mockito.<UserSettingsType>any(), isA(String[].class)))
        .thenReturn(new ArrayList<>());
    JpaUserDao userDao = new JpaUserDao();
    ...
    verify(userSettingsService)
        .updateUserSettings(
            isA(TenantId.class), isNull(), eq(UserSettingsType.MOBILE), isA(JsonNode.class));
  }
  ...
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"Map UserServiceImpl.findMobileSessions(TenantId, UserId)"})
  public void testFindMobileSessions_thenReturnEmpty() throws UnsupportedEncodingException {
    // Arrange
    UserSettings userSettings = new UserSettings();
    userSettings.setSettingsBytes("AXAXAXAX".getBytes("UTF-8"));
    userSettings.setType(UserSettingsType.GENERAL);
    ...
    // Act
    Map<String, MobileSessionInfo> actualFindMobileSessionsResult =
   ...
   *
   * <ul>
   *   <li>Then calls {@link UserSettingsDao#findByTypeAndPath(TenantId, UserSettingsType,
   *       String[])}.
   * </ul>
   *
  ...
  public void testRemoveMobileSession_thenCallsFindByTypeAndPath() {
    // Arrange
    when(userSettingsDao.findByTypeAndPath(
            Mockito.<TenantId>any(), Mockito.<UserSettingsType>any(), isA(String[].class)))
        .thenReturn(new ArrayList<>());
