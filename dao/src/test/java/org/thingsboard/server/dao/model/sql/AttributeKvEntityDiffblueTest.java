...
public class AttributeKvEntityDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"AttributeKvEntry AttributeKvEntity.toData()"})
  public void testToData_givenAttributeKvEntityDoubleValueIsNull_thenKvReturnLongDataEntry() {
    // Arrange
    AttributeKvCompositeKey id = new AttributeKvCompositeKey();
    id.setAttributeKey(1);
    id.setAttributeType(1);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"AttributeKvEntry AttributeKvEntity.toData()"})
  public void testToData_givenAttributeKvEntityJsonValueIsNull_thenReturnKvIsNull() {
    // Arrange
    AttributeKvCompositeKey id = new AttributeKvCompositeKey();
    id.setAttributeKey(1);
    id.setAttributeType(1);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"AttributeKvEntry AttributeKvEntity.toData()"})
  public void testToData_givenAttributeKvEntityLongValueIsNull_thenKvReturnJsonDataEntry() {
    // Arrange
    AttributeKvCompositeKey id = new AttributeKvCompositeKey();
    id.setAttributeKey(1);
    id.setAttributeType(1);
