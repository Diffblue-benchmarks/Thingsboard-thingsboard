...
public class BaseResourceServiceDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"TbResource BaseResourceService.saveResource(TbResource)"})
  public void testSaveResourceWithResource8() throws UnsupportedEncodingException {
    // Arrange
    JpaTbResourceDao resourceDao = new JpaTbResourceDao(mock(TbResourceRepository.class));
    JpaTbResourceInfoDao resourceInfoDao = new JpaTbResourceInfoDao();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"TbResource BaseResourceService.saveResource(TbResource, boolean)"})
  public void testSaveResourceWithResourceDoValidate11() throws UnsupportedEncodingException {
    // Arrange
    JpaTbResourceDao resourceDao = new JpaTbResourceDao(mock(TbResourceRepository.class));
    JpaTbResourceInfoDao resourceInfoDao = new JpaTbResourceInfoDao();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"TbResource BaseResourceService.saveResource(TbResource, boolean)"})
  public void testSaveResourceWithResourceDoValidate_givenResourceDataValidator_whenFalse()
   ...
   *   <li>Then calls {@link TbResource#getFileName()}.
   * </ul>
   *
   * <p>Method under test: {@link BaseResourceService#saveResource(TbResource, boolean)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"TbResource BaseResourceService.saveResource(TbResource, boolean)"})
  public void testSaveResourceWithResourceDoValidate_givenResourceKey_thenCallsGetFileName()
      throws UnsupportedEncodingException {
    // Arrange
    JpaTbResourceDao resourceDao = new JpaTbResourceDao(mock(TbResourceRepository.class));
    JpaTbResourceInfoDao resourceInfoDao = new JpaTbResourceInfoDao();
    ...
    verify(resource, atLeast(1)).getResourceType();
    verify(resource, atLeast(1)).getTenantId();
    verify(resource).getTitle();
    verify(resource).setEtag("5c5b6209d867a8c020ea0d75a22fb3ccf66cb4d88a4b53e001e1398f1a60badc");
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"TbResource BaseResourceService.saveResource(TbResource, boolean)"})
  public void testSaveResourceWithResourceDoValidate_thenCallsIsSysTenantId()
      throws UnsupportedEncodingException {
    // Arrange
    ...
    when(resource.getResourceType()).thenReturn(ResourceType.LWM2M_MODEL);
    when(resource.getTitle()).thenReturn("Dr");
    when(resource.getTenantId()).thenReturn(tenantId);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"TbResource BaseResourceService.saveResource(TbResource)"})
  public void testSaveResourceWithResource_givenResourceKey_thenCallsGetFileName()
      throws UnsupportedEncodingException {
    // Arrange
    JpaTbResourceDao resourceDao = new JpaTbResourceDao(mock(TbResourceRepository.class));
    JpaTbResourceInfoDao resourceInfoDao = new JpaTbResourceInfoDao();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"TbResource BaseResourceService.saveResource(TbResource)"})
  public void testSaveResourceWithResource_thenCallsIsSysTenantId()
      throws UnsupportedEncodingException {
    // Arrange
    JpaTbResourceDao resourceDao = mock(JpaTbResourceDao.class);
    ConstraintViolationException constraintViolationException =
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"TbResource BaseResourceService.doSaveResource(TbResource)"})
  public void testDoSaveResource_givenAxaxaxaxBytesIsUtf8() throws UnsupportedEncodingException {
    // Arrange
    doNothing().when(tbTransactionalCache).evict(Mockito.<ResourceInfoCacheKey>any());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"TbResource BaseResourceService.doSaveResource(TbResource)"})
  public void testDoSaveResource_givenNull_whenTbResourceGetDataReturnNull_thenCallsGetData() {
    // Arrange
    doNothing().when(tbTransactionalCache).evict(Mockito.<ResourceInfoCacheKey>any());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void BaseResourceService.deleteResource(TenantId, TbResourceId)"})
  public void testDeleteResourceWithTenantIdResourceId_thenCallsHandleEntityDeletionEvent() {
    // Arrange
    doNothing().when(cleanUpService).handleEntityDeletionEvent(Mockito.<DeleteEntityEvent<?>>any());
    doNothing().when(tbResourceDao).removeById(Mockito.<TenantId>any(), Mockito.<UUID>any());
    when(tbResourceDao.findById(Mockito.<TenantId>any(), Mockito.<UUID>any()))
  ...
  /**
   * Test {@link BaseResourceService#deleteEntity(TenantId, EntityId, boolean)}.
   *
   * <p>Method under test: {@link BaseResourceService#deleteEntity(TenantId, EntityId, boolean)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"void BaseResourceService.deleteEntity(TenantId, EntityId, boolean)"})
  public void testDeleteEntity() {
    ...
    assertThrows(
        ConstraintViolationException.class,
        () ->
            baseResourceService.deleteEntity(
                ModelConstants.SYSTEM_TENANT, new TbResourceId(ModelConstants.NULL_UUID), false));
    verify(resourceDataValidator).validateDelete(isA(TenantId.class), isA(EntityId.class));
  }
   ...
   *       null}.
   *   <li>Then calls {@link TbResourceDao#findById(TenantId, UUID)}.
   * </ul>
   *
   * <p>Method under test: {@link BaseResourceService#deleteEntity(TenantId, EntityId, boolean)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void BaseResourceService.deleteEntity(TenantId, EntityId, boolean)"})
  public void testDeleteEntity_givenTbResourceDaoFindByIdReturnNull_thenCallsFindById() {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void BaseResourceService.deleteEntity(TenantId, EntityId, boolean)"})
  public void testDeleteEntity_whenTrue_thenCallsHandleEntityDeletionEvent() {
    // Arrange
    doNothing().when(cleanUpService).handleEntityDeletionEvent(Mockito.<DeleteEntityEvent<?>>any());
    doNothing().when(tbResourceDao).removeById(Mockito.<TenantId>any(), Mockito.<UUID>any());
    when(tbResourceDao.findById(Mockito.<TenantId>any(), Mockito.<UUID>any()))
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String BaseResourceService.calculateEtag(byte[])"})
  public void testCalculateEtag2() throws UnsupportedEncodingException {
    // Arrange, Act and Assert
    assertEquals(
        "b3b8e9bb377ea61eeb38b29303ca700c2abe0289b83f742f1b4aa1ee3fec5938",
        baseResourceService.calculateEtag("XXAXAXAX".getBytes("UTF-8")));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void BaseResourceService.handleEvictEvent(ResourceInfoEvictEvent)"})
  public void testHandleEvictEventWithResourceInfoEvictEvent_thenDoesNotThrow() {
    // Arrange
    ResourceInfoEvictEvent event = new ResourceInfoEvictEvent(ModelConstants.SYSTEM_TENANT, null);
