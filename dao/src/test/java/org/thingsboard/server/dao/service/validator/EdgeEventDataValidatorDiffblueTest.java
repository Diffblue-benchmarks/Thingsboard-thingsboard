...
public class EdgeEventDataValidatorDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link EdgeEventDataValidator} (default constructor).
   * </ul>
   *
  ...
  public void testValidateDataImplWithTenantIdEdgeEvent_givenEdgeEventDataValidator() {
    // Arrange
    EdgeEventDataValidator edgeEventDataValidator = new EdgeEventDataValidator();
