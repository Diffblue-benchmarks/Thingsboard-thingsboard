...
public class ResourceDataValidatorDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link ResourceDataValidator} (default constructor).
   * </ul>
   *
  ...
  public void testValidateCreateWithTenantIdTbResource_givenResourceDataValidator() {
    // Arrange
    ResourceDataValidator resourceDataValidator = new ResourceDataValidator();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void ResourceDataValidator.validateCreate(TenantId, TbResource)"})
  public void testValidateCreateWithTenantIdTbResource_givenResource_thenDoesNotThrow() {
    // Arrange
    TbResource resource = new TbResource(new TbResourceId(ModelConstants.NULL_UUID));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void ResourceDataValidator.validateDataImpl(TenantId, TbResource)"})
  public void testValidateDataImplWithTenantIdTbResource4() throws UnsupportedEncodingException {
    // Arrange
    TbResource resource = mock(TbResource.class);
  ...
  public void testValidateResourceSize2() {
    // Arrange
   ...
   *
   * <ul>
   *   <li>Given {@link TbResourceDao} {@link TbResourceDao#sumDataSizeByTenantId(TenantId)} return
   *       one.
   * </ul>
   *
   * <p>Method under test: {@link ResourceDataValidator#validateResourceSize(TenantId, TbResourceId,
  ...
  public void testValidateResourceSize_givenTbResourceDaoSumDataSizeByTenantIdReturnOne() {
    // Arrange
  ...
  public void testValidateResourceSize_givenTbResourceDaoSumDataSizeByTenantIdReturnThree() {
    // Arrange
    when(tbResourceDao.sumDataSizeByTenantId(Mockito.<TenantId>any())).thenReturn(3L);
    when(tbResourceDao.getResourceSize(Mockito.<TenantId>any(), Mockito.<TbResourceId>any()))
        .thenReturn(3L);
  ...
  public void testValidateResourceSize_givenTbResourceDao_whenSystem_tenant_thenDoesNotThrow() {
    // Arrange, Act and Assert
    resourceDataValidator.validateResourceSize(
        ModelConstants.SYSTEM_TENANT, new TbResourceId(ModelConstants.NULL_UUID), 3L);
  }
