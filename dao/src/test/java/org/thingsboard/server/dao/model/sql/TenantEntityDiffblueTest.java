...
public class TenantEntityDiffblueTest {
  ...
  public void testNewTenantEntity_thenAdditionalInfoReturnNullNode() {
    // Arrange
    Tenant tenant = new Tenant(new Tenant());
    tenant.setTenantProfileId(new TenantProfileId(ModelConstants.NULL_UUID));

    // Act and Assert
    assertTrue(new TenantEntity(tenant).getAdditionalInfo() instanceof NullNode);
  }
  ...
  public void testNewTenantEntity_whenTenant_thenToDataAdditionalInfoReturnNullNode() {
    ...
    assertTrue(toDataResult.getAdditionalInfo() instanceof NullNode);
    assertNull(actualTenantEntity.getAdditionalInfo());
    assertNull(actualTenantEntity.getTenantProfileId());
