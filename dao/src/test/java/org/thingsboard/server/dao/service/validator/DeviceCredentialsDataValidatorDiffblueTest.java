...
public class DeviceCredentialsDataValidatorDiffblueTest {
  @Mock private DeviceCredentialsDao deviceCredentialsDao;

  @InjectMocks private DeviceCredentialsDataValidator deviceCredentialsDataValidator;
  ...
  public void testValidateDataImplWithTenantIdDeviceCredentials() {
    // Arrange
    DeviceCredentialsDataValidator deviceCredentialsDataValidator =
  ...
  public void testValidateDataImplWithTenantIdDeviceCredentials5() {
    // Arrange
    when(deviceService.findDeviceById(Mockito.<TenantId>any(), Mockito.<DeviceId>any()))
        .thenReturn(null);
