...
public class EdgeInfoEntityDiffblueTest {
  ...
  public void testNewEdgeInfoEntity_thenReturnToDataCustomerIsPublic() {
    // Arrange
    EdgeEntity edgeEntity = new EdgeEntity();
    edgeEntity.setAdditionalInfo(CustomerServiceImpl.PUBLIC_CUSTOMER_ADDITIONAL_INFO_JSON);
    edgeEntity.setCreatedTime(1L);
    ...
    assertSame(jsonNode, actualEdgeInfoEntity.getAdditionalInfo());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void EdgeInfoEntity.<init>(EdgeEntity, String, Object)"})
  public void testNewEdgeInfoEntity_whenNull_thenReturnNotToDataCustomerIsPublic() {
    // Arrange
    EdgeEntity edgeEntity = new EdgeEntity();
    edgeEntity.setAdditionalInfo(CustomerServiceImpl.PUBLIC_CUSTOMER_ADDITIONAL_INFO_JSON);
    edgeEntity.setCreatedTime(1L);
    ...
    // Assert
    assertFalse(actualEdgeInfoEntity.toData().isCustomerIsPublic());
