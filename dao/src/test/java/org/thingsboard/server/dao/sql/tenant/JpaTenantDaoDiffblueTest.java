...
public class JpaTenantDaoDiffblueTest {
  ...
  public void testFindTenantInfoById_thenAdditionalInfoReturnNullNode() {
    ...
    assertTrue(actualFindTenantInfoByIdResult.getAdditionalInfo() instanceof NullNode);
    assertNull(actualFindTenantInfoByIdResult.getVersion());
    assertNull(actualFindTenantInfoByIdResult.getAddress());
    assertNull(actualFindTenantInfoByIdResult.getAddress2());
    assertNull(actualFindTenantInfoByIdResult.getCity());
    assertNull(actualFindTenantInfoByIdResult.getCountry());
    assertNull(actualFindTenantInfoByIdResult.getEmail());
    assertNull(actualFindTenantInfoByIdResult.getName());
    assertNull(actualFindTenantInfoByIdResult.getPhone());
    assertNull(actualFindTenantInfoByIdResult.getRegion());
    assertNull(actualFindTenantInfoByIdResult.getState());
    assertNull(actualFindTenantInfoByIdResult.getTitle());
    assertNull(actualFindTenantInfoByIdResult.getZip());
    assertNull(actualFindTenantInfoByIdResult.getTenantProfileName());
    assertNull(actualFindTenantInfoByIdResult.getUuidId());
    assertNull(actualFindTenantInfoByIdResult.getTenantProfileId());
    assertEquals(0L, actualFindTenantInfoByIdResult.getCreatedTime());
  }
