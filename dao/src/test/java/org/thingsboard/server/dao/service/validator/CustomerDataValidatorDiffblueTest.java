...
public class CustomerDataValidatorDiffblueTest {
  ...
  public void testValidateUpdateWithTenantIdCustomer() {
    ...
    assertThrows(
        ...
        () ->
            customerDataValidator.validateUpdate(
                ModelConstants.SYSTEM_TENANT, new Customer(BaseEntityService.NULL_CUSTOMER_ID)));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void CustomerDataValidator.validateDataImpl(TenantId, Customer)"})
  public void testValidateDataImplWithTenantIdCustomer4() {
    // Arrange
    Customer customer = new Customer(BaseEntityService.NULL_CUSTOMER_ID);
    customer.setTitle("Dr\u0000");
    customer.setTenantId(ModelConstants.SYSTEM_TENANT);
   ...
   * <ul>
   *   <li>Given {@code U@U.U}.
   *   <li>When {@link Customer#Customer()} Email is {@code U@U.U}.
   * </ul>
   *
   * <p>Method under test: {@link CustomerDataValidator#validateDataImpl(TenantId, Customer)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void CustomerDataValidator.validateDataImpl(TenantId, Customer)"})
  public void testValidateDataImplWithTenantIdCustomer_givenUUU_whenCustomerEmailIsUUU() {
    // Arrange
    CustomerDataValidator customerDataValidator = new CustomerDataValidator();

    Customer customer = new Customer();
    customer.setEmail("U@U.U");
    customer.setTitle("Dr");
   ...
   *
   * <ul>
   *   <li>When {@link Customer#Customer()} Title is {@code Dr}.
   * </ul>
   *
   * <p>Method under test: {@link CustomerDataValidator#validateDataImpl(TenantId, Customer)}
   */
