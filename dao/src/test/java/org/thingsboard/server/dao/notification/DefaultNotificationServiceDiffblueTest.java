...
import org.thingsboard.server.common.data.notification.Notification.NotificationBuilder;
...
public class DefaultNotificationServiceDiffblueTest {
  @Autowired private DefaultNotificationService defaultNotificationService;

  @MockBean private NotificationDao notificationDao;

  /**
   * Test {@link DefaultNotificationService#saveNotification(TenantId, Notification)}.
   *
   * <p>Method under test: {@link DefaultNotificationService#saveNotification(TenantId,
   * Notification)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Notification DefaultNotificationService.saveNotification(TenantId, Notification)"
  })
  public void testSaveNotification() {
    // Arrange
    NotificationBuilder notificationBuilder = mock(NotificationBuilder.class);
    when(notificationBuilder.info(Mockito.<NotificationInfo>any()))
        .thenReturn(Notification.builder());

    NotificationBuilder notificationBuilder2 = mock(NotificationBuilder.class);
    when(notificationBuilder2.deliveryMethod(Mockito.<NotificationDeliveryMethod>any()))
        .thenReturn(notificationBuilder);

    NotificationBuilder recipientIdResult =
    ...
    when(notificationDao.save(Mockito.<TenantId>any(), Mockito.<Notification>any()))
        .thenReturn(
            recipientIdResult
                .requestId(requestId)
    ...
    // Act
    Notification actualSaveNotificationResult =
        defaultNotificationService.saveNotification(
            ModelConstants.SYSTEM_TENANT, new Notification());

    // Assert
    verify(notificationBuilder2).deliveryMethod(NotificationDeliveryMethod.WEB);
  ...
  /**
   * Test {@link DefaultNotificationService#findNotificationById(TenantId, NotificationId)}.
   *
   * <p>Method under test: {@link DefaultNotificationService#findNotificationById(TenantId,
   * NotificationId)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Notification DefaultNotificationService.findNotificationById(TenantId, NotificationId)"
  })
  public void testFindNotificationById() {
    ...
    NotificationBuilder recipientIdResult =
        notificationBuilder2
            ...
            .recipientId(null);
    NotificationRequestId requestId = new NotificationRequestId(ModelConstants.NULL_UUID);
    when(notificationDao.findById(Mockito.<TenantId>any(), Mockito.<UUID>any()))
        .thenReturn(
            recipientIdResult
                .requestId(requestId)
                .status(NotificationStatus.SENT)
    ...
    // Act
    Notification actualFindNotificationByIdResult =
        defaultNotificationService.findNotificationById(
            ModelConstants.SYSTEM_TENANT, new NotificationId(ModelConstants.NULL_UUID));
  ...
  /**
   * Test {@link DefaultNotificationService#markNotificationAsRead(TenantId, UserId,
   * NotificationId)}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link DefaultNotificationService#markNotificationAsRead(TenantId,
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean DefaultNotificationService.markNotificationAsRead(TenantId, UserId, NotificationId)"
  })
  public void testMarkNotificationAsRead_thenReturnFalse() {
    // Arrange
    when(notificationDao.updateStatusByIdAndRecipientId(
            Mockito.<TenantId>any(),
            Mockito.<UserId>any(),
            Mockito.<NotificationId>any(),
            Mockito.<NotificationStatus>any()))
        .thenReturn(false);

    // Act
    boolean actualMarkNotificationAsReadResult =
        defaultNotificationService.markNotificationAsRead(
            ModelConstants.SYSTEM_TENANT, null, new NotificationId(ModelConstants.NULL_UUID));

    // Assert
    verify(notificationDao)
        .updateStatusByIdAndRecipientId(
            isA(TenantId.class), isNull(), isA(NotificationId.class), eq(NotificationStatus.READ));
  ...
  /**
   * Test {@link DefaultNotificationService#markAllNotificationsAsRead(TenantId,
   ...
   * </ul>
   *
   * <p>Method under test: {@link DefaultNotificationService#markAllNotificationsAsRead(TenantId,
   * NotificationDeliveryMethod, UserId)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "int DefaultNotificationService.markAllNotificationsAsRead(TenantId, NotificationDeliveryMethod, UserId)"
  })
  public void testMarkAllNotificationsAsRead_thenReturnOne() {
    // Arrange
    when(notificationDao.updateStatusByDeliveryMethodAndRecipientId(
            Mockito.<TenantId>any(),
    ...
    // Act
    int actualMarkAllNotificationsAsReadResult =
        defaultNotificationService.markAllNotificationsAsRead(
            ModelConstants.SYSTEM_TENANT, NotificationDeliveryMethod.WEB, null);

    // Assert
    verify(notificationDao)
        .updateStatusByDeliveryMethodAndRecipientId(
            isA(TenantId.class),
  ...
  /**
   * Test {@link DefaultNotificationService#findNotificationsByRecipientIdAndReadStatus(TenantId,
   * NotificationDeliveryMethod, UserId, boolean, PageLink)}.
   *
   * <p>Method under test: {@link
   * DefaultNotificationService#findNotificationsByRecipientIdAndReadStatus(TenantId,
   * NotificationDeliveryMethod, UserId, boolean, PageLink)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "PageData DefaultNotificationService.findNotificationsByRecipientIdAndReadStatus(TenantId, NotificationDeliveryMethod, UserId, boolean, PageLink)"
  })
  public void testFindNotificationsByRecipientIdAndReadStatus() {
    ...
    when(notificationDao.findUnreadByDeliveryMethodAndRecipientIdAndPageLink(
            Mockito.<TenantId>any(),
            Mockito.<NotificationDeliveryMethod>any(),
            Mockito.<UserId>any(),
    ...
    // Act
    PageData<Notification> actualFindNotificationsByRecipientIdAndReadStatusResult =
        defaultNotificationService.findNotificationsByRecipientIdAndReadStatus(
    ...
    verify(notificationDao)
        .findUnreadByDeliveryMethodAndRecipientIdAndPageLink(
            isA(TenantId.class), eq(NotificationDeliveryMethod.WEB), isNull(), isA(PageLink.class));
    assertSame(PageData.EMPTY_PAGE_DATA, actualFindNotificationsByRecipientIdAndReadStatusResult);
  }
  ...
  public void testFindNotificationsByRecipientIdAndReadStatus2() {
    // Arrange
    PageData<Notification> emptyPageDataResult = PageData.emptyPageData();
    when(notificationDao.findByDeliveryMethodAndRecipientIdAndPageLink(
            Mockito.<TenantId>any(),
            Mockito.<NotificationDeliveryMethod>any(),
            Mockito.<UserId>any(),
            Mockito.<PageLink>any()))
  ...
  /**
   * Test {@link
   * DefaultNotificationService#findLatestUnreadNotificationsByRecipientIdAndNotificationTypes(TenantId,
   * NotificationDeliveryMethod, UserId, Set, int)}.
   *
   * <ul>
   *   <li>Given {@code ALARM}.
   * </ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "PageData DefaultNotificationService.findLatestUnreadNotificationsByRecipientIdAndNotificationTypes(TenantId, NotificationDeliveryMethod, UserId, Set, int)"
  })
    ...
    PageData<Notification>
        actualFindLatestUnreadNotificationsByRecipientIdAndNotificationTypesResult =
            defaultNotificationService
                .findLatestUnreadNotificationsByRecipientIdAndNotificationTypes(
                    ModelConstants.SYSTEM_TENANT, NotificationDeliveryMethod.WEB, null, types, 1);
  ...
  /**
   * Test {@link DefaultNotificationService#countUnreadNotificationsByRecipientId(TenantId,
   * NotificationDeliveryMethod, UserId)}.
   *
   * <ul>
   *   <li>Then return one.
   ...
   *
   * <p>Method under test: {@link
   * DefaultNotificationService#countUnreadNotificationsByRecipientId(TenantId,
   * NotificationDeliveryMethod, UserId)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  ...
  public void testCountUnreadNotificationsByRecipientId_thenReturnOne() {
    // Arrange
    when(notificationDao.countUnreadByDeliveryMethodAndRecipientId(
            Mockito.<TenantId>any(),
            Mockito.<NotificationDeliveryMethod>any(),
            Mockito.<UserId>any()))
        .thenReturn(1);
    ...
    // Act
    int actualCountUnreadNotificationsByRecipientIdResult =
        defaultNotificationService.countUnreadNotificationsByRecipientId(
            ModelConstants.SYSTEM_TENANT, NotificationDeliveryMethod.WEB, null);

    // Assert
    verify(notificationDao)
        .countUnreadByDeliveryMethodAndRecipientId(
            isA(TenantId.class), eq(NotificationDeliveryMethod.WEB), isNull());
   ...
   * </ul>
   *
   * <p>Method under test: {@link DefaultNotificationService#deleteNotification(TenantId, UserId,
   * NotificationId)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean DefaultNotificationService.deleteNotification(TenantId, UserId, NotificationId)"
  })
  public void testDeleteNotification_thenReturnFalse() {
    // Arrange
    when(notificationDao.deleteByIdAndRecipientId(
            Mockito.<TenantId>any(), Mockito.<UserId>any(), Mockito.<NotificationId>any()))
        .thenReturn(false);

    // Act
    boolean actualDeleteNotificationResult =
        defaultNotificationService.deleteNotification(
            ModelConstants.SYSTEM_TENANT, null, new NotificationId(ModelConstants.NULL_UUID));

    // Assert
    verify(notificationDao)
        .deleteByIdAndRecipientId(isA(TenantId.class), isNull(), isA(NotificationId.class));
   ...
   *
   * <ul>
   *   <li>Then {@link Optional#get()} AdditionalConfig return {@link ObjectNode}.
   * </ul>
   *
   * <p>Method under test: {@link DefaultNotificationService#findEntity(TenantId, EntityId)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"Optional DefaultNotificationService.findEntity(TenantId, EntityId)"})
  public void testFindEntity_thenGetAdditionalConfigReturnObjectNode() {
    // Arrange
    ...
    when(notificationRepository.findById(Mockito.<UUID>any())).thenReturn(ofResult);
    ...
    Optional<HasId<?>> actualFindEntityResult =
        new DefaultNotificationService(notificationDao)
            .findEntity(ModelConstants.SYSTEM_TENANT, BaseEntityService.NULL_CUSTOMER_ID);

    // Assert
    verify(notificationRepository).findById(isA(UUID.class));
    HasId<?> getResult = actualFindEntityResult.get();
    assertTrue(((Notification) getResult).getAdditionalConfig() instanceof ObjectNode);
    ...
    assertEquals(1L, ((Notification) getResult).getCreatedTime());
    assertEquals(NotificationDeliveryMethod.WEB, ((Notification) getResult).getDeliveryMethod());
   ...
   *
   * <p>Method under test: {@link DefaultNotificationService#getEntityType()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testGetEntityType() {
    ...
    // Act and Assert
    assertEquals(
        EntityType.NOTIFICATION, new DefaultNotificationService(notificationDao).getEntityType());
  }
}
