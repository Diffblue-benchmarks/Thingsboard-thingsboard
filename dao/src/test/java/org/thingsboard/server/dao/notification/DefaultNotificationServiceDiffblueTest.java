...
public class DefaultNotificationServiceDiffblueTest {
  ...
  public void testFindNotificationById() {
    ...
    Notification actualFindNotificationByIdResult =
        defaultNotificationService.findNotificationById(
            ...
            new NotificationId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9")));
  ...
  public void testFindNotificationsByRecipientIdAndReadStatus() {
    ...
    assertSame(
        actualFindNotificationsByRecipientIdAndReadStatusResult.EMPTY_PAGE_DATA,
  ...
  public void testFindLatestUnreadNotificationsByRecipientIdAndNotificationTypes_givenAlarm() {
    ...
    verify(notificationDao)
        .findUnreadByDeliveryMethodAndRecipientIdAndNotificationTypesAndPageLink(
            ...
            isA(PageLink.class));
    assertSame(
        actualFindLatestUnreadNotificationsByRecipientIdAndNotificationTypesResult.EMPTY_PAGE_DATA,
        actualFindLatestUnreadNotificationsByRecipientIdAndNotificationTypesResult);
  }
