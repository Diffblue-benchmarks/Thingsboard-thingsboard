...
public class DeviceConnectivityUtilDiffblueTest {
  ...
  public void testGetMqttPublishCommand3() {
    // Arrange
  ...
  public void testGetMqttPublishCommand_givenNull_thenReturnNull() {
    // Arrange
    DeviceCredentials deviceCredentials =
        new DeviceCredentials(new DeviceCredentialsId(ModelConstants.NULL_UUID));
    deviceCredentials.setCredentialsType(DeviceCredentialsType.MQTT_BASIC);
   ...
   * <ul>
   *   <li>Given space.
   *   <li>Then return array length is {@code 1236}.
   * </ul>
   *
   * <p>Method under test: {@link DeviceConnectivityUtil#getGatewayDockerComposeFile(String,
   * DeviceConnectivityInfo, DeviceCredentials, String)}
  ...
  public void testGetGatewayDockerComposeFile_givenSpace_thenReturnArrayLengthIs1236()
      throws IOException, URISyntaxException {
    // Arrange
    try (MockedStatic<InetAddress> mockInetAddress = mockStatic(InetAddress.class)) {
      mockInetAddress
      ...
      assertTrue(actualGatewayDockerComposeFile instanceof ByteArrayResource);
      assertEquals(
          1236, ((ByteArrayResource) actualGatewayDockerComposeFile).getByteArray().length);
      assertEquals(1236, actualGatewayDockerComposeFile.getContentAsByteArray().length);
    }
  }
   ...
   *
   * <ul>
   *   <li>Then return array length is {@code 1220}.
   * </ul>
   *
   * <p>Method under test: {@link DeviceConnectivityUtil#getGatewayDockerComposeFile(String,
   * DeviceConnectivityInfo, DeviceCredentials, String)}
  ...
  public void testGetGatewayDockerComposeFile_thenReturnArrayLengthIs1220()
      throws IOException, URISyntaxException {
    // Arrange
    try (MockedStatic<InetAddress> mockInetAddress = mockStatic(InetAddress.class)) {
  ...
  public void testGetGatewayDockerComposeFile_thenReturnArrayLengthIs1245()
      throws IOException, URISyntaxException {
    // Arrange
    try (MockedStatic<InetAddress> mockInetAddress = mockStatic(InetAddress.class)) {
  ...
  public void testGetDockerMqttPublishCommand_givenBasicMqttCredentialsClientIdIs42()
