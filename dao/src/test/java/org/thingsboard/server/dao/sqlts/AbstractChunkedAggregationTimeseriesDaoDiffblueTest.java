...
public class AbstractChunkedAggregationTimeseriesDaoDiffblueTest {
  ...
  public void testFindAllAsyncWithTenantIdEntityIdQueries_thenCallsExecute() {
    // Arrange
  ...
  public void testFindAllAsyncWithTenantIdEntityIdQuery_givenOne_thenCallsGetEndTs() {
    // Arrange
    JpaSqlTimeseriesDao jpaSqlTimeseriesDao = new JpaSqlTimeseriesDao();
