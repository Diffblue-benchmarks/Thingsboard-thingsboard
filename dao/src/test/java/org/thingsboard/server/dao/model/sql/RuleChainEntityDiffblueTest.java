...
public class RuleChainEntityDiffblueTest {
  ...
  public void testNewRuleChainEntity() {
    ...
    assertSame(externalId, actualRuleChainEntity.getFirstRuleNodeId());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void RuleChainEntity.<init>(RuleChain)"})
  public void testNewRuleChainEntity_whenRuleChain_thenReturnNotRoot() {
    // Arrange and Act
  ...
  public void testToData_givenRuleChainEntity_thenAdditionalInfoReturnNullNode()
    ...
    assertNull(actualToDataResult.getFirstRuleNodeId());
  ...
  public void testToData_thenAdditionalInfoReturnObjectNode() throws UnsupportedEncodingException {
    ...
    assertEquals(RuleChainType.CORE, actualToDataResult.getType());
    assertTrue(actualToDataResult.isDebugMode());
    assertTrue(actualToDataResult.isDefault());
    assertTrue(actualToDataResult.isRoot());
    assertArrayEquals(
