...
public class DeviceProfileDataValidatorDiffblueTest {
  ...
  /**
   * Test {@link DeviceProfileDataValidator#validateUpdate(TenantId, DeviceProfile)} with {@code
   * TenantId}, {@code DeviceProfile}.
   *
   * <p>Method under test: {@link DeviceProfileDataValidator#validateUpdate(TenantId,
   * DeviceProfile)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "DeviceProfile DeviceProfileDataValidator.validateUpdate(TenantId, DeviceProfile)"
  })
  public void testValidateUpdateWithTenantIdDeviceProfile() {
    ...
    DeviceProfile deviceProfile = new DeviceProfile(new DeviceProfileId(ModelConstants.NULL_UUID));
    deviceProfile.setProvisionDeviceKey("Device Profile");
   ...
   *
   * <ul>
   *   <li>Then calls {@link DeviceProfile#getType()}.
   * </ul>
   *
   * <p>Method under test: {@link DeviceProfileDataValidator#validateUpdate(TenantId,
   * DeviceProfile)}
  ...
  public void testValidateUpdateWithTenantIdDeviceProfile_thenCallsGetType() {
    // Arrange
    DeviceProfile deviceProfile = mock(DeviceProfile.class);
    ...
    DeviceProfile deviceProfile2 = new DeviceProfile(new DeviceProfileId(ModelConstants.NULL_UUID));
    deviceProfile2.setProvisionDeviceKey("Device Profile");

    // Act and Assert
    assertThrows(
        DataValidationException.class,
        () ->
            deviceProfileDataValidator.validateUpdate(
                ModelConstants.SYSTEM_TENANT, deviceProfile2));
