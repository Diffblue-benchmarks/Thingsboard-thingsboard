...
public class DeviceInfoEntityDiffblueTest {
  ...
  public void testToData_givenDeviceInfoEntityDeviceDataIsInstance() {
    // Arrange
    DeviceInfoEntity deviceInfoEntity = new DeviceInfoEntity();
    deviceInfoEntity.setActive(true);
    deviceInfoEntity.setAdditionalInfo(CustomerServiceImpl.PUBLIC_CUSTOMER_ADDITIONAL_INFO_JSON);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"DeviceInfo DeviceInfoEntity.toData()"})
  public void testToData_givenDeviceInfoEntityDeviceDataIsNull() {
    // Arrange
    DeviceInfoEntity deviceInfoEntity = new DeviceInfoEntity();
    deviceInfoEntity.setActive(true);
    deviceInfoEntity.setAdditionalInfo(CustomerServiceImpl.PUBLIC_CUSTOMER_ADDITIONAL_INFO_JSON);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"DeviceInfo DeviceInfoEntity.toData()"})
  public void testToData_givenDeviceInfoEntityTenantIdIsRandomUUID() {
    // Arrange
    DeviceInfoEntity deviceInfoEntity = new DeviceInfoEntity();
    deviceInfoEntity.setActive(true);
    deviceInfoEntity.setAdditionalInfo(CustomerServiceImpl.PUBLIC_CUSTOMER_ADDITIONAL_INFO_JSON);
