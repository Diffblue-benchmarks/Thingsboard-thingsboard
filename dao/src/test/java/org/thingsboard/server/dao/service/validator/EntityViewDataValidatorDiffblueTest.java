...
import org.thingsboard.server.dao.sql.entityview.JpaEntityViewDao;
...
public class EntityViewDataValidatorDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void EntityViewDataValidator.validateDataImpl(TenantId, EntityView)"})
  public void testValidateDataImplWithTenantIdEntityView4() {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void EntityViewDataValidator.validateDataImpl(TenantId, EntityView)"})
  public void testValidateDataImplWithTenantIdEntityView5() {
    // Arrange
    when(tenantService.tenantExists(Mockito.<TenantId>any())).thenReturn(true);
  ...
  public void testValidateDataImplWithTenantIdEntityView_givenCustomerTenantIdIsSystem_tenant() {
    ...
    JpaCustomerDao customerDao = mock(JpaCustomerDao.class);
    when(customerDao.findById(Mockito.<TenantId>any(), Mockito.<UUID>any())).thenReturn(customer);

    EntityViewDataValidator entityViewDataValidator =
        new EntityViewDataValidator(new JpaEntityViewDao(), tenantService, customerDao);
   ...
   *
   * <ul>
   *   <li>Given {@link JpaCustomerDao} {@link JpaCustomerDao#findById(TenantId, UUID)} return
   *       {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link EntityViewDataValidator#validateDataImpl(TenantId, EntityView)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void EntityViewDataValidator.validateDataImpl(TenantId, EntityView)"})
  public void testValidateDataImplWithTenantIdEntityView_givenJpaCustomerDaoFindByIdReturnNull() {
    // Arrange
    TenantServiceImpl tenantService = mock(TenantServiceImpl.class);
    when(tenantService.tenantExists(Mockito.<TenantId>any())).thenReturn(true);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void EntityViewDataValidator.validateDataImpl(TenantId, EntityView)"})
  public void testValidateDataImplWithTenantIdEntityView_thenCallsGetTenantId() {
    // Arrange
    TenantServiceImpl tenantService = mock(TenantServiceImpl.class);
    when(tenantService.tenantExists(Mockito.<TenantId>any())).thenReturn(true);
