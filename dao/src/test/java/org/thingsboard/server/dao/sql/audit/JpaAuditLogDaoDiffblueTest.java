...
public class JpaAuditLogDaoDiffblueTest {
  ...
  public void testFindAuditLogsByTenantIdAndEntityId_givenNull_thenCallsGetPage() {
    // Arrange
    when(auditLogRepository.findAuditLogsByTenantIdAndEntityId(
            Mockito.<UUID>any(),
            Mockito.<EntityType>any(),
  ...
  public void testFindAuditLogsByTenantIdAndCustomerId_givenNull_thenReturnTotalElementsIsZero() {
    // Arrange
    when(auditLogRepository.findAuditLogsByTenantIdAndCustomerId(
            Mockito.<UUID>any(),
            Mockito.<UUID>any(),
  ...
  public void testFindAuditLogsByTenantIdAndUserId_givenNull_thenReturnTotalElementsIsZero() {
    // Arrange
    when(auditLogRepository.findAuditLogsByTenantIdAndUserId(
            Mockito.<UUID>any(),
            Mockito.<UUID>any(),
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData JpaAuditLogDao.findAuditLogsByTenantId(UUID, List, TimePageLink)"})
  public void testFindAuditLogsByTenantId_givenNull_thenReturnTotalElementsIsZero() {
    // Arrange
    when(auditLogRepository.findByTenantId(
            Mockito.<UUID>any(),
            Mockito.<String>any(),
