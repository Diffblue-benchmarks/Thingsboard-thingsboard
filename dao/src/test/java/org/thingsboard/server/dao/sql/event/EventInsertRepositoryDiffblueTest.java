...
public class EventInsertRepositoryDiffblueTest {
  ...
  public void testSave_givenTransactionManagerGetStatusReturnOne_thenCallsGetStatus()
    ...
    TransactionTemplate transactionTemplate =
        new TransactionTemplate(transactionManager2, new DefaultTransactionAttribute());
    DedicatedEventInsertRepository dedicatedEventInsertRepository =
        new DedicatedEventInsertRepository(mock(JdbcTemplate.class), transactionTemplate);

    // Act
    dedicatedEventInsertRepository.save(new ArrayList<>());
   ...
   *   <li>Then calls {@link TransactionTemplate#execute(TransactionCallback)}.
   * </ul>
   *
   * <p>Method under test: {@link EventInsertRepository#save(List)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void EventInsertRepository.save(List)"})
  public void testSave_givenTransactionTemplateExecuteReturnExecute_thenCallsExecute()
