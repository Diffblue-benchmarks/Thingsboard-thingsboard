...
public class CassandraPartitionCacheKeyDiffblueTest {
  /**
   * Test {@link CassandraPartitionCacheKey#equals(Object)}, and {@link
   * CassandraPartitionCacheKey#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean CassandraPartitionCacheKey.equals(Object)",
    "int CassandraPartitionCacheKey.hashCode()"
  })
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    CassandraPartitionCacheKey cassandraPartitionCacheKey =
        new CassandraPartitionCacheKey(BaseEntityService.NULL_CUSTOMER_ID, "Key", 1L);
    CassandraPartitionCacheKey cassandraPartitionCacheKey2 =
        new CassandraPartitionCacheKey(BaseEntityService.NULL_CUSTOMER_ID, "Key", 1L);

    // Act and Assert
    assertEquals(cassandraPartitionCacheKey, cassandraPartitionCacheKey2);
    assertEquals(cassandraPartitionCacheKey.hashCode(), cassandraPartitionCacheKey2.hashCode());
  }
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual2() {
    // Arrange
    CassandraPartitionCacheKey cassandraPartitionCacheKey =
        new CassandraPartitionCacheKey(null, "Key", 1L);
    CassandraPartitionCacheKey cassandraPartitionCacheKey2 =
        new CassandraPartitionCacheKey(null, "Key", 1L);
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual3() {
    // Arrange
    CassandraPartitionCacheKey cassandraPartitionCacheKey =
        new CassandraPartitionCacheKey(BaseEntityService.NULL_CUSTOMER_ID, null, 1L);
    CassandraPartitionCacheKey cassandraPartitionCacheKey2 =
        new CassandraPartitionCacheKey(BaseEntityService.NULL_CUSTOMER_ID, null, 1L);
   ...
   * </ul>
   *
   * <p>Method under test: {@link CassandraPartitionCacheKey#equals(Object)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    // Arrange
    CassandraPartitionCacheKey cassandraPartitionCacheKey =
        new CassandraPartitionCacheKey(ModelConstants.SYSTEM_TENANT, "Key", 1L);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual4() {
    // Arrange
    CassandraPartitionCacheKey cassandraPartitionCacheKey =
        new CassandraPartitionCacheKey(
            BaseEntityService.NULL_CUSTOMER_ID,
            "org.thingsboard.server.dao.timeseries.CassandraPartitionCacheKey",
            1L);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual5() {
    // Arrange
    CassandraPartitionCacheKey cassandraPartitionCacheKey =
        new CassandraPartitionCacheKey(BaseEntityService.NULL_CUSTOMER_ID, "Key", 3L);
  ...
  public void testEquals_whenOtherIsNull_thenReturnNotEqual() {
    ...
    assertNotEquals(
        new CassandraPartitionCacheKey(BaseEntityService.NULL_CUSTOMER_ID, "Key", 1L), null);
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void CassandraPartitionCacheKey.<init>(EntityId, String, long)",
    "EntityId CassandraPartitionCacheKey.getEntityId()",
    "String CassandraPartitionCacheKey.getKey()",
    "long CassandraPartitionCacheKey.getPartition()",
    "void CassandraPartitionCacheKey.setEntityId(EntityId)",
    "void CassandraPartitionCacheKey.setKey(String)",
    "void CassandraPartitionCacheKey.setPartition(long)",
    "String CassandraPartitionCacheKey.toString()"
  })
  public void testGettersAndSetters() {
    // Arrange and Act
    CassandraPartitionCacheKey actualCassandraPartitionCacheKey =
        new CassandraPartitionCacheKey(BaseEntityService.NULL_CUSTOMER_ID, "Key", 1L);
    ...
    // Assert
    assertEquals(
        "CassandraPartitionCacheKey(entityId=13814000-1dd2-11b2-8080-808080808080, key=Key, partition=1)",
