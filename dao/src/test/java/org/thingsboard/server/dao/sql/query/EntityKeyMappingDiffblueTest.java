...
public class EntityKeyMappingDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return {@code cast(e.entityType as varchar) as null}.
   * </ul>
   *
   * <p>Method under test: {@link EntityKeyMapping#toSelection(EntityFilterType, EntityType)}
   */
  ...
  public void testToSelection_thenReturnCastEEntityTypeAsVarcharAsNull() {
    ...
    // Act and Assert
    assertEquals(
        "cast(e.entityType as varchar) as null",
        entityKeyMapping.toSelection(EntityFilterType.SINGLE_ENTITY, EntityType.TENANT));
  }
   ...
   *
   * <ul>
   *   <li>Given {@link EntityKeyMapping} (default constructor) EntityKeyColumn is {@code Entity Key
   *       Column}.
   * </ul>
   *
   * <p>Method under test: {@link EntityKeyMapping#toQueries(QueryContext, EntityFilterType)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Stream EntityKeyMapping.toQueries(QueryContext, EntityFilterType)"})
  public void testToQueries_givenEntityKeyMappingEntityKeyColumnIsEntityKeyColumn() {
    // Arrange
    ComplexFilterPredicate predicate = new ComplexFilterPredicate();
    predicate.setOperation(ComplexOperation.AND);
    predicate.setPredicates(new ArrayList<>());
   ...
   *
   * <ul>
   *   <li>Then return first EntityKey Key is {@code Key}.
   * </ul>
   *
   * <p>Method under test: {@link EntityKeyMapping#prepareKeyMapping(EntityType, EntityDataQuery)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List EntityKeyMapping.prepareKeyMapping(EntityType, EntityDataQuery)"})
  public void testPrepareKeyMapping_thenReturnFirstEntityKeyKeyIsKey() {
    // Arrange
    EntityFilter entityFilter = mock(EntityFilter.class);
    when(entityFilter.getType()).thenReturn(EntityFilterType.SINGLE_ENTITY);
   ...
   *
   * <ul>
   *   <li>Then return not second Latest.
   * </ul>
   *
   * <p>Method under test: {@link EntityKeyMapping#prepareKeyMapping(EntityType, EntityDataQuery)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List EntityKeyMapping.prepareKeyMapping(EntityType, EntityDataQuery)"})
  public void testPrepareKeyMapping_thenReturnNotSecondLatest() {
    // Arrange
    EntityFilter entityFilter = mock(EntityFilter.class);
    when(entityFilter.getType()).thenReturn(EntityFilterType.SINGLE_ENTITY);
   ...
   *
   * <ul>
   *   <li>Then return second EntityKey Type is {@code ENTITY_FIELD}.
   * </ul>
   *
   * <p>Method under test: {@link EntityKeyMapping#prepareKeyMapping(EntityType, EntityDataQuery)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List EntityKeyMapping.prepareKeyMapping(EntityType, EntityDataQuery)"})
  public void testPrepareKeyMapping_thenReturnSecondEntityKeyTypeIsEntityField() {
    // Arrange
    EntityFilter entityFilter = mock(EntityFilter.class);
    when(entityFilter.getType()).thenReturn(EntityFilterType.SINGLE_ENTITY);
    ...
    verify(entityFilter).getType();
    assertEquals(2, actualPrepareKeyMappingResult.size());
    assertEquals("additional_info", actualPrepareKeyMappingResult.get(0).getEntityKeyColumn());
    EntityKeyMapping getResult = actualPrepareKeyMappingResult.get(1);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List EntityKeyMapping.prepareKeyMapping(EntityType, EntityDataQuery)"})
  public void testPrepareKeyMapping_thenReturnSecondLatest() {
    // Arrange
    EntityFilter entityFilter = mock(EntityFilter.class);
    when(entityFilter.getType()).thenReturn(EntityFilterType.SINGLE_ENTITY);
    ...
    EntityKeyMapping getResult = actualPrepareKeyMappingResult.get(1);
    assertTrue(getResult.isLatest());
    EntityKey entityKey3 = actualPrepareKeyMappingResult.get(0).getEntityKey();
    assertEquals(EntityKeyMapping.ADDITIONAL_INFO, entityKey3.getKey());
    assertSame(entityKey2, getResult.getEntityKey());
    assertSame(entityKey, entityKey3);
  }
