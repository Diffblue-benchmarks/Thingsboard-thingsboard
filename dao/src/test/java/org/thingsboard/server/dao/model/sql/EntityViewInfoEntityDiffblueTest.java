...
public class EntityViewInfoEntityDiffblueTest {
  ...
  public void testNewEntityViewInfoEntity() {
    // Arrange
    EntityViewEntity entityViewEntity = new EntityViewEntity();
    entityViewEntity.setAdditionalInfo(CustomerServiceImpl.PUBLIC_CUSTOMER_ADDITIONAL_INFO_JSON);
    entityViewEntity.setCreatedTime(1L);
    ...
    // Assert
    assertTrue(actualEntityViewInfoEntity.getAdditionalInfo() instanceof ObjectNode);
    assertEquals("Dr", actualEntityViewInfoEntity.getCustomerTitle());
    assertEquals("Keys", actualEntityViewInfoEntity.getKeys());
    assertEquals("Name", actualEntityViewInfoEntity.getName());
    assertEquals("Type", actualEntityViewInfoEntity.getType());
    assertEquals(1L, actualEntityViewInfoEntity.getVersion().longValue());
    assertEquals(1L, actualEntityViewInfoEntity.getCreatedTime());
    assertEquals(1L, actualEntityViewInfoEntity.getEndTs());
    assertEquals(1L, actualEntityViewInfoEntity.getStartTs());
    assertEquals(EntityType.TENANT, actualEntityViewInfoEntity.getEntityType());
