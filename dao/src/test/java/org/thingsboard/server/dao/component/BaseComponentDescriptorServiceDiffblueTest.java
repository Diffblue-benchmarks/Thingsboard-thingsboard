...
class BaseComponentDescriptorServiceDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test findById(TenantId, ComponentDescriptorId)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  @Test
  @DisplayName(
      "Test findById(TenantId, ComponentDescriptorId); given DataValidationException(String) with message is 'An error occurred'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ComponentDescriptor BaseComponentDescriptorService.findById(TenantId, ComponentDescriptorId)"
  })
  void testFindById_givenDataValidationExceptionWithMessageIsAnErrorOccurred() {
    // Arrange
  ...
  @Test
  @DisplayName(
      "Test findById(TenantId, ComponentDescriptorId); given fromString '784f394c-42b6-435a-983c-b7beff2784f9'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ComponentDescriptor BaseComponentDescriptorService.findById(TenantId, ComponentDescriptorId)"
  })
  void testFindById_givenFromString784f394c42b6435a983cB7beff2784f9() {
    // Arrange
    ComponentDescriptor componentDescriptor = new ComponentDescriptor();
    when(componentDescriptorDao.findById(
            Mockito.<TenantId>any(), Mockito.<ComponentDescriptorId>any()))
    ...
    ComponentDescriptorId componentId = mock(ComponentDescriptorId.class);
    when(componentId.getId()).thenReturn(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"));
  ...
  void testFindByTypeAndPageLink4() {
    // Arrange
  ...
  @Test
  @DisplayName(
      "Test findByTypeAndPageLink(TenantId, ComponentType, PageLink); given BY_CREATED_TIME_DESC")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "PageData BaseComponentDescriptorService.findByTypeAndPageLink(TenantId, ComponentType, PageLink)"
  })
  void testFindByTypeAndPageLink_givenBy_created_time_desc() {
    // Arrange
  ...
  @Test
  @DisplayName(
      "Test findByTypeAndPageLink(TenantId, ComponentType, PageLink); given SortOrder getProperty() return empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "PageData BaseComponentDescriptorService.findByTypeAndPageLink(TenantId, ComponentType, PageLink)"
  })
  void testFindByTypeAndPageLink_givenSortOrderGetPropertyReturnEmptyString() {
    // Arrange
    PageData<ComponentDescriptor> emptyPageDataResult = PageData.emptyPageData();
    when(componentDescriptorDao.findByTypeAndPageLink(
            Mockito.<TenantId>any(), Mockito.<ComponentType>any(), Mockito.<PageLink>any()))
  ...
  void testFindByScopeAndTypeAndPageLink3() {
    // Arrange
    SortOrder sortOrder = mock(SortOrder.class);
    when(sortOrder.getProperty()).thenThrow(new DataValidationException("An error occurred"));
  ...
  @Test
  @DisplayName(
      "Test findByScopeAndTypeAndPageLink(TenantId, ComponentScope, ComponentType, PageLink); given BY_CREATED_TIME_DESC")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "PageData BaseComponentDescriptorService.findByScopeAndTypeAndPageLink(TenantId, ComponentScope, ComponentType, PageLink)"
  })
  void testFindByScopeAndTypeAndPageLink_givenBy_created_time_desc() {
    // Arrange
    PageData<ComponentDescriptor> emptyPageDataResult = PageData.emptyPageData();
    when(componentDescriptorDao.findByScopeAndTypeAndPageLink(
            Mockito.<TenantId>any(),
  ...
  @Test
  @DisplayName(
      "Test findByScopeAndTypeAndPageLink(TenantId, ComponentScope, ComponentType, PageLink); given SortOrder getProperty() return empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "PageData BaseComponentDescriptorService.findByScopeAndTypeAndPageLink(TenantId, ComponentScope, ComponentType, PageLink)"
  })
  void testFindByScopeAndTypeAndPageLink_givenSortOrderGetPropertyReturnEmptyString() {
    // Arrange
    PageData<ComponentDescriptor> emptyPageDataResult = PageData.emptyPageData();
    when(componentDescriptorDao.findByScopeAndTypeAndPageLink(
            Mockito.<TenantId>any(),
