...
public class RuleNodeEntityDiffblueTest {
  ...
  public void testNewRuleNodeEntity() {
    ...
    assertSame(externalId, actualRuleNodeEntity.getId());
    assertSame(externalId, actualRuleNodeEntity.getUuid());
    assertSame(externalId, actualRuleNodeEntity.getRuleChainId());
  }
  ...
  public void testToData_givenRuleNodeEntity_thenAdditionalInfoReturnNullNode()
    ...
    assertNull(actualToDataResult.getRuleChainId());
  ...
  public void testToData_thenAdditionalInfoReturnObjectNode() throws UnsupportedEncodingException {
    ...
    assertEquals("Queue Name", actualToDataResult.getQueueName());
    assertEquals("Type", actualToDataResult.getType());
    assertEquals(1, actualToDataResult.getConfigurationVersion());
    assertEquals(1L, actualToDataResult.getCreatedTime());
    assertTrue(actualToDataResult.isDebugMode());
    assertTrue(actualToDataResult.isSingletonMode());
    assertArrayEquals(
