...
public class EdgeDataValidatorDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void EdgeDataValidator.validateDataImpl(TenantId, Edge)"})
  public void testValidateDataImplWithTenantIdEdge3() {
    // Arrange
    when(tenantService.tenantExists(Mockito.<TenantId>any())).thenReturn(true);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void EdgeDataValidator.validateDataImpl(TenantId, Edge)"})
  public void testValidateDataImplWithTenantIdEdge_whenEdgeNameIsEdgeName() {
    // Arrange
    Edge edge = new Edge();
    edge.setName("Edge name");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void EdgeDataValidator.validateDataImpl(TenantId, Edge)"})
  public void testValidateDataImplWithTenantIdEdge_whenEdgeRoutingKeyIsEdgeName() {
    // Arrange
    Edge edge = new Edge();
    edge.setRoutingKey("Edge name");
    edge.setSecret("Edge name");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void EdgeDataValidator.validateDataImpl(TenantId, Edge)"})
  public void testValidateDataImplWithTenantIdEdge_whenEdgeSecretIsEdgeName() {
    // Arrange
    Edge edge = new Edge();
    edge.setSecret("Edge name");
    edge.setType("Edge name");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void EdgeDataValidator.validateDataImpl(TenantId, Edge)"})
  public void testValidateDataImplWithTenantIdEdge_whenEdgeTypeIsEdgeName() {
    // Arrange
    Edge edge = new Edge();
    edge.setType("Edge name");
    edge.setName("Edge name");
