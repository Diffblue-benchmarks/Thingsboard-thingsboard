...
public class NoXssValidatorDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean NoXssValidator.isValid(Object, ConstraintValidatorContext)"})
  public void testIsValidWithValueConstraintValidatorContext2() {
    // Arrange
    NoXssValidator noXssValidator = new NoXssValidator();
    Segment segment = new Segment("\u0001A\u0001A".toCharArray(), 2, 1);
    ClockProvider clockProvider = mock(ClockProvider.class);
    ConstraintValidatorContextImpl constraintValidatorContext =
        new ConstraintValidatorContextImpl(
            clockProvider,
    ...
    // Act and Assert
    assertTrue(noXssValidator.isValid(segment, constraintValidatorContext));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean NoXssValidator.isValid(Object, ConstraintValidatorContext)"})
  public void testIsValidWithValueConstraintValidatorContext_whenEmptyString_thenReturnTrue() {
    // Arrange
    NoXssValidator noXssValidator = new NoXssValidator();
    ClockProvider clockProvider = mock(ClockProvider.class);
    ConstraintValidatorContextImpl constraintValidatorContext =
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean NoXssValidator.isValid(Object, ConstraintValidatorContext)"})
  public void testIsValidWithValueConstraintValidatorContext_whenFortyTwo_thenReturnTrue() {
    // Arrange
    NoXssValidator noXssValidator = new NoXssValidator();
    ClockProvider clockProvider = mock(ClockProvider.class);
    ConstraintValidatorContextImpl constraintValidatorContext =
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean NoXssValidator.isValid(Object, ConstraintValidatorContext)"})
  public void testIsValidWithValueConstraintValidatorContext_whenValue_thenReturnTrue() {
    // Arrange
    NoXssValidator noXssValidator = new NoXssValidator();
    ClockProvider clockProvider = mock(ClockProvider.class);
    ConstraintValidatorContextImpl constraintValidatorContext =
