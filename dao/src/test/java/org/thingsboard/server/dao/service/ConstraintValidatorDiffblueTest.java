...
public class ConstraintValidatorDiffblueTest {
  ...
  public void testGetErrorMessageWithConstraintViolation_thenReturnNotAllWhoWanderAreLost() {
    ...
    AnnotationProxy<Annotation> newProxyResult = AnnotationProxy.newProxy(annotationType);
    when(constraintDescriptorImpl.getAnnotation()).thenReturn(newProxyResult);
