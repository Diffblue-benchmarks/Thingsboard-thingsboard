...
public class BaseAssetServiceDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@code null}.
   *   <li>Then calls {@link AssetCacheEvictEvent#getNewName()}.
   * </ul>
   *
   * <p>Method under test: {@link BaseAssetService#handleEvictEvent(AssetCacheEvictEvent)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void BaseAssetService.handleEvictEvent(AssetCacheEvictEvent)"})
  public void testHandleEvictEventWithAssetCacheEvictEvent_givenNull_thenCallsGetNewName() {
    // Arrange
    doNothing().when(tbTransactionalCache).evict(Mockito.<Collection<AssetCacheKey>>any());

    AssetCacheEvictEvent event = mock(AssetCacheEvictEvent.class);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.saveAsset(Asset)"})
  public void testSaveAssetWithAsset3() {
    // Arrange
    ...
    Asset asset2 = new Asset(new Asset());
    asset2.setId(null);
    asset2.setAssetProfileId(new AssetProfileId(ModelConstants.NULL_UUID));
    asset2.setType("");
    ...
    verify(tbTransactionalCache).evict(isA(Collection.class));
    verify(asset).getName();
    verify(assetProfileService).findAssetProfileById(isNull(), isA(AssetProfileId.class));
    verify(dataValidator).validate(isA(Asset.class), isA(Function.class));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.saveAsset(Asset)"})
  public void testSaveAssetWithAsset4() {
    // Arrange
    when(assetDao.saveAndFlush(Mockito.<TenantId>any(), Mockito.<Asset>any()))
        .thenThrow(new DataValidationException("An error occurred"));
    ...
    when(asset2.getAssetProfileId()).thenReturn(new AssetProfileId(ModelConstants.NULL_UUID));
    when(asset2.getName()).thenReturn("Name");
    when(asset2.getTenantId()).thenReturn(ModelConstants.SYSTEM_TENANT);
    doNothing().when(asset2).setAssetProfileId(Mockito.<AssetProfileId>any());
    doNothing().when(asset2).setType(Mockito.<String>any());
    doNothing().when(asset2).setId(Mockito.<AssetId>any());
    asset2.setId(null);
    asset2.setAssetProfileId(new AssetProfileId(ModelConstants.NULL_UUID));
    asset2.setType("");
    ...
    assertThrows(DataValidationException.class, () -> baseAssetService.saveAsset(asset2));
    verify(tbTransactionalCache).evict(isA(Collection.class));
    verify(asset2, atLeast(1)).getAssetProfileId();
    verify(asset).getName();
    verify(asset2).getName();
    verify(asset2, atLeast(1)).getTenantId();
    verify(asset2).setAssetProfileId(isA(AssetProfileId.class));
    verify(asset2, atLeast(1)).setType(Mockito.<String>any());
    verify(asset2).setId(isNull());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.saveAsset(Asset, boolean)"})
  public void testSaveAssetWithAssetDoValidate3() {
    // Arrange
    when(assetProfileService.findAssetProfileById(
            Mockito.<TenantId>any(), Mockito.<AssetProfileId>any()))
        .thenThrow(new DataValidationException("An error occurred"));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.saveAsset(Asset, boolean)"})
  public void testSaveAssetWithAssetDoValidate4() {
    // Arrange
    when(assetProfileService.findAssetProfileById(
            Mockito.<TenantId>any(), Mockito.<AssetProfileId>any()))
        .thenReturn(null);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.saveAsset(Asset, boolean)"})
  public void testSaveAssetWithAssetDoValidate5() {
    // Arrange
    when(assetDao.saveAndFlush(Mockito.<TenantId>any(), Mockito.<Asset>any()))
        .thenThrow(new DataValidationException("An error occurred"));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.saveAsset(Asset, boolean)"})
  public void testSaveAssetWithAssetDoValidate6() {
    // Arrange
    when(assetDao.saveAndFlush(Mockito.<TenantId>any(), Mockito.<Asset>any()))
    ...
    Asset asset2 = mock(Asset.class);
    when(asset2.getId()).thenThrow(new DataValidationException("An error occurred"));
    when(asset2.getAssetProfileId()).thenReturn(new AssetProfileId(ModelConstants.NULL_UUID));
    when(asset2.getName()).thenReturn("Name");
    when(asset2.getTenantId()).thenReturn(ModelConstants.SYSTEM_TENANT);
    doNothing().when(asset2).setAssetProfileId(Mockito.<AssetProfileId>any());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.saveAsset(Asset, boolean)"})
  public void testSaveAssetWithAssetDoValidate7() {
    // Arrange
    Asset asset = new Asset();
    when(assetDao.saveAndFlush(Mockito.<TenantId>any(), Mockito.<Asset>any())).thenReturn(asset);
    ...
    when(asset3.getId()).thenReturn(null);
    when(asset3.getAssetProfileId()).thenReturn(new AssetProfileId(ModelConstants.NULL_UUID));
    when(asset3.getName()).thenReturn("Name");
    when(asset3.getTenantId()).thenReturn(ModelConstants.SYSTEM_TENANT);
    doNothing().when(asset3).setAssetProfileId(Mockito.<AssetProfileId>any());
    doNothing().when(asset3).setType(Mockito.<String>any());
    doNothing().when(asset3).setId(Mockito.<AssetId>any());
    asset3.setId(null);
    asset3.setAssetProfileId(new AssetProfileId(ModelConstants.NULL_UUID));
    asset3.setType("");

    // Act
    Asset actualSaveAssetResult = baseAssetService.saveAsset(asset3, true);

    // Assert
    verify(tbTransactionalCache).evict(isA(Collection.class));
    verify(asset3, atLeast(1)).getAssetProfileId();
    verify(asset3, atLeast(1)).getId();
    verify(asset2).getName();
    verify(asset3).getName();
    verify(asset3, atLeast(1)).getTenantId();
    verify(asset3).setAssetProfileId(isA(AssetProfileId.class));
    verify(asset3, atLeast(1)).setType(Mockito.<String>any());
    verify(asset3).setId(isNull());
    verify(assetDao).saveAndFlush(isA(TenantId.class), isA(Asset.class));
    verify(assetProfileService)
        .findAssetProfileById(isA(TenantId.class), isA(AssetProfileId.class));
    verify(entityCountService).publishCountEntityEvictEvent(isNull(), eq(EntityType.ASSET));
    verify(dataValidator).validate(isA(Asset.class), isA(Function.class));
    assertSame(asset, actualSaveAssetResult);
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.saveAsset(Asset, boolean)"})
  public void testSaveAssetWithAssetDoValidate_givenAssetProfileTenantIdIsTenantId() {
    // Arrange
    AssetProfile assetProfile = new AssetProfile();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.saveAsset(Asset, boolean)"})
  public void testSaveAssetWithAssetDoValidate_thenReturnAsset() {
    // Arrange
    Asset asset = new Asset();
    when(assetDao.saveAndFlush(Mockito.<TenantId>any(), Mockito.<Asset>any())).thenReturn(asset);
   ...
   *
   * <ul>
   *   <li>Given {@link AssetDao} {@link AssetDao#saveAndFlush(TenantId, Object)} return {@link
   *       Asset#Asset()}.
   *   <li>Then return {@link Asset#Asset()}.
   * </ul>
   *
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.saveAsset(Asset)"})
  public void testSaveAssetWithAsset_givenAssetDaoSaveAndFlushReturnAsset_thenReturnAsset() {
    // Arrange
    Asset asset = new Asset();
    when(assetDao.saveAndFlush(Mockito.<TenantId>any(), Mockito.<Asset>any())).thenReturn(asset);
    ...
    // Act
    Asset actualSaveAssetResult = baseAssetService.saveAsset(asset3);
   ...
   *
   * <ul>
   *   <li>Given {@link AssetProfileService} {@link
   *       AssetProfileService#findAssetProfileById(TenantId, AssetProfileId)} return {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link BaseAssetService#saveAsset(Asset)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.saveAsset(Asset)"})
  public void testSaveAssetWithAsset_givenAssetProfileServiceFindAssetProfileByIdReturnNull() {
    // Arrange
    when(assetProfileService.findAssetProfileById(
            Mockito.<TenantId>any(), Mockito.<AssetProfileId>any()))
        .thenReturn(null);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.saveAsset(Asset)"})
  public void testSaveAssetWithAsset_givenAssetProfileTenantIdIsTenantId() {
    // Arrange
    AssetProfile assetProfile = new AssetProfile();
    assetProfile.setTenantId(mock(TenantId.class));
    when(assetProfileService.findAssetProfileById(
   ...
   *
   * <ul>
   *   <li>Given {@link AssetProfile#AssetProfile()} TenantId is {@link TenantId#TenantId(UUID)}
   *       with id is {@link ModelConstants#NULL_UUID}.
   * </ul>
   *
   * <p>Method under test: {@link BaseAssetService#saveAsset(Asset)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.saveAsset(Asset)"})
  public void testSaveAssetWithAsset_givenAssetProfileTenantIdIsTenantIdWithIdIsNull_uuid() {
    // Arrange
    Asset asset = new Asset();
    when(assetDao.saveAndFlush(Mockito.<TenantId>any(), Mockito.<Asset>any())).thenReturn(asset);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.saveAsset(Asset)"})
  public void testSaveAssetWithAsset_givenDataValidationExceptionWithMessageIsAnErrorOccurred() {
    // Arrange
    when(assetDao.saveAndFlush(Mockito.<TenantId>any(), Mockito.<Asset>any()))
        .thenReturn(new Asset());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.assignAssetToCustomer(TenantId, AssetId, CustomerId)"})
  public void testAssignAssetToCustomer3() {
    // Arrange
    when(assetDao.findById(Mockito.<TenantId>any(), Mockito.<UUID>any())).thenReturn(new Asset());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.assignAssetToCustomer(TenantId, AssetId, CustomerId)"})
  public void testAssignAssetToCustomer_givenAssetGetNameReturnEmptyString() {
    // Arrange
    Asset asset = new Asset();
    ...
    verify(assetDao).findById(isA(TenantId.class), isA(UUID.class));
    verify(assetProfileService)
        .findOrCreateAssetProfile(isNull(), eq("Executing findAssetById [{}]"));
    verify(dataValidator).validate(isA(Asset.class), isA(Function.class));
  }
   ...
   *
   * <ul>
   *   <li>Given {@link Asset#Asset()} Name is {@code Name}.
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.assignAssetToCustomer(TenantId, AssetId, CustomerId)"})
  public void testAssignAssetToCustomer_givenAssetNameIsName_thenThrowRuntimeException() {
    // Arrange
    Asset asset = new Asset();
    asset.setName("Name");
    asset.setType("Executing findAssetById [{}]");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.assignAssetToCustomer(TenantId, AssetId, CustomerId)"})
  public void testAssignAssetToCustomer_thenCallsFindOrCreateAssetProfile() {
    // Arrange
    Asset asset = new Asset();
    asset.setType("Executing findAssetById [{}]");
    when(assetDao.findById(Mockito.<TenantId>any(), Mockito.<UUID>any())).thenReturn(asset);
  ...
  public void testUnassignAssetFromCustomer4() {
    ...
    Asset asset2 = mock(Asset.class);
    when(asset2.getName()).thenThrow(new DataValidationException("An error occurred"));
    when(dataValidator.validate(Mockito.<Asset>any(), Mockito.<Function<Asset, TenantId>>any()))
        .thenReturn(asset2);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Asset BaseAssetService.unassignAssetFromCustomer(TenantId, AssetId)"})
  public void testUnassignAssetFromCustomer6() {
    // Arrange
    Asset asset = mock(Asset.class);
    doThrow(new DataValidationException("An error occurred"))
        .when(asset)
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData BaseAssetService.findAssetsByTenantId(TenantId, PageLink)"})
  public void testFindAssetsByTenantId_givenSortOrderGetPropertyReturnEmptyString() {
    // Arrange
    PageData<Asset> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetsByTenantId(Mockito.<UUID>any(), Mockito.<PageLink>any()))
        .thenReturn(emptyPageDataResult);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData BaseAssetService.findAssetsByTenantId(TenantId, PageLink)"})
  public void testFindAssetsByTenantId_givenSortOrderGetPropertyReturnNull() {
    // Arrange
    PageData<Asset> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetsByTenantId(Mockito.<UUID>any(), Mockito.<PageLink>any()))
        .thenReturn(emptyPageDataResult);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData BaseAssetService.findAssetsByTenantId(TenantId, PageLink)"})
  public void testFindAssetsByTenantId_givenZero_whenPageLinkGetPageReturnZero() {
    // Arrange
    PageData<Asset> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetsByTenantId(Mockito.<UUID>any(), Mockito.<PageLink>any()))
        .thenReturn(emptyPageDataResult);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData BaseAssetService.findAssetInfosByTenantId(TenantId, PageLink)"})
  public void testFindAssetInfosByTenantId_givenSortOrderGetPropertyReturnEmptyString() {
    // Arrange
    PageData<AssetInfo> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetInfosByTenantId(Mockito.<UUID>any(), Mockito.<PageLink>any()))
        .thenReturn(emptyPageDataResult);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData BaseAssetService.findAssetInfosByTenantId(TenantId, PageLink)"})
  public void testFindAssetInfosByTenantId_givenSortOrderGetPropertyReturnNull() {
    // Arrange
    PageData<AssetInfo> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetInfosByTenantId(Mockito.<UUID>any(), Mockito.<PageLink>any()))
        .thenReturn(emptyPageDataResult);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageData BaseAssetService.findAssetInfosByTenantId(TenantId, PageLink)"})
  public void testFindAssetInfosByTenantId_givenZero_whenPageLinkGetPageReturnZero() {
    // Arrange
    PageData<AssetInfo> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetInfosByTenantId(Mockito.<UUID>any(), Mockito.<PageLink>any()))
        .thenReturn(emptyPageDataResult);
  ...
  public void testFindAssetsByTenantIdAndType_givenSortOrderGetPropertyReturnNull() {
    // Arrange
    PageData<Asset> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetsByTenantIdAndType(
            Mockito.<UUID>any(), Mockito.<String>any(), Mockito.<PageLink>any()))
  ...
  public void testFindAssetsByTenantIdAndType_givenZero_whenPageLinkGetPageReturnZero() {
    // Arrange
    PageData<Asset> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetsByTenantIdAndType(
            Mockito.<UUID>any(), Mockito.<String>any(), Mockito.<PageLink>any()))
  ...
  public void testFindAssetInfosByTenantIdAndType_givenSortOrderGetPropertyReturnNull() {
    // Arrange
    PageData<AssetInfo> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetInfosByTenantIdAndType(
            Mockito.<UUID>any(), Mockito.<String>any(), Mockito.<PageLink>any()))
  ...
  public void testFindAssetInfosByTenantIdAndType_givenZero_whenPageLinkGetPageReturnZero() {
    // Arrange
    PageData<AssetInfo> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetInfosByTenantIdAndType(
            Mockito.<UUID>any(), Mockito.<String>any(), Mockito.<PageLink>any()))
  ...
  public void testFindAssetInfosByTenantIdAndAssetProfileId7() {
    // Arrange
    AssetProfileId assetProfileId = mock(AssetProfileId.class);
    when(assetProfileId.getId()).thenReturn(ModelConstants.NULL_UUID);
  ...
  public void testFindAssetInfosByTenantIdAndAssetProfileId_whenPageLinkGetPageReturnZero() {
    // Arrange
    PageData<AssetInfo> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetInfosByTenantIdAndAssetProfileId(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
  ...
  public void testFindAssetsByTenantIdAndIdsAsync() {
    ...
    assertThrows(
        DataValidationException.class,
        () ->
            baseAssetService.findAssetsByTenantIdAndIdsAsync(
                ModelConstants.SYSTEM_TENANT, assetIds));
  ...
  public void testFindAssetsByTenantIdAndIdsAsync_givenAssetIdGetIdReturnNull_uuid() {
    ...
    ListenableFuture<List<Asset>> actualFindAssetsByTenantIdAndIdsAsyncResult =
        baseAssetService.findAssetsByTenantIdAndIdsAsync(ModelConstants.SYSTEM_TENANT, assetIds);
  ...
  public void testFindAssetsByTenantIdAndCustomerId_givenNull_uuid_thenCallsGetId() {
    // Arrange
    PageData<Asset> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetsByTenantIdAndCustomerId(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
  ...
  public void testFindAssetsByTenantIdAndCustomerId_givenSortOrderGetPropertyReturnEmptyString() {
    // Arrange
    PageData<Asset> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetsByTenantIdAndCustomerId(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
  ...
  public void testFindAssetsByTenantIdAndCustomerId_givenSortOrderGetPropertyReturnNull() {
    // Arrange
    PageData<Asset> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetsByTenantIdAndCustomerId(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
  ...
  public void testFindAssetsByTenantIdAndCustomerId_givenZero_whenPageLinkGetPageReturnZero() {
    // Arrange
    PageData<Asset> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetsByTenantIdAndCustomerId(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
  ...
  public void testFindAssetInfosByTenantIdAndCustomerId5() {
    // Arrange
    TenantId tenantId = mock(TenantId.class);
    when(tenantId.getId()).thenThrow(new DataValidationException("An error occurred"));
  ...
  public void testFindAssetInfosByTenantIdAndCustomerId_givenNull_uuid_thenCallsGetId() {
    // Arrange
    PageData<AssetInfo> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetInfosByTenantIdAndCustomerId(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
  ...
  public void testFindAssetInfosByTenantIdAndCustomerId_givenSortOrderGetPropertyReturnNull() {
    // Arrange
    PageData<AssetInfo> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetInfosByTenantIdAndCustomerId(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
  ...
  public void testFindAssetInfosByTenantIdAndCustomerId_whenPageLinkGetPageReturnZero() {
    // Arrange
    PageData<AssetInfo> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetInfosByTenantIdAndCustomerId(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
  ...
  public void testFindAssetsByTenantIdAndCustomerIdAndType_givenNull_uuid_thenCallsGetId() {
    // Arrange
    PageData<Asset> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetsByTenantIdAndCustomerIdAndType(
            Mockito.<UUID>any(),
  ...
  public void testFindAssetsByTenantIdAndCustomerIdAndType_givenSortOrderGetPropertyReturnNull() {
    // Arrange
    PageData<Asset> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetsByTenantIdAndCustomerIdAndType(
            Mockito.<UUID>any(),
  ...
  public void testFindAssetsByTenantIdAndCustomerIdAndType_whenPageLinkGetPageReturnZero() {
    // Arrange
    PageData<Asset> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetsByTenantIdAndCustomerIdAndType(
            Mockito.<UUID>any(),
  ...
  public void testFindAssetInfosByTenantIdAndCustomerIdAndType6() {
    // Arrange
    TenantId tenantId = mock(TenantId.class);
    when(tenantId.getId()).thenThrow(new DataValidationException("An error occurred"));
  ...
  public void testFindAssetInfosByTenantIdAndCustomerIdAndType_givenNull_uuid_thenCallsGetId() {
    // Arrange
    PageData<AssetInfo> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetInfosByTenantIdAndCustomerIdAndType(
            Mockito.<UUID>any(),
  ...
  public void testFindAssetInfosByTenantIdAndCustomerIdAndType_whenPageLinkGetPageReturnZero() {
    // Arrange
    PageData<AssetInfo> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetInfosByTenantIdAndCustomerIdAndType(
            Mockito.<UUID>any(),
  ...
  public void testFindAssetInfosByTenantIdAndCustomerIdAndAssetProfileId10() {
    // Arrange
    PageData<AssetInfo> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetInfosByTenantIdAndCustomerIdAndAssetProfileId(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
  ...
  public void testFindAssetInfosByTenantIdAndCustomerIdAndAssetProfileId11() {
    // Arrange
    AssetProfileId assetProfileId = mock(AssetProfileId.class);
    when(assetProfileId.getId()).thenReturn(ModelConstants.NULL_UUID);
    ...
    assertThrows(
        ...
        () ->
            baseAssetService.findAssetsByTenantIdCustomerIdAndIdsAsync(
                ModelConstants.SYSTEM_TENANT, BaseEntityService.NULL_CUSTOMER_ID, assetIds));
    verify(assetDao)
  ...
  public void testFindAssetsByQuery_thenCallsFindByQuery() {
    // Arrange
  ...
  public void testFindAssetsByTenantIdAndEdgeId_givenSortOrderGetPropertyReturnNull() {
    // Arrange
    PageData<Asset> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetsByTenantIdAndEdgeId(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
  ...
  public void testFindAssetsByTenantIdAndEdgeId_givenZero_whenPageLinkGetPageReturnZero() {
    // Arrange
    PageData<Asset> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetsByTenantIdAndEdgeId(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
  ...
  public void testFindAssetsByTenantIdAndEdgeIdAndType6() {
    // Arrange
    EdgeId edgeId = mock(EdgeId.class);
    when(edgeId.getId()).thenReturn(ModelConstants.NULL_UUID);
  ...
  public void testFindAssetsByTenantIdAndEdgeIdAndType_givenSortOrderGetPropertyReturnNull() {
    // Arrange
    PageData<Asset> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetsByTenantIdAndEdgeIdAndType(
            Mockito.<UUID>any(),
  ...
  public void testFindAssetsByTenantIdAndEdgeIdAndType_givenZero_whenPageLinkGetPageReturnZero() {
    // Arrange
    PageData<Asset> emptyPageDataResult = PageData.emptyPageData();
    when(assetDao.findAssetsByTenantIdAndEdgeIdAndType(
            Mockito.<UUID>any(),
