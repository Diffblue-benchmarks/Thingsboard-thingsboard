...
public class TsKvLatestCompositeKeyDiffblueTest {
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(tsKvLatestCompositeKey.hashCode(), tsKvLatestCompositeKey2.hashCode());
  }
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual2() {
    ...
    TsKvLatestCompositeKey tsKvLatestCompositeKey =
        new TsKvLatestCompositeKey(ModelConstants.NULL_UUID, 1);
  ...
  public void testGettersAndSetters() {
    ...
    assertEquals(
        "TsKvLatestCompositeKey(entityId=13814000-1dd2-11b2-8080-808080808080, key=1)",
        actualToStringResult);
    assertEquals(1, actualTsKvLatestCompositeKey.getKey());
