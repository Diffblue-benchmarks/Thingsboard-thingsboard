...
public class OAuth2ClientRegistrationTemplateEntityDiffblueTest {
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(
        oAuth2ClientRegistrationTemplateEntity.hashCode(),
        oAuth2ClientRegistrationTemplateEntity2.hashCode());
  }
  ...
  public void testNewOAuth2ClientRegistrationTemplateEntity3() {
    // Arrange
    OAuth2MapperConfigBuilder allowUserCreationResult =
        OAuth2MapperConfig.builder().activateUser(true).allowUserCreation(true);
    ...
    OAuth2ClientRegistrationTemplate clientRegistrationTemplate =
        new OAuth2ClientRegistrationTemplate(new OAuth2ClientRegistrationTemplate());
    clientRegistrationTemplate.setId(
    ...
    // Assert
    assertEquals("", actualOAuth2ClientRegistrationTemplateEntity.getScope());
    UUID id = actualOAuth2ClientRegistrationTemplateEntity.getId();
  ...
  public void testNewOAuth2ClientRegistrationTemplateEntity_thenReturnScopeIs42Foo() {
    // Arrange
    ...
    verify(mapperConfig).getType();
    verify(mapperConfig).setBasic(isNull());
    assertEquals("42,foo", actualOAuth2ClientRegistrationTemplateEntity.getScope());
    assertEquals(
        "Customer Name Pattern",
        actualOAuth2ClientRegistrationTemplateEntity.getCustomerNamePattern());
    assertEquals(
  ...
  public void testNewOAuth2ClientRegistrationTemplateEntity_thenReturnScopeIs4242Foo() {
    // Arrange
    ArrayList<String> scope = new ArrayList<>();
    scope.add("42");
    scope.add("42");
    ...
    verify(mapperConfig).getType();
    verify(mapperConfig).setBasic(isNull());
    assertEquals("42,42,foo", actualOAuth2ClientRegistrationTemplateEntity.getScope());
    assertEquals(
        "Customer Name Pattern",
        actualOAuth2ClientRegistrationTemplateEntity.getCustomerNamePattern());
    assertEquals(
  ...
  public void testToData_thenAdditionalInfoReturnObjectNode() {
    ...
    oAuth2ClientRegistrationTemplateEntity.setUserNameAttributeName("janedoe");
    oAuth2ClientRegistrationTemplateEntity.setUuid(ModelConstants.NULL_UUID);
    oAuth2ClientRegistrationTemplateEntity.setScope("");
