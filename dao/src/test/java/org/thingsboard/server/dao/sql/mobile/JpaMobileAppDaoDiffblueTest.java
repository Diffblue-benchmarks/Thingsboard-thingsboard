...
public class JpaMobileAppDaoDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then calls {@link MobileAppOauth2ClientRepository#save(Object)}.
   * </ul>
   *
  ...
  public void testAddOauth2Client_thenCallsSave() {
    // Arrange
    MobileAppOauth2ClientEntity mobileAppOauth2ClientEntity = new MobileAppOauth2ClientEntity();
    mobileAppOauth2ClientEntity.setMobileAppId(ModelConstants.NULL_UUID);
    mobileAppOauth2ClientEntity.setOauth2ClientId(ModelConstants.NULL_UUID);

    MobileAppOauth2ClientRepository mobileOauth2ProviderRepository =
        mock(MobileAppOauth2ClientRepository.class);
    when(mobileOauth2ProviderRepository.save(Mockito.<MobileAppOauth2ClientEntity>any()))
        .thenReturn(mobileAppOauth2ClientEntity);
    JpaMobileAppDao jpaMobileAppDao =
        new JpaMobileAppDao(mock(MobileAppRepository.class), mobileOauth2ProviderRepository);
    ...
    // Assert
    verify(mobileOauth2ProviderRepository).save(isA(MobileAppOauth2ClientEntity.class));
    verify(mobileAppId).getId();
  }
  ...
  public void testDeleteByTenantId_thenCallsGetId() {
    // Arrange
    MobileAppRepository mobileAppRepository = mock(MobileAppRepository.class);
    doNothing().when(mobileAppRepository).deleteByTenantId(Mockito.<UUID>any());
    JpaMobileAppDao jpaMobileAppDao =
        new JpaMobileAppDao(mobileAppRepository, mock(MobileAppOauth2ClientRepository.class));
