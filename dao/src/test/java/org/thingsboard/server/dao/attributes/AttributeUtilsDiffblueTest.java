...
class AttributeUtilsDiffblueTest {
  ...
  void testValidateWithAttributeKvEntryBoolean() {
    ...
    // Act and Assert
    assertDoesNotThrow(() -> AttributeUtils.validate(kvEntry, true));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void AttributeUtils.validate(AttributeKvEntry, boolean)"})
  void testValidateWithAttributeKvEntryBoolean2() {
    // Arrange
  ...
  @Test
  @DisplayName(
      "Test validate(AttributeKvEntry, boolean) with 'AttributeKvEntry', 'boolean'; when JsonDataEntry(String, String) with 'Key' and value is '42'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AttributeUtils.validate(AttributeKvEntry, boolean)"})
  void testValidateWithAttributeKvEntryBoolean_whenJsonDataEntryWithKeyAndValueIs42() {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void AttributeUtils.validate(AttributeKvEntry, boolean)"})
  void testValidateWithAttributeKvEntryBoolean_whenJsonDataEntryWithKeyAndValueIs422() {
    // Arrange
    BaseAttributeKvEntry kvEntry = new BaseAttributeKvEntry(1L, new JsonDataEntry("Key", "42"));

    // Act and Assert
    assertDoesNotThrow(() -> AttributeUtils.validate(kvEntry, false));
  }
  ...
  @Test
  @DisplayName(
      "Test validate(AttributeKvEntry, boolean) with 'AttributeKvEntry', 'boolean'; when JsonDataEntry(String, String) with 'Key' and value is 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AttributeUtils.validate(AttributeKvEntry, boolean)"})
  void testValidateWithAttributeKvEntryBoolean_whenJsonDataEntryWithKeyAndValueIsNull() {
    // Arrange
   ...
   */
  @Test
  @DisplayName("Test validate(List, boolean) with 'List', 'boolean'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AttributeUtils.validate(List, boolean)"})
  void testValidateWithListBoolean() {
    // Arrange
    ...
    // Act and Assert
    assertDoesNotThrow(() -> AttributeUtils.validate(kvEntries, true));
  }
   ...
   *
   * <ul>
   *   <li>Given {@link AttributeKvEntry} {@link AttributeKvEntry#getKey()} return {@code foo}.
   * </ul>
   *
   * <p>Method under test: {@link AttributeUtils#validate(List, boolean)}
   */
  @Test
  @DisplayName(
      "Test validate(List, boolean) with 'List', 'boolean'; given AttributeKvEntry getKey() return 'foo'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AttributeUtils.validate(List, boolean)"})
  void testValidateWithListBoolean_givenAttributeKvEntryGetKeyReturnFoo() {
    // Arrange
    AttributeKvEntry attributeKvEntry = mock(AttributeKvEntry.class);
    ...
    when(attributeKvEntry.getKey()).thenReturn("foo");
  ...
  @Test
  @DisplayName(
      "Test validate(List, boolean) with 'List', 'boolean'; given JsonDataEntry(String, String) with 'Key' and value is '42'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AttributeUtils.validate(List, boolean)"})
  void testValidateWithListBoolean_givenJsonDataEntryWithKeyAndValueIs42() {
    // Arrange
    ArrayList<AttributeKvEntry> kvEntries = new ArrayList<>();
    BaseAttributeKvEntry baseAttributeKvEntry =
        new BaseAttributeKvEntry(1L, new JsonDataEntry("Key", "42"));
  ...
  @Test
  @DisplayName(
      "Test validate(List, boolean) with 'List', 'boolean'; given JsonDataEntry(String, String) with 'Key' and value is empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AttributeUtils.validate(List, boolean)"})
  void testValidateWithListBoolean_givenJsonDataEntryWithKeyAndValueIsEmptyString() {
    // Arrange
    ArrayList<AttributeKvEntry> kvEntries = new ArrayList<>();
    BaseAttributeKvEntry baseAttributeKvEntry =
  ...
  @Test
  @DisplayName(
      "Test validate(List, boolean) with 'List', 'boolean'; given JsonDataEntry(String, String) with 'Key' and value is 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AttributeUtils.validate(List, boolean)"})
  void testValidateWithListBoolean_givenJsonDataEntryWithKeyAndValueIsNull() {
    // Arrange
    ArrayList<AttributeKvEntry> kvEntries = new ArrayList<>();
    JsonDataEntry kv = new JsonDataEntry("Key", null);
  ...
  @Test
  @DisplayName(
      "Test validate(List, boolean) with 'List', 'boolean'; when ArrayList(); then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AttributeUtils.validate(List, boolean)"})
  void testValidateWithListBoolean_whenArrayList_thenDoesNotThrow() {
    // Arrange, Act and Assert
    assertDoesNotThrow(() -> AttributeUtils.validate(new ArrayList<>(), true));
  }
