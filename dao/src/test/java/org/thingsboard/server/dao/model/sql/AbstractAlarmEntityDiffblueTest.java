...
public class AbstractAlarmEntityDiffblueTest {
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual2() {
    ...
    when(alarmEntity2.getDetails()).thenReturn(null);
    when(alarmEntity2.getPropagateRelationTypes()).thenReturn(null);
    when(alarmEntity2.getType()).thenReturn(null);
    when(alarmEntity2.getAssigneeId()).thenReturn(null);
    when(alarmEntity2.getCustomerId()).thenReturn(null);
    when(alarmEntity2.getOriginatorId()).thenReturn(null);
    when(alarmEntity2.getTenantId()).thenReturn(null);
    when(alarmEntity2.getOriginatorType()).thenReturn(null);
    when(alarmEntity2.getSeverity()).thenReturn(null);
    when(alarmEntity2.getPropagateToTenant()).thenReturn(null);
    when(alarmEntity2.getPropagateToOwner()).thenReturn(null);
    when(alarmEntity2.getPropagate()).thenReturn(null);
    when(alarmEntity2.getAssignTs()).thenReturn(null);
    when(alarmEntity2.getClearTs()).thenReturn(null);
    when(alarmEntity2.getAckTs()).thenReturn(null);
    when(alarmEntity2.getEndTs()).thenReturn(null);
    when(alarmEntity2.getStartTs()).thenReturn(null);
    when(alarmEntity2.getId()).thenReturn(null);
    when(alarmEntity2.isAcknowledged()).thenReturn(false);
    ...
    // Act and Assert
    assertEquals(alarmEntity, alarmEntity2);
    assertNotEquals(alarmEntity.hashCode(), alarmEntity2.hashCode());
  }
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual6() {
    ...
    AlarmEntity alarmEntity2 = mock(AlarmEntity.class);
    when(alarmEntity2.getEndTs()).thenReturn(1L);
    when(alarmEntity2.getStartTs()).thenReturn(null);
    when(alarmEntity2.getId()).thenReturn(null);
    when(alarmEntity2.isAcknowledged()).thenReturn(false);
    when(alarmEntity2.isCleared()).thenReturn(true);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual7() {
    ...
    AlarmEntity alarmEntity2 = mock(AlarmEntity.class);
    when(alarmEntity2.getAckTs()).thenReturn(1L);
    when(alarmEntity2.getEndTs()).thenReturn(null);
    when(alarmEntity2.getStartTs()).thenReturn(null);
    when(alarmEntity2.getId()).thenReturn(null);
    when(alarmEntity2.isAcknowledged()).thenReturn(false);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual8() {
    ...
    AlarmEntity alarmEntity2 = mock(AlarmEntity.class);
    when(alarmEntity2.getClearTs()).thenReturn(1L);
    when(alarmEntity2.getAckTs()).thenReturn(null);
    when(alarmEntity2.getEndTs()).thenReturn(null);
    when(alarmEntity2.getStartTs()).thenReturn(null);
    when(alarmEntity2.getId()).thenReturn(null);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual9() {
    ...
    AlarmEntity alarmEntity2 = mock(AlarmEntity.class);
    when(alarmEntity2.getAssignTs()).thenReturn(1L);
    when(alarmEntity2.getClearTs()).thenReturn(null);
    when(alarmEntity2.getAckTs()).thenReturn(null);
    when(alarmEntity2.getEndTs()).thenReturn(null);
    when(alarmEntity2.getStartTs()).thenReturn(null);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual10() {
    ...
    AlarmEntity alarmEntity2 = mock(AlarmEntity.class);
    when(alarmEntity2.getPropagate()).thenReturn(true);
    when(alarmEntity2.getAssignTs()).thenReturn(null);
    when(alarmEntity2.getClearTs()).thenReturn(null);
    when(alarmEntity2.getAckTs()).thenReturn(null);
    when(alarmEntity2.getEndTs()).thenReturn(null);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual11() {
    ...
    AlarmEntity alarmEntity2 = mock(AlarmEntity.class);
    when(alarmEntity2.getPropagateToOwner()).thenReturn(true);
    when(alarmEntity2.getPropagate()).thenReturn(null);
    when(alarmEntity2.getAssignTs()).thenReturn(null);
    when(alarmEntity2.getClearTs()).thenReturn(null);
    when(alarmEntity2.getAckTs()).thenReturn(null);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual12() {
    ...
    AlarmEntity alarmEntity2 = mock(AlarmEntity.class);
    when(alarmEntity2.getPropagateToTenant()).thenReturn(true);
    when(alarmEntity2.getPropagateToOwner()).thenReturn(null);
    when(alarmEntity2.getPropagate()).thenReturn(null);
    when(alarmEntity2.getAssignTs()).thenReturn(null);
    when(alarmEntity2.getClearTs()).thenReturn(null);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual13() {
    ...
    AlarmEntity alarmEntity2 = mock(AlarmEntity.class);
    when(alarmEntity2.getDetails())
        .thenReturn(CustomerServiceImpl.PUBLIC_CUSTOMER_ADDITIONAL_INFO_JSON);
    when(alarmEntity2.getPropagateRelationTypes()).thenReturn("Propagate Relation Types");
    when(alarmEntity2.getType()).thenReturn("Type");
    when(alarmEntity2.getAssigneeId()).thenReturn(ModelConstants.NULL_UUID);
    when(alarmEntity2.getCustomerId()).thenReturn(ModelConstants.NULL_UUID);
    when(alarmEntity2.getOriginatorId()).thenReturn(ModelConstants.NULL_UUID);
    when(alarmEntity2.getTenantId()).thenReturn(ModelConstants.NULL_UUID);
    when(alarmEntity2.getOriginatorType()).thenReturn(EntityType.TENANT);
    when(alarmEntity2.getSeverity()).thenReturn(AlarmSeverity.CRITICAL);
    when(alarmEntity2.getPropagateToTenant()).thenReturn(null);
    when(alarmEntity2.getPropagateToOwner()).thenReturn(null);
    when(alarmEntity2.getPropagate()).thenReturn(null);
    when(alarmEntity2.getAssignTs()).thenReturn(null);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual33() {
    ...
    AlarmEntity alarmEntity2 = mock(AlarmEntity.class);
    when(alarmEntity2.getDetails()).thenReturn(null);
    when(alarmEntity2.getPropagateRelationTypes()).thenReturn("foo");
    when(alarmEntity2.getType()).thenReturn(null);
    when(alarmEntity2.getAssigneeId()).thenReturn(null);
    when(alarmEntity2.getCustomerId()).thenReturn(null);
    when(alarmEntity2.getOriginatorId()).thenReturn(null);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual34() {
    ...
    when(alarmEntity2.getDetails()).thenReturn(null);
    when(alarmEntity2.getPropagateRelationTypes()).thenReturn(null);
    when(alarmEntity2.getType()).thenReturn("foo");
    when(alarmEntity2.getAssigneeId()).thenReturn(null);
    when(alarmEntity2.getCustomerId()).thenReturn(null);
    when(alarmEntity2.getOriginatorId()).thenReturn(null);
    when(alarmEntity2.getTenantId()).thenReturn(null);
