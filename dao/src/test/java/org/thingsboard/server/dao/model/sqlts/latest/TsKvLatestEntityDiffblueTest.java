...
public class TsKvLatestEntityDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link TsKvLatestEntity#TsKvLatestEntity()} BooleanValue is {@code null}.
  ...
  public void testIsNotEmpty_givenTsKvLatestEntityBooleanValueIsNull_thenReturnTrue() {
    // Arrange
   ...
   *
   * <ul>
   *   <li>Given {@link TsKvLatestEntity#TsKvLatestEntity()} DoubleValue is {@code null}.
   *   <li>Then return {@code true}.
   * </ul>
   *
   * <p>Method under test: {@link TsKvLatestEntity#isNotEmpty()}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean TsKvLatestEntity.isNotEmpty()"})
  public void testIsNotEmpty_givenTsKvLatestEntityDoubleValueIsNull_thenReturnTrue() {
    // Arrange
    TsKvLatestEntity tsKvLatestEntity = new TsKvLatestEntity();
    tsKvLatestEntity.setAggValuesCount(3L);
    tsKvLatestEntity.setAggValuesLastTs(42L);
   ...
   *
   * <ul>
   *   <li>Given {@link TsKvLatestEntity#TsKvLatestEntity()} LongValue is {@code null}.
   *   <li>Then return {@code true}.
   * </ul>
   *
   * <p>Method under test: {@link TsKvLatestEntity#isNotEmpty()}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean TsKvLatestEntity.isNotEmpty()"})
  public void testIsNotEmpty_givenTsKvLatestEntityLongValueIsNull_thenReturnTrue() {
    // Arrange
    TsKvLatestEntity tsKvLatestEntity = new TsKvLatestEntity();
    tsKvLatestEntity.setAggValuesCount(3L);
    tsKvLatestEntity.setAggValuesLastTs(42L);
