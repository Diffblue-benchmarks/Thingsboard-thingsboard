...
public class JpaEdgeDaoDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then {@link Optional#get()} AdditionalInfo iterator next return {@link BooleanNode}.
   * </ul>
   *
  ...
  public void testFindByRoutingKey_thenGetAdditionalInfoIteratorNextReturnBooleanNode() {
    // Arrange
    EdgeEntity edgeEntity = new EdgeEntity();
    edgeEntity.setAdditionalInfo(CustomerServiceImpl.PUBLIC_CUSTOMER_ADDITIONAL_INFO_JSON);
    edgeEntity.setCreatedTime(1L);
    ...
    Optional<Edge> actualFindByRoutingKeyResult =
        jpaEdgeDao.findByRoutingKey(ModelConstants.NULL_UUID, "Routing Key");

    // Assert
    verify(edgeRepository).findByRoutingKey("Routing Key");
    JsonNode additionalInfo = actualFindByRoutingKeyResult.get().getAdditionalInfo();
   ...
   *
   * <ul>
   *   <li>Then return {@link Optional#get()} AdditionalInfo is valueOf ten.
   * </ul>
   *
   * <p>Method under test: {@link JpaEdgeDao#findByRoutingKey(UUID, String)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Optional JpaEdgeDao.findByRoutingKey(UUID, String)"})
  public void testFindByRoutingKey_thenReturnGetAdditionalInfoIsValueOfTen() {
    // Arrange
    EdgeEntity edgeEntity = new EdgeEntity();
    ...
    // Assert
    verify(edgeRepository).findByRoutingKey("Routing Key");
    assertSame(additionalInfo, actualFindByRoutingKeyResult.get().getAdditionalInfo());
  }
