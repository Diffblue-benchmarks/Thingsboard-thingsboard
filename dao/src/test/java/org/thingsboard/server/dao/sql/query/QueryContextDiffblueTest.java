...
public class QueryContextDiffblueTest {
   ...
   *
   * <p>Method under test: {@link QueryContext#QueryContext(QuerySecurityContext)}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link QueryContext#addParameter(String, Object, int, String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <ul>
   *   <li>Given {@link QueryContext#addParameter(String, Object, int, String)} with {@code Name}
   *       and {@code Value} and type is two and {@code Type Name}.
   * </ul>
   *
   * <p>Method under test: {@link QueryContext#addParameter(String, Object, int, String)}
   */
   ...
   * <ul>
   *   <li>Given {@link QueryContext#addParameter(String, Object, int, String)} with {@code Name}
   *       and value is {@code null} and type is two and {@code Type Name}.
   * </ul>
   *
   * <p>Method under test: {@link QueryContext#addParameter(String, Object, int, String)}
   */
  ...
  public void testAddParameter_thenThrowRuntimeException() {
    ...
    // Act and Assert
    assertThrows(
        RuntimeException.class, () -> queryContext.addParameter("Name", "Value", 2, "Type Name"));
  }
   ...
   *
   * <p>Method under test: {@link QueryContext#append(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link QueryContext#hasValue(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link QueryContext#getValue(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link QueryContext#getSqlType(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link QueryContext#getParameterNames()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link QueryContext#addUuidParameter(String, UUID)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link QueryContext#addStringParameter(String, String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link QueryContext#addDoubleParameter(String, double)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link QueryContext#addLongParameter(String, long)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link QueryContext#addStringListParameter(String, List)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <ul>
   *   <li>Given {@code VARCHAR}.
   *   <li>When {@link ArrayList#ArrayList()} add {@code VARCHAR}.
   * </ul>
   *
   * <p>Method under test: {@link QueryContext#addStringListParameter(String, List)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void QueryContext.addStringListParameter(String, List)"})
  public void testAddStringListParameter_whenNull() {
    // Arrange
    QueryContext queryContext =
        new QueryContext(
            new QuerySecurityContext(
    ...
    // Act
    queryContext.addStringListParameter("Name", null);
   ...
   *
   * <p>Method under test: {@link QueryContext#addBooleanParameter(String, boolean)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link QueryContext#addUuidListParameter(String, List)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testAddUuidListParameter_thenThrowRuntimeException() {
    ...
    // Act and Assert
    assertThrows(
        RuntimeException.class, () -> queryContext.addUuidListParameter("Name", new ArrayList<>()));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void QueryContext.addUuidListParameter(String, List)"})
  public void testAddUuidListParameter_whenNull() {
    // Arrange
    QueryContext queryContext =
        new QueryContext(
            new QuerySecurityContext(
    ...
    // Act
    queryContext.addUuidListParameter("Name", null);
   ...
   *
   * <p>Method under test: {@link QueryContext#getQuery()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   * </ul>
   *
   * <p>Method under test: {@link QueryContext#getTenantId()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   * </ul>
   *
   * <p>Method under test: {@link QueryContext#getCustomerId()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   * </ul>
   *
   * <p>Method under test: {@link QueryContext#getEntityType()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   * </ul>
   *
   * <p>Method under test: {@link QueryContext#isIgnorePermissionCheck()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testIsIgnorePermissionCheck_thenReturnTrue() {
    // Arrange
    QuerySecurityContext securityCtx =
        new QuerySecurityContext(
            ModelConstants.SYSTEM_TENANT,
            BaseEntityService.NULL_CUSTOMER_ID,
            EntityType.TENANT,
    ...
    // Act and Assert
    assertTrue(new QueryContext(securityCtx).isIgnorePermissionCheck());
  }
}
