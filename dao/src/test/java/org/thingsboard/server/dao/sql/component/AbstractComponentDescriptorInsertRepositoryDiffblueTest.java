...
public class AbstractComponentDescriptorInsertRepositoryDiffblueTest {
  ...
  /**
   * Test {@link AbstractComponentDescriptorInsertRepository#saveAndGet(ComponentDescriptorEntity,
   * String, String)}.
   *
   * <ul>
   ...
   * AbstractComponentDescriptorInsertRepository#saveAndGet(ComponentDescriptorEntity, String,
   * String)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ComponentDescriptorEntity AbstractComponentDescriptorInsertRepository.saveAndGet(ComponentDescriptorEntity, String, String)"
  })
  public void testSaveAndGet_thenReturnNull() throws TransactionException {
    // Arrange
    ...
    // Act
    ComponentDescriptorEntity actualSaveAndGetResult =
        sqlComponentDescriptorInsertRepository.saveAndGet(entity, "2020-03-01", "2020-03-01");
    ...
    assertNull(actualSaveAndGetResult);
  }
}
