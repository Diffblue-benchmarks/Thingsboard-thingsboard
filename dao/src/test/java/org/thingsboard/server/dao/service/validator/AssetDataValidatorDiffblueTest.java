...
public class AssetDataValidatorDiffblueTest {
  ...
  /**
   * Test {@link AssetDataValidator#validateUpdate(TenantId, Asset)} with {@code TenantId}, {@code Asset}.
   * <p>
   ...
   * Test {@link AssetDataValidator#validateUpdate(TenantId, Asset)} with {@code TenantId}, {@code Asset}.
   * <ul>
   *   <li>Given {@link AssetDao} {@link Dao#findById(TenantId, UUID)} return {@code null}.</li>
   * </ul>
   * <p>
   * Method under test: {@link AssetDataValidator#validateUpdate(TenantId, Asset)}
   */
  ...
  /**
   * Test {@link AssetDataValidator#validateDataImpl(TenantId, Asset)} with {@code TenantId}, {@code Asset}.
   * <ul>
   *   <li>Then throw {@link DataValidationException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link AssetDataValidator#validateDataImpl(TenantId, Asset)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
