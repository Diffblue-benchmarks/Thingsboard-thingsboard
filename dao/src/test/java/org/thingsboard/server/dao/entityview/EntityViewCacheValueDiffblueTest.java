...
class EntityViewCacheValueDiffblueTest {
  ...
  void testGetVersion_givenEntityViewVersionIsOne_thenReturnLongValueIsOne() {
    ...
    // Act and Assert
    assertEquals(
        1L, new EntityViewCacheValue(entityView, new ArrayList<>()).getVersion().longValue());
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual2() {
    // Arrange
    EntityViewCacheValueBuilder entityViewCacheValueBuilder =
        mock(EntityViewCacheValueBuilder.class);
    when(entityViewCacheValueBuilder.entityView(Mockito.<EntityView>any()))
        .thenReturn(EntityViewCacheValue.builder());
    EntityViewCacheValueBuilder entityViewResult =
        entityViewCacheValueBuilder.entityView(new EntityView());
    EntityViewCacheValue buildResult = entityViewResult.entityViews(new ArrayList<>()).build();
    EntityViewCacheValueBuilder entityViewCacheValueBuilder2 =
        mock(EntityViewCacheValueBuilder.class);
    when(entityViewCacheValueBuilder2.entityView(Mockito.<EntityView>any()))
        .thenReturn(EntityViewCacheValue.builder());
    EntityViewCacheValueBuilder entityViewResult2 =
        entityViewCacheValueBuilder2.entityView(new EntityView());
    EntityViewCacheValue buildResult2 = entityViewResult2.entityViews(new ArrayList<>()).build();
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    ...
    EntityViewCacheValueBuilder entityViewResult =
        entityViewCacheValueBuilder2.entityView(new EntityView());
    EntityViewCacheValue buildResult = entityViewResult.entityViews(new ArrayList<>()).build();
    EntityViewCacheValueBuilder entityViewCacheValueBuilder3 =
        mock(EntityViewCacheValueBuilder.class);
    when(entityViewCacheValueBuilder3.entityView(Mockito.<EntityView>any()))
        .thenReturn(EntityViewCacheValue.builder());
    EntityViewCacheValueBuilder entityViewResult2 =
        entityViewCacheValueBuilder3.entityView(new EntityView());
    EntityViewCacheValue buildResult2 = entityViewResult2.entityViews(new ArrayList<>()).build();
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual3() {
    ...
    EntityViewCacheValueBuilder entityViewCacheValueBuilder3 =
        mock(EntityViewCacheValueBuilder.class);
    when(entityViewCacheValueBuilder3.entityView(Mockito.<EntityView>any()))
        .thenReturn(entityViewCacheValueBuilder2);
    EntityViewCacheValueBuilder entityViewResult2 =
        entityViewCacheValueBuilder3.entityView(new EntityView());
    EntityViewCacheValue buildResult2 = entityViewResult2.entityViews(new ArrayList<>()).build();
    EntityViewCacheValueBuilder entityViewCacheValueBuilder4 =
        mock(EntityViewCacheValueBuilder.class);
    when(entityViewCacheValueBuilder4.entityView(Mockito.<EntityView>any()))
        .thenReturn(EntityViewCacheValue.builder());
    EntityViewCacheValueBuilder entityViewResult3 =
        entityViewCacheValueBuilder4.entityView(new EntityView());
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual4() {
    ...
    EntityViewCacheValue buildResult =
        EntityViewCacheValue.builder().entityView(null).entityViews(entityViews).build();
    EntityViewCacheValueBuilder entityViewCacheValueBuilder =
        mock(EntityViewCacheValueBuilder.class);
    when(entityViewCacheValueBuilder.build()).thenReturn(buildResult);
    EntityViewCacheValueBuilder entityViewCacheValueBuilder2 =
