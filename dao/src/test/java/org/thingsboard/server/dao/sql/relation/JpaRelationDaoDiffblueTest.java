...
public class JpaRelationDaoDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then calls {@link EntityRelation#getAdditionalInfo()}.
   * </ul>
   *
  ...
  public void testSaveRelation_thenCallsGetAdditionalInfo() {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"EntityRelation JpaRelationDao.saveRelation(TenantId, EntityRelation)"})
  public void testSaveRelation_thenCallsGetId2() {
    // Arrange
    AlarmId alarmId = mock(AlarmId.class);
    when(alarmId.getId()).thenThrow(new EmptyResultDataAccessException(3));

    EntityRelation relation = mock(EntityRelation.class);
    when(relation.getTo()).thenReturn(alarmId);
    doNothing().when(relation).setTypeGroup(Mockito.<RelationTypeGroup>any());
    relation.setTypeGroup(RelationTypeGroup.COMMON);
   ...
   *
   * <ul>
   *   <li>Then calls {@link RelationInsertRepository#saveOrUpdate(RelationEntity)}.
   * </ul>
   *
   * <p>Method under test: {@link JpaRelationDao#saveRelation(TenantId, EntityRelation)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"EntityRelation JpaRelationDao.saveRelation(TenantId, EntityRelation)"})
  public void testSaveRelation_thenCallsSaveOrUpdate() {
    // Arrange
  ...
  public void testSaveRelations3() {
    ...
    when(entityRelation.getAdditionalInfo())
  ...
  public void testSaveRelations4() {
    ...
    EntityRelation entityRelation = mock(EntityRelation.class);
    when(entityRelation.getFrom()).thenReturn(alarmId);
    when(entityRelation.getTo()).thenReturn(BaseEntityService.NULL_CUSTOMER_ID);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List JpaRelationDao.saveRelations(TenantId, List)"})
  public void testSaveRelations5() {
    // Arrange
    AlarmId alarmId = mock(AlarmId.class);
    when(alarmId.getId()).thenThrow(new EmptyResultDataAccessException(3));

    EntityRelation entityRelation = mock(EntityRelation.class);
    when(entityRelation.getTo()).thenReturn(alarmId);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List JpaRelationDao.saveRelations(TenantId, List)"})
  public void testSaveRelations6() {
    // Arrange
    AlarmId alarmId = mock(AlarmId.class);
    ...
    when(alarmId2.getEntityType()).thenReturn(EntityType.TENANT);

    EntityRelation entityRelation = mock(EntityRelation.class);
    when(entityRelation.getAdditionalInfo()).thenThrow(new EmptyResultDataAccessException(3));
    when(entityRelation.getType()).thenReturn("Type");
    when(entityRelation.getFrom()).thenReturn(alarmId);
    when(entityRelation.getTo()).thenReturn(alarmId2);
    when(entityRelation.getTypeGroup()).thenReturn(RelationTypeGroup.COMMON);
   ...
   *
   * <ul>
   *   <li>Given {@link AlarmId} {@link AlarmId#getId()} return {@link ModelConstants#NULL_UUID}.
   *   <li>Then calls {@link AlarmId#getEntityType()}.
   * </ul>
   *
   * <p>Method under test: {@link JpaRelationDao#saveRelations(TenantId, List)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List JpaRelationDao.saveRelations(TenantId, List)"})
  public void testSaveRelations_givenAlarmIdGetIdReturnNull_uuid_thenCallsGetEntityType() {
    // Arrange
    AlarmId alarmId = mock(AlarmId.class);
    when(alarmId.getId()).thenReturn(ModelConstants.NULL_UUID);
    when(alarmId.getEntityType()).thenReturn(EntityType.TENANT);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List JpaRelationDao.saveRelations(TenantId, List)"})
  public void testSaveRelations_givenAlarmIdGetIdReturnNull_uuid_thenCallsGetEntityType2() {
    // Arrange
    AlarmId alarmId = mock(AlarmId.class);
    when(alarmId.getId()).thenReturn(ModelConstants.NULL_UUID);
    when(alarmId.getEntityType()).thenReturn(EntityType.TENANT);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List JpaRelationDao.saveRelations(TenantId, List)"})
  public void testSaveRelations_givenEntityRelationGetFromReturnSystem_tenant_thenReturnEmpty() {
    // Arrange
    when(relationInsertRepository.saveOrUpdate(Mockito.<List<RelationEntity>>any()))
        .thenReturn(new ArrayList<>());
   ...
   *
   * <ul>
   *   <li>Given {@link EntityRelation} {@link EntityRelation#getTo()} return {@link
   *       ModelConstants#SYSTEM_TENANT}.
   *   <li>Then return Empty.
   * </ul>
   *
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List JpaRelationDao.saveRelations(TenantId, List)"})
  public void testSaveRelations_givenEntityRelationGetToReturnSystem_tenant_thenReturnEmpty() {
    // Arrange
    when(relationInsertRepository.saveOrUpdate(Mockito.<List<RelationEntity>>any()))
        .thenReturn(new ArrayList<>());
  ...
  public void testDeleteRelationWithTenantIdRelation() {
    // Arrange
    EntityRelation relation = mock(EntityRelation.class);
    when(relation.getTo()).thenThrow(new EmptyResultDataAccessException(3));
   ...
   *
   * <ul>
   *   <li>Then calls {@link EntityRelation#getType()}.
   * </ul>
   *
   * <p>Method under test: {@link JpaRelationDao#deleteRelation(TenantId, EntityRelation)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"EntityRelation JpaRelationDao.deleteRelation(TenantId, EntityRelation)"})
  public void testDeleteRelationWithTenantIdRelation_thenCallsGetType() {
    // Arrange
    EntityRelation relation = mock(EntityRelation.class);
   ...
   *
   * <ul>
   *   <li>Then calls {@link JdbcTemplate#query(String, ResultSetExtractor, Object[])}.
   * </ul>
   *
   * <p>Method under test: {@link JpaRelationDao#deleteRelation(TenantId, EntityRelation)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"EntityRelation JpaRelationDao.deleteRelation(TenantId, EntityRelation)"})
  public void testDeleteRelationWithTenantIdRelation_thenCallsQuery() throws DataAccessException {
    // Arrange
    when(jdbcTemplate.query(
            Mockito.<String>any(), Mockito.<ResultSetExtractor<Object>>any(), isA(Object[].class)))
        .thenThrow(new EmptyResultDataAccessException(3));
  ...
  public void testDeleteRelationAsyncWithTenantIdRelation4() {
    ...
    when(relation.getType()).thenReturn("Type");
    when(relation.getTypeGroup()).thenReturn(RelationTypeGroup.COMMON);
    when(relation.getTo()).thenReturn(ModelConstants.SYSTEM_TENANT);
    when(relation.getFrom()).thenReturn(BaseEntityService.NULL_CUSTOMER_ID);
    doNothing().when(relation).setFrom(Mockito.<EntityId>any());
    doNothing().when(relation).setTo(Mockito.<EntityId>any());
    doNothing().when(relation).setTypeGroup(Mockito.<RelationTypeGroup>any());
   ...
   *
   * <ul>
   *   <li>When {@link EntityRelation} {@link EntityRelation#getTo()} return {@link AlarmId}.
   * </ul>
   *
   * <p>Method under test: {@link JpaRelationDao#deleteRelationAsync(TenantId, EntityRelation)}
   */
  ...
  public void testDeleteRelationAsyncWithTenantIdRelation_whenEntityRelationGetToReturnAlarmId() {
    // Arrange
    SettableFuture<Object> createResult = SettableFuture.create();
    when(jpaExecutorService.submit(Mockito.<Callable<Object>>any())).thenReturn(createResult);
    ...
    when(relation.getTypeGroup()).thenReturn(RelationTypeGroup.COMMON);
    when(relation.getTo()).thenReturn(alarmId);
    when(relation.getFrom()).thenReturn(ModelConstants.SYSTEM_TENANT);
    doNothing().when(relation).setFrom(Mockito.<EntityId>any());
    doNothing().when(relation).setTo(Mockito.<EntityId>any());
    doNothing().when(relation).setTypeGroup(Mockito.<RelationTypeGroup>any());
    relation.setTypeGroup(RelationTypeGroup.COMMON);
