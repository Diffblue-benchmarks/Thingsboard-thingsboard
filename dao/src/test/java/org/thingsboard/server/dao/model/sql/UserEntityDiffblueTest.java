...
public class UserEntityDiffblueTest {
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    // Arrange
    UserEntity userEntity = new UserEntity();
    userEntity.setAdditionalInfo(MissingNode.getInstance());
    userEntity.setAuthority(Authority.SYS_ADMIN);
    userEntity.setCreatedTime(1L);
    userEntity.setCustomerId(ModelConstants.NULL_UUID);
    userEntity.setEmail("jane.doe@example.org");
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual3() {
    // Arrange
    UserEntity userEntity = new UserEntity();
    userEntity.setAdditionalInfo(mock(JsonNode.class));
    userEntity.setAuthority(Authority.SYS_ADMIN);
    userEntity.setCreatedTime(1L);
    userEntity.setCustomerId(ModelConstants.NULL_UUID);
    userEntity.setEmail("jane.doe@example.org");
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserEntity#UserEntity(User)}
   */
  @Test
  public void testNewUserEntity_thenReturnCustomerIdToStringIs138140001dd211b28080808080808080() {
    ...
    // Assert
    assertEquals("13814000-1dd2-11b2-8080-808080808080", actualUserEntity.getCustomerId().toString());
   ...
   * <ul>
   *   <li>Given {@link UserEntity#UserEntity()} TenantId is {@code null}.</li>
   *   <li>Then return TenantId is {@code null}.</li>
   * </ul>
   * <p>
   * Method under test: {@link UserEntity#toData()}
   */
  @Test
   ...
   * Test {@link UserEntity#toData()}.
   * <ul>
   *   <li>Given {@link UserEntity#UserEntity()} TenantId is randomUUID.</li>
   *   <li>Then return not SystemAdmin.</li>
   * </ul>
   * <p>
   * Method under test: {@link UserEntity#toData()}
   */
   ...
   * Test {@link UserEntity#toData()}.
   * <ul>
   *   <li>Given {@link UserEntity#UserEntity()}.</li>
  ...
  public void testToData_givenUserEntity_thenAdditionalInfoReturnNullNode() {
    ...
    UserId id = actualToDataResult.getId();
    assertNull(id.getId());
