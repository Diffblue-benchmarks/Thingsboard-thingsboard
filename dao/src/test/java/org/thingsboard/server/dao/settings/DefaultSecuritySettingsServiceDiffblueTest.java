...
public class DefaultSecuritySettingsServiceDiffblueTest {
  ...
  public void testGetSecuritySettings4() {
    ...
    adminSettings.setJsonValue(new BigIntegerNode(v));
   ...
   *
   * <ul>
   *   <li>Given {@link AdminSettingsId#AdminSettingsId(UUID)} with id is {@link
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"SecuritySettings DefaultSecuritySettingsService.getSecuritySettings()"})
  public void testGetSecuritySettings_givenAdminSettingsIdWithIdIsNull_uuid() {
    // Arrange
  ...
  public void testSaveSecuritySettings_givenAdminSettingsIdWithIdIsNull_uuid() {
    // Arrange
    AdminSettings adminSettings = new AdminSettings(new AdminSettingsId(ModelConstants.NULL_UUID));
    adminSettings.setJsonValue(CustomerServiceImpl.PUBLIC_CUSTOMER_ADDITIONAL_INFO_JSON);
    when(adminSettingsService.findAdminSettingsByKey(
