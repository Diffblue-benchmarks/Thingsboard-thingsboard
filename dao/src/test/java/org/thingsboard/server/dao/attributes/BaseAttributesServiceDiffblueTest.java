...
public class BaseAttributesServiceDiffblueTest {
  ...
  public void testFindWithTenantIdEntityIdScopeAttributeKeys()
      throws InterruptedException, ExecutionException {
    // Arrange
  ...
  public void testFindWithTenantIdEntityIdScopeAttributeKeys2()
      throws InterruptedException, ExecutionException {
    // Arrange
    AttributesDao attributesDao = mock(AttributesDao.class);
    when(attributesDao.find(
  ...
  public void testFindWithTenantIdEntityIdScopeAttributeKeys_givenFoo_whenArrayListAddFoo()
      throws InterruptedException, ExecutionException {
    // Arrange
    when(attributesDao.find(
            Mockito.<TenantId>any(),
  ...
  public void testFindAll_givenJpaAttributeDaoFindAllReturnArrayList_thenReturnGetEmpty()
      throws InterruptedException, ExecutionException {
    // Arrange
    JpaAttributeDao attributesDao = mock(JpaAttributeDao.class);
  ...
  public void testFindAllKeysByEntityIdsWithTenantIdEntityIds() {
    // Arrange
    AttributesDao attributesDao = mock(AttributesDao.class);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List BaseAttributesService.findAllKeysByEntityIds(TenantId, List, String)"})
  public void testFindAllKeysByEntityIdsWithTenantIdEntityIdsScope_givenBaseAttributesService() {
    // Arrange
    when(attributesDao.findAllKeysByEntityIdsAndAttributeType(
            Mockito.<TenantId>any(), Mockito.<List<EntityId>>any(), Mockito.<String>any()))
        .thenReturn(new ArrayList<>());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List BaseAttributesService.findAllKeysByEntityIds(TenantId, List, String)"})
  public void testFindAllKeysByEntityIdsWithTenantIdEntityIdsScope_givenBaseAttributesService2() {
    // Arrange
    when(attributesDao.findAllKeysByEntityIdsAndAttributeType(
            Mockito.<TenantId>any(), Mockito.<List<EntityId>>any(), Mockito.<String>any()))
        .thenReturn(new ArrayList<>());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List BaseAttributesService.findAllKeysByEntityIds(TenantId, List)"})
  public void testFindAllKeysByEntityIdsWithTenantIdEntityIds_givenBaseAttributesService() {
    // Arrange
    when(attributesDao.findAllKeysByEntityIds(
            Mockito.<TenantId>any(), Mockito.<List<EntityId>>any()))
        .thenReturn(new ArrayList<>());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List BaseAttributesService.findAllKeysByEntityIds(TenantId, List)"})
  public void testFindAllKeysByEntityIdsWithTenantIdEntityIds_givenBaseAttributesService2() {
    // Arrange
    when(attributesDao.findAllKeysByEntityIds(
            Mockito.<TenantId>any(), Mockito.<List<EntityId>>any()))
        .thenReturn(new ArrayList<>());
  ...
  public void testSaveWithTenantIdEntityIdStringList_thenReturnGetEmpty()
      throws InterruptedException, ExecutionException {
    // Arrange
    BaseAttributesService baseAttributesService = new BaseAttributesService(new JpaAttributeDao());
