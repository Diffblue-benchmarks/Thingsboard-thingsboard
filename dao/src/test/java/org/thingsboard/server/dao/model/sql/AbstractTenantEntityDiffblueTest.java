...
public class AbstractTenantEntityDiffblueTest {
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual2() {
    ...
    when(tenantEntity2.getAdditionalInfo()).thenReturn(null);
    when(tenantEntity2.getAddress()).thenReturn(null);
    when(tenantEntity2.getAddress2()).thenReturn(null);
    when(tenantEntity2.getCity()).thenReturn(null);
    when(tenantEntity2.getCountry()).thenReturn(null);
    when(tenantEntity2.getEmail()).thenReturn(null);
    when(tenantEntity2.getPhone()).thenReturn(null);
    when(tenantEntity2.getRegion()).thenReturn(null);
    when(tenantEntity2.getState()).thenReturn(null);
    when(tenantEntity2.getTitle()).thenReturn(null);
    when(tenantEntity2.getZip()).thenReturn(null);
    when(tenantEntity2.getTenantProfileId()).thenReturn(null);
    when(tenantEntity2.getVersion()).thenReturn(null);
    when(tenantEntity2.getId()).thenReturn(null);
    when(tenantEntity2.getCreatedTime()).thenReturn(1L);
    when(tenantEntity2.canEqual(Mockito.<Object>any())).thenReturn(true);

    // Act and Assert
    assertEquals(tenantEntity, tenantEntity2);
    assertNotEquals(tenantEntity.hashCode(), tenantEntity2.hashCode());
  }
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual3() {
    ...
    TenantEntity tenantEntity2 = mock(TenantEntity.class);
    when(tenantEntity2.getAdditionalInfo())
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual4() {
    ...
    when(tenantEntity2.getTitle()).thenReturn(null);
    when(tenantEntity2.getZip()).thenReturn(null);
    when(tenantEntity2.getTenantProfileId()).thenReturn(ModelConstants.NULL_UUID);
    when(tenantEntity2.getVersion()).thenReturn(null);
    when(tenantEntity2.getId()).thenReturn(null);
    when(tenantEntity2.getCreatedTime()).thenReturn(1L);
    when(tenantEntity2.canEqual(Mockito.<Object>any())).thenReturn(true);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual3() {
    ...
    when(tenantEntity2.getAdditionalInfo())
        .thenReturn(CustomerServiceImpl.PUBLIC_CUSTOMER_ADDITIONAL_INFO_JSON);
    when(tenantEntity2.getAddress()).thenReturn("42 Main St");
    when(tenantEntity2.getAddress2()).thenReturn("42 Main St");
    when(tenantEntity2.getCity()).thenReturn("Oxford");
    when(tenantEntity2.getCountry()).thenReturn("GB");
    when(tenantEntity2.getEmail()).thenReturn("jane.doe@example.org");
    when(tenantEntity2.getPhone()).thenReturn("6625550144");
    when(tenantEntity2.getRegion()).thenReturn("us-east-2");
    when(tenantEntity2.getState()).thenReturn("MD");
    when(tenantEntity2.getTitle()).thenReturn("Dr");
    when(tenantEntity2.getZip()).thenReturn("21654");
    when(tenantEntity2.getTenantProfileId()).thenReturn(ModelConstants.NULL_UUID);
    when(tenantEntity2.getVersion()).thenReturn(null);
    when(tenantEntity2.getId()).thenReturn(null);
    when(tenantEntity2.getCreatedTime()).thenReturn(1L);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual18() {
    ...
    TenantEntity tenantEntity2 = mock(TenantEntity.class);
    when(tenantEntity2.getAdditionalInfo()).thenReturn(null);
    when(tenantEntity2.getAddress()).thenReturn("foo");
    when(tenantEntity2.getAddress2()).thenReturn(null);
    when(tenantEntity2.getCity()).thenReturn(null);
    when(tenantEntity2.getCountry()).thenReturn(null);
    when(tenantEntity2.getEmail()).thenReturn(null);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual19() {
    ...
    when(tenantEntity2.getAdditionalInfo()).thenReturn(null);
    when(tenantEntity2.getAddress()).thenReturn(null);
    when(tenantEntity2.getAddress2()).thenReturn("foo");
    when(tenantEntity2.getCity()).thenReturn(null);
    when(tenantEntity2.getCountry()).thenReturn(null);
    when(tenantEntity2.getEmail()).thenReturn(null);
    when(tenantEntity2.getPhone()).thenReturn(null);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual20() {
    ...
    when(tenantEntity2.getAddress()).thenReturn(null);
    when(tenantEntity2.getAddress2()).thenReturn(null);
    when(tenantEntity2.getCity()).thenReturn("foo");
    when(tenantEntity2.getCountry()).thenReturn(null);
    when(tenantEntity2.getEmail()).thenReturn(null);
    when(tenantEntity2.getPhone()).thenReturn(null);
    when(tenantEntity2.getRegion()).thenReturn(null);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual21() {
    ...
    when(tenantEntity2.getAddress2()).thenReturn(null);
    when(tenantEntity2.getCity()).thenReturn(null);
    when(tenantEntity2.getCountry()).thenReturn("foo");
    when(tenantEntity2.getEmail()).thenReturn(null);
    when(tenantEntity2.getPhone()).thenReturn(null);
    when(tenantEntity2.getRegion()).thenReturn(null);
    when(tenantEntity2.getState()).thenReturn(null);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual22() {
    ...
    when(tenantEntity2.getCity()).thenReturn(null);
    when(tenantEntity2.getCountry()).thenReturn(null);
    when(tenantEntity2.getEmail()).thenReturn("foo");
    when(tenantEntity2.getPhone()).thenReturn(null);
    when(tenantEntity2.getRegion()).thenReturn(null);
    when(tenantEntity2.getState()).thenReturn(null);
    when(tenantEntity2.getTitle()).thenReturn(null);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual23() {
    ...
    when(tenantEntity2.getCountry()).thenReturn(null);
    when(tenantEntity2.getEmail()).thenReturn(null);
    when(tenantEntity2.getPhone()).thenReturn("foo");
    when(tenantEntity2.getRegion()).thenReturn(null);
    when(tenantEntity2.getState()).thenReturn(null);
    when(tenantEntity2.getTitle()).thenReturn(null);
    when(tenantEntity2.getZip()).thenReturn(null);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual24() {
    ...
    when(tenantEntity2.getPhone()).thenReturn(null);
    when(tenantEntity2.getRegion()).thenReturn(null);
    when(tenantEntity2.getState()).thenReturn("foo");
    when(tenantEntity2.getTitle()).thenReturn(null);
    when(tenantEntity2.getZip()).thenReturn(null);
    when(tenantEntity2.getTenantProfileId()).thenReturn(null);
    when(tenantEntity2.getVersion()).thenReturn(null);
  ...
  public void testEquals_whenOtherIsDifferent_thenReturnNotEqual25() {
    ...
    when(tenantEntity2.getState()).thenReturn(null);
    when(tenantEntity2.getTitle()).thenReturn(null);
    when(tenantEntity2.getZip()).thenReturn("foo");
    when(tenantEntity2.getTenantProfileId()).thenReturn(null);
    when(tenantEntity2.getVersion()).thenReturn(null);
    when(tenantEntity2.getId()).thenReturn(null);
    when(tenantEntity2.getCreatedTime()).thenReturn(1L);
