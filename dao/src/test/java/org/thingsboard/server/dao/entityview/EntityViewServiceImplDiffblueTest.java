...
public class EntityViewServiceImplDiffblueTest {
  ...
  public void testSaveEntityViewWithEntityView2() {
    ...
    assertThrows(
        DataValidationException.class,
        () ->
            entityViewServiceImpl.saveEntityView(
                new EntityView(new EntityViewId(ModelConstants.NULL_UUID))));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"EntityView EntityViewServiceImpl.saveEntityView(EntityView, boolean)"})
  public void testSaveEntityViewWithEntityViewDoValidate_thenCallsGetId() {
    // Arrange
  ...
  public void testUnassignCustomerEntityViews_thenThrowDataValidationException() {
    // Arrange
    EntityViewServiceImpl entityViewServiceImpl = new EntityViewServiceImpl();
  ...
  public void testFindEntityViewsByTenantIdAndCustomerId_thenReturnEmpty_page_data() {
    // Arrange
    PageData<EntityView> emptyPageDataResult = PageData.emptyPageData();
    when(entityViewDao.findEntityViewsByTenantIdAndCustomerId(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
  ...
  public void testFindEntityViewInfosByTenantIdAndCustomerId_thenReturnEmpty_page_data() {
    // Arrange
    PageData<EntityViewInfo> emptyPageDataResult = PageData.emptyPageData();
    when(entityViewDao.findEntityViewInfosByTenantIdAndCustomerId(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
  ...
  public void testFindEntityViewsByTenantIdAndCustomerIdAndType_thenReturnEmpty_page_data() {
    // Arrange
    PageData<EntityView> emptyPageDataResult = PageData.emptyPageData();
    when(entityViewDao.findEntityViewsByTenantIdAndCustomerIdAndType(
            Mockito.<UUID>any(),
  ...
  public void testFindEntityViewsByQuery() {
    // Arrange
  ...
  public void testFindEntityViewsByQuery2() {
    // Arrange
  ...
  public void testFindEntityViewsByQuery_givenListenableFutureTaskAddListenerDoesNothing() {
    // Arrange
    ListenableFutureTask<List<EntityRelation>> listenableFutureTask =
        mock(ListenableFutureTask.class);
    doNothing()
  ...
  public void testFindEntityViewsByQuery_givenQuery() {
    // Arrange
  ...
  public void testFindEntityViewsByQuery_givenRelationServiceFindByQueryReturnCreate() {
    // Arrange
    SettableFuture<List<EntityRelation>> createResult = SettableFuture.create();
    when(relationService.findByQuery(Mockito.<TenantId>any(), Mockito.<EntityRelationsQuery>any()))
        .thenReturn(createResult);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void EntityViewServiceImpl.deleteEntityView(TenantId, EntityViewId)"})
  public void testDeleteEntityView_givenEntityViewServiceImpl_thenCallsGetId() {
    // Arrange
    EntityViewServiceImpl entityViewServiceImpl = new EntityViewServiceImpl();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void EntityViewServiceImpl.deleteEntityViewsByTenantId(TenantId)"})
  public void testDeleteEntityViewsByTenantId_givenEntityViewServiceImpl_thenCallsGetId() {
    // Arrange
    EntityViewServiceImpl entityViewServiceImpl = new EntityViewServiceImpl();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void EntityViewServiceImpl.deleteByTenantId(TenantId)"})
  public void testDeleteByTenantId_givenEntityViewServiceImpl_thenCallsGetId() {
    // Arrange
    EntityViewServiceImpl entityViewServiceImpl = new EntityViewServiceImpl();
  ...
  public void testFindEntityViewTypesByTenantId() {
    // Arrange
  ...
  public void testFindEntityViewTypesByTenantId2() {
    // Arrange
    when(entityViewDao.findTenantEntityViewTypesAsync(Mockito.<UUID>any()))
        .thenThrow(new DataValidationException("An error occurred"));
  ...
  public void testFindEntityViewTypesByTenantId3() {
    // Arrange
  ...
  public void testFindEntityViewTypesByTenantId_givenEntityViewServiceImpl_thenCallsGetId() {
    // Arrange
    EntityViewServiceImpl entityViewServiceImpl = new EntityViewServiceImpl();
  ...
  public void testFindEntityViewTypesByTenantId_thenCallsAddListener() {
    // Arrange
    ListenableFutureTask<List<EntitySubtype>> listenableFutureTask =
        mock(ListenableFutureTask.class);
    doNothing()
  ...
  public void testAssignEntityViewToEdge_thenThrowDataValidationException() {
    // Arrange
    EntityViewId entityViewId = mock(EntityViewId.class);
    when(entityViewId.getId()).thenThrow(new DataValidationException("An error occurred"));
  ...
  public void testUnassignEntityViewFromEdge_thenThrowDataValidationException() {
    // Arrange
    EntityViewId entityViewId = mock(EntityViewId.class);
    when(entityViewId.getId()).thenThrow(new DataValidationException("An error occurred"));
  ...
  public void testFindEntityViewsByTenantIdAndEdgeId5() {
    // Arrange
    PageData<EntityView> emptyPageDataResult = PageData.emptyPageData();
    when(entityViewDao.findEntityViewsByTenantIdAndEdgeId(
            Mockito.<UUID>any(), Mockito.<UUID>any(), Mockito.<PageLink>any()))
  ...
  public void testFindEntityViewsByTenantIdAndEdgeIdAndType_thenCallsGetSortOrder() {
    // Arrange
    EntityViewServiceImpl entityViewServiceImpl = new EntityViewServiceImpl();
