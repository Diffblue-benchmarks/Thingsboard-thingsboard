...
public class AttributeKvInsertRepositoryDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link AttributeKvInsertRepository} (default constructor).</li>
   *   <li>Then calls {@link PreparedStatement#setNull(int, int)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link AttributeKvInsertRepository#setOnBatchUpdateValues(PreparedStatement, int, List)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void AttributeKvInsertRepository.setOnBatchUpdateValues(PreparedStatement, int, List)"})
  public void testSetOnBatchUpdateValues_givenAttributeKvInsertRepository_thenCallsSetNull() throws SQLException {
    // Arrange
  ...
  /**
   * Test {@link AttributeKvInsertRepository#setOnInsertOrUpdateValues(PreparedStatement, int, List)}.
   * <ul>
   *   <li>Given {@link AttributeKvInsertRepository} (default constructor).</li>
   *   <li>Then calls {@link PreparedStatement#setNull(int, int)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link AttributeKvInsertRepository#setOnInsertOrUpdateValues(PreparedStatement, int, List)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void AttributeKvInsertRepository.setOnInsertOrUpdateValues(PreparedStatement, int, List)"})
  public void testSetOnInsertOrUpdateValues_givenAttributeKvInsertRepository_thenCallsSetNull() throws SQLException {
    // Arrange
    AttributeKvInsertRepository attributeKvInsertRepository = new AttributeKvInsertRepository();
    PreparedStatement ps = mock(PreparedStatement.class);
    doNothing().when(ps).setNull(anyInt(), anyInt());
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"String AttributeKvInsertRepository.getBatchUpdateQuery()",
