...
public class CassandraBufferedRateWriteExecutorDiffblueTest {
  ...
  public void testPrintStats() {
    ...
    // Act
    (new CassandraBufferedRateWriteExecutor(1, 0, 1L, 1, 1, 1L, true, 1, statsFactory, entityService,
  ...
  public void testPrintStats2() {
    ...
    // Act
    (new CassandraBufferedRateWriteExecutor(1, 1, 1L, 1, 1, 0L, true, 1, statsFactory, entityService,
        new DefaultRateLimitService(mock(TenantProfileProvider.class), mock(NotificationRuleProcessor.class), 1, 3)))
        .printStats();
   ...
   */
  @Test
  public void testPrintStats_givenAtomicIntegerWithOneIncrementAndGet_thenCallsCreateGauge() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
