...
public class OtaPackageInfoEntityDiffblueTest {
  ...
  public void testNewOtaPackageInfoEntity() {
    ...
    assertEquals(arrayNode, additionalInfo);
  }
  ...
  public void testNewOtaPackageInfoEntity_thenAdditionalInfoReturnNullNode() {
    // Arrange
   ...
   *
   * <ul>
   *   <li>Given {@link OtaPackageInfoEntity#OtaPackageInfoEntity()} TenantId is {@link
   *       ModelConstants#NULL_UUID}.
   * </ul>
   *
  ...
  public void testToData_givenOtaPackageInfoEntityTenantIdIsNull_uuid() {
    // Arrange
    OtaPackageInfoEntity otaPackageInfoEntity = new OtaPackageInfoEntity();
    otaPackageInfoEntity.setAdditionalInfo(
        CustomerServiceImpl.PUBLIC_CUSTOMER_ADDITIONAL_INFO_JSON);
