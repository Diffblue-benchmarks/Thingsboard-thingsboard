...
public class AuditLogDataValidatorDiffblueTest {
  ...
  /**
   * Test {@link AuditLogDataValidator#validateDataImpl(TenantId, AuditLog)} with {@code TenantId}, {@code AuditLog}.
   * <ul>
   *   <li>When {@link AuditLog#AuditLog()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link AuditLogDataValidator#validateDataImpl(TenantId, AuditLog)}
   */
  @Test
