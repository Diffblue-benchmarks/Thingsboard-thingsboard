...
public class DeviceProfileEntityDiffblueTest {
  ...
  public void testToData_givenDeviceProfileEntityProfileDataIsInstance() {
    // Arrange
    DeviceProfileEntity deviceProfileEntity = new DeviceProfileEntity();
    deviceProfileEntity.setCreatedTime(1L);
    deviceProfileEntity.setDefault(true);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"DeviceProfile DeviceProfileEntity.toData()"})
  public void testToData_givenDeviceProfileEntityProfileDataIsNull_thenReturnDefaultQueueName() {
    // Arrange
    DeviceProfileEntity deviceProfileEntity = new DeviceProfileEntity();
    deviceProfileEntity.setCreatedTime(1L);
    deviceProfileEntity.setDefault(true);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"DeviceProfile DeviceProfileEntity.toData()"})
  public void testToData_givenDeviceProfileEntityTenantIdIsRandomUUID() {
    // Arrange
    DeviceProfileEntity deviceProfileEntity = new DeviceProfileEntity();
    deviceProfileEntity.setCreatedTime(1L);
    deviceProfileEntity.setDefault(true);
