...
public class ValidatorDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Validator.validateEntityId(EntityId, Function)"})
  public void testValidateEntityIdWithEntityIdErrorMessageFunction_givenApply() {
    // Arrange
    AlarmId entityId = new AlarmId(null);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Validator.validateEntityId(EntityId, Function)"})
  public void testValidateEntityIdWithEntityIdErrorMessageFunction_thenDoesNotThrow() {
    // Arrange, Act and Assert
    Validator.validateEntityId(BaseEntityService.NULL_CUSTOMER_ID, mock(Function.class));
  }
  ...
  public void testValidateEntityIdWithEntityIdErrorMessage_thenDoesNotThrow() {
    // Arrange, Act and Assert
    Validator.validateEntityId(BaseEntityService.NULL_CUSTOMER_ID, "An error occurred");
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Validator.validateString(String, Function)"})
  public void testValidateStringWithValErrorMessageFunction_whenVal_thenDoesNotThrow() {
    // Arrange, Act and Assert
    Validator.validateString("Val", mock(Function.class));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Validator.validateString(String, String)"})
  public void testValidateStringWithValErrorMessage_whenVal_thenDoesNotThrow() {
    // Arrange, Act and Assert
    Validator.validateString("Val", "An error occurred");
  }
  ...
  public void testValidatePositiveNumber_whenFortyTwo_thenDoesNotThrow() {
    // Arrange, Act and Assert
    Validator.validatePositiveNumber(42L, "An error occurred");
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Validator.validateId(UUIDBased, Function)"})
  public void testValidateIdWithUUIDBasedFunction_whenNull_customer_id_thenDoesNotThrow() {
    // Arrange, Act and Assert
    Validator.validateId(BaseEntityService.NULL_CUSTOMER_ID, mock(Function.class));
  }

  /**
   * Test {@link Validator#validateId(UUIDBased, List, Function)} with {@code UUIDBased}, {@code
   * List}, {@code Function}.
   *
   * <ul>
   *   <li>When {@link BaseEntityService#NULL_CUSTOMER_ID}.
   ...
   * </ul>
   *
   * <p>Method under test: {@link Validator#validateId(UUIDBased, List, Function)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"void Validator.validateId(UUIDBased, List, Function)"})
  public void testValidateIdWithUUIDBasedListFunction_whenNull_customer_id_thenDoesNotThrow() {
    // Arrange, Act and Assert
    Validator.validateId(
        BaseEntityService.NULL_CUSTOMER_ID, new ArrayList<>(), mock(Function.class));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Validator.validateId(UUIDBased, String)"})
  public void testValidateIdWithUUIDBasedString_whenNull_customer_id_thenDoesNotThrow() {
    // Arrange, Act and Assert
    Validator.validateId(BaseEntityService.NULL_CUSTOMER_ID, "An error occurred");
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Validator.validateId(UUID, Function)"})
  public void testValidateIdWithUuidFunction_whenNull_uuid_thenDoesNotThrow() {
    // Arrange, Act and Assert
    Validator.validateId(ModelConstants.NULL_UUID, mock(Function.class));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Validator.validateId(UUID, String)"})
  public void testValidateIdWithUuidString_whenNull_uuid_thenDoesNotThrow() {
    // Arrange, Act and Assert
    Validator.validateId(ModelConstants.NULL_UUID, "An error occurred");
  }

  /**
   * Test {@link Validator#validateIds(List, Function)} with {@code ids}, {@code
   * errorMessageFunction}.
   *
   * <ul>
   *   <li>Then does not throw.
   * </ul>
   *
   * <p>Method under test: {@link Validator#validateIds(List, Function)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"void Validator.validateIds(List, Function)"})
  public void testValidateIdsWithIdsErrorMessageFunction_thenDoesNotThrow() {
    // Arrange
    ...
    // Act and Assert
    Validator.validateIds(ids, mock(Function.class));
  }
  ...
  public void testValidateIdsWithIdsErrorMessage_givenNull_customer_id() {
    // Arrange
    ArrayList<UUIDBased> ids = new ArrayList<>();
    ids.add(BaseEntityService.NULL_CUSTOMER_ID);
    ids.add(BaseEntityService.NULL_CUSTOMER_ID);
    ...
    // Act and Assert
    Validator.validateIds(ids, "An error occurred");
  }
  ...
  public void testValidatePageLink_whenFirst_page_thenDoesNotThrow() {
    // Arrange, Act and Assert
    Validator.validatePageLink(BaseRelatedEdgesService.FIRST_PAGE);
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Validator.validateEntityDataPageLink(EntityDataPageLink)"})
  public void testValidateEntityDataPageLink3() {
    // Arrange, Act and Assert
    Validator.validateEntityDataPageLink(
        new EntityDataPageLink(
            ...
            1,
            "Text Search",
            new EntityDataSortOrder(new EntityKey(EntityKeyType.ENTITY_FIELD, ""))));
  }
   ...
   * <ul>
   *   <li>Given three.
   *   <li>When {@link EntityDataPageLink#EntityDataPageLink()} PageSize is three.
   * </ul>
   *
   * <p>Method under test: {@link Validator#validateEntityDataPageLink(EntityDataPageLink)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Validator.validateEntityDataPageLink(EntityDataPageLink)"})
  public void testValidateEntityDataPageLink_givenThree_whenEntityDataPageLinkPageSizeIsThree() {
    // Arrange
    EntityDataPageLink pageLink = new EntityDataPageLink();
    pageLink.setPageSize(3);

    // Act and Assert
    Validator.validateEntityDataPageLink(pageLink);
  }
   ...
   *
   * <ul>
   *   <li>When {@link EntityKey#EntityKey(EntityKeyType, String)} with type is {@code ALARM_FIELD}
   *       and {@code Key}.
   * </ul>
   *
   * <p>Method under test: {@link Validator#validateEntityDataPageLink(EntityDataPageLink)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Validator.validateEntityDataPageLink(EntityDataPageLink)"})
  public void testValidateEntityDataPageLink_whenEntityKeyWithTypeIsAlarmFieldAndKey() {
    // Arrange, Act and Assert
    Validator.validateEntityDataPageLink(
        new EntityDataPageLink(
            3,
            1,
            "Text Search",
            new EntityDataSortOrder(new EntityKey(EntityKeyType.ALARM_FIELD, "Key"))));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Validator.validateEntityDataPageLink(EntityDataPageLink)"})
  public void testValidateEntityDataPageLink_whenEntityKeyWithTypeIsAttributeAndKey() {
    // Arrange, Act and Assert
    Validator.validateEntityDataPageLink(
        new EntityDataPageLink(
            3,
   ...
   *
   * <ul>
   *   <li>When {@link EntityKey#EntityKey(EntityKeyType, String)} with type is {@code ENTITY_FIELD}
   *       and {@code Key}.
   * </ul>
   *
   * <p>Method under test: {@link Validator#validateEntityDataPageLink(EntityDataPageLink)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Validator.validateEntityDataPageLink(EntityDataPageLink)"})
  public void testValidateEntityDataPageLink_whenEntityKeyWithTypeIsEntityFieldAndKey() {
    // Arrange, Act and Assert
    Validator.validateEntityDataPageLink(
        new EntityDataPageLink(
            3,
            1,
            "Text Search",
            new EntityDataSortOrder(new EntityKey(EntityKeyType.ENTITY_FIELD, "Key"))));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Validator.validateEntityDataPageLink(EntityDataPageLink)"})
  public void testValidateEntityDataPageLink_whenEntityKeyWithTypeIsEntityFieldAndKeyIsNull() {
    // Arrange, Act and Assert
    Validator.validateEntityDataPageLink(
        new EntityDataPageLink(
            3,
            1,
            "Text Search",
            new EntityDataSortOrder(new EntityKey(EntityKeyType.ENTITY_FIELD, null))));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Validator.checkNotNull(Object, String)"})
  public void testCheckNotNull_whenReference_thenDoesNotThrow() {
    // Arrange, Act and Assert
    Validator.checkNotNull("Reference", "An error occurred");
  }
}
