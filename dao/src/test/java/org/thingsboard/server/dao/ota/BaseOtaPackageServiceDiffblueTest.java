...
public class BaseOtaPackageServiceDiffblueTest {
  ...
  public void testSaveOtaPackageInfo2() {
    ...
    OtaPackageInfo otaPackageInfo = new OtaPackageInfo(new OtaPackageInfo());
    otaPackageInfo.setUrl("");
    otaPackageInfo.setId(new OtaPackageId(ModelConstants.NULL_UUID));
  ...
  public void testSaveOtaPackageInfo4() {
    ...
    when(otaPackageInfoValidator.validate(
            Mockito.<OtaPackageInfo>any(), Mockito.<Function<OtaPackageInfo, TenantId>>any()))
        .thenReturn(new OtaPackageInfo());
    ...
    OtaPackageInfo otaPackageInfo = new OtaPackageInfo(new OtaPackageInfo());
    otaPackageInfo.setTenantId(new TenantId(ModelConstants.NULL_UUID));
    otaPackageInfo.setUrl("java.text");
    otaPackageInfo.setId(null);
    ...
    verify(otaPackageInfoValidator).validate(isA(OtaPackageInfo.class), isA(Function.class));
  ...
  public void testSaveOtaPackageInfo_givenOtaPackageInfoDao() {
    // Arrange
    OtaPackageInfo otaPackageInfo = new OtaPackageInfo(new OtaPackageInfo());
    otaPackageInfo.setUrl("");
    otaPackageInfo.setId(new OtaPackageId(ModelConstants.NULL_UUID));
  ...
  public void testSaveOtaPackageInfo_givenTbTransactionalCache_thenReturnOtaPackageInfo() {
    // Arrange
    ...
    OtaPackageInfo otaPackageInfo2 = new OtaPackageInfo(new OtaPackageInfo());
    otaPackageInfo2.setUrl("");
    otaPackageInfo2.setId(null);
  ...
  public void testSaveOtaPackageInfo_thenReturnOtaPackageInfo() {
    ...
    OtaPackageInfo otaPackageInfo2 = new OtaPackageInfo(new OtaPackageInfo());
    otaPackageInfo2.setUrl("");
    otaPackageInfo2.setId(new OtaPackageId(ModelConstants.NULL_UUID));
  ...
  public void testSaveOtaPackage() {
    ...
    // Act and Assert
    assertThrows(DataValidationException.class, () -> baseOtaPackageService.saveOtaPackage(null));
    verify(dataValidator2).validate(isNull(), isA(Function.class));
  }
  ...
  public void testSaveOtaPackage2() {
    ...
    assertThrows(
        DataValidationException.class,
        () -> baseOtaPackageService.saveOtaPackage(new OtaPackage()));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"OtaPackage BaseOtaPackageService.saveOtaPackage(OtaPackage)"})
  public void testSaveOtaPackage3() {
    // Arrange
    ConstraintViolationException constraintViolationException =
        new ConstraintViolationException(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"OtaPackage BaseOtaPackageService.saveOtaPackage(OtaPackage)"})
  public void testSaveOtaPackage4() {
    // Arrange
    ConstraintViolationException constraintViolationException =
        new ConstraintViolationException(
            "An error occurred", new SQLException(), "ota_package_tenant_title_version_unq_key");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"OtaPackage BaseOtaPackageService.saveOtaPackage(OtaPackage)"})
  public void testSaveOtaPackage5() {
    // Arrange
    ConstraintViolationException constraintViolationException =
        new ConstraintViolationException("An error occurred", new SQLException(), null);
    when(otaPackageDao.save(Mockito.<TenantId>any(), Mockito.<OtaPackage>any()))
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"OtaPackage BaseOtaPackageService.saveOtaPackage(OtaPackage)"})
  public void testSaveOtaPackage6() {
    // Arrange
    OtaPackage createFirmwareResult =
        OtaPackageServiceTest.createFirmware(ModelConstants.SYSTEM_TENANT, "1.0.2", null);
    when(otaPackageDao.save(Mockito.<TenantId>any(), Mockito.<OtaPackage>any()))
        .thenReturn(createFirmwareResult);
    OtaPackage createFirmwareResult2 =
        OtaPackageServiceTest.createFirmware(ModelConstants.SYSTEM_TENANT, "1.0.2", null);
    when(dataValidator2.validate(
            Mockito.<OtaPackage>any(), Mockito.<Function<OtaPackage, TenantId>>any()))
        .thenReturn(createFirmwareResult2);
    ...
    verify(otaPackageDao).save(isNull(), isA(OtaPackage.class));
    verify(dataValidator2).validate(isA(OtaPackage.class), isA(Function.class));
    assertSame(createFirmwareResult, actualSaveOtaPackageResult);
  }
  ...
  public void testFindOtaPackageById_givenDataValidationExceptionWithMessageIsAnErrorOccurred() {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"OtaPackage BaseOtaPackageService.findOtaPackageById(TenantId, OtaPackageId)"})
  public void testFindOtaPackageById_givenNull_uuid_thenCallsFindById() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    //   Run dcover create --keep-partial-tests to gain insights into why
    //   a non-Spring test was created.
  ...
  public void testFindTenantOtaPackagesByTenantId_givenSortOrderGetPropertyReturnEmptyString() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    //   Run dcover create --keep-partial-tests to gain insights into why
    //   a non-Spring test was created.
  ...
  public void testFindTenantOtaPackagesByTenantId_givenSortOrderGetPropertyReturnNull() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    //   Run dcover create --keep-partial-tests to gain insights into why
    //   a non-Spring test was created.
  ...
  public void testFindTenantOtaPackagesByTenantIdAndDeviceProfileIdAndTypeAndHasData10() {
    // Arrange
    TenantId tenantId = mock(TenantId.class);
    when(tenantId.getId()).thenThrow(new DataValidationException("An error occurred"));
  ...
  public void testDeleteOtaPackage4() {
    ...
    assertThrows(
        ...
        () ->
            baseOtaPackageService.deleteOtaPackage(
                ModelConstants.SYSTEM_TENANT, new OtaPackageId(UUID.randomUUID())));
    verify(tbTransactionalCache).evict(isA(OtaPackageCacheKey.class));
    verify(otaPackageDao).removeById(isA(TenantId.class), isA(UUID.class));
  }
  ...
  public void testDeleteOtaPackage5() {
    // Arrange
    OtaPackageDao otaPackageDao = mock(OtaPackageDao.class);
    ConstraintViolationException constraintViolationException =
        new ConstraintViolationException(
            "An error occurred", new SQLException(), "fk_firmware_device");
    doThrow(constraintViolationException)
        .when(otaPackageDao)
        .removeById(Mockito.<TenantId>any(), Mockito.<UUID>any());
    JpaOtaPackageInfoDao otaPackageInfoDao = new JpaOtaPackageInfoDao();
  ...
  public void testDeleteOtaPackage6() {
    ...
    ConstraintViolationException constraintViolationException =
        new ConstraintViolationException(
            "An error occurred", new SQLException(), "fk_firmware_device_profile");
    doThrow(constraintViolationException)
        .when(otaPackageDao)
        .removeById(Mockito.<TenantId>any(), Mockito.<UUID>any());
    JpaOtaPackageInfoDao otaPackageInfoDao = new JpaOtaPackageInfoDao();
  ...
  public void testDeleteOtaPackage7() {
    ...
    ConstraintViolationException constraintViolationException =
        new ConstraintViolationException(
            "An error occurred", new SQLException(), "fk_software_device");
    doThrow(constraintViolationException)
        .when(otaPackageDao)
        .removeById(Mockito.<TenantId>any(), Mockito.<UUID>any());
    JpaOtaPackageInfoDao otaPackageInfoDao = new JpaOtaPackageInfoDao();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void BaseOtaPackageService.deleteOtaPackage(TenantId, OtaPackageId)"})
  public void testDeleteOtaPackage8() {
    // Arrange
    OtaPackageDao otaPackageDao = mock(OtaPackageDao.class);
    ConstraintViolationException constraintViolationException =
        new ConstraintViolationException(
            "An error occurred", new SQLException(), "fk_software_device_profile");
    doThrow(constraintViolationException)
        .when(otaPackageDao)
        .removeById(Mockito.<TenantId>any(), Mockito.<UUID>any());
    JpaOtaPackageInfoDao otaPackageInfoDao = new JpaOtaPackageInfoDao();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void BaseOtaPackageService.deleteOtaPackage(TenantId, OtaPackageId)"})
  public void testDeleteOtaPackage9() {
    // Arrange
    OtaPackageDao otaPackageDao = mock(OtaPackageDao.class);
    ConstraintViolationException constraintViolationException =
        new ConstraintViolationException("An error occurred", new SQLException(), null);
  ...
  public void testDeleteOtaPackagesByTenantId_givenNull_uuid_thenCallsGetId() {
    // Arrange
    PageData<OtaPackageInfo> emptyPageDataResult = PageData.emptyPageData();
    when(otaPackageInfoDao.findOtaPackageInfoByTenantId(
            Mockito.<TenantId>any(), Mockito.<PageLink>any()))
    ...
    // Act
    baseOtaPackageService.deleteOtaPackagesByTenantId(tenantId);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void BaseOtaPackageService.deleteOtaPackagesByTenantId(TenantId)"})
  public void testDeleteOtaPackagesByTenantId_thenThrowDataValidationException() {
    // Arrange
    TenantId tenantId = mock(TenantId.class);
    when(tenantId.getId()).thenThrow(new DataValidationException("An error occurred"));
  ...
  public void testDeleteByTenantId_givenNull_uuid_thenCallsGetId() {
    ...
    // Act
    baseOtaPackageService.deleteByTenantId(tenantId);
  ...
  public void testDeleteByTenantId_thenThrowDataValidationException() {
    ...
    // Act and Assert
    assertThrows(
        DataValidationException.class, () -> baseOtaPackageService.deleteByTenantId(tenantId));
    verify(tenantId).getId();
  }
}
