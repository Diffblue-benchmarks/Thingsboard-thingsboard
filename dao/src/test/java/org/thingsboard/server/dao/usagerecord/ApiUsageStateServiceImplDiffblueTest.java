...
public class ApiUsageStateServiceImplDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link TenantProfileDao}.
  ...
  public void testCreateDefaultApiUsageState_givenTenantProfileDao_thenReturnApiUsageState() {
    // Arrange
    ApiUsageState apiUsageState = new ApiUsageState();
  ...
  public void testCreateDefaultApiUsageState_thenCallsGetId() {
    // Arrange
    ApiUsageStateDao apiUsageStateDao = mock(ApiUsageStateDao.class);
    ApiUsageState apiUsageState = new ApiUsageState();
    when(apiUsageStateDao.save(Mockito.<TenantId>any(), Mockito.<ApiUsageState>any()))
        .thenReturn(apiUsageState);
    ...
    DataValidator<ApiUsageState> apiUsageStateValidator = mock(DataValidator.class);
    when(apiUsageStateValidator.validate(
            Mockito.<ApiUsageState>any(), Mockito.<Function<ApiUsageState, TenantId>>any()))
        .thenReturn(new ApiUsageState());
    ...
    verify(apiUsageStateValidator).validate(isA(ApiUsageState.class), isA(Function.class));
    verify(tsService).save(isA(TenantId.class), isNull(), isA(List.class), eq(0L));
    verify(apiUsageStateDao).save(isA(TenantId.class), isA(ApiUsageState.class));
    assertSame(apiUsageState, actualCreateDefaultApiUsageStateResult);
  }
  ...
  public void testCreateDefaultApiUsageState_thenCallsGetId2() {
    // Arrange
    ApiUsageStateDao apiUsageStateDao = mock(ApiUsageStateDao.class);
    ApiUsageState apiUsageState = new ApiUsageState();
    when(apiUsageStateDao.save(Mockito.<TenantId>any(), Mockito.<ApiUsageState>any()))
  ...
  public void testUpdate_givenTenantIdGetIdReturnNull_uuid_thenCallsGetId() {
    ...
    ApiUsageState apiUsageState2 = new ApiUsageState(id);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"ApiUsageState ApiUsageStateServiceImpl.update(ApiUsageState)"})
  public void testUpdate_whenApiUsageStateIdWithIdIsNull_uuid_thenReturnApiUsageState() {
    // Arrange
    ApiUsageState apiUsageState = new ApiUsageState();
    when(apiUsageStateDao.save(Mockito.<TenantId>any(), Mockito.<ApiUsageState>any()))
        .thenReturn(apiUsageState);

    ApiUsageState apiUsageState2 = new ApiUsageState(new ApiUsageStateId(ModelConstants.NULL_UUID));
   ...
   *
   * <ul>
   *   <li>When {@link ApiUsageState#ApiUsageState(ApiUsageStateId)} with id is {@link
   *       ApiUsageStateId} TenantId is {@link ModelConstants#SYSTEM_TENANT}.
   * </ul>
   *
   * <p>Method under test: {@link ApiUsageStateServiceImpl#update(ApiUsageState)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"ApiUsageState ApiUsageStateServiceImpl.update(ApiUsageState)"})
  public void testUpdate_whenApiUsageStateWithIdIsApiUsageStateIdTenantIdIsSystem_tenant() {
    // Arrange
    ApiUsageState apiUsageState = new ApiUsageState();
    when(apiUsageStateDao.save(Mockito.<TenantId>any(), Mockito.<ApiUsageState>any()))
        .thenReturn(apiUsageState);
