...
public class JpaWidgetsBundleDaoDiffblueTest {
  ...
  public void testFindAllTenantWidgetsBundlesByTenantId_givenNull_uuid_thenCallsGetId() {
    // Arrange
    when(widgetsBundleRepository.findAllTenantWidgetsBundlesByTenantIdsFullSearch(
            Mockito.<List<UUID>>any(),
            Mockito.<String>any(),
  ...
  public void testFindAllTenantWidgetsBundlesByTenantId_givenOne_thenReturnTotalElementsIsZero() {
    // Arrange
    when(widgetsBundleRepository.findAllTenantWidgetsBundlesByTenantIdsFullSearch(
            Mockito.<List<UUID>>any(),
            Mockito.<String>any(),
  ...
  public void testFindAllTenantWidgetsBundlesByTenantId_thenReturnTotalElementsIsZero() {
    // Arrange
    when(widgetsBundleRepository.findAllTenantWidgetsBundlesByTenantIdsFullSearch(
            Mockito.<List<UUID>>any(),
            Mockito.<String>any(),
