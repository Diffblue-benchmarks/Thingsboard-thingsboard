...
class FromDeviceRpcResponseDiffblueTest {
  ...
  void testGetResponse() {
    // Arrange and Act
    Optional<String> actualResponse = (new FromDeviceRpcResponse(
        UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"), "Response", RpcError.NOT_FOUND)).getResponse();
  ...
  void testGetError() {
    // Arrange and Act
    Optional<RpcError> actualError = (new FromDeviceRpcResponse(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"),
        "Response", RpcError.NOT_FOUND)).getError();
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    FromDeviceRpcResponse fromDeviceRpcResponse = new FromDeviceRpcResponse(
        UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"), "Response", RpcError.NOT_FOUND);
    FromDeviceRpcResponse fromDeviceRpcResponse2 = new FromDeviceRpcResponse(
        UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"), "Response", RpcError.NOT_FOUND);
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    ...
    // Act and Assert
    assertNotEquals(fromDeviceRpcResponse, new FromDeviceRpcResponse(
        UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"), "Response", RpcError.NOT_FOUND));
  }
  ...
  void testEquals_whenOtherIsNull_thenReturnNotEqual() {
    ...
    assertNotEquals(new FromDeviceRpcResponse(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"), "Response",
        RpcError.NOT_FOUND), null);
  }
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new FromDeviceRpcResponse(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"), "Response",
        RpcError.NOT_FOUND), "Different type to FromDeviceRpcResponse");
  }
  ...
  void testGettersAndSetters() {
    ...
    assertEquals("FromDeviceRpcResponse(id=784f394c-42b6-435a-983c-b7beff2784f9, response=Optional[Response],"
        + " error=Optional[NOT_FOUND])", actualToStringResult);
