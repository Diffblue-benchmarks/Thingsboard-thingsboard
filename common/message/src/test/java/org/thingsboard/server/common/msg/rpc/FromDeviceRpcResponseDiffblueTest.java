...
class FromDeviceRpcResponseDiffblueTest {
  ...
  void testGetResponse() {
    ...
    Optional<String> actualResponse =
        new FromDeviceRpcResponse(UUID.randomUUID(), "Response", RpcError.NOT_FOUND).getResponse();
  ...
  void testGetError() {
    ...
    Optional<RpcError> actualError =
        new FromDeviceRpcResponse(UUID.randomUUID(), "Response", RpcError.NOT_FOUND).getError();
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(fromDeviceRpcResponse.hashCode(), fromDeviceRpcResponse2.hashCode());
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual2() {
    // Arrange
    FromDeviceRpcResponse fromDeviceRpcResponse =
        new FromDeviceRpcResponse(new UUID(1L, 1L), "Response", RpcError.NOT_FOUND);
    FromDeviceRpcResponse fromDeviceRpcResponse2 =
        new FromDeviceRpcResponse(new UUID(1L, 1L), "Response", RpcError.NOT_FOUND);
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual3() {
    // Arrange
    FromDeviceRpcResponse fromDeviceRpcResponse =
        new FromDeviceRpcResponse(null, null, RpcError.NOT_FOUND);

    // Act and Assert
    assertNotEquals(
        fromDeviceRpcResponse, new FromDeviceRpcResponse(null, "Response", RpcError.NOT_FOUND));
  }
  ...
  void testEquals_whenOtherIsNull_thenReturnNotEqual() {
    ...
    assertNotEquals(
        new FromDeviceRpcResponse(UUID.randomUUID(), "Response", RpcError.NOT_FOUND), null);
  }
