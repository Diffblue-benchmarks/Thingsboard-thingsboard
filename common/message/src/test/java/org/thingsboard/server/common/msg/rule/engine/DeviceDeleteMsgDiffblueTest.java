...
class DeviceDeleteMsgDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual3() {
    ...
    DeviceDeleteMsg deviceDeleteMsg =
        new DeviceDeleteMsg(
            tenantId, new DeviceId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9")));
    TenantId tenantId2 = new TenantId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"));
    DeviceDeleteMsg deviceDeleteMsg2 =
        new DeviceDeleteMsg(
            tenantId2, new DeviceId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9")));
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual5() {
    ...
    assertNotEquals(
        deviceDeleteMsg,
        new DeviceDeleteMsg(
            null, new DeviceId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"))));
  }
}
