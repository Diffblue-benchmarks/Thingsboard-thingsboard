...
class FstStatsServiceImplDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test incrementEncode(Class); given AtomicInteger(int) with forty-two; then calls createStatsCounter(String, String, String[])")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void FstStatsServiceImpl.incrementEncode(Class)"})
  void testIncrementEncode_givenAtomicIntegerWithFortyTwo_thenCallsCreateStatsCounter() {
    // Arrange
  ...
  @Test
  @DisplayName(
      "Test incrementDecode(Class); given AtomicInteger(int) with forty-two; then calls createStatsCounter(String, String, String[])")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void FstStatsServiceImpl.incrementDecode(Class)"})
  void testIncrementDecode_givenAtomicIntegerWithFortyTwo_thenCallsCreateStatsCounter() {
    // Arrange
    AtomicInteger aiCounter = new AtomicInteger(42);
    Id id =
        new Id(
