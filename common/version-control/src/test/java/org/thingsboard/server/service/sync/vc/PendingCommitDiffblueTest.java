...
class PendingCommitDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, pendingCommit2.hashCode());
  }
  ...
  void testGettersAndSetters() {
    ...
    String actualWorkingBranch = pendingCommit.getWorkingBranch();
    ...
    assertEquals("784f394c-42b6-435a-983c-b7beff2784f9", actualWorkingBranch);
