...
class DateTimeFormatOptionsDiffblueTest {
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    // Arrange
    DateTimeFormatOptions dateTimeFormatOptions = new DateTimeFormatOptions("Europe/London");
   ...
   *
   * <ul>
   *   <li>Given {@link DateTimeFormatOptions#DateTimeFormatOptions(String)} with timeZone is empty
   *       string.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test getTimeZone(); given DateTimeFormatOptions(String) with timeZone is empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"TimeZone DateTimeFormatOptions.getTimeZone()"})
  void testGetTimeZone_givenDateTimeFormatOptionsWithTimeZoneIsEmptyString() {
    // Arrange, Act and Assert
    assertEquals(0, new DateTimeFormatOptions("").getTimeZone().getDSTSavings());
  }
   ...
   */
  @Test
  @DisplayName("Test getTimeZone(); given DateTimeFormatOptions(String) with timeZone is 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"TimeZone DateTimeFormatOptions.getTimeZone()"})
  void testGetTimeZone_givenDateTimeFormatOptionsWithTimeZoneIsNull() {
    // Arrange, Act and Assert
    assertEquals(0, new DateTimeFormatOptions(null).getTimeZone().getDSTSavings());
  }
