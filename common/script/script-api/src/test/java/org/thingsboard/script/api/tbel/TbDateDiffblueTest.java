...
class TbDateDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link TbDate#TbDate(String, String, String)}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link TbDate#TbDate(int, int, int, int, int, int, int, String)}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link TbDate#TbDate(int, int, int, int, int, int, String)}
   */
  @Test
   ...
   */
  @Test
  @DisplayName("Test new TbDate(String, String, String); when 'foo'; then throw ConversionException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void TbDate.<init>(String, String, String)"})
   ...
   *   <li>Then return toDateString is {@code 100 Jan 1, Fri}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TbDate#TbDate(int, int, int, int, int)}
   */
  @Test
  @DisplayName("Test new TbDate(int, int, int, int, int); when one hundred; then return toDateString is '100 Jan 1, Fri'")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test new TbDate(int, int, int, int, int, int); when one hundred; then return toDateString is '100 Jan 1, Fri'")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test new TbDate(int, int, int, int, int, int, int); when one hundred; then return toDateString is '100 Jan 1, Fri'")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test new TbDate(int, int, int, int, int, int, int, String); when one hundred; then return toDateString is '100 Jan 1, Fri'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void TbDate.<init>(int, int, int, int, int, int, int, String)"})
   ...
   */
  @Test
  @DisplayName("Test new TbDate(int, int, int, int, int, int, String); when one hundred; then return toDateString is '100 Jan 1, Fri'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void TbDate.<init>(int, int, int, int, int, int, String)"})
   ...
   */
  @Test
  @DisplayName("Test new TbDate(int, int, int, int, int, String); when one hundred; then return toDateString is '100 Jan 1, Fri'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void TbDate.<init>(int, int, int, int, int, String)"})
  ...
  /**
   * Test {@link TbDate#toLocaleString(String, String, BiFunction)} with {@code localeStr}, {@code optionsStr}, {@code formatterBuilder}.
   * <p>
  ...
  /**
   * Test {@link TbDate#UTC(int, int, int, int, int, int, int)} with {@code year}, {@code month}, {@code date}, {@code hrs}, {@code min}, {@code sec}, {@code ms}.
   * <ul>
   *   <li>When {@code 2000}.</li>
   *   <li>Then return {@code 952052463003}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TbDate#UTC(int, int, int, int, int, int, int)}
   */
  @Test
  @DisplayName("Test UTC(int, int, int, int, int, int, int) with 'year', 'month', 'date', 'hrs', 'min', 'sec', 'ms'; when '2000'; then return '952052463003'")
  @Tag("MaintainedByDiffblue")
  ...
  void testUtcWithYearMonthDateHrsMinSecMs_when2000_thenReturn952052463003() {
    // Arrange, Act and Assert
    assertEquals(952052463003L, TbDate.UTC(2000, 3, 3, 3, 1, 3, 3));
  }
   ...
   */
  @Test
  @DisplayName("Test UTC(int, int, int, int, int, int, int) with 'year', 'month', 'date', 'hrs', 'min', 'sec', 'ms'; when MIN_VALUE; then return '1046660463000'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"long TbDate.UTC(int, int, int, int, int, int, int)"})
  void testUtcWithYearMonthDateHrsMinSecMs_whenMin_value_thenReturn1046660463000() {
    // Arrange, Act and Assert
    assertEquals(1046660463000L, TbDate.UTC(3, 3, 3, 3, 1, 3, Integer.MIN_VALUE));
  }
   ...
   * <ul>
   *   <li>When seventy.</li>
   *   <li>Then return {@code 5281263003}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TbDate#UTC(int, int, int, int, int, int, int)}
   */
  @Test
  @DisplayName("Test UTC(int, int, int, int, int, int, int) with 'year', 'month', 'date', 'hrs', 'min', 'sec', 'ms'; when seventy; then return '5281263003'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"long TbDate.UTC(int, int, int, int, int, int, int)"})
  void testUtcWithYearMonthDateHrsMinSecMs_whenSeventy_thenReturn5281263003() {
    // Arrange, Act and Assert
    assertEquals(5281263003L, TbDate.UTC(70, 3, 3, 3, 1, 3, 3));
  }
   ...
   * <ul>
   *   <li>When seventy.</li>
   *   <li>Then return {@code 1046660463070}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TbDate#UTC(int, int, int, int, int, int, int)}
   */
  @Test
  @DisplayName("Test UTC(int, int, int, int, int, int, int) with 'year', 'month', 'date', 'hrs', 'min', 'sec', 'ms'; when seventy; then return '1046660463070'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"long TbDate.UTC(int, int, int, int, int, int, int)"})
  void testUtcWithYearMonthDateHrsMinSecMs_whenSeventy_thenReturn1046660463070() {
    // Arrange, Act and Assert
    assertEquals(1046660463070L, TbDate.UTC(3, 3, 3, 3, 1, 3, 70));
  }
   ...
   */
  @Test
  @DisplayName("Test UTC(int, int, int, int, int, int, int) with 'year', 'month', 'date', 'hrs', 'min', 'sec', 'ms'; when zero; then return '1046660463000'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"long TbDate.UTC(int, int, int, int, int, int, int)"})
  void testUtcWithYearMonthDateHrsMinSecMs_whenZero_thenReturn1046660463000() {
    // Arrange, Act and Assert
    assertEquals(1046660463000L, TbDate.UTC(3, 3, 3, 3, 1, 3, 0));
  }
   ...
   * <ul>
   *   <li>When zero.</li>
   *   <li>Then return {@code 1049079663003}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TbDate#UTC(int, int, int, int, int, int, int)}
   */
  @Test
  @DisplayName("Test UTC(int, int, int, int, int, int, int) with 'year', 'month', 'date', 'hrs', 'min', 'sec', 'ms'; when zero; then return '1049079663003'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"long TbDate.UTC(int, int, int, int, int, int, int)"})
  void testUtcWithYearMonthDateHrsMinSecMs_whenZero_thenReturn1049079663003() {
    // Arrange, Act and Assert
    assertEquals(1049079663003L, TbDate.UTC(3, 3, 0, 3, 1, 3, 3));
  }
   ...
   * <ul>
   *   <li>When zero.</li>
   *   <li>Then return {@code 1070420463003}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TbDate#UTC(int, int, int, int, int, int, int)}
   */
  @Test
  @DisplayName("Test UTC(int, int, int, int, int, int, int) with 'year', 'month', 'date', 'hrs', 'min', 'sec', 'ms'; when zero; then return '1070420463003'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"long TbDate.UTC(int, int, int, int, int, int, int)"})
  void testUtcWithYearMonthDateHrsMinSecMs_whenZero_thenReturn1070420463003() {
    // Arrange, Act and Assert
    assertEquals(1070420463003L, TbDate.UTC(3, 0, 3, 3, 1, 3, 3));
  }
   ...
   * <ul>
   *   <li>When zero.</li>
   *   <li>Then return {@code -2235243536997}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TbDate#UTC(int, int, int, int, int, int, int)}
   */
  @Test
  @DisplayName("Test UTC(int, int, int, int, int, int, int) with 'year', 'month', 'date', 'hrs', 'min', 'sec', 'ms'; when zero; then return '-2235243536997'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"long TbDate.UTC(int, int, int, int, int, int, int)"})
  void testUtcWithYearMonthDateHrsMinSecMs_whenZero_thenReturn2235243536997() {
    // Arrange, Act and Assert
    assertEquals(-2235243536997L, TbDate.UTC(0, 3, 3, 3, 1, 3, 3));
  }

  /**
   * Test {@link TbDate#UTC(int, int, int, int, int, int)} with {@code year}, {@code month}, {@code date}, {@code hrs}, {@code min}, {@code sec}.
   * <ul>
  ...
  /**
   * Test {@link TbDate#UTC(int, int, int, int, int)} with {@code year}, {@code month}, {@code date}, {@code hrs}, {@code min}.
   * <ul>
   *   <li>When seventy.</li>
  ...
  /**
   * Test {@link TbDate#UTC(int, int, int, int)} with {@code year}, {@code month}, {@code date}, {@code hrs}.
   * <ul>
   *   <li>When ninety-nine.</li>
   ...
   */
  @Test
  @DisplayName("Test UTC(int, int, int) with 'year', 'month', 'date'; when ninety-nine; then return '946598400000'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"long TbDate.UTC(int, int, int)"})
  void testUtcWithYearMonthDate_whenNinetyNine_thenReturn946598400000() {
    // Arrange, Act and Assert
    assertEquals(946598400000L, TbDate.UTC(99, 0, 0));
  }
   ...
   */
  @Test
  @DisplayName("Test UTC(int, int, int) with 'year', 'month', 'date'; when one hundred; then return '-58980009600000'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"long TbDate.UTC(int, int, int)"})
  void testUtcWithYearMonthDate_whenOneHundred_thenReturn58980009600000() {
    // Arrange, Act and Assert
    assertEquals(-58980009600000L, TbDate.UTC(100, 0, 0));
  }
  ...
  /**
   * Test {@link TbDate#setUTCFullYear(int, int, int)} with {@code year}, {@code month}, {@code date}.
   * <p>
   ...
   */
  @Test
  @DisplayName("Test setUTCMonth(int) with 'month'; given TbDate(); when one; then TbDate() UTCMonth is one")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void TbDate.setUTCMonth(int)"})
  ...
  /**
   * Test {@link TbDate#setUTCHours(int, int, int, int)} with {@code hrs}, {@code minutes}, {@code seconds}, {@code ms}.
   * <ul>
   *   <li>When one.</li>
   ...
   */
  @Test
  @DisplayName("Test setUTCHours(int, int, int, int) with 'hrs', 'minutes', 'seconds', 'ms'; when one; then TbDate() Milliseconds is one")
  @Tag("MaintainedByDiffblue")
  ...
  /**
   * Test {@link TbDate#setUTCHours(int, int, int)} with {@code hrs}, {@code minutes}, {@code seconds}.
   * <ul>
   *   <li>When one.</li>
  ...
  /**
   * Test {@link TbDate#setUTCMinutes(int, int, int)} with {@code minutes}, {@code seconds}, {@code ms}.
   * <ul>
   *   <li>Then {@link TbDate#TbDate()} FullYear is {@code 2001}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TbDate#setUTCMinutes(int, int, int)}
   */
  @Test
  @DisplayName("Test setUTCMinutes(int, int, int) with 'minutes', 'seconds', 'ms'; then TbDate() FullYear is '2001'")
  @Tag("MaintainedByDiffblue")
  ...
  /**
   * Test {@link TbDate#setHours(int, int, int, int)} with {@code hrs}, {@code minutes}, {@code seconds}, {@code ms}.
   * <ul>
   *   <li>When one.</li>
   *   <li>Then {@link TbDate#TbDate()} Milliseconds is one.</li>
   * </ul>
  ...
  /**
   * Test {@link TbDate#setMinutes(int, int, int)} with {@code minutes}, {@code seconds}, {@code ms}.
   * <ul>
   *   <li>When one.</li>
   *   <li>Then {@link TbDate#TbDate()} Milliseconds is one.</li>
   * </ul>
