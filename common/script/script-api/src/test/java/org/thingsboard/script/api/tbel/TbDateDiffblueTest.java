...
class TbDateDiffblueTest {
  ...
  void testNewTbDate() {
    ...
    // Assert
    assertEquals("12:00:00 AM", actualTbDate.toLocaleTimeString());
  ...
  @Test
  @DisplayName(
      "Test new TbDate(int, int, int); when one hundred; then return toDateString is '100 Jan 1, Fri'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.<init>(int, int, int, int, int, String)"})
  void testNewTbDate_whenOneHundred_thenReturnToDateStringIs100Jan1Fri7() {
    // Arrange and Act
  ...
  @Test
  @DisplayName(
      "Test new TbDate(int, int, int, String); when one hundred; then return toDateString is '100 Jan 1, Fri'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.<init>(int, int, int, String)"})
  void testNewTbDate_whenOneHundred_thenReturnToDateStringIs100Jan1Fri8() {
    // Arrange and Act
  ...
  @Test
  @DisplayName(
      "Test new TbDate(int, int, int); when seventy; then return toDateString is '1970 Jan 1, Thu'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.<init>(int, int, int)"})
  void testNewTbDate_whenSeventy_thenReturnToDateStringIs1970Jan1Thu() {
    // Arrange and Act
    TbDate actualTbDate = new TbDate(70, 1, 1);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.<init>(int, int, int, int, int, String)"})
  void testNewTbDate_whenSeventy_thenReturnToDateStringIs1970Jan1Thu7() {
    // Arrange and Act
  ...
  @Test
  @DisplayName(
      "Test new TbDate(int, int, int, String); when seventy; then return toDateString is '1970 Jan 1, Thu'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.<init>(int, int, int, String)"})
  void testNewTbDate_whenSeventy_thenReturnToDateStringIs1970Jan1Thu8() {
    // Arrange and Act
    TbDate actualTbDate = new TbDate(70, 1, 1, null);
   ...
   * <ul>
   *   <li>When one.
   *   <li>Then {@link TbDate#TbDate()} toDateString is {@code 1 Jan 1, Mon}.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test setUTCFullYear(int, int, int) with 'year', 'month', 'date'; when one; then TbDate() toDateString is '1 Jan 1, Mon'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.setUTCFullYear(int, int, int)"})
  void testSetUTCFullYearWithYearMonthDate_whenOne_thenTbDateToDateStringIs1Jan1Mon() {
    // Arrange
    TbDate tbDate = new TbDate();
    ...
    // Assert
    assertEquals("1 Jan 1, Mon", tbDate.toDateString());
    assertEquals("1 Jan 1, Mon", tbDate.toLocaleDateString());
   ...
   *   <li>When one.
   *   <li>Then {@link TbDate#TbDate()} Month is one.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test setUTCFullYear(int, int) with 'year', 'month'; given TbDate(); when one; then TbDate() Month is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.setUTCFullYear(int, int)"})
  void testSetUTCFullYearWithYearMonth_givenTbDate_whenOne_thenTbDateMonthIsOne() {
    // Arrange
    TbDate tbDate = new TbDate();
  ...
  @Test
  @DisplayName(
      "Test setUTCMonth(int) with 'month'; given TbDate(); when one; then TbDate() Month is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testSetUTCMonthWithMonth_thenTbDateToUTCStringIs1969Jan31Fri235959() {
    ...
    assertEquals("1969 Jan 31, Fri", tbDate.toDateString());
    assertEquals("1969 Jan 31, Fri", tbDate.toLocaleDateString());
   ...
   *
   * <ul>
   *   <li>Then {@link TbDate#TbDate()} toLocaleTimeString is {@code 1:01:01 AM}.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test setUTCHours(int, int, int, int) with 'hrs', 'minutes', 'seconds', 'ms'; then TbDate() toLocaleTimeString is '1:01:01 AM'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.setUTCHours(int, int, int, int)"})
  void testSetUTCHoursWithHrsMinutesSecondsMs_thenTbDateToLocaleTimeStringIs10101Am() {
    // Arrange
    TbDate tbDate = new TbDate();
    ...
    // Assert
    assertEquals("1:01:01 AM", tbDate.toLocaleTimeString());
  ...
  @Test
  @DisplayName(
      "Test setUTCHours(int, int, int) with 'hrs', 'minutes', 'seconds'; then TbDate() toLocaleTimeString is '1:01:01 AM'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.setUTCHours(int, int, int)"})
  void testSetUTCHoursWithHrsMinutesSeconds_thenTbDateToLocaleTimeStringIs10101Am() {
    // Arrange
    TbDate tbDate = new TbDate();
   ...
   */
  @Test
  @DisplayName("Test setFullYear(int) with 'year'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.setFullYear(int)"})
  void testSetFullYearWithYear() {
    // Arrange
    TbDate tbDate = new TbDate();
    tbDate.setTime(-1L);
   ...
   * <ul>
   *   <li>When one.
   *   <li>Then {@link TbDate#TbDate()} Day is one.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test setFullYear(int, int, int) with 'year', 'month', 'date'; when one; then TbDate() Day is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.setFullYear(int, int, int)"})
  void testSetFullYearWithYearMonthDate_whenOne_thenTbDateDayIsOne() {
    // Arrange
    TbDate tbDate = new TbDate();
    ...
    // Assert
    assertEquals(1, tbDate.getDay());
    assertEquals(1, tbDate.getFullYear());
    assertEquals(1, tbDate.getUTCFullYear());
  }
  ...
  @Test
  @DisplayName(
      "Test setFullYear(int, int) with 'year', 'month'; given TbDate(); when one; then TbDate() Month is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.setFullYear(int, int)"})
  void testSetFullYearWithYearMonth_givenTbDate_whenOne_thenTbDateMonthIsOne() {
    // Arrange
    TbDate tbDate = new TbDate();
  ...
  @Test
  @DisplayName(
      "Test setFullYear(int, int) with 'year', 'month'; then TbDate() toISOString is '0001-01-31T23:59:59.999Z'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.setFullYear(int, int)"})
  void testSetFullYearWithYearMonth_thenTbDateToISOStringIs00010131t235959999z() {
    // Arrange
    TbDate tbDate = new TbDate();
    tbDate.setTime(-1L);
  ...
  /**
   * Test {@link TbDate#setMonth(int)} with {@code month}.
   *
   * <ul>
   *   <li>Given {@link TbDate#TbDate()}.
   *   <li>When one.
   ...
   * </ul>
   *
   * <p>Method under test: {@link TbDate#setMonth(int)}
   */
  @Test
  @DisplayName(
      "Test setMonth(int) with 'month'; given TbDate(); when one; then TbDate() Month is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.setMonth(int)"})
  void testSetMonthWithMonth_givenTbDate_whenOne_thenTbDateMonthIsOne() {
    // Arrange
    TbDate tbDate = new TbDate();
  ...
  @Test
  @DisplayName(
      "Test setMonth(int) with 'month'; then TbDate() toUTCString is '1969 Jan 31, Fri 23:59:59'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.setMonth(int)"})
  void testSetMonthWithMonth_thenTbDateToUTCStringIs1969Jan31Fri235959() {
    // Arrange
    TbDate tbDate = new TbDate();
    tbDate.setTime(-1L);
   ...
   * <ul>
   *   <li>When one.
   *   <li>Then {@link TbDate#TbDate()} Hours is one.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test setHours(int, int, int, int) with 'hrs', 'minutes', 'seconds', 'ms'; when one; then TbDate() Hours is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.setHours(int, int, int, int)"})
  void testSetHoursWithHrsMinutesSecondsMs_whenOne_thenTbDateHoursIsOne() {
    // Arrange
    TbDate tbDate = new TbDate();
    ...
    // Assert
    assertEquals(1, tbDate.getHours());
    assertEquals(1, tbDate.getMilliseconds());
    assertEquals(1, tbDate.getMinutes());
    assertEquals(1, tbDate.getSeconds());
    assertEquals(1, tbDate.getUTCMilliseconds());
  ...
  @Test
  @DisplayName(
      "Test setHours(int, int, int) with 'hrs', 'minutes', 'seconds'; when one; then TbDate() Hours is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.setHours(int, int, int)"})
  void testSetHoursWithHrsMinutesSeconds_whenOne_thenTbDateHoursIsOne() {
    // Arrange
    TbDate tbDate = new TbDate();
  ...
  @Test
  @DisplayName(
      "Test setHours(int, int) with 'hrs', 'minutes'; when one; then TbDate() Hours is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.setHours(int, int)"})
  void testSetHoursWithHrsMinutes_whenOne_thenTbDateHoursIsOne() {
    // Arrange
    TbDate tbDate = new TbDate();
  ...
  /**
   * Test {@link TbDate#setHours(int)} with {@code hrs}.
   *
   * <ul>
   *   <li>When one.
   *   <li>Then {@link TbDate#TbDate()} Hours is one.
   * </ul>
   *
   * <p>Method under test: {@link TbDate#setHours(int)}
   */
  @Test
  @DisplayName("Test setHours(int) with 'hrs'; when one; then TbDate() Hours is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbDate.setHours(int)"})
  void testSetHoursWithHrs_whenOne_thenTbDateHoursIsOne() {
    // Arrange
    TbDate tbDate = new TbDate();
