...
class RelatedEdgesCacheValueDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(relatedEdgesCacheValue.hashCode(), relatedEdgesCacheValue2.hashCode());
  }
  ...
  void testGettersAndSetters() {
    ...
    assertSame(PageData.EMPTY_PAGE_DATA, actualRelatedEdgesCacheValue.getPageData());
  }
