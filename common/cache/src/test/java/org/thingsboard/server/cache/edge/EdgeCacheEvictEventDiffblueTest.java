...
class EdgeCacheEvictEventDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    EdgeCacheEvictEvent edgeCacheEvictEvent2 =
        new EdgeCacheEvictEvent(tenantId2, "New Name", "Old Name");
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual3() {
    // Arrange
    TenantId tenantId = new TenantId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"));
    EdgeCacheEvictEvent edgeCacheEvictEvent = new EdgeCacheEvictEvent(tenantId, null, "Old Name");
    TenantId tenantId2 = new TenantId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"));
    EdgeCacheEvictEvent edgeCacheEvictEvent2 = new EdgeCacheEvictEvent(tenantId2, null, "Old Name");
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual4() {
    // Arrange
    TenantId tenantId = new TenantId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"));
    EdgeCacheEvictEvent edgeCacheEvictEvent = new EdgeCacheEvictEvent(tenantId, "New Name", null);
    TenantId tenantId2 = new TenantId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"));
    EdgeCacheEvictEvent edgeCacheEvictEvent2 = new EdgeCacheEvictEvent(tenantId2, "New Name", null);
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    ...
    // Act and Assert
    assertNotEquals(edgeCacheEvictEvent, new EdgeCacheEvictEvent(tenantId, "New Name", "Old Name"));
  }
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual3() {
    ...
    TenantId tenantId = new TenantId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"));
    EdgeCacheEvictEvent edgeCacheEvictEvent =
        new EdgeCacheEvictEvent(tenantId, "Old Name", "Old Name");
    TenantId tenantId2 = new TenantId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"));

    // Act and Assert
    assertNotEquals(
        edgeCacheEvictEvent, new EdgeCacheEvictEvent(tenantId2, "New Name", "Old Name"));
  }
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual5() {
    ...
    TenantId tenantId = new TenantId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"));
    EdgeCacheEvictEvent edgeCacheEvictEvent =
        new EdgeCacheEvictEvent(tenantId, "New Name", "New Name");
    TenantId tenantId2 = new TenantId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"));
  ...
  void testEquals_whenOtherIsNull_thenReturnNotEqual() {
    ...
    // Act and Assert
    assertNotEquals(new EdgeCacheEvictEvent(tenantId, "New Name", "Old Name"), null);
  }
  ...
  void testGettersAndSetters() {
    ...
    // Assert
    assertEquals(
        "EdgeCacheEvictEvent(tenantId=784f394c-42b6-435a-983c-b7beff2784f9, newName=New Name, oldName=Old"
            + " Name)",
