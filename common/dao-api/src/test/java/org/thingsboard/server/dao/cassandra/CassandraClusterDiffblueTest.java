...
class CassandraClusterDiffblueTest {
  ...
  /**
   * Test {@link CassandraCluster#init()}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link CassandraCluster#init()}
   */
  @Test
  @DisplayName(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void CassandraCluster.init()"})
