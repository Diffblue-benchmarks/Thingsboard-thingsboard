...
class ProvisionRequestDiffblueTest {
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link ProvisionRequest#ProvisionRequest(String, DeviceCredentialsType, ProvisionDeviceCredentialsData, ProvisionDeviceProfileCredentials, Boolean)}
  ...
  @MethodsUnderTest({
      ...
      "DeviceCredentialsType ProvisionRequest.getCredentialsType()", "String ProvisionRequest.getDeviceName()",
      ...
      "void ProvisionRequest.setCredentialsType(DeviceCredentialsType)", "void ProvisionRequest.setDeviceName(String)",
      "void ProvisionRequest.setGateway(Boolean)", "String ProvisionRequest.toString()"})
