...
class TbCoapClientStateDiffblueTest {
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    // Arrange
    TbCoapClientState tbCoapClientState = new TbCoapClientState(new DeviceId(UUID.randomUUID()));
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual16() {
    ...
    TbCoapClientState tbCoapClientState2 = new TbCoapClientState(new DeviceId(UUID.randomUUID()));
    tbCoapClientState2.setPsmActivityTimer(1L);
