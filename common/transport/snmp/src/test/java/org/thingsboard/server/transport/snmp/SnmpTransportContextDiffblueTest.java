...
class SnmpTransportContextDiffblueTest {
   ...
   * <ul>
   *   <li>Then calls {@link Device#getDeviceData()}.</li>
   * </ul>
   * <p>
   * Method under test:
   * {@link SnmpTransportContext#onDeviceUpdatedOrCreated(DeviceUpdatedEvent)}
   */
  @Test
  @DisplayName("Test onDeviceUpdatedOrCreated(DeviceUpdatedEvent); then calls getDeviceData()")
  void testOnDeviceUpdatedOrCreated_thenCallsGetDeviceData() {
