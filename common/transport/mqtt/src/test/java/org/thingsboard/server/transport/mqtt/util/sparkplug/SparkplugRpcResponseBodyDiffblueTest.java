...
class SparkplugRpcResponseBodyDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    SparkplugRpcResponseBody buildResult =
        SparkplugRpcResponseBody.builder()
            .error("An error occurred")
            .result("Result")
            .value("42")
            .build();
    SparkplugRpcResponseBody buildResult2 =
        SparkplugRpcResponseBody.builder()
            .error("An error occurred")
            .result("Result")
            .value("42")
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    // Arrange
    SparkplugRpcResponseBodyBuilder sparkplugRpcResponseBodyBuilder =
        mock(SparkplugRpcResponseBodyBuilder.class);
    when(sparkplugRpcResponseBodyBuilder.error(Mockito.<String>any()))
        .thenReturn(SparkplugRpcResponseBody.builder());
    SparkplugRpcResponseBody buildResult =
        sparkplugRpcResponseBodyBuilder
            .error("An error occurred")
            .result("Result")
            .value("42")
            .build();
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    ...
    SparkplugRpcResponseBodyBuilder sparkplugRpcResponseBodyBuilder =
        mock(SparkplugRpcResponseBodyBuilder.class);
    when(sparkplugRpcResponseBodyBuilder.result(Mockito.<String>any()))
        .thenReturn(SparkplugRpcResponseBody.builder());
    SparkplugRpcResponseBodyBuilder sparkplugRpcResponseBodyBuilder2 =
        mock(SparkplugRpcResponseBodyBuilder.class);
    when(sparkplugRpcResponseBodyBuilder2.error(Mockito.<String>any()))
        .thenReturn(sparkplugRpcResponseBodyBuilder);
    SparkplugRpcResponseBody buildResult =
        sparkplugRpcResponseBodyBuilder2
            .error("An error occurred")
            .result("Result")
            .value("42")
            .build();
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual4() {
    ...
    SparkplugRpcResponseBodyBuilder sparkplugRpcResponseBodyBuilder =
        mock(SparkplugRpcResponseBodyBuilder.class);
    when(sparkplugRpcResponseBodyBuilder.value(Mockito.<String>any()))
        .thenReturn(SparkplugRpcResponseBody.builder());
    SparkplugRpcResponseBodyBuilder sparkplugRpcResponseBodyBuilder2 =
        mock(SparkplugRpcResponseBodyBuilder.class);
    when(sparkplugRpcResponseBodyBuilder2.result(Mockito.<String>any()))
        .thenReturn(sparkplugRpcResponseBodyBuilder);
    SparkplugRpcResponseBodyBuilder sparkplugRpcResponseBodyBuilder3 =
        mock(SparkplugRpcResponseBodyBuilder.class);
    when(sparkplugRpcResponseBodyBuilder3.error(Mockito.<String>any()))
        .thenReturn(sparkplugRpcResponseBodyBuilder2);
    SparkplugRpcResponseBody buildResult =
        sparkplugRpcResponseBodyBuilder3
            .error("An error occurred")
            .result("Result")
            .value("42")
            .build();
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual5() {
    ...
    SparkplugRpcResponseBodyBuilder sparkplugRpcResponseBodyBuilder2 =
        mock(SparkplugRpcResponseBodyBuilder.class);
    when(sparkplugRpcResponseBodyBuilder2.value(Mockito.<String>any()))
        .thenReturn(sparkplugRpcResponseBodyBuilder);
    SparkplugRpcResponseBodyBuilder sparkplugRpcResponseBodyBuilder3 =
        mock(SparkplugRpcResponseBodyBuilder.class);
    when(sparkplugRpcResponseBodyBuilder3.result(Mockito.<String>any()))
        .thenReturn(sparkplugRpcResponseBodyBuilder2);
    SparkplugRpcResponseBodyBuilder sparkplugRpcResponseBodyBuilder4 =
        mock(SparkplugRpcResponseBodyBuilder.class);
    when(sparkplugRpcResponseBodyBuilder4.error(Mockito.<String>any()))
        .thenReturn(sparkplugRpcResponseBodyBuilder3);
    SparkplugRpcResponseBody buildResult2 =
        sparkplugRpcResponseBodyBuilder4
            .error("An error occurred")
            .result("Result")
            .value("42")
            .build();
    SparkplugRpcResponseBody buildResult3 =
        SparkplugRpcResponseBody.builder()
            .error("An error occurred")
            .result(null)
            .value("42")
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual6() {
    ...
    SparkplugRpcResponseBodyBuilder sparkplugRpcResponseBodyBuilder =
        mock(SparkplugRpcResponseBodyBuilder.class);
    SparkplugRpcResponseBody buildResult =
        SparkplugRpcResponseBody.builder().error("Error").result(null).value("42").build();
    when(sparkplugRpcResponseBodyBuilder.build()).thenReturn(buildResult);
    SparkplugRpcResponseBodyBuilder sparkplugRpcResponseBodyBuilder2 =
        mock(SparkplugRpcResponseBodyBuilder.class);
    when(sparkplugRpcResponseBodyBuilder2.value(Mockito.<String>any()))
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual7() {
    ...
    SparkplugRpcResponseBodyBuilder sparkplugRpcResponseBodyBuilder =
        mock(SparkplugRpcResponseBodyBuilder.class);
    SparkplugRpcResponseBody buildResult =
        SparkplugRpcResponseBody.builder().error("Error").result(null).value("Error").build();
    when(sparkplugRpcResponseBodyBuilder.build()).thenReturn(buildResult);
    SparkplugRpcResponseBodyBuilder sparkplugRpcResponseBodyBuilder2 =
        mock(SparkplugRpcResponseBodyBuilder.class);
    when(sparkplugRpcResponseBodyBuilder2.value(Mockito.<String>any()))
  ...
  void testSparkplugRpcResponseBodyBuilderBuild() {
    // Arrange and Act
    SparkplugRpcResponseBody actualBuildResult =
        SparkplugRpcResponseBody.builder()
            .error("An error occurred")
            .result("Result")
            .value("42")
