...
class SessionLimitsDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    sessionLimits.setRateLimits(new SessionRateLimits("Messages", "Telemetry Messages", "Telemetry Data Points"));

    SessionLimits sessionLimits2 = new SessionLimits();
    sessionLimits2.setMaxInflightMessages(3);
    sessionLimits2.setMaxPayloadSize(3);
    sessionLimits2.setRateLimits(new SessionRateLimits("Messages", "Telemetry Messages", "Telemetry Data Points"));
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual2() {
    ...
    when(gatewaySessionLimits.getRateLimits())
        .thenReturn(new SessionRateLimits("Messages", "Telemetry Messages", "Telemetry Data Points"));
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual4() {
    ...
    sessionLimits.setMaxInflightMessages(3);
    sessionLimits.setMaxPayloadSize(3);
    sessionLimits.setRateLimits(new SessionRateLimits(null, "Telemetry Messages", "Telemetry Data Points"));
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void SessionLimits.<init>()", "int SessionLimits.getMaxInflightMessages()",
      "int SessionLimits.getMaxPayloadSize()", "SessionRateLimits SessionLimits.getRateLimits()",
      "void SessionLimits.setMaxInflightMessages(int)", "void SessionLimits.setMaxPayloadSize(int)",
      "void SessionLimits.setRateLimits(SessionRateLimits)", "String SessionLimits.toString()"})
  void testGettersAndSetters() {
    ...
    SessionRateLimits rateLimits = new SessionRateLimits("Messages", "Telemetry Messages", "Telemetry Data Points");
