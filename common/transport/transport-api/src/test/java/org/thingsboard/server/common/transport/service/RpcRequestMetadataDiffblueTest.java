...
class RpcRequestMetadataDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(rpcRequestMetadata.hashCode(), rpcRequestMetadata2.hashCode());
  }
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(
        new RpcRequestMetadata(UUID.randomUUID(), 1), "Different type to RpcRequestMetadata");
  }
  ...
  @MethodsUnderTest({
    ...
    "java.lang.String RpcRequestMetadata.toString()"
  })
