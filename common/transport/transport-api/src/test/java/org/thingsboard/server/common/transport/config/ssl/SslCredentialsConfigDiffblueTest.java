...
class SslCredentialsConfigDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link KeystoreSslCredentials} (default constructor) StoreFile is {@code 42}.
  ...
  @Test
  @DisplayName(
      "Test init(); given KeystoreSslCredentials (default constructor) StoreFile is '42'; then throw RuntimeException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void SslCredentialsConfig.init()"})
  void testInit_givenKeystoreSslCredentialsStoreFileIs42_thenThrowRuntimeException() {
    // Arrange
    KeystoreSslCredentials keystore = new KeystoreSslCredentials();
    keystore.setStoreFile("42");
  ...
  @Test
  @DisplayName(
      "Test init(); given PemSslCredentials (default constructor) CertFile is 'classpath:'; then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void SslCredentialsConfig.init()"})
  void testInit_givenPemSslCredentialsCertFileIsClasspath_thenDoesNotThrow() {
    // Arrange
    PemSslCredentials pem = new PemSslCredentials();
    pem.setCertFile("classpath:");
    ...
    SslCredentialsConfig sslCredentialsConfig = new SslCredentialsConfig("Name", true);
    sslCredentialsConfig.setEnabled(false);
    sslCredentialsConfig.setPem(pem);
    sslCredentialsConfig.setKeystore(keystore);

    // Act and Assert
    assertDoesNotThrow(() -> sslCredentialsConfig.init());
  }
}
