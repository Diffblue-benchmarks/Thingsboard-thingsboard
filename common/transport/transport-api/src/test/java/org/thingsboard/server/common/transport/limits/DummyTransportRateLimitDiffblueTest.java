...
class DummyTransportRateLimitDiffblueTest {
   ...
   *
   * <p>Method under test: {@link DummyTransportRateLimit#tryConsume()}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link DummyTransportRateLimit#tryConsume(long)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "void DummyTransportRateLimit.<init>()",
