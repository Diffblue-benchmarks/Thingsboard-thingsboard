...
class TenantProfileUpdateResultDiffblueTest {
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    ...
    // Act and Assert
    assertNotEquals(
        tenantProfileUpdateResult, new TenantProfileUpdateResult(profile, new HashSet<>()));
  }
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    ...
    // Act and Assert
    assertNotEquals(
        tenantProfileUpdateResult, new TenantProfileUpdateResult(profile2, new HashSet<>()));
  }
