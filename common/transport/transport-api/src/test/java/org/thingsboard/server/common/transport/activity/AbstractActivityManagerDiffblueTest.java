...
class AbstractActivityManagerDiffblueTest {
  /**
   * Test {@link AbstractActivityManager#getLastRecordedTime(Object)}.
   *
   * <ul>
   *   <li>When randomUUID.
   *   <li>Then return zero.
   * </ul>
   *
   * <p>Method under test: {@link AbstractActivityManager#getLastRecordedTime(Object)}
   */
  @Test
  @DisplayName("Test getLastRecordedTime(Object); when randomUUID; then return zero")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"long AbstractActivityManager.getLastRecordedTime(Object)"})
  void testGetLastRecordedTime_whenRandomUUID_thenReturnZero() {
    // Arrange
    ...
    // Act and Assert
    assertEquals(0L, defaultTransportService.getLastRecordedTime(UUID.randomUUID()));
  }
}
