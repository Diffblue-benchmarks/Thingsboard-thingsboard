...
class LwM2MRpcResponseBodyDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    LwM2MRpcResponseBody buildResult =
        LwM2MRpcResponseBody.builder()
            .error("An error occurred")
            .result("Result")
            .value("42")
            .build();
    LwM2MRpcResponseBody buildResult2 =
        LwM2MRpcResponseBody.builder()
            .error("An error occurred")
            .result("Result")
            .value("42")
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    // Arrange
    LwM2MRpcResponseBodyBuilder lwM2MRpcResponseBodyBuilder =
        mock(LwM2MRpcResponseBodyBuilder.class);
    when(lwM2MRpcResponseBodyBuilder.error(Mockito.<String>any()))
        .thenReturn(LwM2MRpcResponseBody.builder());
    LwM2MRpcResponseBody buildResult =
        lwM2MRpcResponseBodyBuilder.error("An error occurred").result("Result").value("42").build();
    LwM2MRpcResponseBody buildResult2 =
        LwM2MRpcResponseBody.builder()
            .error("An error occurred")
            .result("Result")
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    ...
    LwM2MRpcResponseBodyBuilder lwM2MRpcResponseBodyBuilder =
        mock(LwM2MRpcResponseBodyBuilder.class);
    when(lwM2MRpcResponseBodyBuilder.result(Mockito.<String>any()))
        .thenReturn(LwM2MRpcResponseBody.builder());
    LwM2MRpcResponseBodyBuilder lwM2MRpcResponseBodyBuilder2 =
        mock(LwM2MRpcResponseBodyBuilder.class);
    when(lwM2MRpcResponseBodyBuilder2.error(Mockito.<String>any()))
        .thenReturn(lwM2MRpcResponseBodyBuilder);
    LwM2MRpcResponseBody buildResult =
        lwM2MRpcResponseBodyBuilder2
            .error("An error occurred")
            .result("Result")
            .value("42")
            .build();
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual4() {
    ...
    LwM2MRpcResponseBodyBuilder lwM2MRpcResponseBodyBuilder =
        mock(LwM2MRpcResponseBodyBuilder.class);
    when(lwM2MRpcResponseBodyBuilder.value(Mockito.<String>any()))
        .thenReturn(LwM2MRpcResponseBody.builder());
    LwM2MRpcResponseBodyBuilder lwM2MRpcResponseBodyBuilder2 =
        mock(LwM2MRpcResponseBodyBuilder.class);
    when(lwM2MRpcResponseBodyBuilder2.result(Mockito.<String>any()))
        .thenReturn(lwM2MRpcResponseBodyBuilder);
    LwM2MRpcResponseBodyBuilder lwM2MRpcResponseBodyBuilder3 =
        mock(LwM2MRpcResponseBodyBuilder.class);
    when(lwM2MRpcResponseBodyBuilder3.error(Mockito.<String>any()))
        .thenReturn(lwM2MRpcResponseBodyBuilder2);
    LwM2MRpcResponseBody buildResult =
        lwM2MRpcResponseBodyBuilder3
            .error("An error occurred")
            .result("Result")
            .value("42")
            .build();
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual5() {
    ...
    LwM2MRpcResponseBodyBuilder lwM2MRpcResponseBodyBuilder2 =
        mock(LwM2MRpcResponseBodyBuilder.class);
    when(lwM2MRpcResponseBodyBuilder2.value(Mockito.<String>any()))
        .thenReturn(lwM2MRpcResponseBodyBuilder);
    LwM2MRpcResponseBodyBuilder lwM2MRpcResponseBodyBuilder3 =
        mock(LwM2MRpcResponseBodyBuilder.class);
    when(lwM2MRpcResponseBodyBuilder3.result(Mockito.<String>any()))
        .thenReturn(lwM2MRpcResponseBodyBuilder2);
    LwM2MRpcResponseBodyBuilder lwM2MRpcResponseBodyBuilder4 =
        mock(LwM2MRpcResponseBodyBuilder.class);
    when(lwM2MRpcResponseBodyBuilder4.error(Mockito.<String>any()))
        .thenReturn(lwM2MRpcResponseBodyBuilder3);
    LwM2MRpcResponseBody buildResult2 =
        lwM2MRpcResponseBodyBuilder4
            .error("An error occurred")
            .result("Result")
            .value("42")
            .build();
    LwM2MRpcResponseBody buildResult3 =
        LwM2MRpcResponseBody.builder().error("An error occurred").result(null).value("42").build();
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual6() {
    ...
    LwM2MRpcResponseBodyBuilder lwM2MRpcResponseBodyBuilder =
        mock(LwM2MRpcResponseBodyBuilder.class);
    LwM2MRpcResponseBody buildResult =
        LwM2MRpcResponseBody.builder().error("Error").result(null).value("42").build();
    when(lwM2MRpcResponseBodyBuilder.build()).thenReturn(buildResult);
    LwM2MRpcResponseBodyBuilder lwM2MRpcResponseBodyBuilder2 =
        mock(LwM2MRpcResponseBodyBuilder.class);
    when(lwM2MRpcResponseBodyBuilder2.value(Mockito.<String>any()))
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual7() {
    ...
    LwM2MRpcResponseBodyBuilder lwM2MRpcResponseBodyBuilder =
        mock(LwM2MRpcResponseBodyBuilder.class);
    LwM2MRpcResponseBody buildResult =
        LwM2MRpcResponseBody.builder().error("Error").result(null).value("Error").build();
    when(lwM2MRpcResponseBodyBuilder.build()).thenReturn(buildResult);
    LwM2MRpcResponseBodyBuilder lwM2MRpcResponseBodyBuilder2 =
        mock(LwM2MRpcResponseBodyBuilder.class);
    when(lwM2MRpcResponseBodyBuilder2.value(Mockito.<String>any()))
  ...
  void testLwM2MRpcResponseBodyBuilderBuild() {
    // Arrange and Act
    LwM2MRpcResponseBody actualBuildResult =
        LwM2MRpcResponseBody.builder()
            .error("An error occurred")
            .result("Result")
            .value("42")
