...
class LwM2MClientFwOtaInfoDiffblueTest {
  ...
  @MethodsUnderTest({"boolean LwM2MClientFwOtaInfo.equals(Object)", "int LwM2MClientFwOtaInfo.hashCode()"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void LwM2MClientFwOtaInfo.<init>()",
      "void LwM2MClientFwOtaInfo.<init>(String, String, LwM2MFirmwareUpdateStrategy)",
      "Integer LwM2MClientFwOtaInfo.getDeliveryMethod()", "OtaPackageType LwM2MClientFwOtaInfo.getType()",
      "void LwM2MClientFwOtaInfo.setDeliveryMethod(Integer)", "String LwM2MClientFwOtaInfo.toString()"})
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link LwM2MClientFwOtaInfo#LwM2MClientFwOtaInfo(String, String, LwM2MFirmwareUpdateStrategy)}
   *   <li>{@link LwM2MClientFwOtaInfo#setDeliveryMethod(Integer)}
   *   <li>{@link LwM2MClientFwOtaInfo#toString()}
   *   <li>{@link LwM2MClientFwOtaInfo#getDeliveryMethod()}
   *   <li>{@link LwM2MClientFwOtaInfo#getType()}
  ...
  /**
   * Test {@link LwM2MClientFwOtaInfo#update(FirmwareUpdateResult)} with {@code FirmwareUpdateResult}.
   * <p>
