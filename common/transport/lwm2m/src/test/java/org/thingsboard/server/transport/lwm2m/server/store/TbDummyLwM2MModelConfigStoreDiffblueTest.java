...
class TbDummyLwM2MModelConfigStoreDiffblueTest {
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void TbDummyLwM2MModelConfigStore.<init>()",
      "void TbDummyLwM2MModelConfigStore.put(LwM2MModelConfig)", "void TbDummyLwM2MModelConfigStore.remove(String)"})
