...
class TbLwM2MReadCompositeCallbackDiffblueTest {
  /**
   * Test
   * {@link TbLwM2MReadCompositeCallback#onSuccess(ReadCompositeRequest, ReadCompositeResponse)}
   * with {@code ReadCompositeRequest}, {@code ReadCompositeResponse}.
   * <ul>
   *   <li>Then calls
   ...
   */
  @Test
  @DisplayName("Test onSuccess(ReadCompositeRequest, ReadCompositeResponse) with 'ReadCompositeRequest', 'ReadCompositeResponse'; then calls log(LwM2mClient, String)")
  void testOnSuccessWithReadCompositeRequestReadCompositeResponse_thenCallsLog() {
    ...
    TbLwM2MReadCompositeCallback tbLwM2MReadCompositeCallback = new TbLwM2MReadCompositeCallback(handler, logService,
    ...
    ReadCompositeRequest request = new ReadCompositeRequest(requestContentFormat, ContentFormat.fromCode(1), paths);
