...
class TbLwM2MObserveCallbackDiffblueTest {
  /**
   * Test
   * {@link TbLwM2MObserveCallback#onSuccess(ObserveRequest, ObserveResponse)}
   * with {@code ObserveRequest}, {@code ObserveResponse}.
   * <ul>
   *   <li>Then calls
   ...
   */
  @Test
  @DisplayName("Test onSuccess(ObserveRequest, ObserveResponse) with 'ObserveRequest', 'ObserveResponse'; then calls log(LwM2mClient, String)")
  void testOnSuccessWithObserveRequestObserveResponse_thenCallsLog() {
    ...
    TbLwM2MObserveCallback tbLwM2MObserveCallback = new TbLwM2MObserveCallback(handler, logService,
