...
class TbLwM2MSecurityInfoDiffblueTest {
   ...
   *   <li>
   * {@link TbLwM2MSecurityInfo#setBootstrapCredentialConfig(LwM2MBootstrapConfig)}
  ...
  void testGettersAndSetters() {
    ...
    SecurityInfo securityInfo = SecurityInfo.newX509CertInfo("https://config.us-east-2.amazonaws.com");
    ...
    LwM2MBootstrapConfig actualBootstrapCredentialConfig = actualTbLwM2MSecurityInfo.getBootstrapCredentialConfig();
    ...
    actualTbLwM2MSecurityInfo.getMsg();
    SecurityInfo actualSecurityInfo = actualTbLwM2MSecurityInfo.getSecurityInfo();

    // Assert that nothing has changed
    assertEquals("TbLwM2MSecurityInfo(msg=null, deviceProfile=DeviceProfile(tenantId=null, name=null, description=null,"
        ...
        + " bootstrapConfig=BootstrapConfig [servers={}, security={}, acls={}, oscore={}])", actualToStringResult);
