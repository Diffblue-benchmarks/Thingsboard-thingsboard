...
class TbLwM2MLatchCallbackDiffblueTest {
   ...
   * <ul>
   *   <li>Then calls
   * {@link DownlinkRequestCallback#onSuccess(Object, Object)}.</li>
   * </ul>
   * <p>
   ...
   * <ul>
   *   <li>Then calls
   * {@link DownlinkRequestCallback#onValidationError(String, String)}.</li>
   * </ul>
   * <p>
   * Method under test:
   ...
   * <ul>
   *   <li>Then calls
   * {@link DownlinkRequestCallback#onError(String, Exception)}.</li>
   * </ul>
   * <p>
