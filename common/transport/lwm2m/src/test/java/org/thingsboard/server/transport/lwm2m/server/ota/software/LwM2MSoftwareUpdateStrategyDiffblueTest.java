...
class LwM2MSoftwareUpdateStrategyDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link LwM2MSoftwareUpdateStrategy#fromStrategySwByType(String)}
   */
  @Test
  @DisplayName("Test fromStrategySwByType(String); when 'ObjectId 9, Binary'; then return 'BINARY'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"LwM2MSoftwareUpdateStrategy LwM2MSoftwareUpdateStrategy.fromStrategySwByType(String)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link LwM2MSoftwareUpdateStrategy#fromStrategySwByCode(int)}
   */
  @Test
  @DisplayName("Test fromStrategySwByCode(int); when one; then return 'BINARY'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"LwM2MSoftwareUpdateStrategy LwM2MSoftwareUpdateStrategy.fromStrategySwByCode(int)"})
