...
class DefaultLwM2mDownlinkMsgHandlerDiffblueTest {
   ...
   */
  @Test
  void testSendReadCompositeRequest() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
   ...
   */
  @Test
  void testSendReadCompositeRequest2() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
   ...
   */
  @Test
  void testSendObserveCompositeRequest() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
   ...
   */
  @Test
  void testSendObserveCompositeRequest2() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
  ...
  /**
   * Method under test:
   * {@link DefaultLwM2mDownlinkMsgHandler#sendDiscoverAllRequest(LwM2mClient, TbLwM2MDiscoverAllRequest, DownlinkRequestCallback)}
   */
  @Test
  void testSendDiscoverAllRequest() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    ...
    DefaultLwM2mDownlinkMsgHandler defaultLwM2mDownlinkMsgHandler = new DefaultLwM2mDownlinkMsgHandler(context, config,
        ...
        new LwM2mVersionedModelProvider(lwM2mClientContext, helper, new LwM2mTransportContext()));
    LwM2mClient client = mock(LwM2mClient.class);
    when(client.getRegistration()).thenThrow(new InvalidRequestException("foo"));

    // Act and Assert
    assertThrows(InvalidRequestException.class, () -> defaultLwM2mDownlinkMsgHandler.sendDiscoverAllRequest(client,
        mock(TbLwM2MDiscoverAllRequest.class), mock(DownlinkRequestCallback.class)));
