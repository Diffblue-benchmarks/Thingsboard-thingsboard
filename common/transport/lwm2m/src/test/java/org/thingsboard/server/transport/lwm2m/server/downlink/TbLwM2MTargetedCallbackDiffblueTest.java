...
class TbLwM2MTargetedCallbackDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbLwM2MTargetedCallback.onSuccess(Object, Object)"})
  void testOnSuccess() {
    // Arrange
  ...
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbLwM2MTargetedCallback.logForBadResponse(int, String, String)"})
  void testLogForBadResponse() {
    ...
    // Act
    tbLwM2MDeleteCallback.logForBadResponse(1, "Response Str", "Request Name");
  ...
  void testLogForBadResponse3() {
    ...
    // Act
    tbLwM2MDeleteCallback.logForBadResponse(206, "Response Str", "Request Name");
