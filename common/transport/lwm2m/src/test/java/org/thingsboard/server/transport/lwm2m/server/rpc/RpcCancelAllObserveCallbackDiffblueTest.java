...
class RpcCancelAllObserveCallbackDiffblueTest {
  /**
   * Method under test:
   * {@link RpcCancelAllObserveCallback#sendRpcReplyOnSuccess(Integer)}
   */
  @Test
  void testSendRpcReplyOnSuccess() {
    ...
    (new RpcCancelAllObserveCallback(transportService, client, requestMsg, new TbLwM2MCancelAllObserveCallback(
        logService, new LwM2mClient("42", "https://config.us-east-2.amazonaws.com")))).sendRpcReplyOnSuccess(1);
