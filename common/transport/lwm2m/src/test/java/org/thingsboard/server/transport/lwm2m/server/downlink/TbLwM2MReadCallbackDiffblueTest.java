...
class TbLwM2MReadCallbackDiffblueTest {
  /**
   * Test {@link TbLwM2MReadCallback#onSuccess(ReadRequest, ReadResponse)} with {@code ReadRequest},
   * {@code ReadResponse}.
   *
   * <p>Method under test: {@link TbLwM2MReadCallback#onSuccess(ReadRequest, ReadResponse)}
   */
  @Test
  @DisplayName("Test onSuccess(ReadRequest, ReadResponse) with 'ReadRequest', 'ReadResponse'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbLwM2MReadCallback.onSuccess(ReadRequest, ReadResponse)"})
  void testOnSuccessWithReadRequestReadResponse() {
    ...
    DefaultLwM2mUplinkMsgHandler handler =
        new DefaultLwM2mUplinkMsgHandler(
            ...
            mock(LwM2MSessionManager.class),
            mock(LwM2MOtaUpdateService.class),
            null,
    ...
    TbLwM2MReadCallback tbLwM2MReadCallback =
  ...
  @Test
  @DisplayName(
      "Test onSuccess(ReadRequest, ReadResponse) with 'ReadRequest', 'ReadResponse'; then calls log(LwM2mClient, String)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TbLwM2MReadCallback.onSuccess(ReadRequest, ReadResponse)"})
