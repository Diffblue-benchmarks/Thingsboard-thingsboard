...
class RpcLinkSetCallbackDiffblueTest {
  /**
   * Method under test: {@link RpcLinkSetCallback#sendRpcReplyOnSuccess(Object)}
   */
  @Test
  void testSendRpcReplyOnSuccess() {
    ...
    RpcLinkSetCallback<Object, Object> rpcLinkSetCallback = new RpcLinkSetCallback<>(transportService, client,
        requestMsg, new TbLwM2MLatchCallback<>(new CountDownLatch(1), null));

    // Act
    rpcLinkSetCallback.sendRpcReplyOnSuccess("Response");
  ...
  void testSendRpcReplyOnSuccess2() {
    ...
    // Act
    rpcLinkSetCallback.sendRpcReplyOnSuccess(1);
