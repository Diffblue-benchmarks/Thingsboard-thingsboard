...
class TbLwM2MCreateResponseCallbackDiffblueTest {
  /**
   * Test
   * {@link TbLwM2MCreateResponseCallback#onSuccess(CreateRequest, CreateResponse)}
   * with {@code CreateRequest}, {@code CreateResponse}.
   * <ul>
   *   <li>Then calls
   ...
   */
  @Test
  @DisplayName("Test onSuccess(CreateRequest, CreateResponse) with 'CreateRequest', 'CreateResponse'; then calls log(LwM2mClient, String)")
  void testOnSuccessWithCreateRequestCreateResponse_thenCallsLog() {
    ...
    TbLwM2MCreateResponseCallback tbLwM2MCreateResponseCallback = new TbLwM2MCreateResponseCallback(handler, logService,
