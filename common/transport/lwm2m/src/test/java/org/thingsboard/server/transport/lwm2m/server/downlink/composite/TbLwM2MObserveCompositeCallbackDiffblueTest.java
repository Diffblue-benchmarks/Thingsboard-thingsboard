...
class TbLwM2MObserveCompositeCallbackDiffblueTest {
  /**
   * Test {@link TbLwM2MObserveCompositeCallback#onSuccess(ObserveCompositeRequest,
   * ObserveCompositeResponse)} with {@code ObserveCompositeRequest}, {@code
   ...
   * </ul>
   *
   * <p>Method under test: {@link TbLwM2MObserveCompositeCallback#onSuccess(ObserveCompositeRequest,
   * ObserveCompositeResponse)}
   */
  @Test
  @DisplayName(
      "Test onSuccess(ObserveCompositeRequest, ObserveCompositeResponse) with 'ObserveCompositeRequest', 'ObserveCompositeResponse'; then calls log(LwM2mClient, String)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void TbLwM2MObserveCompositeCallback.onSuccess(ObserveCompositeRequest, ObserveCompositeResponse)"
  })
  void testOnSuccessWithObserveCompositeRequestObserveCompositeResponse_thenCallsLog()
    ...
    TbLwM2MObserveCompositeCallback tbLwM2MObserveCompositeCallback =
    ...
    ObserveCompositeRequest request =
        new ObserveCompositeRequest(requestContentFormat, ContentFormat.fromCode(1), paths);
