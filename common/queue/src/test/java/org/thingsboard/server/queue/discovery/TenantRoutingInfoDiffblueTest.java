...
class TenantRoutingInfoDiffblueTest {
  ...
  @MethodsUnderTest({"boolean TenantRoutingInfo.equals(Object)", "int TenantRoutingInfo.hashCode()"})
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    // Arrange
    TenantRoutingInfo tenantRoutingInfo = new TenantRoutingInfo(new TenantId(UUID.randomUUID()), null, true);
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual3() {
    // Arrange
    TenantRoutingInfo tenantRoutingInfo = new TenantRoutingInfo(new TenantId(UUID.randomUUID()), null, false);
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual5() {
    // Arrange
    TenantRoutingInfo tenantRoutingInfo = new TenantRoutingInfo(null, new TenantProfileId(UUID.randomUUID()), true);
