...
class TbQueueCoreSettingsDiffblueTest {
  ...
  @MethodsUnderTest({"boolean TbQueueCoreSettings.equals(Object)", "int TbQueueCoreSettings.hashCode()"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String TbQueueCoreSettings.getHousekeeperReprocessingTopic()",
      "String TbQueueCoreSettings.getHousekeeperTopic()", "String TbQueueCoreSettings.getOtaPackageTopic()",
      "int TbQueueCoreSettings.getPartitions()", "String TbQueueCoreSettings.getTopic()",
      "String TbQueueCoreSettings.getUsageStatsTopic()",
      "void TbQueueCoreSettings.setHousekeeperReprocessingTopic(String)",
      "void TbQueueCoreSettings.setHousekeeperTopic(String)", "void TbQueueCoreSettings.setOtaPackageTopic(String)",
      "void TbQueueCoreSettings.setPartitions(int)", "void TbQueueCoreSettings.setTopic(String)",
      "void TbQueueCoreSettings.setUsageStatsTopic(String)", "String TbQueueCoreSettings.toString()"})
