...
class TbQueueEdgeSettingsDiffblueTest {
  ...
  @MethodsUnderTest({"boolean TbQueueEdgeSettings.equals(Object)", "int TbQueueEdgeSettings.hashCode()"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String TbQueueEdgeSettings.getTopic()", "void TbQueueEdgeSettings.setTopic(String)",
