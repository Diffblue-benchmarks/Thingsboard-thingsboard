...
class AwsSqsTbQueueMsgMetadataDiffblueTest {
  /**
   * Test {@link AwsSqsTbQueueMsgMetadata#equals(Object)}, and {@link AwsSqsTbQueueMsgMetadata#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean AwsSqsTbQueueMsgMetadata.equals(Object)", "int AwsSqsTbQueueMsgMetadata.hashCode()"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AwsSqsTbQueueMsgMetadata.<init>(SdkHttpMetadata)",
      "SdkHttpMetadata AwsSqsTbQueueMsgMetadata.getMetadata()", "String AwsSqsTbQueueMsgMetadata.toString()"})
