...
class TbPubSubSubscriptionSettingsDiffblueTest {
  ...
  @MethodsUnderTest({"Map TbPubSubSubscriptionSettings.getCoreSettings()",
      "Map TbPubSubSubscriptionSettings.getEdgeSettings()", "Map TbPubSubSubscriptionSettings.getJsExecutorSettings()",
      "Map TbPubSubSubscriptionSettings.getNotificationsSettings()",
      "Map TbPubSubSubscriptionSettings.getRuleEngineSettings()",
      "Map TbPubSubSubscriptionSettings.getTransportApiSettings()", "Map TbPubSubSubscriptionSettings.getVcSettings()"})
