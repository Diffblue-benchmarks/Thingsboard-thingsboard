...
class MultipleTbQueueTbMsgCallbackWrapperDiffblueTest {
  /**
   * Test
   * {@link MultipleTbQueueTbMsgCallbackWrapper#MultipleTbQueueTbMsgCallbackWrapper(int, TbMsgCallback)}.
   * <p>
   * Method under test:
   * {@link MultipleTbQueueTbMsgCallbackWrapper#MultipleTbQueueTbMsgCallbackWrapper(int, TbMsgCallback)}
   */
  @Test
  @DisplayName("Test new MultipleTbQueueTbMsgCallbackWrapper(int, TbMsgCallback)")
  void testNewMultipleTbQueueTbMsgCallbackWrapper() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Missing observers.
    //   Diffblue Cover was unable to create an assertion.
    //   Add getters for the following fields or make them package-private:
    //     MultipleTbQueueTbMsgCallbackWrapper.tbMsgCallback
    //     MultipleTbQueueTbMsgCallbackWrapper.tbQueueCallbackCount

    // Arrange and Act
    new MultipleTbQueueTbMsgCallbackWrapper(3, mock(TbMsgCallback.class));
