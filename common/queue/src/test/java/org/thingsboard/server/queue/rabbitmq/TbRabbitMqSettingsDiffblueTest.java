...
class TbRabbitMqSettingsDiffblueTest {
  ...
  @MethodsUnderTest({"boolean TbRabbitMqSettings.equals(Object)", "int TbRabbitMqSettings.hashCode()"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ConnectionFactory TbRabbitMqSettings.getConnectionFactory()",
      "int TbRabbitMqSettings.getConnectionTimeout()", "String TbRabbitMqSettings.getExchangeName()",
      "int TbRabbitMqSettings.getHandshakeTimeout()", "String TbRabbitMqSettings.getHost()",
      "int TbRabbitMqSettings.getMaxPollMessages()", "String TbRabbitMqSettings.getPassword()",
      "int TbRabbitMqSettings.getPort()", "String TbRabbitMqSettings.getUsername()",
      "String TbRabbitMqSettings.getVirtualHost()", "boolean TbRabbitMqSettings.isAutomaticRecoveryEnabled()",
      ...
      "void TbRabbitMqSettings.setConnectionTimeout(int)", "void TbRabbitMqSettings.setExchangeName(String)",
      "void TbRabbitMqSettings.setHandshakeTimeout(int)", "void TbRabbitMqSettings.setHost(String)",
      "void TbRabbitMqSettings.setMaxPollMessages(int)", "void TbRabbitMqSettings.setPassword(String)",
      "void TbRabbitMqSettings.setPort(int)", "void TbRabbitMqSettings.setUsername(String)",
      "void TbRabbitMqSettings.setVirtualHost(String)", "String TbRabbitMqSettings.toString()"})
