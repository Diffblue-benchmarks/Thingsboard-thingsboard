...
@ContextConfiguration(classes = {PubSubTransportQueueFactory.class})
@ExtendWith(SpringExtension.class)
@DisabledInAotMode
class PubSubTransportQueueFactoryDiffblueTest {
  @Autowired
  private PubSubTransportQueueFactory pubSubTransportQueueFactory;
  ...
  /**
   * Test {@link PubSubTransportQueueFactory#createTransportApiRequestTemplate()}.
   * <p>
   * Method under test:
   * {@link PubSubTransportQueueFactory#createTransportApiRequestTemplate()}
   */
  @Test
  ...
  void testCreateTransportApiRequestTemplate() {
    ...
    //   - org.thingsboard.server.queue.provider.PubSubTransportQueueFactory
    //   when running class:
    //   package org.thingsboard.server.queue.provider;
    //   @org.springframework.test.context.ContextConfiguration(classes = {org.thingsboard.server.queue.provider.PubSubTransportQueueFactory.class})
    //   @org.junit.runner.RunWith(value = org.springframework.test.context.junit4.SpringRunner.class) // if JUnit 4
    //   @org.junit.jupiter.api.extension.ExtendWith(value = org.springframework.test.context.junit.jupiter.SpringExtension.class) // if JUnit 5
    //   public class DiffblueFakeClass2700 {
    //     @org.springframework.beans.factory.annotation.Autowired org.thingsboard.server.queue.provider.PubSubTransportQueueFactory pubSubTransportQueueFactory;
    ...
    // Arrange and Act
    pubSubTransportQueueFactory.createTransportApiRequestTemplate();
  }

  /**
   * Test {@link PubSubTransportQueueFactory#createRuleEngineMsgProducer()}.
   * <p>
   * Method under test:
   * {@link PubSubTransportQueueFactory#createRuleEngineMsgProducer()}
   */
  @Test
  ...
  void testCreateRuleEngineMsgProducer() {
    ...
    //   @org.junit.runner.RunWith(value = org.springframework.test.context.junit4.SpringRunner.class) // if JUnit 4
    //   @org.junit.jupiter.api.extension.ExtendWith(value = org.springframework.test.context.junit.jupiter.SpringExtension.class) // if JUnit 5
    //   public class DiffblueFakeClass2688 {
    //     @org.springframework.beans.factory.annotation.Autowired org.thingsboard.server.queue.provider.PubSubTransportQueueFactory pubSubTransportQueueFactory;
    //     @org.springframework.boot.test.mock.mockito.MockBean org.thingsboard.server.queue.pubsub.TbPubSubSettings tbPubSubSettings;
    //     @org.springframework.boot.test.mock.mockito.MockBean org.thingsboard.server.queue.pubsub.TbPubSubSubscriptionSettings tbPubSubSubscriptionSettings;
    //     @org.springframework.boot.test.mock.mockito.MockBean org.thingsboard.server.queue.settings.TbQueueCoreSettings tbQueueCoreSettings;
    ...
    // Arrange and Act
    pubSubTransportQueueFactory.createRuleEngineMsgProducer();
  }

  /**
   * Test {@link PubSubTransportQueueFactory#createTbCoreMsgProducer()}.
   * <p>
   * Method under test:
   * {@link PubSubTransportQueueFactory#createTbCoreMsgProducer()}
   */
  @Test
  ...
  void testCreateTbCoreMsgProducer() {
    ...
    // Arrange and Act
    pubSubTransportQueueFactory.createTbCoreMsgProducer();
  }

  /**
   * Test
   * {@link PubSubTransportQueueFactory#createTbCoreNotificationsMsgProducer()}.
   * <p>
   * Method under test:
   * {@link PubSubTransportQueueFactory#createTbCoreNotificationsMsgProducer()}
   */
  ...
  void testCreateTbCoreNotificationsMsgProducer() {
    ...
    // Arrange and Act
    pubSubTransportQueueFactory.createTbCoreNotificationsMsgProducer();
  }

  /**
   * Test
   * {@link PubSubTransportQueueFactory#createTransportNotificationsConsumer()}.
   * <p>
   * Method under test:
   * {@link PubSubTransportQueueFactory#createTransportNotificationsConsumer()}
   */
  ...
  void testCreateTransportNotificationsConsumer() {
    ...
    //   @org.junit.runner.RunWith(value = org.springframework.test.context.junit4.SpringRunner.class) // if JUnit 4
    //   @org.junit.jupiter.api.extension.ExtendWith(value = org.springframework.test.context.junit.jupiter.SpringExtension.class) // if JUnit 5
    //   public class DiffblueFakeClass2703 {
    //     @org.springframework.beans.factory.annotation.Autowired org.thingsboard.server.queue.provider.PubSubTransportQueueFactory pubSubTransportQueueFactory;
    //     @org.springframework.boot.test.mock.mockito.MockBean org.thingsboard.server.queue.pubsub.TbPubSubSettings tbPubSubSettings;
    //     @org.springframework.boot.test.mock.mockito.MockBean org.thingsboard.server.queue.pubsub.TbPubSubSubscriptionSettings tbPubSubSubscriptionSettings;
    //     @org.springframework.boot.test.mock.mockito.MockBean org.thingsboard.server.queue.settings.TbQueueCoreSettings tbQueueCoreSettings;
    ...
    // Arrange and Act
    pubSubTransportQueueFactory.createTransportNotificationsConsumer();
  }

  /**
   * Test
   * {@link PubSubTransportQueueFactory#createToUsageStatsServiceMsgProducer()}.
   * <p>
   * Method under test:
   * {@link PubSubTransportQueueFactory#createToUsageStatsServiceMsgProducer()}
   */
  ...
  void testCreateToUsageStatsServiceMsgProducer() {
    ...
    // Arrange and Act
    pubSubTransportQueueFactory.createToUsageStatsServiceMsgProducer();
  }

  /**
   * Test {@link PubSubTransportQueueFactory#createHousekeeperMsgProducer()}.
   * <p>
   * Method under test:
   * {@link PubSubTransportQueueFactory#createHousekeeperMsgProducer()}
   */
  @Test
  ...
  void testCreateHousekeeperMsgProducer() {
    ...
    // Arrange and Act
    pubSubTransportQueueFactory.createHousekeeperMsgProducer();
  }
}
