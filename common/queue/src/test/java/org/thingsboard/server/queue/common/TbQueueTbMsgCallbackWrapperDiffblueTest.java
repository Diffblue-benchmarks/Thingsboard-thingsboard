...
class TbQueueTbMsgCallbackWrapperDiffblueTest {
  /**
   * Test
   * {@link TbQueueTbMsgCallbackWrapper#TbQueueTbMsgCallbackWrapper(TbMsgCallback)}.
   * <p>
   * Method under test:
   * {@link TbQueueTbMsgCallbackWrapper#TbQueueTbMsgCallbackWrapper(TbMsgCallback)}
   */
  @Test
  @DisplayName("Test new TbQueueTbMsgCallbackWrapper(TbMsgCallback)")
  void testNewTbQueueTbMsgCallbackWrapper() {
