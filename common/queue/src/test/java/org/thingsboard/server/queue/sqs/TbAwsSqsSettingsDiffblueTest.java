...
class TbAwsSqsSettingsDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(tbAwsSqsSettings.hashCode(), tbAwsSqsSettings2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link TbAwsSqsSettings#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "String TbAwsSqsSettings.getAccessKeyId()",
    "String TbAwsSqsSettings.getRegion()",
    "String TbAwsSqsSettings.getSecretAccessKey()",
    "int TbAwsSqsSettings.getThreadPoolSize()",
    "int TbAwsSqsSettings.getThreadsPerTopic()",
    "Boolean TbAwsSqsSettings.getUseDefaultCredentialProviderChain()",
    "void TbAwsSqsSettings.setAccessKeyId(String)",
    "void TbAwsSqsSettings.setRegion(String)",
    "void TbAwsSqsSettings.setSecretAccessKey(String)",
    "void TbAwsSqsSettings.setThreadPoolSize(int)",
    "void TbAwsSqsSettings.setThreadsPerTopic(int)",
    "void TbAwsSqsSettings.setUseDefaultCredentialProviderChain(Boolean)",
    "String TbAwsSqsSettings.toString()"
  })
