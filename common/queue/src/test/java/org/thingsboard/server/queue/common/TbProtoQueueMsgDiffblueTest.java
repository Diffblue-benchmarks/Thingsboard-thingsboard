...
class TbProtoQueueMsgDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsSame_thenReturnEqual() {
    ...
    TbProtoQueueMsg<GeneratedMessageV3> tbProtoQueueMsg =
        new TbProtoQueueMsg<>(key, Advice.getDefaultInstance());
   ...
   * </ul>
   *
   * <p>Method under test: {@link TbProtoQueueMsg#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual3() {
    // Arrange
    TbProtoQueueMsg<GeneratedMessageV3> tbProtoQueueMsg =
        new TbProtoQueueMsg<>(null, Advice.getDefaultInstance());
    UUID key = UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9");
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual4() {
    // Arrange
    TbProtoQueueMsg<GeneratedMessageV3> tbProtoQueueMsg =
        new TbProtoQueueMsg<>(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"), null);
    UUID key = UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9");
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual5() {
    ...
    UUID key = UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9");
    TbProtoQueueMsg<GeneratedMessageV3> tbProtoQueueMsg =
        new TbProtoQueueMsg<>(key, AuthProvider.getDefaultInstance());
    UUID key2 = UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9");
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual9() {
    ...
    TbProtoQueueMsg<GeneratedMessageV3> tbProtoQueueMsg =
        new TbProtoQueueMsg<>(key, Advice.getDefaultInstance());
    TbProtoJsQueueMsg<GeneratedMessageV3> tbProtoJsQueueMsg = mock(TbProtoJsQueueMsg.class);
    when(tbProtoJsQueueMsg.getHeaders()).thenReturn(null);
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "void TbProtoQueueMsg.<init>(UUID, GeneratedMessageV3, TbQueueMsgHeaders)",
    "TbQueueMsgHeaders TbProtoQueueMsg.getHeaders()",
    "UUID TbProtoQueueMsg.getKey()",
    "GeneratedMessageV3 TbProtoQueueMsg.getValue()",
    "java.lang.String TbProtoQueueMsg.toString()"
  })
  void testGettersAndSetters() {
    ...
    TbProtoQueueMsg<GeneratedMessageV3> actualTbProtoQueueMsg =
        new TbProtoQueueMsg<>(key, defaultInstance, headers);
   ...
   * </ul>
   *
   * <p>Method under test: {@link TbProtoQueueMsg#getData()}
   */
  @Test
