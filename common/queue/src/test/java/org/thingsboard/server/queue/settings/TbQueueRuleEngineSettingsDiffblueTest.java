...
class TbQueueRuleEngineSettingsDiffblueTest {
  /**
   * Test {@link TbQueueRuleEngineSettings#equals(Object)}, and {@link TbQueueRuleEngineSettings#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean TbQueueRuleEngineSettings.equals(Object)", "int TbQueueRuleEngineSettings.hashCode()"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String TbQueueRuleEngineSettings.getTopic()", "void TbQueueRuleEngineSettings.setTopic(String)",
