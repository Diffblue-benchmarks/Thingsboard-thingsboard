...
class TbVersionControlProducerProviderDiffblueTest {
   ...
   * <p>
   * Method under test: {@link TbVersionControlProducerProvider#getTransportNotificationsMsgProducer()}
   */
  @Test
  ...
  void testGetTransportNotificationsMsgProducer() {
    ...
    assertThrows(RuntimeException.class, () -> tbVersionControlProducerProvider.getTransportNotificationsMsgProducer());
  }

  /**
   * Test {@link TbVersionControlProducerProvider#getRuleEngineMsgProducer()}.
   * <p>
   * Method under test: {@link TbVersionControlProducerProvider#getRuleEngineMsgProducer()}
   */
  @Test
  ...
  void testGetRuleEngineMsgProducer() {
    // Arrange, Act and Assert
    assertThrows(RuntimeException.class, () -> tbVersionControlProducerProvider.getRuleEngineMsgProducer());
  }

  /**
   * Test {@link TbVersionControlProducerProvider#getTbCoreMsgProducer()}.
   * <p>
   * Method under test: {@link TbVersionControlProducerProvider#getTbCoreMsgProducer()}
   */
  @Test
  ...
  void testGetTbCoreMsgProducer() {
    // Arrange, Act and Assert
    assertThrows(RuntimeException.class, () -> tbVersionControlProducerProvider.getTbCoreMsgProducer());
  }

  /**
   * Test {@link TbVersionControlProducerProvider#getRuleEngineNotificationsMsgProducer()}.
   * <p>
   * Method under test: {@link TbVersionControlProducerProvider#getRuleEngineNotificationsMsgProducer()}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link TbVersionControlProducerProvider#getTbEdgeMsgProducer()}
   */
  @Test
  ...
  void testGetTbEdgeMsgProducer() {
    // Arrange, Act and Assert
    assertThrows(RuntimeException.class, () -> tbVersionControlProducerProvider.getTbEdgeMsgProducer());
  }

  /**
   * Test {@link TbVersionControlProducerProvider#getTbEdgeNotificationsMsgProducer()}.
   * <p>
   * Method under test: {@link TbVersionControlProducerProvider#getTbEdgeNotificationsMsgProducer()}
   */
  @Test
  ...
  void testGetTbEdgeNotificationsMsgProducer() {
    // Arrange, Act and Assert
    assertThrows(RuntimeException.class, () -> tbVersionControlProducerProvider.getTbEdgeNotificationsMsgProducer());
  }

  /**
   * Test {@link TbVersionControlProducerProvider#getTbVersionControlMsgProducer()}.
   * <p>
   * Method under test: {@link TbVersionControlProducerProvider#getTbVersionControlMsgProducer()}
   */
  @Test
  ...
  void testGetTbVersionControlMsgProducer() {
    // Arrange, Act and Assert
    assertThrows(RuntimeException.class, () -> tbVersionControlProducerProvider.getTbVersionControlMsgProducer());
  }
}
