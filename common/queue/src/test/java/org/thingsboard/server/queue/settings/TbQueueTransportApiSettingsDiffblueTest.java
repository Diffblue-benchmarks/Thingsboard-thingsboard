...
class TbQueueTransportApiSettingsDiffblueTest {
  /**
   * Test {@link TbQueueTransportApiSettings#equals(Object)}, and {@link
   * TbQueueTransportApiSettings#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean TbQueueTransportApiSettings.equals(Object)",
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(tbQueueTransportApiSettings.hashCode(), tbQueueTransportApiSettings2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link TbQueueTransportApiSettings#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(
        new TbQueueTransportApiSettings(), "Different type to TbQueueTransportApiSettings");
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "int TbQueueTransportApiSettings.getMaxCallbackThreads()",
    ...
    "void TbQueueTransportApiSettings.setResponsesTopic(String)",
    "String TbQueueTransportApiSettings.toString()"
  })
  void testGettersAndSetters() {
    ...
    assertEquals(
        "TbQueueTransportApiSettings(requestsTopic=Requests Topic, responsesTopic=Responses Topic,"
            + " maxPendingRequests=3, maxRequestsTimeout=3, maxCallbackThreads=3, requestPollInterval=42,"
            + " responsePollInterval=42)",
