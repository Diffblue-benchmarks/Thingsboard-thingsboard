...
class AlarmPropagationInfoDiffblueTest {
  ...
  void testAlarmPropagationInfoBuilderBuild() {
    ...
    // Act
    AlarmPropagationInfo actualBuildResult =
        propagateResult
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    AlarmPropagationInfoBuilder propagateResult = AlarmPropagationInfo.builder().propagate(true);
    AlarmPropagationInfo buildResult =
        propagateResult
    ...
    AlarmPropagationInfo buildResult2 =
        propagateResult2
            .propagateRelationTypes(new ArrayList<>())
            .propagateToOwner(true)
            .propagateToTenant(true)
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    // Arrange
    AlarmPropagationInfoBuilder alarmPropagationInfoBuilder =
        mock(AlarmPropagationInfoBuilder.class);
    when(alarmPropagationInfoBuilder.propagate(anyBoolean()))
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual3() {
    ...
    when(alarmPropagationInfoBuilder.propagateRelationTypes(Mockito.<List<String>>any()))
        .thenReturn(AlarmPropagationInfo.builder());
    AlarmPropagationInfoBuilder alarmPropagationInfoBuilder2 =
        mock(AlarmPropagationInfoBuilder.class);
    when(alarmPropagationInfoBuilder2.propagate(anyBoolean()))
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual4() {
    ...
    AlarmPropagationInfoBuilder alarmPropagationInfoBuilder =
        mock(AlarmPropagationInfoBuilder.class);
    when(alarmPropagationInfoBuilder.propagateToOwner(anyBoolean()))
        .thenReturn(AlarmPropagationInfo.builder());
    AlarmPropagationInfoBuilder alarmPropagationInfoBuilder2 =
        mock(AlarmPropagationInfoBuilder.class);
    when(alarmPropagationInfoBuilder2.propagateRelationTypes(Mockito.<List<String>>any()))
        .thenReturn(alarmPropagationInfoBuilder);
    AlarmPropagationInfoBuilder alarmPropagationInfoBuilder3 =
        mock(AlarmPropagationInfoBuilder.class);
    when(alarmPropagationInfoBuilder3.propagate(anyBoolean()))
        .thenReturn(alarmPropagationInfoBuilder2);
