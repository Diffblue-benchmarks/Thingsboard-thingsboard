...
class RelationEntityTypeFilterDiffblueTest {
  /**
   * Test {@link RelationEntityTypeFilter#equals(Object)}, and {@link RelationEntityTypeFilter#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean RelationEntityTypeFilter.equals(Object)", "int RelationEntityTypeFilter.hashCode()"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void RelationEntityTypeFilter.<init>()", "void RelationEntityTypeFilter.<init>(String, List)",
      "void RelationEntityTypeFilter.<init>(String, List, boolean)", "List RelationEntityTypeFilter.getEntityTypes()",
      "String RelationEntityTypeFilter.getRelationType()", "boolean RelationEntityTypeFilter.isNegate()",
      "void RelationEntityTypeFilter.setEntityTypes(List)", "void RelationEntityTypeFilter.setNegate(boolean)",
      "void RelationEntityTypeFilter.setRelationType(String)", "String RelationEntityTypeFilter.toString()"})
