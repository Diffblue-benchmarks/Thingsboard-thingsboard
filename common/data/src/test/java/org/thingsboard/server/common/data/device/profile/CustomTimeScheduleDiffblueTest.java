...
class CustomTimeScheduleDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean CustomTimeSchedule.equals(Object)",
    "int CustomTimeSchedule.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    CustomTimeSchedule customTimeSchedule = new CustomTimeSchedule();
    customTimeSchedule.setDynamicValue(
    ...
    customTimeSchedule2.setDynamicValue(
        new DynamicValue<>(DynamicValueSourceType.CURRENT_TENANT, "Source Attribute"));
    ...
    assertEquals(customTimeSchedule.hashCode(), customTimeSchedule2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link CustomTimeSchedule#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void CustomTimeSchedule.<init>()",
    "DynamicValue CustomTimeSchedule.getDynamicValue()",
    "List CustomTimeSchedule.getItems()",
    "String CustomTimeSchedule.getTimezone()",
    "AlarmScheduleType CustomTimeSchedule.getType()",
    "void CustomTimeSchedule.setDynamicValue(DynamicValue)",
    "void CustomTimeSchedule.setItems(List)",
    "void CustomTimeSchedule.setTimezone(String)",
  ...
  void testGettersAndSetters() {
    ...
    // Assert
    assertEquals(
        "CustomTimeSchedule(timezone=UTC, items=[], dynamicValue=DynamicValue(resolvedValue=null, sourceType"
            + "=CURRENT_TENANT, sourceAttribute=Source Attribute, inherit=false))",
