...
class SystemAdministratorsFilterDiffblueTest {
  /**
   * Test {@link SystemAdministratorsFilter#equals(Object)}, and {@link
   * SystemAdministratorsFilter#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean SystemAdministratorsFilter.equals(Object)",
    "int SystemAdministratorsFilter.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(systemAdministratorsFilter.hashCode(), systemAdministratorsFilter2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link SystemAdministratorsFilter#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(
        new SystemAdministratorsFilter(), "Different type to SystemAdministratorsFilter");
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void SystemAdministratorsFilter.<init>()",
    "UsersFilterType SystemAdministratorsFilter.getType()",
