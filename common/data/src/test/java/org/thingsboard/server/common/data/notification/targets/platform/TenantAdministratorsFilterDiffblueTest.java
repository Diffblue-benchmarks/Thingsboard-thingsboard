...
class TenantAdministratorsFilterDiffblueTest {
  /**
   * Test {@link TenantAdministratorsFilter#equals(Object)}, and {@link
   * TenantAdministratorsFilter#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean TenantAdministratorsFilter.equals(Object)",
    "int TenantAdministratorsFilter.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(tenantAdministratorsFilter.hashCode(), tenantAdministratorsFilter2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link TenantAdministratorsFilter#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void TenantAdministratorsFilter.<init>()",
    "Set TenantAdministratorsFilter.getTenantProfilesIds()",
    "Set TenantAdministratorsFilter.getTenantsIds()",
    "UsersFilterType TenantAdministratorsFilter.getType()",
    "void TenantAdministratorsFilter.setTenantProfilesIds(Set)",
    "void TenantAdministratorsFilter.setTenantsIds(Set)",
  ...
  void testGettersAndSetters() {
    ...
    // Assert
    assertEquals(
        "TenantAdministratorsFilter(tenantsIds=[], tenantProfilesIds=[])", actualToStringResult);
