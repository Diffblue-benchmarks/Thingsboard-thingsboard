...
class ApiUsageStateFilterDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    apiUsageStateFilter.setCustomerId(new CustomerId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9")));

    ApiUsageStateFilter apiUsageStateFilter2 = new ApiUsageStateFilter();
    apiUsageStateFilter2.setCustomerId(new CustomerId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9")));
