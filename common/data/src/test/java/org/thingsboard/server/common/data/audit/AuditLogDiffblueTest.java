...
class AuditLogDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link AuditLogId} {@link UUIDBased#getId()} return
   ...
   */
  @Test
  @DisplayName("Test getId(); given AuditLogId getId() return NULL_UUID; then calls getId()")
  void testGetId_givenAuditLogIdGetIdReturnNull_uuid_thenCallsGetId() {
    // Arrange
