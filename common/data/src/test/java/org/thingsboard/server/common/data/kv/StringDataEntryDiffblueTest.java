...
class StringDataEntryDiffblueTest {
  ...
  @MethodsUnderTest({"void StringDataEntry.<init>(String, String)", "DataType StringDataEntry.getDataType()",
      "Object StringDataEntry.getValue()", "String StringDataEntry.getValueAsString()",
