...
class AdminSettingsDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link AdminSettingsId} {@link UUIDBased#getId()} return
   ...
   */
  @Test
  @DisplayName("Test getId(); given AdminSettingsId getId() return NULL_UUID; then calls getId()")
  void testGetId_givenAdminSettingsIdGetIdReturnNull_uuid_thenCallsGetId() {
    // Arrange
