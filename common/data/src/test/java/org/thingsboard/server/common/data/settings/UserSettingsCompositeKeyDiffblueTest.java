...
class UserSettingsCompositeKeyDiffblueTest {
  /**
   * Test {@link UserSettingsCompositeKey#equals(Object)}, and {@link UserSettingsCompositeKey#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean UserSettingsCompositeKey.equals(Object)", "int UserSettingsCompositeKey.hashCode()"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void UserSettingsCompositeKey.<init>()", "void UserSettingsCompositeKey.<init>(UUID, String)",
      "String UserSettingsCompositeKey.getType()", "UUID UserSettingsCompositeKey.getUserId()",
      "void UserSettingsCompositeKey.setType(String)", "void UserSettingsCompositeKey.setUserId(UUID)",
   ...
   * <p>
   * Method under test: {@link UserSettingsCompositeKey#UserSettingsCompositeKey(UserSettings)}
   */
  @Test
