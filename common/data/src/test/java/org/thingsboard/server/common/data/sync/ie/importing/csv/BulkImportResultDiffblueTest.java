...
class BulkImportResultDiffblueTest {
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void BulkImportResult.<init>()", "AtomicInteger BulkImportResult.getCreated()",
      "AtomicInteger BulkImportResult.getErrors()", "Collection BulkImportResult.getErrorsList()",
      "AtomicInteger BulkImportResult.getUpdated()", "void BulkImportResult.setCreated(AtomicInteger)",
      "void BulkImportResult.setErrors(AtomicInteger)", "void BulkImportResult.setErrorsList(Collection)",
      "void BulkImportResult.setUpdated(AtomicInteger)", "String BulkImportResult.toString()"})
