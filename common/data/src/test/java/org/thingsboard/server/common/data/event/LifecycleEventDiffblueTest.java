...
class LifecycleEventDiffblueTest {
  ...
  void testLifecycleEventBuilderBuild() {
    ...
    // Assert
    UUID entityId = actualLifecycleEvent.getEntityId();
    ...
    assertSame(id, actualLifecycleEvent.getUuidId());
   ...
   *
   * <ul>
   *   <li>Then return Body size is three.
   * </ul>
   *
   * <p>Method under test: {@link LifecycleEvent#toInfo(EntityType)}
   */
  @Test
  @DisplayName("Test toInfo(EntityType); then return Body size is three")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"EventInfo LifecycleEvent.toInfo(EntityType)"})
  void testToInfo_thenReturnBodySizeIsThree() {
    // Arrange and Act
