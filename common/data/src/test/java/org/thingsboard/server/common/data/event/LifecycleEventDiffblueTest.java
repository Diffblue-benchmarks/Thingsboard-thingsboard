...
class LifecycleEventDiffblueTest {
  ...
  void testLifecycleEventBuilderBuild() {
    // Arrange and Act
    LifecycleEventBuilder actualBuilderResult = LifecycleEvent.builder();
    UUID entityId = UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9");
    LifecycleEventBuilder actualErrorResult =
        actualBuilderResult.entityId(entityId).error("An error occurred");
    UUID id = UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9");
    LifecycleEvent actualLifecycleEvent =
        actualErrorResult
            .id(id)
    ...
    // Assert
    assertEquals("42", actualLifecycleEvent.getServiceId());
    UUID entityId2 = actualLifecycleEvent.getEntityId();
    assertEquals("784f394c-42b6-435a-983c-b7beff2784f9", entityId2.toString());
    UUID uuidId = actualLifecycleEvent.getUuidId();
    assertEquals("784f394c-42b6-435a-983c-b7beff2784f9", uuidId.toString());
    assertEquals("An error occurred", actualLifecycleEvent.getError());
    assertEquals("Lc Event Type", actualLifecycleEvent.getLcEventType());
    assertEquals(1L, actualLifecycleEvent.getCreatedTime());
    assertEquals(EventType.LC_EVENT, actualLifecycleEvent.getType());
    assertTrue(actualLifecycleEvent.isSuccess());
    assertSame(entityId, entityId2);
    assertSame(id, uuidId);
    assertSame(id, actualLifecycleEvent.getId().getId());
    assertSame(TenantId.SYS_TENANT_ID, actualLifecycleEvent.getTenantId());
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    // Act and Assert
    assertEquals(lifecycleEvent, lifecycleEvent2);
    assertEquals(lifecycleEvent.hashCode(), lifecycleEvent2.hashCode());
  }
  ...
  void testEqualsAndHashCode_whenOtherIsSame_thenReturnEqual() {
    ...
    // Act and Assert
    assertEquals(lifecycleEvent, lifecycleEvent);
    int expectedHashCodeResult = lifecycleEvent.hashCode();
    assertEquals(expectedHashCodeResult, lifecycleEvent.hashCode());
  }
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    // Arrange
    LifecycleEventBuilder errorResult =
        LifecycleEvent.builder().entityId(EntityId.NULL_UUID).error("An error occurred");
    LifecycleEvent lifecycleEvent =
        errorResult
            .id(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"))
            .lcEventType("Lc Event Type")
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    ...
    LifecycleEventBuilder errorResult =
        builderResult.entityId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9")).error("42");
    LifecycleEvent lifecycleEvent =
        errorResult
            .id(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"))
            .lcEventType("Lc Event Type")
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    ...
    assertNotEquals(
        errorResult
            ...
            .ts(1L)
            .build(),
        "Different type to LifecycleEvent");
  }
  ...
  void testGettersAndSetters() {
    ...
    // Act
    lifecycleEvent.setError("An error occurred");
    String actualToStringResult = lifecycleEvent.toString();
    String actualError = lifecycleEvent.getError();
    String actualLcEventType = lifecycleEvent.getLcEventType();
    EventType actualType = lifecycleEvent.getType();
    ...
    assertTrue(lifecycleEvent.isSuccess());
  }
}
