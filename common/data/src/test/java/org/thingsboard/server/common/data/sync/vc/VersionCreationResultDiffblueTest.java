...
class VersionCreationResultDiffblueTest {
  /**
   * Test {@link VersionCreationResult#equals(Object)}, and {@link VersionCreationResult#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean VersionCreationResult.equals(Object)", "int VersionCreationResult.hashCode()"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void VersionCreationResult.<init>()", "void VersionCreationResult.<init>(String)",
      "void VersionCreationResult.<init>(EntityVersion, int, int, int)", "int VersionCreationResult.getAdded()",
      "String VersionCreationResult.getError()", "int VersionCreationResult.getModified()",
      "int VersionCreationResult.getRemoved()", "EntityVersion VersionCreationResult.getVersion()",
      "boolean VersionCreationResult.isDone()", "void VersionCreationResult.setAdded(int)",
      "void VersionCreationResult.setDone(boolean)", "void VersionCreationResult.setError(String)",
      "void VersionCreationResult.setModified(int)", "void VersionCreationResult.setRemoved(int)",
      "void VersionCreationResult.setVersion(EntityVersion)", "String VersionCreationResult.toString()"})
