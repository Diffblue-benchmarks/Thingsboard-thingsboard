...
class RuleNodeDebugEventDiffblueTest {
  ...
  void testRuleNodeDebugEventBuilderBuild() {
    ...
    // Assert
    UUID entityId = actualRuleNodeDebugEvent.getEntityId();
    ...
    assertSame(msgId, entityId);
    assertSame(msgId, actualRuleNodeDebugEvent.getMsgId());
    assertSame(msgId, actualRuleNodeDebugEvent.getUuidId());
    assertSame(msgId, actualRuleNodeDebugEvent.getId().getId());
  ...
  void testToInfo() {
    ...
    assertEquals(
        "{\n"
            ...
            + "  \"entityType\" : \"TENANT\",\n"
            + "  \"msgId\" : \"13814000-1dd2-11b2-8080-808080808080\",\n"
            + "  \"msgType\" : \"Msg Type\",\n"
            + "  \"dataType\" : \"Data Type\",\n"
            + "  \"relationType\" : \"Relation Type\",\n"
            + "  \"metadata\" : \"Metadata\",\n"
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual9() {
    ...
    RuleNodeDebugEvent ruleNodeDebugEvent =
        errorResult
            .eventEntity(new AlarmId(EntityId.NULL_UUID))
            .eventType("Event Type")
            .id(EntityId.NULL_UUID)
            .metadata("Metadata")
            .msgId(EntityId.NULL_UUID)
