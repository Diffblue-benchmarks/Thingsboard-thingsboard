...
class NewPlatformVersionTriggerDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    NewPlatformVersionTrigger buildResult =
        builderResult
            .updateInfo(
                new UpdateMessage(
                    true,
    ...
    NewPlatformVersionTrigger buildResult2 =
        builderResult2
            .updateInfo(
                new UpdateMessage(
                    true,
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual2() {
    // Arrange
    NewPlatformVersionTriggerBuilder newPlatformVersionTriggerBuilder =
        mock(NewPlatformVersionTriggerBuilder.class);
        ...
        newPlatformVersionTriggerBuilder
            .updateInfo(
                new UpdateMessage(
                    ...
                    "https://example.org/example"))
            .build();
    NewPlatformVersionTriggerBuilder newPlatformVersionTriggerBuilder2 =
        mock(NewPlatformVersionTriggerBuilder.class);
    when(newPlatformVersionTriggerBuilder2.updateInfo(Mockito.<UpdateMessage>any()))
        .thenReturn(NewPlatformVersionTrigger.builder());
    NewPlatformVersionTrigger buildResult2 =
        newPlatformVersionTriggerBuilder2
            .updateInfo(
                new UpdateMessage(
                    true,
                    "1.0.2",
        ...
        newPlatformVersionTriggerBuilder2
            .updateInfo(
                new UpdateMessage(
                    ...
                    "https://example.org/example"))
            .build();
    NewPlatformVersionTriggerBuilder newPlatformVersionTriggerBuilder3 =
        mock(NewPlatformVersionTriggerBuilder.class);
    when(newPlatformVersionTriggerBuilder3.updateInfo(Mockito.<UpdateMessage>any()))
        .thenReturn(NewPlatformVersionTrigger.builder());
    NewPlatformVersionTrigger buildResult3 =
        newPlatformVersionTriggerBuilder3
            .updateInfo(
                new UpdateMessage(
                    true,
                    "1.0.2",
