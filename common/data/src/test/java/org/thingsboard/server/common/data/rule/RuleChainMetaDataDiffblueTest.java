...
class RuleChainMetaDataDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(ruleChainMetaData.hashCode(), ruleChainMetaData2.hashCode());
  }
  ...
  void testGettersAndSetters() {
    ...
    // Assert
    assertEquals(
        "RuleChainMetaData(ruleChainId=13814000-1dd2-11b2-8080-808080808080, version=1, firstNodeIndex=1,"
