...
class EntityDataDiffDiffblueTest {
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void EntityDataDiff.<init>(EntityExportData, EntityExportData)",
      "EntityExportData EntityDataDiff.getCurrentVersion()", "EntityExportData EntityDataDiff.getOtherVersion()",
      "void EntityDataDiff.setCurrentVersion(EntityExportData)",
      "void EntityDataDiff.setOtherVersion(EntityExportData)", "String EntityDataDiff.toString()"})
