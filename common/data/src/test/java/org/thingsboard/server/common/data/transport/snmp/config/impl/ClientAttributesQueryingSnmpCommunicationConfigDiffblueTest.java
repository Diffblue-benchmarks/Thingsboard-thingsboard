...
class ClientAttributesQueryingSnmpCommunicationConfigDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ClientAttributesQueryingSnmpCommunicationConfig.<init>()",
    "SnmpCommunicationSpec ClientAttributesQueryingSnmpCommunicationConfig.getSpec()"
  })
  void testGettersAndSetters() {
    // Arrange and Act
    ClientAttributesQueryingSnmpCommunicationConfig
        actualClientAttributesQueryingSnmpCommunicationConfig =
            new ClientAttributesQueryingSnmpCommunicationConfig();
    SnmpCommunicationSpec actualSpec =
        actualClientAttributesQueryingSnmpCommunicationConfig.getSpec();
