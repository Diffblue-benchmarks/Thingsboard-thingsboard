...
class RuleChainDebugEventDiffblueTest {
  ...
  void testRuleChainDebugEventBuilderBuild() {
    // Arrange and Act
    RuleChainDebugEventBuilder actualBuilderResult = RuleChainDebugEvent.builder();
    UUID entityId = UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9");
    RuleChainDebugEventBuilder actualErrorResult =
    ...
    UUID entityId2 = actualRuleChainDebugEvent.getEntityId();
    assertEquals("784f394c-42b6-435a-983c-b7beff2784f9", entityId2.toString());
    UUID uuidId = actualRuleChainDebugEvent.getUuidId();
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    // Arrange
    RuleChainDebugEventBuilder errorResult =
        RuleChainDebugEvent.builder().entityId(EntityId.NULL_UUID).error("An error occurred");
    RuleChainDebugEvent ruleChainDebugEvent =
        errorResult
            .id(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"))
            .message("Not all who wander are lost")
