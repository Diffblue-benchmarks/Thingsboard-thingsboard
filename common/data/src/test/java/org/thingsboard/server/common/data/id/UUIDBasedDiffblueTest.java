...
class UUIDBasedDiffblueTest {
  ...
  void testGetId() {
    ...
    assertEquals(
        ...
        new AdminSettingsId(EntityId.NULL_UUID).getId().toString());
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(tenantId.hashCode(), tenantId2.hashCode());
  }
  ...
  void testToString() {
    // Arrange, Act and Assert
    assertEquals(
        "13814000-1dd2-11b2-8080-808080808080", new AdminSettingsId(EntityId.NULL_UUID).toString());
  }
}
