...
class EdgeConnectionTriggerDiffblueTest {
  ...
  void testDeduplicate_thenReturnTrue() {
    ...
    assertTrue((new EdgeConnectionTrigger(TenantId.SYS_TENANT_ID,
        new CustomerId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9")), null, true, "Edge Name"))
        .deduplicate());
  }
  ...
  void testGetDeduplicationKey() {
    ...
    // Act and Assert
    assertEquals("EDGE_CONNECTION:EDGE:784f394c-42b6-435a-983c-b7beff2784f9:true",
        (new EdgeConnectionTrigger(TenantId.SYS_TENANT_ID, customerId,
            new EdgeId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9")), true, "Edge Name"))
            .getDeduplicationKey());
  }
  ...
  void testGetDefaultDeduplicationDuration_thenReturn60000() {
    // Arrange, Act and Assert
    assertEquals(60000L,
        (new EdgeConnectionTrigger(TenantId.SYS_TENANT_ID,
            new CustomerId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9")), null, true, "Edge Name"))
