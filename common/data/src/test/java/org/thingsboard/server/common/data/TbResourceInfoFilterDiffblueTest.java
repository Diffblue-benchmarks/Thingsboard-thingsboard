...
class TbResourceInfoFilterDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    TbResourceInfoFilter buildResult =
    ...
    TbResourceInfoFilter buildResult2 =
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual3() {
    ...
    TbResourceInfoFilterBuilder tbResourceInfoFilterBuilder =
        mock(TbResourceInfoFilterBuilder.class);
    when(tbResourceInfoFilterBuilder.tenantId(Mockito.<TenantId>any()))
        .thenReturn(TbResourceInfoFilter.builder());
    TbResourceInfoFilterBuilder tbResourceInfoFilterBuilder2 =
        mock(TbResourceInfoFilterBuilder.class);
    when(tbResourceInfoFilterBuilder2.resourceTypes(Mockito.<Set<ResourceType>>any()))
        .thenReturn(tbResourceInfoFilterBuilder);
    TbResourceInfoFilterBuilder tbResourceInfoFilterBuilder3 =
        mock(TbResourceInfoFilterBuilder.class);
    ...
    TbResourceInfoFilterBuilder resourceSubTypesResult =
        tbResourceInfoFilterBuilder3.resourceSubTypes(new HashSet<>());
    TbResourceInfoFilter buildResult =
        resourceSubTypesResult
            .resourceTypes(new HashSet<>())
            .tenantId(TenantId.SYS_TENANT_ID)
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual5() {
    ...
    TbResourceInfoFilterBuilder tbResourceInfoFilterBuilder2 =
        mock(TbResourceInfoFilterBuilder.class);
    when(tbResourceInfoFilterBuilder2.tenantId(Mockito.<TenantId>any()))
        .thenReturn(tbResourceInfoFilterBuilder);
    TbResourceInfoFilterBuilder tbResourceInfoFilterBuilder3 =
        mock(TbResourceInfoFilterBuilder.class);
    when(tbResourceInfoFilterBuilder3.resourceTypes(Mockito.<Set<ResourceType>>any()))
        .thenReturn(tbResourceInfoFilterBuilder2);
    TbResourceInfoFilterBuilder tbResourceInfoFilterBuilder4 =
        mock(TbResourceInfoFilterBuilder.class);
    ...
    TbResourceInfoFilterBuilder resourceSubTypesResult2 =
        tbResourceInfoFilterBuilder4.resourceSubTypes(new HashSet<>());
    TbResourceInfoFilter buildResult2 =
        resourceSubTypesResult2
            .resourceTypes(new HashSet<>())
            .tenantId(TenantId.SYS_TENANT_ID)
            .build();
    TbResourceInfoFilterBuilder builderResult2 = TbResourceInfoFilter.builder();
    TbResourceInfoFilterBuilder resourceSubTypesResult3 =
        builderResult2.resourceSubTypes(new HashSet<>());
    TbResourceInfoFilter buildResult3 =
        resourceSubTypesResult3.resourceTypes(new HashSet<>()).tenantId(null).build();
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual7() {
    ...
    TbResourceInfoFilter buildResult =
        resourceSubTypesResult.resourceTypes(resourceTypes).tenantId(null).build();
    TbResourceInfoFilterBuilder tbResourceInfoFilterBuilder =
        mock(TbResourceInfoFilterBuilder.class);
    when(tbResourceInfoFilterBuilder.build()).thenReturn(buildResult);
    TbResourceInfoFilterBuilder tbResourceInfoFilterBuilder2 =
  ...
  void testTbResourceInfoFilterBuilderBuild() {
    ...
    HashSet<ResourceSubType> resourceSubTypes = new HashSet<>();
    TbResourceInfoFilterBuilder resourceSubTypesResult =
        builderResult.resourceSubTypes(resourceSubTypes);
    HashSet<ResourceType> resourceTypes = new HashSet<>();

    // Act
    TbResourceInfoFilter actualBuildResult =
        resourceSubTypesResult
