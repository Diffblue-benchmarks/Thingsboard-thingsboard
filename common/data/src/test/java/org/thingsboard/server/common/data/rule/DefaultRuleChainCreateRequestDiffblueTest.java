...
class DefaultRuleChainCreateRequestDiffblueTest {
  /**
   * Test {@link DefaultRuleChainCreateRequest#equals(Object)}, and {@link
   * DefaultRuleChainCreateRequest#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean DefaultRuleChainCreateRequest.equals(Object)",
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    DefaultRuleChainCreateRequest defaultRuleChainCreateRequest2 =
        new DefaultRuleChainCreateRequest();
    ...
    assertEquals(
        defaultRuleChainCreateRequest.hashCode(), defaultRuleChainCreateRequest2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link DefaultRuleChainCreateRequest#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    ...
    DefaultRuleChainCreateRequest defaultRuleChainCreateRequest =
        new DefaultRuleChainCreateRequest();
    defaultRuleChainCreateRequest.setName(
        "org.thingsboard.server.common.data.rule.DefaultRuleChainCreateRequest");
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    ...
    // Act and Assert
    assertNotEquals(
        defaultRuleChainCreateRequest, "Different type to DefaultRuleChainCreateRequest");
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void DefaultRuleChainCreateRequest.<init>()",
    "String DefaultRuleChainCreateRequest.getName()",
    "void DefaultRuleChainCreateRequest.setName(String)",
    "String DefaultRuleChainCreateRequest.toString()"
  })
  void testGettersAndSetters() {
    // Arrange and Act
    DefaultRuleChainCreateRequest actualDefaultRuleChainCreateRequest =
        new DefaultRuleChainCreateRequest();
