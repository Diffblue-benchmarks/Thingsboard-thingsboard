...
class RepositorySettingsInfoDiffblueTest {
  @Autowired
  private RepositorySettingsInfoBuilder repositorySettingsInfoBuilder;

  /**
   * Test {@link RepositorySettingsInfo#equals(Object)}, and {@link RepositorySettingsInfo#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean RepositorySettingsInfo.equals(Object)", "int RepositorySettingsInfo.hashCode()"})
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual2() {
    // Arrange
    RepositorySettingsInfoBuilder repositorySettingsInfoBuilder = mock(RepositorySettingsInfoBuilder.class);
    when(repositorySettingsInfoBuilder.readOnly(Mockito.<Boolean>any())).thenReturn(RepositorySettingsInfo.builder());
    RepositorySettingsInfoBuilder repositorySettingsInfoBuilder2 = mock(RepositorySettingsInfoBuilder.class);
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void RepositorySettingsInfo.<init>()", "void RepositorySettingsInfo.<init>(boolean, Boolean)",
      "Boolean RepositorySettingsInfo.getReadOnly()", "boolean RepositorySettingsInfo.isConfigured()",
      "void RepositorySettingsInfo.setConfigured(boolean)", "void RepositorySettingsInfo.setReadOnly(Boolean)",
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void RepositorySettingsInfoBuilder.<init>()",
