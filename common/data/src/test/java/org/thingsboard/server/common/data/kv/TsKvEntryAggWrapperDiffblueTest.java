...
class TsKvEntryAggWrapperDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    TsKvEntryAggWrapper tsKvEntryAggWrapper2 = new TsKvEntryAggWrapper(
        new BasicTsKvEntry(1L, new JsonDataEntry("Key", "42")), 1L);
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    // Arrange
    TsKvEntryAggWrapper tsKvEntryAggWrapper = new TsKvEntryAggWrapper(
        new BasicTsKvEntry(3L, new JsonDataEntry("Key", "42")), 1L);
  ...
  void testGettersAndSetters() {
    ...
    // Assert
    assertEquals("TsKvEntryAggWrapper(entry=BasicTsKvEntry(ts=1, kv=JsonDataEntry{value=42} BasicKvEntry{key='Key'},"
        + " version=null), lastEntryTs=1)", actualToStringResult);
