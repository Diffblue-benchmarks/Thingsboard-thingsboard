...
class TsKvEntryAggWrapperDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    TsKvEntryAggWrapper tsKvEntryAggWrapper = new TsKvEntryAggWrapper(entry, 1L);
    BasicTsKvEntry entry2 = new BasicTsKvEntry(1L, new JsonDataEntry("Key", "42"));
    TsKvEntryAggWrapper tsKvEntryAggWrapper2 = new TsKvEntryAggWrapper(entry2, 1L);

    // Act and Assert
    assertEquals(tsKvEntryAggWrapper, tsKvEntryAggWrapper2);
    assertEquals(tsKvEntryAggWrapper.hashCode(), tsKvEntryAggWrapper2.hashCode());
  }
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    // Arrange
    BasicTsKvEntry entry = new BasicTsKvEntry(3L, new JsonDataEntry("Key", "42"));
    TsKvEntryAggWrapper tsKvEntryAggWrapper = new TsKvEntryAggWrapper(entry, 1L);
    BasicTsKvEntry entry2 = new BasicTsKvEntry(1L, new JsonDataEntry("Key", "42"));

    // Act and Assert
    assertNotEquals(tsKvEntryAggWrapper, new TsKvEntryAggWrapper(entry2, 1L));
  }
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    ...
    // Act and Assert
    assertNotEquals(tsKvEntryAggWrapper, new TsKvEntryAggWrapper(entry, 1L));
  }
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual3() {
    // Arrange
    BasicTsKvEntry entry = new BasicTsKvEntry(1L, new JsonDataEntry("Key", "42"));
    TsKvEntryAggWrapper tsKvEntryAggWrapper = new TsKvEntryAggWrapper(entry, 3L);
    BasicTsKvEntry entry2 = new BasicTsKvEntry(1L, new JsonDataEntry("Key", "42"));
  ...
  void testEquals_whenOtherIsNull_thenReturnNotEqual() {
    ...
    // Act and Assert
    assertNotEquals(new TsKvEntryAggWrapper(entry, 1L), null);
  }
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    ...
    // Act and Assert
    assertNotEquals(new TsKvEntryAggWrapper(entry, 1L), "Different type to TsKvEntryAggWrapper");
  }
