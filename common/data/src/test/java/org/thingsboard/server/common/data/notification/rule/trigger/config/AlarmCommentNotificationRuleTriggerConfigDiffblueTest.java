...
class AlarmCommentNotificationRuleTriggerConfigDiffblueTest {
  ...
  void testAlarmCommentNotificationRuleTriggerConfigBuilderBuild() {
    // Arrange and Act
    AlarmCommentNotificationRuleTriggerConfigBuilder actualBuilderResult =
        AlarmCommentNotificationRuleTriggerConfig.builder();
    HashSet<AlarmSeverity> alarmSeverities = new HashSet<>();
    AlarmCommentNotificationRuleTriggerConfigBuilder actualAlarmSeveritiesResult =
        actualBuilderResult.alarmSeverities(alarmSeverities);
    HashSet<AlarmSearchStatus> alarmStatuses = new HashSet<>();
    AlarmCommentNotificationRuleTriggerConfigBuilder actualAlarmStatusesResult =
    ...
    // Assert
    assertEquals("#", actualAlarmCommentNotificationRuleTriggerConfig.getDeduplicationKey());
    assertEquals(
    ...
    Set<String> alarmTypes2 = actualAlarmCommentNotificationRuleTriggerConfig.getAlarmTypes();
    assertTrue(alarmTypes2.isEmpty());
    assertTrue(actualAlarmCommentNotificationRuleTriggerConfig.isNotifyOnCommentUpdate());
    assertTrue(actualAlarmCommentNotificationRuleTriggerConfig.isOnlyUserComments());
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    AlarmCommentNotificationRuleTriggerConfig alarmCommentNotificationRuleTriggerConfig2 =
    ...
    assertEquals(
        alarmCommentNotificationRuleTriggerConfig.hashCode(),
        alarmCommentNotificationRuleTriggerConfig2.hashCode());
  }
  ...
  void testEqualsAndHashCode_whenOtherIsSame_thenReturnEqual() {
    ...
    assertEquals(
        alarmCommentNotificationRuleTriggerConfig, alarmCommentNotificationRuleTriggerConfig);
    int expectedHashCodeResult = alarmCommentNotificationRuleTriggerConfig.hashCode();
    assertEquals(expectedHashCodeResult, alarmCommentNotificationRuleTriggerConfig.hashCode());
  }
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    ...
    AlarmCommentNotificationRuleTriggerConfigBuilder alarmSeveritiesResult =
        AlarmCommentNotificationRuleTriggerConfig.builder().alarmSeverities(alarmSeverities);
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    ...
    assertNotEquals(
        alarmStatusesResult
            ...
            .onlyUserComments(true)
            .build(),
        "Different type to AlarmCommentNotificationRuleTriggerConfig");
  }
