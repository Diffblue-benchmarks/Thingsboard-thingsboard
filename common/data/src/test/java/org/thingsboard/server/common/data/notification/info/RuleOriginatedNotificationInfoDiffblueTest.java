...
class RuleOriginatedNotificationInfoDiffblueTest {
   ...
   * <p>
   * Method under test: {@link RuleOriginatedNotificationInfo#getAffectedCustomerId()}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"org.thingsboard.server.common.data.id.UserId RuleOriginatedNotificationInfo.getAffectedUserId()"})
   ...
   * <p>
   * Method under test: {@link RuleOriginatedNotificationInfo#getAffectedTenantId()}
   */
  @Test
