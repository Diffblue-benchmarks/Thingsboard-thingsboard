...
class RepositorySettingsDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(repositorySettings.hashCode(), repositorySettings2.hashCode());
  }
  ...
  void testNewRepositorySettings_givenTrue_whenRepositorySettingsReadOnlyIsTrue() {
    ...
    // Act
    RepositorySettings actualRepositorySettings = new RepositorySettings(settings);

    // Assert
    assertEquals(settings, actualRepositorySettings);
  }
