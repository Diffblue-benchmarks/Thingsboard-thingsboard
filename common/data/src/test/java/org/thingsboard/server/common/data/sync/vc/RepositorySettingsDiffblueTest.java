...
class RepositorySettingsDiffblueTest {
  /**
   * Test {@link RepositorySettings#equals(Object)}, and
   * {@link RepositorySettings#hashCode()}.
   * <ul>
   ...
   *   <li>When {@link RepositorySettings#RepositorySettings()} ReadOnly is
   * {@code true}.</li>
   * </ul>
   * <p>
   * Method under test:
   ...
   */
  @Test
  @DisplayName("Test new RepositorySettings(RepositorySettings); given 'true'; when RepositorySettings() ReadOnly is 'true'")
   ...
   */
  @Test
  @DisplayName("Test new RepositorySettings(RepositorySettings); when RepositorySettings(); then return RepositorySettings()")
