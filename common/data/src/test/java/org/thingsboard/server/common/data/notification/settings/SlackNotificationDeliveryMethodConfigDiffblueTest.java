...
class SlackNotificationDeliveryMethodConfigDiffblueTest {
  /**
   * Test {@link SlackNotificationDeliveryMethodConfig#equals(Object)}, and {@link
   * SlackNotificationDeliveryMethodConfig#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean SlackNotificationDeliveryMethodConfig.equals(Object)",
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    SlackNotificationDeliveryMethodConfig slackNotificationDeliveryMethodConfig =
        new SlackNotificationDeliveryMethodConfig();
    slackNotificationDeliveryMethodConfig.setBotToken("ABC123");

    SlackNotificationDeliveryMethodConfig slackNotificationDeliveryMethodConfig2 =
        new SlackNotificationDeliveryMethodConfig();
    ...
    assertEquals(
        slackNotificationDeliveryMethodConfig.hashCode(),
        slackNotificationDeliveryMethodConfig2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link SlackNotificationDeliveryMethodConfig#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    ...
    assertNotEquals(
        ...
        "Different type to SlackNotificationDeliveryMethodConfig");
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void SlackNotificationDeliveryMethodConfig.<init>()",
  ...
  void testGettersAndSetters() {
    // Arrange and Act
    SlackNotificationDeliveryMethodConfig actualSlackNotificationDeliveryMethodConfig =
        new SlackNotificationDeliveryMethodConfig();
    ...
    assertEquals(
        NotificationDeliveryMethod.SLACK, actualSlackNotificationDeliveryMethodConfig.getMethod());
  }
}
