...
class TestSmsRequestDiffblueTest {
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void TestSmsRequest.<init>()", "String TestSmsRequest.getMessage()",
      "String TestSmsRequest.getNumberTo()", "SmsProviderConfiguration TestSmsRequest.getProviderConfiguration()",
      "void TestSmsRequest.setMessage(String)", "void TestSmsRequest.setNumberTo(String)",
      "void TestSmsRequest.setProviderConfiguration(SmsProviderConfiguration)", "String TestSmsRequest.toString()"})
