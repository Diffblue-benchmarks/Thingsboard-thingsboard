...
class ImageDescriptorDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    previewDescriptor4.setMediaType("text/plain");
    ...
    previewDescriptor5.setMediaType("text/plain");
    ...
    previewDescriptor6.setMediaType("text/plain");
    ...
    previewDescriptor7.setMediaType("text/plain");
    ...
    previewDescriptor8.setMediaType("text/plain");
    ...
    imageDescriptor2.setMediaType("text/plain");
    ...
    assertEquals(imageDescriptor.hashCode(), imageDescriptor2.hashCode());
  }
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    ...
    ImageDescriptor imageDescriptor = new ImageDescriptor();
    imageDescriptor.setEtag("text/plain");
    imageDescriptor.setHeight(1);
    imageDescriptor.setMediaType("text/plain");
    imageDescriptor.setPreviewDescriptor(previewDescriptor4);
    imageDescriptor.setSize(3L);
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual4() {
    ...
    imageDescriptor.setEtag("Etag");
    imageDescriptor.setHeight(1);
    imageDescriptor.setMediaType("text/html");
    imageDescriptor.setPreviewDescriptor(previewDescriptor4);
    imageDescriptor.setSize(3L);
    imageDescriptor.setWidth(1);
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual6() {
    ...
    ImageDescriptor previewDescriptor4 = new ImageDescriptor();
    previewDescriptor4.setEtag("text/plain");
    previewDescriptor4.setHeight(1);
    previewDescriptor4.setMediaType("text/plain");
    previewDescriptor4.setPreviewDescriptor(previewDescriptor3);
    previewDescriptor4.setSize(3L);
  ...
  void testGettersAndSetters() {
    ...
    actualImageDescriptor.setMediaType("text/plain");
    ImageDescriptor previewDescriptor = new ImageDescriptor();
    previewDescriptor.setEtag("Etag");
    previewDescriptor.setHeight(1);
    previewDescriptor.setMediaType("text/plain");
    ...
    assertEquals(
        "ImageDescriptor(mediaType=text/plain, width=1, height=1, size=3, etag=Etag, previewDescriptor"
            + "=ImageDescriptor(mediaType=text/plain, width=1, height=1, size=3, etag=Etag, previewDescriptor"
            + "=ImageDescriptor(mediaType=text/plain, width=1, height=1, size=3, etag=Etag, previewDescriptor"
            + "=ImageDescriptor(mediaType=text/plain, width=1, height=1, size=3, etag=Etag, previewDescriptor"
            + "=ImageDescriptor(mediaType=text/plain, width=1, height=1, size=3, etag=Etag, previewDescriptor"
