...
class AbstractLwM2MBootstrapClientCredentialWithKeysDiffblueTest {
   ...
   * AbstractLwM2MBootstrapClientCredentialWithKeys#getDecodedClientPublicKeyOrId()}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "byte[] AbstractLwM2MBootstrapClientCredentialWithKeys.getDecodedClientPublicKeyOrId()"
  })
  void testGetDecodedClientPublicKeyOrId() {
    ...
    // Act and Assert
    assertArrayEquals(
        new byte[] {-29, '`', -91, -119, -23, -19, '>', -26, -27, -119, -62, -98, -56, -22, -56},
   ...
   *
   * <ul>
   *   <li>Then return array of {@code byte} with lf and {@code X}.
   * </ul>
   *
   * <p>Method under test: {@link
   * AbstractLwM2MBootstrapClientCredentialWithKeys#getDecodedClientPublicKeyOrId()}
  ...
  @Test
  @DisplayName(
      "Test getDecodedClientPublicKeyOrId(); then return array of byte with minus twenty-nine")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "byte[] AbstractLwM2MBootstrapClientCredentialWithKeys.getDecodedClientPublicKeyOrId()"
  ...
  void testGetDecodedClientPublicKeyOrId_thenReturnArrayOfByteWithMinusTwentyNine() {
    ...
    // Act and Assert
    assertArrayEquals(
        new byte[] {-29}, pskBootstrapClientCredential.getDecodedClientPublicKeyOrId());
  }
  ...
  @Test
  @DisplayName(
      "Test getDecodedClientPublicKeyOrId(); then return array of byte with minus twenty-nine and 'n'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "byte[] AbstractLwM2MBootstrapClientCredentialWithKeys.getDecodedClientPublicKeyOrId()"
  ...
  void testGetDecodedClientPublicKeyOrId_thenReturnArrayOfByteWithMinusTwentyNineAndN() {
    ...
    // Act and Assert
    assertArrayEquals(
        new byte[] {-29, 'n', '6'}, pskBootstrapClientCredential.getDecodedClientPublicKeyOrId());
  }
   ...
   *
   * <p>Method under test: {@link
   * AbstractLwM2MBootstrapClientCredentialWithKeys#getDecodedClientSecretKey()}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "byte[] AbstractLwM2MBootstrapClientCredentialWithKeys.getDecodedClientSecretKey()"
  })
   ...
   *
   * <ul>
   *   <li>Then return array of {@code byte} with seventeen and {@code p}.
   * </ul>
   *
   * <p>Method under test: {@link
   * AbstractLwM2MBootstrapClientCredentialWithKeys#getDecodedClientSecretKey()}
   ...
   *
   * <p>Method under test: {@link
   * AbstractLwM2MBootstrapClientCredentialWithKeys#getClientPublicKeyOrId()}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "String AbstractLwM2MBootstrapClientCredentialWithKeys.getClientPublicKeyOrId()"
  })
   ...
   *
   * <p>Method under test: {@link
   * AbstractLwM2MBootstrapClientCredentialWithKeys#getClientSecretKey()}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link
   * AbstractLwM2MBootstrapClientCredentialWithKeys#setClientPublicKeyOrId(String)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void AbstractLwM2MBootstrapClientCredentialWithKeys.setClientPublicKeyOrId(String)"
  })
   ...
   *
   * <p>Method under test: {@link
   * AbstractLwM2MBootstrapClientCredentialWithKeys#setClientSecretKey(String)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void AbstractLwM2MBootstrapClientCredentialWithKeys.setClientSecretKey(String)"
  })
  void testSetClientSecretKey() {
    ...
    assertEquals(
        ...
        pskBootstrapClientCredential.getClientSecretKey());
    assertArrayEquals(
        new byte[] {
          17, 'p', '\f', '<', -79, '\n', 17, -116, '#', 'j', 'Z', -41, 'R', -39, -59, 16, -62, '?',
          '+', -77, 3, 16, -47, -65, 'l', -4, 'Q', '~', ' ', -104
