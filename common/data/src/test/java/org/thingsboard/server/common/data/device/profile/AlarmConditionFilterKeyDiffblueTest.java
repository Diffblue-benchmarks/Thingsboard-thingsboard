...
class AlarmConditionFilterKeyDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    AlarmConditionFilterKey alarmConditionFilterKey = new AlarmConditionFilterKey(AlarmConditionKeyType.ATTRIBUTE,
        "Key");
    AlarmConditionFilterKey alarmConditionFilterKey2 = new AlarmConditionFilterKey(AlarmConditionKeyType.ATTRIBUTE,
        "Key");

    // Act and Assert
    assertEquals(alarmConditionFilterKey, alarmConditionFilterKey2);
    int expectedHashCodeResult = alarmConditionFilterKey.hashCode();
    assertEquals(expectedHashCodeResult, alarmConditionFilterKey2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link AlarmConditionFilterKey#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    ...
    // Act and Assert
    assertNotEquals(alarmConditionFilterKey, new AlarmConditionFilterKey(AlarmConditionKeyType.ATTRIBUTE, "Key"));
  }
