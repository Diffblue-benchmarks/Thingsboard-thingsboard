...
class EntityDataInfoDiffblueTest {
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void EntityDataInfo.<init>()", "void EntityDataInfo.<init>(boolean, boolean, boolean)",
      "boolean EntityDataInfo.isHasAttributes()", "boolean EntityDataInfo.isHasCredentials()",
      "boolean EntityDataInfo.isHasRelations()", "void EntityDataInfo.setHasAttributes(boolean)",
      "void EntityDataInfo.setHasCredentials(boolean)", "void EntityDataInfo.setHasRelations(boolean)",
