...
class ErrorEventDiffblueTest {
  ...
  void testErrorEventBuilderBuild() {
    // Arrange and Act
    ErrorEventBuilder actualBuilderResult = ErrorEvent.builder();
    UUID entityId = UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9");
    ErrorEventBuilder actualErrorResult =
    ...
    UUID entityId2 = actualErrorEvent.getEntityId();
    assertEquals("784f394c-42b6-435a-983c-b7beff2784f9", entityId2.toString());
    UUID uuidId = actualErrorEvent.getUuidId();
