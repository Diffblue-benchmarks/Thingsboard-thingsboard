...
class ErrorEventDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link ErrorEvent#toInfo(EntityType)}
   */
  @Test
  ...
  void testToInfo_whenAlarm_thenEntityIdReturnAlarmId() {
    // Arrange
    ErrorEventBuilder builderResult = ErrorEvent.builder();
    ErrorEventBuilder errorResult = builderResult.entityId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"))
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    ErrorEventBuilder errorResult2 = builderResult2.entityId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"))
        .error("An error occurred");
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    ...
    ErrorEventBuilder errorResult = errorEventBuilder.entityId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"))
        .error("An error occurred");
    ErrorEvent buildResult = errorResult.id(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"))
        .method("Method")
        .serviceId("42")
        ...
        .build();
    ErrorEventBuilder builderResult = ErrorEvent.builder();
    ErrorEventBuilder errorResult2 = builderResult.entityId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"))
        .error("An error occurred");
    ErrorEvent buildResult2 = errorResult2.id(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"))
        .method("Method")
        .serviceId("42")
