...
class EntityTypeLoadResultDiffblueTest {
  @Autowired
  private EntityTypeLoadResultBuilder entityTypeLoadResultBuilder;
  ...
  @MethodsUnderTest({"void EntityTypeLoadResultBuilder.<init>()",
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean EntityTypeLoadResult.equals(Object)", "int EntityTypeLoadResult.hashCode()"})
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    // Arrange
    EntityTypeLoadResultBuilder entityTypeLoadResultBuilder = mock(EntityTypeLoadResultBuilder.class);
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void EntityTypeLoadResult.<init>()", "void EntityTypeLoadResult.<init>(EntityType)",
      "void EntityTypeLoadResult.<init>(EntityType, int, int, int)", "int EntityTypeLoadResult.getCreated()",
      "int EntityTypeLoadResult.getDeleted()", "EntityType EntityTypeLoadResult.getEntityType()",
      "int EntityTypeLoadResult.getUpdated()", "void EntityTypeLoadResult.setCreated(int)",
      "void EntityTypeLoadResult.setDeleted(int)", "void EntityTypeLoadResult.setEntityType(EntityType)",
      "void EntityTypeLoadResult.setUpdated(int)", "String EntityTypeLoadResult.toString()"})
