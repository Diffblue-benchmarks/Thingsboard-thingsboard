...
class VersionLoadConfigDiffblueTest {
  ...
  @MethodsUnderTest({"boolean VersionLoadConfig.equals(Object)", "int VersionLoadConfig.hashCode()"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void VersionLoadConfig.<init>()", "boolean VersionLoadConfig.isLoadAttributes()",
      "boolean VersionLoadConfig.isLoadCredentials()", "boolean VersionLoadConfig.isLoadRelations()",
      "void VersionLoadConfig.setLoadAttributes(boolean)", "void VersionLoadConfig.setLoadCredentials(boolean)",
      "void VersionLoadConfig.setLoadRelations(boolean)", "String VersionLoadConfig.toString()"})
