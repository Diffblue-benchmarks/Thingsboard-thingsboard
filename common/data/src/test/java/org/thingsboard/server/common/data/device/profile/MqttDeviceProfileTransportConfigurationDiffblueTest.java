...
class MqttDeviceProfileTransportConfigurationDiffblueTest {
   ...
   * MqttDeviceProfileTransportConfiguration#getTransportPayloadTypeConfiguration()}
   */
  @Test
  ...
  void testGetTransportPayloadTypeConfiguration() {
    ...
    TransportPayloadTypeConfiguration actualTransportPayloadTypeConfiguration =
        new MqttDeviceProfileTransportConfiguration().getTransportPayloadTypeConfiguration();
   ...
   *
   * <p>Method under test: {@link MqttDeviceProfileTransportConfiguration#getDeviceTelemetryTopic()}
   */
  @Test
  ...
  void testGetDeviceTelemetryTopic() {
    ...
    assertEquals(
        ...
        mqttDeviceProfileTransportConfiguration.getDeviceTelemetryTopic());
  }
   ...
   *
   * <ul>
   *   <li>Given {@link MqttDeviceProfileTransportConfiguration} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link MqttDeviceProfileTransportConfiguration#getDeviceTelemetryTopic()}
   */
  @Test
  @DisplayName(
      "Test getDeviceTelemetryTopic(); given MqttDeviceProfileTransportConfiguration (default constructor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String MqttDeviceProfileTransportConfiguration.getDeviceTelemetryTopic()"})
  ...
  @Test
  @DisplayName(
      "Test getDeviceAttributesTopic(); given MqttDeviceProfileTransportConfiguration (default constructor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String MqttDeviceProfileTransportConfiguration.getDeviceAttributesTopic()"})
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "String MqttDeviceProfileTransportConfiguration.getDeviceAttributesSubscribeTopic()"
  })
  ...
  /**
   * Test {@link MqttDeviceProfileTransportConfiguration#equals(Object)}, and {@link
   * MqttDeviceProfileTransportConfiguration#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean MqttDeviceProfileTransportConfiguration.equals(Object)",
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    MqttDeviceProfileTransportConfiguration mqttDeviceProfileTransportConfiguration =
        new MqttDeviceProfileTransportConfiguration();
    MqttDeviceProfileTransportConfiguration mqttDeviceProfileTransportConfiguration2 =
        new MqttDeviceProfileTransportConfiguration();
    ...
    assertEquals(
        mqttDeviceProfileTransportConfiguration.hashCode(),
        mqttDeviceProfileTransportConfiguration2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link MqttDeviceProfileTransportConfiguration#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    ...
    // Act and Assert
    assertNotEquals(
        mqttDeviceProfileTransportConfiguration, new JsonTransportPayloadConfiguration());
  }
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    ...
    // Act and Assert
    assertNotEquals(
        mqttDeviceProfileTransportConfiguration, new MqttDeviceProfileTransportConfiguration());
  }
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual4() {
    ...
    MqttDeviceProfileTransportConfiguration mqttDeviceProfileTransportConfiguration =
        new MqttDeviceProfileTransportConfiguration();
    mqttDeviceProfileTransportConfiguration.setTransportPayloadTypeConfiguration(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void MqttDeviceProfileTransportConfiguration.<init>()",
  ...
  void testGettersAndSetters() {
    // Arrange and Act
    MqttDeviceProfileTransportConfiguration actualMqttDeviceProfileTransportConfiguration =
        new MqttDeviceProfileTransportConfiguration();
    actualMqttDeviceProfileTransportConfiguration.setDeviceAttributesSubscribeTopic(
        "Device Attributes Subscribe Topic");
    actualMqttDeviceProfileTransportConfiguration.setDeviceAttributesTopic(
    ...
    actualMqttDeviceProfileTransportConfiguration.setSparkplugAttributesMetricNames(
        sparkplugAttributesMetricNames);
    actualMqttDeviceProfileTransportConfiguration.setTransportPayloadTypeConfiguration(
        mock(TransportPayloadTypeConfiguration.class));
    actualMqttDeviceProfileTransportConfiguration.toString();
    Set<String> actualSparkplugAttributesMetricNames =
        actualMqttDeviceProfileTransportConfiguration.getSparkplugAttributesMetricNames();
    DeviceTransportType actualType = actualMqttDeviceProfileTransportConfiguration.getType();
    boolean actualIsSendAckOnValidationExceptionResult =
        actualMqttDeviceProfileTransportConfiguration.isSendAckOnValidationException();
