...
class AndroidConfigDiffblueTest {
  @Autowired
  private AndroidConfigBuilder androidConfigBuilder;
  ...
  @MethodsUnderTest({"void AndroidConfigBuilder.<init>()",
      "AndroidConfigBuilder AndroidConfigBuilder.appPackage(String)", "AndroidConfig AndroidConfigBuilder.build()",
      ...
      "AndroidConfigBuilder AndroidConfigBuilder.storeLink(String)", "String AndroidConfigBuilder.toString()"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AndroidConfig.<init>()", "void AndroidConfig.<init>(boolean, String, String, String)",
      "String AndroidConfig.getAppPackage()", "String AndroidConfig.getSha256CertFingerprints()",
      "String AndroidConfig.getStoreLink()", "boolean AndroidConfig.isEnabled()",
      "void AndroidConfig.setAppPackage(String)", "void AndroidConfig.setEnabled(boolean)",
      "void AndroidConfig.setSha256CertFingerprints(String)", "void AndroidConfig.setStoreLink(String)",
