...
class DictionaryParserDiffblueTest {
   ...
   * <ul>
   *   <li>Then return KeyByKeyId is {@code 42} is {@code null}.</li>
   * </ul>
   * <p>
   * Method under test: {@link DictionaryParser#DictionaryParser(File)}
   */
  @Test
  ...
  void testNewDictionaryParser_thenReturnKeyByKeyIdIs42IsNull() throws IOException {
    ...
    assertNull((new DictionaryParser(Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile()))
        .getKeyByKeyId("42"));
  }
   ...
   * <p>
   * Method under test: {@link DictionaryParser#getKeyByKeyId(String)}
   */
  @Test
