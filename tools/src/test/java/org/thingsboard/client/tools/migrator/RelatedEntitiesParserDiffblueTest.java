...
class RelatedEntitiesParserDiffblueTest {
   ...
   *
   * <p>Method under test: {@link RelatedEntitiesParser#RelatedEntitiesParser(File)}
   */
  @Test
  @DisplayName("Test new RelatedEntitiesParser(File)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void RelatedEntitiesParser.<init>(File)"})
  void testNewRelatedEntitiesParser() throws IOException {
    // Arrange, Act and Assert
    assertNull(
        new RelatedEntitiesParser(
   ...
   *
   * <p>Method under test: {@link RelatedEntitiesParser#getEntityType(String)}
   */
  @Test
  @DisplayName("Test getEntityType(String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String RelatedEntitiesParser.getEntityType(String)"})
