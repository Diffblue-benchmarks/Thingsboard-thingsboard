...
class BaseRuleChainMsgConstructorDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test constructRuleChainDeleteMsg(RuleChainId); then return IdLSB is '-7476899250389416711'")
  ...
  void testConstructRuleChainDeleteMsg_thenReturnIdLSBIs7476899250389416711() {
    ...
    RuleChainUpdateMsg defaultInstanceForType =
        actualConstructRuleChainDeleteMsgResult.getDefaultInstanceForType();
   ...
   *
   * <ul>
   *   <li>When {@link RuleChainId#RuleChainId(UUID)} with id is randomUUID.
   * </ul>
   *
   * <p>Method under test: {@link
   * BaseRuleChainMsgConstructor#constructRuleChainDeleteMsg(RuleChainId)}
  ...
  @Test
  @DisplayName(
      "Test constructRuleChainDeleteMsg(RuleChainId); when RuleChainId(UUID) with id is randomUUID")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "RuleChainUpdateMsg BaseRuleChainMsgConstructor.constructRuleChainDeleteMsg(RuleChainId)"
  })
  void testConstructRuleChainDeleteMsg_whenRuleChainIdWithIdIsRandomUUID() {
    ...
    // Act
    RuleChainUpdateMsg actualConstructRuleChainDeleteMsgResult =
        ruleChainMsgConstructorV1.constructRuleChainDeleteMsg(new RuleChainId(UUID.randomUUID()));
  ...
  /**
   * Test {@link BaseRuleChainMsgConstructor#constructRuleChainMetadataUpdatedMsg(TenantId,
   * UpdateMsgType, RuleChainMetaData, EdgeVersion)}.
   *
   * <p>Method under test: {@link
   * BaseRuleChainMsgConstructor#constructRuleChainMetadataUpdatedMsg(TenantId, UpdateMsgType,
   * RuleChainMetaData, EdgeVersion)}
   */
  @Test
  @DisplayName(
      "Test constructRuleChainMetadataUpdatedMsg(TenantId, UpdateMsgType, RuleChainMetaData, EdgeVersion)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testConstructRuleChainMetadataUpdatedMsg() {
    ...
    assertEquals(
        1,
        actualConstructRuleChainMetadataUpdatedMsgResult
  ...
  void testConstructRuleChainMetadataUpdatedMsg2() {
    ...
    UnknownFieldSet unknownFields =
        actualConstructRuleChainMetadataUpdatedMsgResult.getUnknownFields();
    RuleChainMetadataUpdateMsg defaultInstanceForType =
        actualConstructRuleChainMetadataUpdatedMsgResult.getDefaultInstanceForType();
    assertSame(unknownFields, defaultInstanceForType.getUnknownFields());
    assertSame(unknownFields, unknownFields.getDefaultInstanceForType());
    assertSame(
        defaultInstanceForType.getDefaultInstanceForType(),
   ...
   *
   * <ul>
   *   <li>Then return ConnectionsList size is one.
   * </ul>
   *
   * <p>Method under test: {@link
   * BaseRuleChainMsgConstructor#constructRuleChainMetadataUpdatedMsg(TenantId, UpdateMsgType,
  ...
  @Test
  @DisplayName(
      "Test constructRuleChainMetadataUpdatedMsg(TenantId, UpdateMsgType, RuleChainMetaData, EdgeVersion); then return ConnectionsList size is one")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "RuleChainMetadataUpdateMsg BaseRuleChainMsgConstructor.constructRuleChainMetadataUpdatedMsg(TenantId, UpdateMsgType, RuleChainMetaData, EdgeVersion)"
  })
  void testConstructRuleChainMetadataUpdatedMsg_thenReturnConnectionsListSizeIsOne() {
    ...
    Descriptor descriptorForType =
        actualConstructRuleChainMetadataUpdatedMsgResult.getDescriptorForType();
  ...
  @Test
  @DisplayName(
      "Test constructRuleChainMetadataUpdatedMsg(TenantId, UpdateMsgType, RuleChainMetaData, EdgeVersion); when 'V_3_6_2'; then return Entity is a string")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "RuleChainMetadataUpdateMsg BaseRuleChainMsgConstructor.constructRuleChainMetadataUpdatedMsg(TenantId, UpdateMsgType, RuleChainMetaData, EdgeVersion)"
  })
