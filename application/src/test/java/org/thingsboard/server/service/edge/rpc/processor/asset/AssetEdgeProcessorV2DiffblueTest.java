...
class AssetEdgeProcessorV2DiffblueTest {
  @InjectMocks private AssetEdgeProcessorV2 assetEdgeProcessorV2;

  /**
   * Test {@link AssetEdgeProcessorV2#setCustomerId(TenantId, CustomerId, Asset, AssetUpdateMsg)}.
   *
   * <p>Method under test: {@link AssetEdgeProcessorV2#setCustomerId(TenantId, CustomerId, Asset,
   * AssetUpdateMsg)}
   */
  @Test
  ...
  @MethodsUnderTest({
    "void AssetEdgeProcessorV2.setCustomerId(TenantId, CustomerId, Asset, AssetUpdateMsg)"
  })
  void testSetCustomerId() {
    ...
    // Act
    assetEdgeProcessorV2.setCustomerId(
