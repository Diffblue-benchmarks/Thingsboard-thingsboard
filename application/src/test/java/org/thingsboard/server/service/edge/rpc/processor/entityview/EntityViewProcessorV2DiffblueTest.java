...
class EntityViewProcessorV2DiffblueTest {
  @InjectMocks private EntityViewProcessorV2 entityViewProcessorV2;

  /**
   * Test {@link EntityViewProcessorV2#setCustomerId(TenantId, CustomerId, EntityView,
   * EntityViewUpdateMsg)}.
   *
   * <p>Method under test: {@link EntityViewProcessorV2#setCustomerId(TenantId, CustomerId,
  ...
  @MethodsUnderTest({
    "void EntityViewProcessorV2.setCustomerId(TenantId, CustomerId, EntityView, EntityViewUpdateMsg)"
  })
  void testSetCustomerId() {
    ...
    // Act
    entityViewProcessorV2.setCustomerId(
