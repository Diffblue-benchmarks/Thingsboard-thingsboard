...
class NotificationMsgConstructorImplDiffblueTest {
  /**
   * Test {@link NotificationMsgConstructorImpl#constructNotificationRuleUpdateMsg(UpdateMsgType, NotificationRule)}.
   * <p>
   * Method under test: {@link NotificationMsgConstructorImpl#constructNotificationRuleUpdateMsg(UpdateMsgType, NotificationRule)}
   */
  @Test
  ...
  void testConstructNotificationRuleUpdateMsg() {
    ...
    NotificationRuleUpdateMsg defaultInstanceForType = actualConstructNotificationRuleUpdateMsgResult
  ...
  /**
   * Test {@link NotificationMsgConstructorImpl#constructNotificationRuleDeleteMsg(NotificationRuleId)}.
   * <ul>
   *   <li>Then return IdLSB is {@code -7476899250389416711}.</li>
   * </ul>
   * <p>
   * Method under test: {@link NotificationMsgConstructorImpl#constructNotificationRuleDeleteMsg(NotificationRuleId)}
   */
  @Test
  @DisplayName("Test constructNotificationRuleDeleteMsg(NotificationRuleId); then return IdLSB is '-7476899250389416711'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testConstructNotificationRuleDeleteMsg_thenReturnIdLSBIs7476899250389416711() {
    ...
    NotificationRuleUpdateMsg actualConstructNotificationRuleDeleteMsgResult = notificationMsgConstructorImpl
        .constructNotificationRuleDeleteMsg(
    ...
    NotificationRuleUpdateMsg defaultInstanceForType = actualConstructNotificationRuleDeleteMsgResult
        .getDefaultInstanceForType();
    assertSame(unknownFields, defaultInstanceForType.getUnknownFields());
    assertSame(unknownFields, unknownFields.getDefaultInstanceForType());
    assertSame(defaultInstanceForType.getDefaultInstanceForType(), defaultInstanceForType.getDefaultInstanceForType());
   ...
   * Test {@link NotificationMsgConstructorImpl#constructNotificationRuleDeleteMsg(NotificationRuleId)}.
   * <ul>
   *   <li>When {@link NotificationRuleId#NotificationRuleId(UUID)} with id is randomUUID.</li>
   * </ul>
   * <p>
   * Method under test: {@link NotificationMsgConstructorImpl#constructNotificationRuleDeleteMsg(NotificationRuleId)}
   */
  ...
  /**
   * Test {@link NotificationMsgConstructorImpl#constructNotificationTargetUpdateMsg(UpdateMsgType, NotificationTarget)}.
   * <ul>
   *   <li>Then return MsgTypeValue is one.</li>
   * </ul>
   * <p>
   * Method under test: {@link NotificationMsgConstructorImpl#constructNotificationTargetUpdateMsg(UpdateMsgType, NotificationTarget)}
   */
  @Test
  ...
  void testConstructNotificationTargetUpdateMsg_thenReturnMsgTypeValueIsOne() {
    ...
    NotificationTargetUpdateMsg defaultInstanceForType = actualConstructNotificationTargetUpdateMsgResult
        .getDefaultInstanceForType();
    assertSame(unknownFields, defaultInstanceForType.getUnknownFields());
    assertSame(unknownFields, unknownFields.getDefaultInstanceForType());
    assertSame(defaultInstanceForType.getDefaultInstanceForType(), defaultInstanceForType.getDefaultInstanceForType());
  ...
  /**
   * Test {@link NotificationMsgConstructorImpl#constructNotificationTargetDeleteMsg(NotificationTargetId)}.
   * <p>
   * Method under test: {@link NotificationMsgConstructorImpl#constructNotificationTargetDeleteMsg(NotificationTargetId)}
   */
  @Test
  ...
  void testConstructNotificationTargetDeleteMsg() {
    ...
    NotificationTargetUpdateMsg defaultInstanceForType = actualConstructNotificationTargetDeleteMsgResult
        .getDefaultInstanceForType();
    assertSame(unknownFields, defaultInstanceForType.getUnknownFields());
    assertSame(unknownFields, unknownFields.getDefaultInstanceForType());
    assertSame(defaultInstanceForType.getDefaultInstanceForType(), defaultInstanceForType.getDefaultInstanceForType());
   ...
   */
  @Test
  @DisplayName("Test constructNotificationTargetDeleteMsg(NotificationTargetId); then return IdLSB is '-7476899250389416711'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "NotificationTargetUpdateMsg NotificationMsgConstructorImpl.constructNotificationTargetDeleteMsg(NotificationTargetId)"})
  void testConstructNotificationTargetDeleteMsg_thenReturnIdLSBIs7476899250389416711() {
    ...
    // Act
    NotificationTargetUpdateMsg actualConstructNotificationTargetDeleteMsgResult = notificationMsgConstructorImpl
        .constructNotificationTargetDeleteMsg(
            new NotificationTargetId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9")));

    // Assert
    assertEquals(-7476899250389416711L, actualConstructNotificationTargetDeleteMsgResult.getIdLSB());
  ...
  /**
   * Test {@link NotificationMsgConstructorImpl#constructNotificationTemplateUpdateMsg(UpdateMsgType, NotificationTemplate)}.
   * <ul>
   *   <li>Then return MsgTypeValue is one.</li>
   * </ul>
   * <p>
   * Method under test: {@link NotificationMsgConstructorImpl#constructNotificationTemplateUpdateMsg(UpdateMsgType, NotificationTemplate)}
   */
  @Test
  ...
  void testConstructNotificationTemplateUpdateMsg_thenReturnMsgTypeValueIsOne() {
    ...
    NotificationTemplateUpdateMsg defaultInstanceForType = actualConstructNotificationTemplateUpdateMsgResult
        .getDefaultInstanceForType();
    assertSame(unknownFields, defaultInstanceForType.getUnknownFields());
    assertSame(unknownFields, unknownFields.getDefaultInstanceForType());
    assertSame(defaultInstanceForType.getDefaultInstanceForType(), defaultInstanceForType.getDefaultInstanceForType());
  ...
  /**
   * Test {@link NotificationMsgConstructorImpl#constructNotificationTemplateDeleteMsg(NotificationTemplateId)}.
   * <p>
   * Method under test: {@link NotificationMsgConstructorImpl#constructNotificationTemplateDeleteMsg(NotificationTemplateId)}
   */
  @Test
  ...
  void testConstructNotificationTemplateDeleteMsg() {
    ...
    NotificationTemplateUpdateMsg defaultInstanceForType = actualConstructNotificationTemplateDeleteMsgResult
        .getDefaultInstanceForType();
    assertSame(unknownFields, defaultInstanceForType.getUnknownFields());
    assertSame(unknownFields, unknownFields.getDefaultInstanceForType());
    assertSame(defaultInstanceForType.getDefaultInstanceForType(), defaultInstanceForType.getDefaultInstanceForType());
   ...
   */
  @Test
  @DisplayName("Test constructNotificationTemplateDeleteMsg(NotificationTemplateId); then return IdLSB is '-7476899250389416711'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "NotificationTemplateUpdateMsg NotificationMsgConstructorImpl.constructNotificationTemplateDeleteMsg(NotificationTemplateId)"})
  void testConstructNotificationTemplateDeleteMsg_thenReturnIdLSBIs7476899250389416711() {
    ...
    // Act
    NotificationTemplateUpdateMsg actualConstructNotificationTemplateDeleteMsgResult = notificationMsgConstructorImpl
        .constructNotificationTemplateDeleteMsg(
            new NotificationTemplateId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9")));

    // Assert
    assertEquals(-7476899250389416711L, actualConstructNotificationTemplateDeleteMsgResult.getIdLSB());
    assertEquals(23, actualConstructNotificationTemplateDeleteMsgResult.getSerializedSize());
    assertEquals(8669210807411032922L, actualConstructNotificationTemplateDeleteMsgResult.getIdMSB());
    UnknownFieldSet unknownFields = actualConstructNotificationTemplateDeleteMsgResult.getUnknownFields();
    NotificationTemplateUpdateMsg defaultInstanceForType = actualConstructNotificationTemplateDeleteMsgResult
        .getDefaultInstanceForType();
    assertSame(unknownFields, defaultInstanceForType.getUnknownFields());
