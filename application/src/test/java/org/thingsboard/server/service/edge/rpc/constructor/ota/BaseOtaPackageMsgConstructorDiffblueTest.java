...
class BaseOtaPackageMsgConstructorDiffblueTest {
  /**
   * Test
   * {@link BaseOtaPackageMsgConstructor#constructOtaPackageDeleteMsg(OtaPackageId)}.
   * <ul>
   ...
   */
  @Test
  @DisplayName("Test constructOtaPackageDeleteMsg(OtaPackageId); given randomUUID; then calls getId()")
  void testConstructOtaPackageDeleteMsg_givenRandomUUID_thenCallsGetId() {
    ...
    when(otaPackageId.getId()).thenReturn(UUID.randomUUID());

    // Act
    OtaPackageUpdateMsg actualConstructOtaPackageDeleteMsgResult = otaPackageMsgConstructorV1
        .constructOtaPackageDeleteMsg(otaPackageId);

    // Assert
    verify(otaPackageId, atLeast(1)).getId();
    Descriptors.Descriptor descriptorForType = actualConstructOtaPackageDeleteMsgResult.getDescriptorForType();
    ...
    OtaPackageUpdateMsg defaultInstanceForType3 = actualConstructOtaPackageDeleteMsgResult.getDefaultInstanceForType();
    assertSame(descriptorForType, defaultInstanceForType3.getDescriptorForType());
    UnknownFieldSet unknownFields = actualConstructOtaPackageDeleteMsgResult.getUnknownFields();
    ...
    ByteString expectedData = actualConstructOtaPackageDeleteMsgResult.getData();
    assertSame(expectedData, defaultInstanceForType3.getData());
   ...
   * {@link BaseOtaPackageMsgConstructor#constructOtaPackageDeleteMsg(OtaPackageId)}.
   * <ul>
   *   <li>When {@link OtaPackageId#OtaPackageId(UUID)} with id is randomUUID.</li>
   * </ul>
   * <p>
   * Method under test:
   * {@link BaseOtaPackageMsgConstructor#constructOtaPackageDeleteMsg(OtaPackageId)}
   */
  @Test
  @DisplayName("Test constructOtaPackageDeleteMsg(OtaPackageId); when OtaPackageId(UUID) with id is randomUUID")
  void testConstructOtaPackageDeleteMsg_whenOtaPackageIdWithIdIsRandomUUID() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    ...
    // Act
    OtaPackageUpdateMsg actualConstructOtaPackageDeleteMsgResult = otaPackageMsgConstructorV1
        .constructOtaPackageDeleteMsg(new OtaPackageId(UUID.randomUUID()));
