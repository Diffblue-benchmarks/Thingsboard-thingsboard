...
class BaseUserMsgConstructorDiffblueTest {
   ...
   * <p>
   * Method under test:
   * {@link BaseUserMsgConstructor#constructUserDeleteMsg(UserId)}
   */
  @Test
  @DisplayName("Test constructUserDeleteMsg(UserId); given randomUUID; then calls getId()")
  void testConstructUserDeleteMsg_givenRandomUUID_thenCallsGetId() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.

    // Arrange
    UserMsgConstructorV1 userMsgConstructorV1 = new UserMsgConstructorV1();
    UserId userId = mock(UserId.class);
    when(userId.getId()).thenReturn(UUID.randomUUID());

    // Act
    UserUpdateMsg actualConstructUserDeleteMsgResult = userMsgConstructorV1.constructUserDeleteMsg(userId);

    // Assert
    verify(userId, atLeast(1)).getId();
    Descriptors.Descriptor descriptorForType = actualConstructUserDeleteMsgResult.getDescriptorForType();
    ...
    UserUpdateMsg defaultInstanceForType3 = actualConstructUserDeleteMsgResult.getDefaultInstanceForType();
    assertSame(descriptorForType, defaultInstanceForType3.getDescriptorForType());
    UnknownFieldSet unknownFields = actualConstructUserDeleteMsgResult.getUnknownFields();
   ...
   */
  @Test
  @DisplayName("Test constructUserDeleteMsg(UserId); when UserId(UUID) with id is randomUUID")
  void testConstructUserDeleteMsg_whenUserIdWithIdIsRandomUUID() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    ...
    UserUpdateMsg actualConstructUserDeleteMsgResult = userMsgConstructorV1
        .constructUserDeleteMsg(new UserId(UUID.randomUUID()));
