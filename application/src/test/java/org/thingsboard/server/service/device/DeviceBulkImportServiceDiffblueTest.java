...
class DeviceBulkImportServiceDiffblueTest {
  @InjectMocks
  private DeviceBulkImportService deviceBulkImportService;

  /**
   * Test {@link DeviceBulkImportService#setEntityFields(Device, Map)} with {@code Device}, {@code Map}.
   * <ul>
   *   <li>Given Instance.</li>
   * </ul>
   * <p>
   * Method under test: {@link DeviceBulkImportService#setEntityFields(Device, Map)}
   */
  @Test
   ...
   * Test {@link DeviceBulkImportService#setEntityFields(Device, Map)} with {@code Device}, {@code Map}.
   * <ul>
   *   <li>Given {@code SHARED_ATTRIBUTE}.</li>
   * </ul>
   * <p>
   * Method under test: {@link DeviceBulkImportService#setEntityFields(Device, Map)}
   */
  @Test
  @DisplayName("Test setEntityFields(Device, Map) with 'Device', 'Map'; given 'SHARED_ATTRIBUTE'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void DeviceBulkImportService.setEntityFields(Device, Map)"})
  void testSetEntityFieldsWithDeviceMap_givenSharedAttribute() {
    // Arrange
   ...
   */
  @Test
  @DisplayName("Test setEntityFields(Device, Map) with 'Device', 'Map'; then calls setAdditionalInfo(JsonNode)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void DeviceBulkImportService.setEntityFields(Device, Map)"})
   ...
   */
  @Test
  @DisplayName("Test setEntityFields(Device, Map) with 'Device', 'Map'; then throw DeviceCredentialsValidationException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void DeviceBulkImportService.setEntityFields(Device, Map)"})
  void testSetEntityFieldsWithDeviceMap_thenThrowDeviceCredentialsValidationException() {
    // Arrange
    JsonNode jsonNode = mock(JsonNode.class);
    when(jsonNode.isNull()).thenReturn(true);
    Device device = mock(Device.class);
    doThrow(new DeviceCredentialsValidationException("An error occurred")).when(device).setLabel(Mockito.<String>any());
    when(device.getAdditionalInfo()).thenReturn(jsonNode);
   ...
   */
  @Test
  @DisplayName("Test setEntityFields(Device, Map) with 'Device', 'Map'; when HashMap(); then calls isNull()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void DeviceBulkImportService.setEntityFields(Device, Map)"})
  ...
  /**
   * Test {@link DeviceBulkImportService#setOwners(Device, SecurityUser)} with {@code Device}, {@code SecurityUser}.
   * <ul>
   *   <li>Then calls {@link Device#setCustomerId(CustomerId)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link DeviceBulkImportService#setOwners(Device, SecurityUser)}
   */
  @Test
