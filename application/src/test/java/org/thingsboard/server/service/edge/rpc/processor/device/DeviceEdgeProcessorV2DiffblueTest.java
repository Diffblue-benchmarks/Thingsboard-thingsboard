...
class DeviceEdgeProcessorV2DiffblueTest {
  @InjectMocks private DeviceEdgeProcessorV2 deviceEdgeProcessorV2;

  /**
   * Test {@link DeviceEdgeProcessorV2#setCustomerId(TenantId, CustomerId, Device,
   * DeviceUpdateMsg)}.
   *
   * <p>Method under test: {@link DeviceEdgeProcessorV2#setCustomerId(TenantId, CustomerId, Device,
   * DeviceUpdateMsg)}
   */
  @Test
  ...
  @MethodsUnderTest({
    "void DeviceEdgeProcessorV2.setCustomerId(TenantId, CustomerId, Device, DeviceUpdateMsg)"
  })
  void testSetCustomerId() {
    ...
    // Act
    deviceEdgeProcessorV2.setCustomerId(
        tenantId, customerId, device, DeviceUpdateMsg.getDefaultInstance());
