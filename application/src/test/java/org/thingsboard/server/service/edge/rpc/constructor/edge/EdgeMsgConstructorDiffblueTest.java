...
class EdgeMsgConstructorDiffblueTest {
  ...
  void testConstructEdgeConfiguration_thenReturnCustomerIdLSBIs7476899250389416711() {
    ...
    edge2.setType("");
    edge2.setName("Name");
    edge2.setTenantId(new TenantId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9")));
    edge2.setId(new EdgeId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9")));

    // Act
    EdgeConfiguration actualConstructEdgeConfigurationResult =
        edgeMsgConstructor.constructEdgeConfiguration(edge2);
