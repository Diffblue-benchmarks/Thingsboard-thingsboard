...
class EdgeContextComponentDiffblueTest {
  /**
   * Test {@link EdgeContextComponent#equals(Object)}, and
   * {@link EdgeContextComponent#hashCode()}.
   * <ul>
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    ...
    edgeContextComponent
        .setClusterService(new DefaultTbClusterService(topicService, deviceProfileCache, assetProfileCache,
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual5() {
    ...
    edgeContextComponent.setEdgeEventService(new BaseEdgeEventService(edgeEventDao, rateLimitService,
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual7() {
    ...
    DeviceDataValidator deviceValidator = new DeviceDataValidator();
    BaseEntityCountService countService = new BaseEntityCountService();
    edgeContextComponent.setDeviceService(new DeviceServiceImpl(deviceDao, deviceCredentialsService,
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual15() {
    ...
    BaseEntityCountService countService = new BaseEntityCountService();
    edgeContextComponent.setUserService(new UserServiceImpl(userDao, userCredentialsDao, userAuthSettingsDao,
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual20() {
    ...
    edgeContextComponent.setOtaPackageService(new BaseOtaPackageService(otaPackageDao, otaPackageInfoDao,
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual24() {
    ...
    edgeContextComponent
        .setResourceService(new BaseResourceService(resourceDao, resourceInfoDao, new ResourceDataValidator()));
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual26() {
    ...
    ApplicationEventPublisher eventPublisher = mock(ApplicationEventPublisher.class);
    BaseEntityCountService countService = new BaseEntityCountService();
    edgeContextComponent.setNotificationTargetService(
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual27() {
    ...
    edgeContextComponent.setNotificationTemplateService(new DefaultNotificationTemplateService(notificationTemplateDao,
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual29() {
    // Arrange
    EdgeContextComponent edgeContextComponent = new EdgeContextComponent();
    edgeContextComponent.setRateLimitService(
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual57() {
    // Arrange
    EdgeContextComponent edgeContextComponent = new EdgeContextComponent();
    edgeContextComponent.setAssetProfileEdgeProcessorFactory(new AssetProfileEdgeProcessorFactory());
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual60() {
    // Arrange
    EdgeContextComponent edgeContextComponent = new EdgeContextComponent();
    edgeContextComponent.setDeviceProfileEdgeProcessorFactory(new DeviceProfileEdgeProcessorFactory());
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual70() {
    ...
    edgeContextComponent2.setEdgeEventService(new BaseEdgeEventService(edgeEventDao, rateLimitService,
        new EdgeEventDataValidator(), mock(ApplicationEventPublisher.class)));
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual72() {
    ...
    DeviceDataValidator deviceValidator = new DeviceDataValidator();
    BaseEntityCountService countService = new BaseEntityCountService();
    edgeContextComponent2.setDeviceService(new DeviceServiceImpl(deviceDao, deviceCredentialsService,
        deviceProfileService, eventService, tenantService, deviceValidator, countService, new JpaExecutorService()));
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual80() {
    ...
    ApplicationEventPublisher eventPublisher = mock(ApplicationEventPublisher.class);
    BaseEntityCountService countService = new BaseEntityCountService();
    edgeContextComponent2.setUserService(new UserServiceImpl(userDao, userCredentialsDao, userAuthSettingsDao,
        userSettingsService, userSettingsDao, securitySettingsService, userValidator, userCredentialsValidator,
        eventPublisher, countService, new JpaExecutorService()));
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual85() {
    ...
    CaffeineOtaPackageCache otaPackageDataCache = new CaffeineOtaPackageCache(new CaffeineCacheManager());
    OtaPackageInfoDataValidator otaPackageInfoValidator = new OtaPackageInfoDataValidator();
    edgeContextComponent2.setOtaPackageService(new BaseOtaPackageService(otaPackageDao, otaPackageInfoDao,
        otaPackageDataCache, otaPackageInfoValidator, new OtaPackageDataValidator()));
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual91() {
    ...
    ApplicationEventPublisher eventPublisher = mock(ApplicationEventPublisher.class);
    BaseEntityCountService countService = new BaseEntityCountService();
    edgeContextComponent2.setNotificationTargetService(
        new DefaultNotificationTargetService(notificationTargetDao, notificationRequestDao, notificationRuleDao,
            new UserServiceImpl(userDao, userCredentialsDao, userAuthSettingsDao, userSettingsService, userSettingsDao,
                securitySettingsService, userValidator, userCredentialsValidator, eventPublisher, countService,
                new JpaExecutorService())));
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual92() {
    ...
    JpaNotificationTemplateDao notificationTemplateDao = new JpaNotificationTemplateDao(
        mock(NotificationTemplateRepository.class));
    edgeContextComponent2.setNotificationTemplateService(new DefaultNotificationTemplateService(notificationTemplateDao,
        new JpaNotificationRequestDao(mock(NotificationRequestRepository.class))));
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual94() {
    ...
    EdgeContextComponent edgeContextComponent2 = new EdgeContextComponent();
    edgeContextComponent2.setRateLimitService(
        new DefaultRateLimitService(mock(TenantProfileProvider.class), mock(NotificationRuleProcessor.class), 1, 3));
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual122() {
    ...
    EdgeContextComponent edgeContextComponent2 = new EdgeContextComponent();
    edgeContextComponent2.setAssetProfileEdgeProcessorFactory(new AssetProfileEdgeProcessorFactory());
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual125() {
    ...
    EdgeContextComponent edgeContextComponent2 = new EdgeContextComponent();
    edgeContextComponent2.setDeviceProfileEdgeProcessorFactory(new DeviceProfileEdgeProcessorFactory());
  ...
  @Test
  @DisplayName("Test equals(Object); when other is different; then return not equal")
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual128() {
    // Arrange
    EdgeContextComponent edgeContextComponent = new EdgeContextComponent();
  ...
  @Test
  @DisplayName("Test equals(Object); when other is different; then return not equal")
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual129() {
    // Arrange
    EdgeContextComponent edgeContextComponent = new EdgeContextComponent();
  ...
  @Test
  @DisplayName("Test equals(Object); when other is different; then return not equal")
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual130() {
    // Arrange
    EdgeContextComponent edgeContextComponent = new EdgeContextComponent();
  ...
  @Test
  @DisplayName("Test equals(Object); when other is different; then return not equal")
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual131() {
    // Arrange
    EdgeContextComponent edgeContextComponent = new EdgeContextComponent();
   ...
   * <ul>
   *   <li>
   * {@link EdgeContextComponent#setAdminSettingsProcessor(AdminSettingsEdgeProcessor)}
   *   <li>
   * {@link EdgeContextComponent#setAdminSettingsService(AdminSettingsService)}
   *   <li>
   * {@link EdgeContextComponent#setAlarmEdgeProcessorFactory(AlarmEdgeProcessorFactory)}
   *   <li>{@link EdgeContextComponent#setAlarmProcessor(AlarmEdgeProcessor)}
   *   <li>
   * {@link EdgeContextComponent#setAssetEdgeProcessorFactory(AssetEdgeProcessorFactory)}
   *   <li>{@link EdgeContextComponent#setAssetProcessor(AssetEdgeProcessor)}
   *   <li>
   * {@link EdgeContextComponent#setAssetProfileEdgeProcessorFactory(AssetProfileEdgeProcessorFactory)}
   *   <li>
   * {@link EdgeContextComponent#setAssetProfileProcessor(AssetProfileEdgeProcessor)}
   ...
   *   <li>{@link EdgeContextComponent#setClusterService(TbClusterService)}
   ...
   *   <li>
   * {@link EdgeContextComponent#setDashboardEdgeProcessorFactory(DashboardEdgeProcessorFactory)}
   *   <li>
   * {@link EdgeContextComponent#setDashboardProcessor(DashboardEdgeProcessor)}
   *   <li>{@link EdgeContextComponent#setDashboardService(DashboardService)}
   *   <li>
   * {@link EdgeContextComponent#setDbCallbackExecutor(DbCallbackExecutorService)}
   *   <li>
   * {@link EdgeContextComponent#setDeviceEdgeProcessorFactory(DeviceEdgeProcessorFactory)}
   *   <li>{@link EdgeContextComponent#setDeviceProcessor(DeviceEdgeProcessor)}
   *   <li>
   * {@link EdgeContextComponent#setDeviceProfileEdgeProcessorFactory(DeviceProfileEdgeProcessorFactory)}
   *   <li>
   * {@link EdgeContextComponent#setDeviceProfileProcessor(DeviceProfileEdgeProcessor)}
   *   <li>
   * {@link EdgeContextComponent#setDeviceProfileService(DeviceProfileService)}
   ...
   *   <li>
   * {@link EdgeContextComponent#setEdgeEventStorageSettings(EdgeEventStorageSettings)}
   ...
   *   <li>
   * {@link EdgeContextComponent#setEntityViewProcessor(EntityViewEdgeProcessor)}
   *   <li>
   * {@link EdgeContextComponent#setEntityViewProcessorFactory(EntityViewProcessorFactory)}
   *   <li>{@link EdgeContextComponent#setEntityViewService(EntityViewService)}
   *   <li>
   * {@link EdgeContextComponent#setGrpcCallbackExecutorService(GrpcCallbackExecutorService)}
   *   <li>
   * {@link EdgeContextComponent#setNotificationEdgeProcessor(NotificationEdgeProcessor)}
   *   <li>
   * {@link EdgeContextComponent#setNotificationRuleProcessor(NotificationRuleProcessor)}
   *   <li>
   * {@link EdgeContextComponent#setNotificationRuleService(NotificationRuleService)}
   *   <li>
   * {@link EdgeContextComponent#setNotificationTargetService(NotificationTargetService)}
   *   <li>
   * {@link EdgeContextComponent#setNotificationTemplateService(NotificationTemplateService)}
   *   <li>{@link EdgeContextComponent#setOAuth2EdgeProcessor(OAuth2EdgeProcessor)}
   *   <li>
   * {@link EdgeContextComponent#setOtaPackageProcessor(OtaPackageEdgeProcessor)}
   *   <li>{@link EdgeContextComponent#setOtaPackageService(OtaPackageService)}
   ...
   *   <li>
   * {@link EdgeContextComponent#setRelationEdgeProcessorFactory(RelationEdgeProcessorFactory)}
   *   <li>{@link EdgeContextComponent#setRelationProcessor(RelationEdgeProcessor)}
   *   <li>
   * {@link EdgeContextComponent#setResourceEdgeProcessorFactory(ResourceEdgeProcessorFactory)}
   ...
   *   <li>
   * {@link EdgeContextComponent#setRuleChainProcessor(RuleChainEdgeProcessor)}
   *   <li>{@link EdgeContextComponent#setRuleChainService(RuleChainService)}
   *   <li>
   * {@link EdgeContextComponent#setTelemetryProcessor(TelemetryEdgeProcessor)}
   *   <li>{@link EdgeContextComponent#setTenantProcessor(TenantEdgeProcessor)}
   *   <li>
   * {@link EdgeContextComponent#setTenantProfileProcessor(TenantProfileEdgeProcessor)}
   *   <li>
   * {@link EdgeContextComponent#setTenantProfileService(TenantProfileService)}
   ...
   *   <li>
   * {@link EdgeContextComponent#setWidgetBundleProcessor(WidgetBundleEdgeProcessor)}
   *   <li>
   * {@link EdgeContextComponent#setWidgetTypeProcessor(WidgetTypeEdgeProcessor)}
   *   <li>{@link EdgeContextComponent#setWidgetTypeService(WidgetTypeService)}
   *   <li>
   * {@link EdgeContextComponent#setWidgetsBundleService(WidgetsBundleService)}
  ...
  void testGettersAndSetters() {
    ...
    AssetProfileEdgeProcessorFactory assetProfileEdgeProcessorFactory = new AssetProfileEdgeProcessorFactory();
    ...
    DefaultTbAssetProfileCache assetProfileCache = new DefaultTbAssetProfileCache(assetProfileService2,
        new BaseAssetService());
    ...
    edgeContextComponent.setClusterService(clusterService);
    ...
    DashboardEdgeProcessorFactory dashboardEdgeProcessorFactory = new DashboardEdgeProcessorFactory();
    ...
    DeviceProfileEdgeProcessorFactory deviceProfileEdgeProcessorFactory = new DeviceProfileEdgeProcessorFactory();
    ...
    edgeContextComponent.setDeviceProfileService(deviceProfileService3);
    ...
    DeviceServiceImpl deviceService = new DeviceServiceImpl(deviceDao2, deviceCredentialsService2,
        deviceProfileService4, eventService2, tenantService2, deviceValidator2, countService2,
        new JpaExecutorService());
    ...
    BaseEdgeEventService edgeEventService = new BaseEdgeEventService(edgeEventDao, rateLimitService,
        new EdgeEventDataValidator(), mock(ApplicationEventPublisher.class));
    ...
    edgeContextComponent.setEdgeService(edgeService2);
    ...
    DefaultNotificationRuleService notificationRuleService = new DefaultNotificationRuleService(
    ...
    DefaultNotificationTargetService notificationTargetService = new DefaultNotificationTargetService(
        ...
        new UserServiceImpl(userDao, userCredentialsDao, userAuthSettingsDao, userSettingsService, userSettingsDao,
            securitySettingsService, userValidator, userCredentialsValidator, eventPublisher, countService3,
            new JpaExecutorService()));
    ...
    CaffeineOtaPackageCache otaPackageDataCache = new CaffeineOtaPackageCache(new CaffeineCacheManager());
    OtaPackageInfoDataValidator otaPackageInfoValidator = new OtaPackageInfoDataValidator();
    BaseOtaPackageService otaPackageService = new BaseOtaPackageService(otaPackageDao, otaPackageInfoDao,
        otaPackageDataCache, otaPackageInfoValidator, new OtaPackageDataValidator());

    edgeContextComponent.setOtaPackageService(otaPackageService);
    ...
    DefaultRateLimitService rateLimitService2 = new DefaultRateLimitService(mock(TenantProfileProvider.class),
        mock(NotificationRuleProcessor.class), 1, 3);
    ...
    edgeContextComponent.setTenantService(tenantService3);
    ...
    UserServiceImpl userService = new UserServiceImpl(userDao2, userCredentialsDao2, userAuthSettingsDao2,
        userSettingsService2, userSettingsDao2, securitySettingsService2, userValidator2, userCredentialsValidator2,
        eventPublisher2, countService4, new JpaExecutorService());
    ...
    AdminSettingsEdgeProcessor actualAdminSettingsProcessor = edgeContextComponent.getAdminSettingsProcessor();
    AdminSettingsService actualAdminSettingsService = edgeContextComponent.getAdminSettingsService();
    AlarmEdgeProcessorFactory actualAlarmEdgeProcessorFactory = edgeContextComponent.getAlarmEdgeProcessorFactory();
    AlarmEdgeProcessor actualAlarmProcessor = edgeContextComponent.getAlarmProcessor();
    AssetEdgeProcessorFactory actualAssetEdgeProcessorFactory = edgeContextComponent.getAssetEdgeProcessorFactory();
    AssetEdgeProcessor actualAssetProcessor = edgeContextComponent.getAssetProcessor();
    AssetProfileEdgeProcessorFactory actualAssetProfileEdgeProcessorFactory = edgeContextComponent
        .getAssetProfileEdgeProcessorFactory();
    AssetProfileEdgeProcessor actualAssetProfileProcessor = edgeContextComponent.getAssetProfileProcessor();
    ...
    DashboardEdgeProcessorFactory actualDashboardEdgeProcessorFactory = edgeContextComponent
        .getDashboardEdgeProcessorFactory();
    ...
    DbCallbackExecutorService actualDbCallbackExecutor = edgeContextComponent.getDbCallbackExecutor();
    DeviceEdgeProcessorFactory actualDeviceEdgeProcessorFactory = edgeContextComponent.getDeviceEdgeProcessorFactory();
    DeviceEdgeProcessor actualDeviceProcessor = edgeContextComponent.getDeviceProcessor();
    DeviceProfileEdgeProcessorFactory actualDeviceProfileEdgeProcessorFactory = edgeContextComponent
        .getDeviceProfileEdgeProcessorFactory();
    DeviceProfileEdgeProcessor actualDeviceProfileProcessor = edgeContextComponent.getDeviceProfileProcessor();
    DeviceProfileService actualDeviceProfileService = edgeContextComponent.getDeviceProfileService();
    ...
    EdgeEventStorageSettings actualEdgeEventStorageSettings = edgeContextComponent.getEdgeEventStorageSettings();
    ...
    EntityViewEdgeProcessor actualEntityViewProcessor = edgeContextComponent.getEntityViewProcessor();
    EntityViewProcessorFactory actualEntityViewProcessorFactory = edgeContextComponent.getEntityViewProcessorFactory();
    EntityViewService actualEntityViewService = edgeContextComponent.getEntityViewService();
    GrpcCallbackExecutorService actualGrpcCallbackExecutorService = edgeContextComponent
        .getGrpcCallbackExecutorService();
    NotificationEdgeProcessor actualNotificationEdgeProcessor = edgeContextComponent.getNotificationEdgeProcessor();
    NotificationRuleProcessor actualNotificationRuleProcessor = edgeContextComponent.getNotificationRuleProcessor();
    NotificationRuleService actualNotificationRuleService = edgeContextComponent.getNotificationRuleService();
    NotificationTargetService actualNotificationTargetService = edgeContextComponent.getNotificationTargetService();
    NotificationTemplateService actualNotificationTemplateService = edgeContextComponent
        .getNotificationTemplateService();
    OAuth2EdgeProcessor actualOAuth2EdgeProcessor = edgeContextComponent.getOAuth2EdgeProcessor();
    OtaPackageEdgeProcessor actualOtaPackageProcessor = edgeContextComponent.getOtaPackageProcessor();
    ...
    RelationEdgeProcessorFactory actualRelationEdgeProcessorFactory = edgeContextComponent
        .getRelationEdgeProcessorFactory();
    RelationEdgeProcessor actualRelationProcessor = edgeContextComponent.getRelationProcessor();
    ResourceEdgeProcessorFactory actualResourceEdgeProcessorFactory = edgeContextComponent
        .getResourceEdgeProcessorFactory();
    ...
    TenantProfileEdgeProcessor actualTenantProfileProcessor = edgeContextComponent.getTenantProfileProcessor();
    TenantProfileService actualTenantProfileService = edgeContextComponent.getTenantProfileService();
    ...
    WidgetBundleEdgeProcessor actualWidgetBundleProcessor = edgeContextComponent.getWidgetBundleProcessor();
    WidgetTypeEdgeProcessor actualWidgetTypeProcessor = edgeContextComponent.getWidgetTypeProcessor();
    WidgetTypeService actualWidgetTypeService = edgeContextComponent.getWidgetTypeService();
    WidgetsBundleService actualWidgetsBundleService = edgeContextComponent.getWidgetsBundleService();
    ...
    assertSame(deviceProfileService3, actualDeviceProfileService);
    ...
    assertSame(edgeService2, actualEdgeService);
    ...
    assertSame(otaPackageService, actualOtaPackageService);
    ...
    assertSame(tenantService3, actualTenantService);
    ...
    assertSame(clusterService, actualClusterService);
