...
class CQLStatementsParserDiffblueTest {
   ...
   *
   * <p>Method under test: {@link CQLStatementsParser#getStatements()}
   */
  @Test
  @DisplayName("Test getStatements()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"java.util.List CQLStatementsParser.getStatements()"})
  void testGetStatements() throws IOException {
    // Arrange, Act and Assert
    assertTrue(
        new CQLStatementsParser(Paths.get(System.getProperty("java.io.tmpdir"), "test.txt"))
            .getStatements()
            .isEmpty());
  }
}
