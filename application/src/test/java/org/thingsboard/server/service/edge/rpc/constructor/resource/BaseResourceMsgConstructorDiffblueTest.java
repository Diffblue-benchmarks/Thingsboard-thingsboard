...
class BaseResourceMsgConstructorDiffblueTest {
   ...
   * BaseResourceMsgConstructor#constructResourceDeleteMsg(TbResourceId)}
   */
  @Test
  @DisplayName(
      "Test constructResourceDeleteMsg(TbResourceId); then return IdLSB is '-7476899250389416711'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
    "ResourceUpdateMsg BaseResourceMsgConstructor.constructResourceDeleteMsg(TbResourceId)"
  })
  void testConstructResourceDeleteMsg_thenReturnIdLSBIs7476899250389416711() {
    ...
    // Act
    ResourceUpdateMsg actualConstructResourceDeleteMsgResult =
        resourceMsgConstructorV1.constructResourceDeleteMsg(
