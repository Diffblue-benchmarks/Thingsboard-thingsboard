...
class AlarmCountUnsubscribeCmdDiffblueTest {
  /**
   * Test {@link AlarmCountUnsubscribeCmd#equals(Object)}, and {@link AlarmCountUnsubscribeCmd#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean AlarmCountUnsubscribeCmd.equals(Object)", "int AlarmCountUnsubscribeCmd.hashCode()"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AlarmCountUnsubscribeCmd.<init>(int)", "int AlarmCountUnsubscribeCmd.getCmdId()",
      "WsCmdType AlarmCountUnsubscribeCmd.getType()", "String AlarmCountUnsubscribeCmd.toString()"})
