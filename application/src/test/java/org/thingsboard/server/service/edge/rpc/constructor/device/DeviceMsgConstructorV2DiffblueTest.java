...
class DeviceMsgConstructorV2DiffblueTest {
   ...
   * <p>
   * Method under test: {@link DeviceMsgConstructorV2#constructDeviceCredentialsUpdatedMsg(DeviceCredentials)}
   */
  @Test
  ...
  void testConstructDeviceCredentialsUpdatedMsg() {
    ...
    DeviceCredentialsUpdateMsg defaultInstanceForType = actualConstructDeviceCredentialsUpdatedMsgResult
