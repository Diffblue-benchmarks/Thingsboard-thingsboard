...
class BaseAssetMsgConstructorDiffblueTest {
   ...
   * <p>
   * Method under test:
   * {@link BaseAssetMsgConstructor#constructAssetDeleteMsg(AssetId)}
   */
  @Test
  @DisplayName("Test constructAssetDeleteMsg(AssetId); given randomUUID; then calls getId()")
  void testConstructAssetDeleteMsg_givenRandomUUID_thenCallsGetId() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.

    // Arrange
    AssetMsgConstructorV1 assetMsgConstructorV1 = new AssetMsgConstructorV1();
    AssetId assetId = mock(AssetId.class);
    when(assetId.getId()).thenReturn(UUID.randomUUID());

    // Act
    AssetUpdateMsg actualConstructAssetDeleteMsgResult = assetMsgConstructorV1.constructAssetDeleteMsg(assetId);

    // Assert
    verify(assetId, atLeast(1)).getId();
    Descriptors.Descriptor descriptorForType = actualConstructAssetDeleteMsgResult.getDescriptorForType();
    ...
    Descriptors.FieldDescriptor getResult2 = fields.get(10);
    ...
    Descriptors.FieldDescriptor getResult8 = fields.get(11);
    ...
    Descriptors.OneofDescriptor getResult11 = oneofs.get(4);
    assertSame(file, getResult11.getFile());
    Descriptors.OneofDescriptor getResult12 = oneofs.get(5);
    ...
    AssetUpdateMsg defaultInstanceForType3 = actualConstructAssetDeleteMsgResult.getDefaultInstanceForType();
    assertSame(descriptorForType, defaultInstanceForType3.getDescriptorForType());
    UnknownFieldSet unknownFields = actualConstructAssetDeleteMsgResult.getUnknownFields();
   ...
   * Test {@link BaseAssetMsgConstructor#constructAssetDeleteMsg(AssetId)}.
   * <ul>
   *   <li>When {@link AssetId#AssetId(UUID)} with id is randomUUID.</li>
   * </ul>
   * <p>
   * Method under test:
   * {@link BaseAssetMsgConstructor#constructAssetDeleteMsg(AssetId)}
   */
  @Test
  @DisplayName("Test constructAssetDeleteMsg(AssetId); when AssetId(UUID) with id is randomUUID")
  void testConstructAssetDeleteMsg_whenAssetIdWithIdIsRandomUUID() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    ...
    AssetUpdateMsg actualConstructAssetDeleteMsgResult = assetMsgConstructorV1
        .constructAssetDeleteMsg(new AssetId(UUID.randomUUID()));
  ...
  /**
   * Test
   * {@link BaseAssetMsgConstructor#constructAssetProfileDeleteMsg(AssetProfileId)}.
   * <ul>
   *   <li>Given randomUUID.</li>
   *   <li>Then calls {@link UUIDBased#getId()}.</li>
   * </ul>
   ...
   */
  @Test
  @DisplayName("Test constructAssetProfileDeleteMsg(AssetProfileId); given randomUUID; then calls getId()")
  void testConstructAssetProfileDeleteMsg_givenRandomUUID_thenCallsGetId() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    ...
    AssetProfileUpdateMsg actualConstructAssetProfileDeleteMsgResult = assetMsgConstructorV1
        .constructAssetProfileDeleteMsg(assetProfileId);

    // Assert
    verify(assetProfileId, atLeast(1)).getId();
    Descriptors.Descriptor descriptorForType = actualConstructAssetProfileDeleteMsgResult.getDescriptorForType();
    Descriptors.FileDescriptor file = descriptorForType.getFile();
    assertEquals(1, file.getDependencies().size());
    DescriptorProtos.DescriptorProto toProtoResult = descriptorForType.toProto();
    List<DescriptorProtos.FieldDescriptorProto> fieldList = toProtoResult.getFieldList();
    assertEquals(13, fieldList.size());
    List<Descriptors.FieldDescriptor> fields = descriptorForType.getFields();
    ...
    DescriptorProtos.FieldOptions options3 = getResult.getOptions();
    assertSame(features, options3.getFeatures());
    Descriptors.FieldDescriptor getResult2 = fields.get(11);
    DescriptorProtos.FieldOptions options4 = getResult2.getOptions();
    assertSame(features, options4.getFeatures());
    assertSame(features, options3.getFeaturesOrBuilder());
    assertSame(features, options4.getFeaturesOrBuilder());
    ...
    assertSame(file, getResult7.getFile());
    assertSame(file, getResult2.getFile());
    Descriptors.FieldDescriptor getResult8 = fields.get(12);
    assertSame(file, getResult8.getFile());
    Descriptors.OneofDescriptor getResult9 = oneofs.get(0);
    assertSame(file, getResult9.getFile());
    Descriptors.OneofDescriptor getResult10 = oneofs.get(1);
    ...
    assertSame(descriptorForType, getResult10.getContainingType());
    assertSame(descriptorForType, getResult11.getContainingType());
    AssetProfileUpdateMsg defaultInstanceForType3 = actualConstructAssetProfileDeleteMsgResult
        .getDefaultInstanceForType();
    assertSame(descriptorForType, defaultInstanceForType3.getDescriptorForType());
    UnknownFieldSet unknownFields = actualConstructAssetProfileDeleteMsgResult.getUnknownFields();
    assertSame(unknownFields, defaultInstanceForType.getUnknownFields());
    assertSame(unknownFields, defaultInstanceForType2.getUnknownFields());
    assertSame(unknownFields, features.getUnknownFields());
    assertSame(unknownFields, options2.getUnknownFields());
    ...
    assertSame(defaultInstanceForType3.getDefaultInstanceForType(),
        defaultInstanceForType3.getDefaultInstanceForType());
    ByteString image = actualConstructAssetProfileDeleteMsgResult.getImage();
    assertSame(image, getResult2.getDefaultValue());
   ...
   */
  @Test
  @DisplayName("Test constructAssetProfileDeleteMsg(AssetProfileId); when AssetProfileId(UUID) with id is randomUUID")
  void testConstructAssetProfileDeleteMsg_whenAssetProfileIdWithIdIsRandomUUID() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    ...
    // Act
    AssetProfileUpdateMsg actualConstructAssetProfileDeleteMsgResult = assetMsgConstructorV1
        .constructAssetProfileDeleteMsg(new AssetProfileId(UUID.randomUUID()));
