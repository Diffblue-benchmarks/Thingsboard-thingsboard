...
class QueueMsgConstructorV1DiffblueTest {
   ...
   * <p>
   * Method under test:
   * {@link QueueMsgConstructorV1#constructQueueDeleteMsg(QueueId)}
   */
  @Test
  ...
  void testConstructQueueDeleteMsg_givenRandomUUID_thenCallsGetId() {
    ...
    // Act
    QueueUpdateMsg actualConstructQueueDeleteMsgResult = queueMsgConstructorV1.constructQueueDeleteMsg(queueId);
