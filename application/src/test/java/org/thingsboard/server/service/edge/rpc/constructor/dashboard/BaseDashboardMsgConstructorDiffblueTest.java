...
class BaseDashboardMsgConstructorDiffblueTest {
  /**
   * Test
   * {@link BaseDashboardMsgConstructor#constructDashboardDeleteMsg(DashboardId)}.
   * <ul>
   ...
   */
  @Test
  @DisplayName("Test constructDashboardDeleteMsg(DashboardId); given randomUUID; then calls getId()")
  void testConstructDashboardDeleteMsg_givenRandomUUID_thenCallsGetId() {
    ...
    when(dashboardId.getId()).thenReturn(UUID.randomUUID());

    // Act
    DashboardUpdateMsg actualConstructDashboardDeleteMsgResult = dashboardMsgConstructorV1
        .constructDashboardDeleteMsg(dashboardId);

    // Assert
    verify(dashboardId, atLeast(1)).getId();
    Descriptors.Descriptor descriptorForType = actualConstructDashboardDeleteMsgResult.getDescriptorForType();
    ...
    DashboardUpdateMsg defaultInstanceForType3 = actualConstructDashboardDeleteMsgResult.getDefaultInstanceForType();
    assertSame(descriptorForType, defaultInstanceForType3.getDescriptorForType());
    UnknownFieldSet unknownFields = actualConstructDashboardDeleteMsgResult.getUnknownFields();
   ...
   */
  @Test
  @DisplayName("Test constructDashboardDeleteMsg(DashboardId); when DashboardId(UUID) with id is randomUUID")
  void testConstructDashboardDeleteMsg_whenDashboardIdWithIdIsRandomUUID() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    ...
    // Act
    DashboardUpdateMsg actualConstructDashboardDeleteMsgResult = dashboardMsgConstructorV1
        .constructDashboardDeleteMsg(new DashboardId(UUID.randomUUID()));
