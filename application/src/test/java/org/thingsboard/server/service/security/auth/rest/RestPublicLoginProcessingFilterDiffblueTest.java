...
class RestPublicLoginProcessingFilterDiffblueTest {
  /**
   * Test {@link RestPublicLoginProcessingFilter#attemptAuthentication(HttpServletRequest, HttpServletResponse)}.
   * <p>
   * Method under test: {@link RestPublicLoginProcessingFilter#attemptAuthentication(HttpServletRequest, HttpServletResponse)}
   */
  @Test
  @DisplayName("Test attemptAuthentication(HttpServletRequest, HttpServletResponse)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "org.springframework.security.core.Authentication RestPublicLoginProcessingFilter.attemptAuthentication(HttpServletRequest, HttpServletResponse)"})
  ...
  /**
   * Test {@link RestPublicLoginProcessingFilter#unsuccessfulAuthentication(HttpServletRequest, HttpServletResponse, AuthenticationException)}.
   * <ul>
   *   <li>Then calls {@link ThingsboardErrorResponseHandler#handle(Exception, HttpServletResponse)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link RestPublicLoginProcessingFilter#unsuccessfulAuthentication(HttpServletRequest, HttpServletResponse, AuthenticationException)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void RestPublicLoginProcessingFilter.unsuccessfulAuthentication(HttpServletRequest, HttpServletResponse, AuthenticationException)"})
