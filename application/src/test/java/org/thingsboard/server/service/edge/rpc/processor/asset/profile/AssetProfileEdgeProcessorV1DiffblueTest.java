...
class AssetProfileEdgeProcessorV1DiffblueTest {
  @InjectMocks private AssetProfileEdgeProcessorV1 assetProfileEdgeProcessorV1;

  /**
   * Test {@link AssetProfileEdgeProcessorV1#setDefaultRuleChainId(TenantId, AssetProfile,
   * RuleChainId)}.
   *
   * <p>Method under test: {@link AssetProfileEdgeProcessorV1#setDefaultRuleChainId(TenantId,
  ...
  @MethodsUnderTest({
    "void AssetProfileEdgeProcessorV1.setDefaultRuleChainId(TenantId, AssetProfile, RuleChainId)"
  })
  ...
  /**
   * Test {@link AssetProfileEdgeProcessorV1#setDefaultEdgeRuleChainId(AssetProfile, RuleChainId,
  ...
  void testSetDefaultEdgeRuleChainId() {
    ...
    // Act
    assetProfileEdgeProcessorV1.setDefaultEdgeRuleChainId(
