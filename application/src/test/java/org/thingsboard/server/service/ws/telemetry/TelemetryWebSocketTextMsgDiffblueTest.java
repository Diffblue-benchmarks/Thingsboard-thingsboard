...
class TelemetryWebSocketTextMsgDiffblueTest {
  /**
   * Test {@link TelemetryWebSocketTextMsg#equals(Object)}, and {@link TelemetryWebSocketTextMsg#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean TelemetryWebSocketTextMsg.equals(Object)", "int TelemetryWebSocketTextMsg.hashCode()"})
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link TelemetryWebSocketTextMsg#TelemetryWebSocketTextMsg(WebSocketSessionRef, String)}
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void TelemetryWebSocketTextMsg.<init>(WebSocketSessionRef, String)",
      "String TelemetryWebSocketTextMsg.getPayload()", "WebSocketSessionRef TelemetryWebSocketTextMsg.getSessionRef()",
      "String TelemetryWebSocketTextMsg.toString()"})
