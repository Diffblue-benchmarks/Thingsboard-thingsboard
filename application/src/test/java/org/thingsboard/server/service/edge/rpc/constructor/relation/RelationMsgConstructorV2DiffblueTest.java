...
class RelationMsgConstructorV2DiffblueTest {
  ...
  void testConstructRelationUpdatedMsg_thenReturnMsgTypeValueIsOne() {
    ...
    // Act
    RelationUpdateMsg actualConstructRelationUpdatedMsgResult = relationMsgConstructorV2
  ...
  void testConstructRelationUpdatedMsg_thenReturnMsgTypeValueIsZero() {
    ...
    // Act
    RelationUpdateMsg actualConstructRelationUpdatedMsgResult = relationMsgConstructorV2
        .constructRelationUpdatedMsg(UpdateMsgType.ENTITY_CREATED_RPC_MESSAGE, new EntityRelation());
