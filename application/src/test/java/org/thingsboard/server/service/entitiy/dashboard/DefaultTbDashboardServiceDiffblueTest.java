...
class DefaultTbDashboardServiceDiffblueTest {
  @InjectMocks
  private DefaultTbDashboardService defaultTbDashboardService;
   ...
   * </ul>
   * <p>
   * Method under test: {@link DefaultTbDashboardService#updateDashboardCustomers(Dashboard, Set, User)}
   */
  @Test
  @DisplayName("Test updateDashboardCustomers(Dashboard, Set, User); then return Dashboard()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Dashboard DefaultTbDashboardService.updateDashboardCustomers(Dashboard, Set, User)"})
  void testUpdateDashboardCustomers_thenReturnDashboard() throws ThingsboardException {
    // Arrange
   ...
   */
  @Test
  @DisplayName("Test updateDashboardCustomers(Dashboard, Set, User); when Dashboard(); then return Dashboard()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Dashboard DefaultTbDashboardService.updateDashboardCustomers(Dashboard, Set, User)"})
  void testUpdateDashboardCustomers_whenDashboard_thenReturnDashboard() throws ThingsboardException {
    // Arrange
    Dashboard dashboard = new Dashboard();
   ...
   * </ul>
   * <p>
   * Method under test: {@link DefaultTbDashboardService#addDashboardCustomers(Dashboard, Set, User)}
   */
  @Test
  @DisplayName("Test addDashboardCustomers(Dashboard, Set, User); when HashSet(); then return Dashboard()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Dashboard DefaultTbDashboardService.addDashboardCustomers(Dashboard, Set, User)"})
   ...
   * <p>
   * Method under test: {@link DefaultTbDashboardService#removeDashboardCustomers(Dashboard, Set, User)}
   */
  @Test
  @DisplayName("Test removeDashboardCustomers(Dashboard, Set, User)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Dashboard DefaultTbDashboardService.removeDashboardCustomers(Dashboard, Set, User)"})
   ...
   */
  @Test
  @DisplayName("Test removeDashboardCustomers(Dashboard, Set, User); when Dashboard(); then return Dashboard()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Dashboard DefaultTbDashboardService.removeDashboardCustomers(Dashboard, Set, User)"})
  void testRemoveDashboardCustomers_whenDashboard_thenReturnDashboard() throws ThingsboardException {
    // Arrange
    Dashboard dashboard = new Dashboard();
    HashSet<CustomerId> customerIds = new HashSet<>();
