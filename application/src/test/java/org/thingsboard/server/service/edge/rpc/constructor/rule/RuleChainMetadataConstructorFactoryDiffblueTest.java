...
class RuleChainMetadataConstructorFactoryDiffblueTest {
  ...
  void testGetByEdgeVersion_whenV330_thenReturnRuleChainMetadataConstructorV330() {
    ...
    // Assert
    assertTrue(actualByEdgeVersion instanceof RuleChainMetadataConstructorV330);
    assertTrue(
        ((RuleChainMetadataConstructorV330) actualByEdgeVersion)
            .constructConnections(null)
            .isEmpty());
    assertTrue(
        ((RuleChainMetadataConstructorV330) actualByEdgeVersion).constructNodes(null).isEmpty());
  }
  ...
  void testGetByEdgeVersion_whenV333_thenReturnRuleChainMetadataConstructorV340() {
    ...
    // Assert
    assertTrue(actualByEdgeVersion instanceof RuleChainMetadataConstructorV340);
    assertTrue(
        ((RuleChainMetadataConstructorV340) actualByEdgeVersion)
            .constructConnections(null)
            .isEmpty());
    assertTrue(
        ((RuleChainMetadataConstructorV340) actualByEdgeVersion).constructNodes(null).isEmpty());
  }
  ...
  void testGetByEdgeVersion_whenV362_thenReturnRuleChainMetadataConstructorV362() {
    ...
    assertTrue(
        ((RuleChainMetadataConstructorV362) actualByEdgeVersion)
            .constructConnections(null)
            .isEmpty());
    assertTrue(
        ((RuleChainMetadataConstructorV362) actualByEdgeVersion).constructNodes(null).isEmpty());
    assertSame(
        connectionsList,
