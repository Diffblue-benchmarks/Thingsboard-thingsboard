...
class RuleChainMetadataConstructorFactoryDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link RuleChainMetadataConstructorFactory#getByEdgeVersion(EdgeVersion)}
   */
  @Test
  @DisplayName("Test getByEdgeVersion(EdgeVersion); when 'V_3_3_0'; then return RuleChainMetadataConstructorV330")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"RuleChainMetadataConstructor RuleChainMetadataConstructorFactory.getByEdgeVersion(EdgeVersion)"})
  ...
  void testGetByEdgeVersion_whenV362_thenReturnRuleChainMetadataConstructorV362() {
    // Arrange and Act
    RuleChainMetadataConstructor actualByEdgeVersion = RuleChainMetadataConstructorFactory
        .getByEdgeVersion(EdgeVersion.V_3_6_2);
    TenantId tenantId = new TenantId(UUID.fromString("784f394c-42b6-435a-983c-b7beff2784f9"));
    RuleChainMetadataUpdateMsg actualConstructRuleChainMetadataUpdatedMsgResult = actualByEdgeVersion
        .constructRuleChainMetadataUpdatedMsg(tenantId, UpdateMsgType.ENTITY_CREATED_RPC_MESSAGE,
            new RuleChainMetaData(), EdgeVersion.V_3_3_0);

    // Assert
    assertTrue(actualByEdgeVersion instanceof RuleChainMetadataConstructorV362);
    assertEquals("", actualConstructRuleChainMetadataUpdatedMsgResult.getInitializationErrorString());
    assertEquals(
    ...
    assertEquals(0, actualConstructRuleChainMetadataUpdatedMsgResult.getRuleChainConnectionsCount());
    ...
    assertTrue(actualConstructRuleChainMetadataUpdatedMsgResult.findInitializationErrors().isEmpty());
    ...
    assertSame(connectionsList, actualConstructRuleChainMetadataUpdatedMsgResult.getConnectionsOrBuilderList());
    assertSame(connectionsList, actualConstructRuleChainMetadataUpdatedMsgResult.getNodesList());
    assertSame(connectionsList, actualConstructRuleChainMetadataUpdatedMsgResult.getNodesOrBuilderList());
    assertSame(connectionsList, actualConstructRuleChainMetadataUpdatedMsgResult.getRuleChainConnectionsList());
    assertSame(connectionsList,
