...
class ResourceMsgConstructorV2DiffblueTest {
  /**
   * Test
   * {@link ResourceMsgConstructorV2#constructResourceUpdatedMsg(UpdateMsgType, TbResource)}.
   * <ul>
   *   <li>When {@link TbResource#TbResource()} Id is
   * {@link TbResourceId#TbResourceId(UUID)} with id is randomUUID.</li>
   * </ul>
   * <p>
   * Method under test:
   * {@link ResourceMsgConstructorV2#constructResourceUpdatedMsg(UpdateMsgType, TbResource)}
   */
  @Test
  @DisplayName("Test constructResourceUpdatedMsg(UpdateMsgType, TbResource); when TbResource() Id is TbResourceId(UUID) with id is randomUUID")
  void testConstructResourceUpdatedMsg_whenTbResourceIdIsTbResourceIdWithIdIsRandomUUID() {
    ...
    tbResource.setId(new TbResourceId(UUID.randomUUID()));

    // Act
    ResourceUpdateMsg actualConstructResourceUpdatedMsgResult = resourceMsgConstructorV2
        .constructResourceUpdatedMsg(UpdateMsgType.ENTITY_CREATED_RPC_MESSAGE, tbResource);

    // Assert
    Descriptors.Descriptor descriptorForType = actualConstructResourceUpdatedMsgResult.getDescriptorForType();
    ...
    ResourceUpdateMsg defaultInstanceForType3 = actualConstructResourceUpdatedMsgResult.getDefaultInstanceForType();
    assertSame(descriptorForType, defaultInstanceForType3.getDescriptorForType());
    UnknownFieldSet unknownFields = actualConstructResourceUpdatedMsgResult.getUnknownFields();
   ...
   */
  @Test
  @DisplayName("Test constructResourceUpdatedMsg(UpdateMsgType, TbResource); when TbResourceId(UUID) with id is randomUUID")
  void testConstructResourceUpdatedMsg_whenTbResourceIdWithIdIsRandomUUID() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    ...
    // Act
    ResourceUpdateMsg actualConstructResourceUpdatedMsgResult = resourceMsgConstructorV2.constructResourceUpdatedMsg(
        UpdateMsgType.ENTITY_CREATED_RPC_MESSAGE, new TbResource(new TbResourceId(UUID.randomUUID())));
