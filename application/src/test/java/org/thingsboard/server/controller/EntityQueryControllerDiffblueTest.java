...
class EntityQueryControllerDiffblueTest {
   ...
   * <p>
   * Method under test: {@link EntityQueryController#countEntitiesByQuery(EntityCountQuery)}
   */
  @Test
  ...
  void testCountEntitiesByQuery() throws Exception {
    ...
    MockHttpServletRequestBuilder contentTypeResult = MockMvcRequestBuilders.post("/api/entitiesQuery/count")
        .contentType(MediaType.APPLICATION_JSON);

    ObjectMapper objectMapper = new ObjectMapper();
    MockHttpServletRequestBuilder requestBuilder = contentTypeResult
        .content(objectMapper.writeValueAsString(new EntityCountQuery()));
  ...
  void testCountEntitiesByQuery_givenHttpsExampleOrgExample() throws Exception {
    ...
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder postResult = MockMvcRequestBuilders.post("/api/entitiesQuery/count");
   ...
   * <p>
   * Method under test: {@link EntityQueryController#findEntityDataByQuery(EntityDataQuery)}
   */
  @Test
  ...
  void testFindEntityDataByQuery() throws Exception {
    ...
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder contentTypeResult = MockMvcRequestBuilders.post("/api/entitiesQuery/find")
        .contentType(MediaType.APPLICATION_JSON);

    ObjectMapper objectMapper = new ObjectMapper();
    MockHttpServletRequestBuilder requestBuilder = contentTypeResult
        .content(objectMapper.writeValueAsString(new EntityDataQuery()));
  ...
  void testFindEntityDataByQuery_givenHttpsExampleOrgExample() throws Exception {
    ...
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder postResult = MockMvcRequestBuilders.post("/api/entitiesQuery/find");
    postResult.characterEncoding("https://example.org/example");
    MockHttpServletRequestBuilder contentTypeResult = postResult.contentType(MediaType.APPLICATION_JSON);
   ...
   * <p>
   * Method under test: {@link EntityQueryController#findAlarmDataByQuery(AlarmDataQuery)}
   */
  @Test
  ...
  void testFindAlarmDataByQuery() throws Exception {
    ...
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder contentTypeResult = MockMvcRequestBuilders.post("/api/alarmsQuery/find")
        .contentType(MediaType.APPLICATION_JSON);

    ObjectMapper objectMapper = new ObjectMapper();
    MockHttpServletRequestBuilder requestBuilder = contentTypeResult
        .content(objectMapper.writeValueAsString(new AlarmDataQuery()));
   ...
   * <p>
   * Method under test: {@link EntityQueryController#countAlarmsByQuery(AlarmCountQuery)}
   */
  @Test
  ...
  void testCountAlarmsByQuery() throws Exception {
    ...
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder contentTypeResult = MockMvcRequestBuilders.post("/api/alarmsQuery/count")
        .contentType(MediaType.APPLICATION_JSON);

    ObjectMapper objectMapper = new ObjectMapper();
    MockHttpServletRequestBuilder requestBuilder = contentTypeResult
        .content(objectMapper.writeValueAsString(new AlarmCountQuery()));
  ...
  void testCountAlarmsByQuery_givenHttpsExampleOrgExample() throws Exception {
    ...
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder postResult = MockMvcRequestBuilders.post("/api/alarmsQuery/count");
    postResult.characterEncoding("https://example.org/example");
    MockHttpServletRequestBuilder contentTypeResult = postResult.contentType(MediaType.APPLICATION_JSON);
  ...
  /**
   * Test {@link EntityQueryController#findEntityTimeseriesAndAttributesKeysByQuery(EntityDataQuery, boolean, boolean, String)}.
   * <p>
   * Method under test: {@link EntityQueryController#findEntityTimeseriesAndAttributesKeysByQuery(EntityDataQuery, boolean, boolean, String)}
   */
  @Test
  @DisplayName("Test findEntityTimeseriesAndAttributesKeysByQuery(EntityDataQuery, boolean, boolean, String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testFindEntityTimeseriesAndAttributesKeysByQuery() throws Exception {
    ...
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder postResult = MockMvcRequestBuilders.post("/api/entitiesQuery/find/keys");
    MockHttpServletRequestBuilder paramResult = postResult.param("attributes", String.valueOf(true));
    MockHttpServletRequestBuilder contentTypeResult = paramResult.param("timeseries", String.valueOf(true))
        .contentType(MediaType.APPLICATION_JSON);
   ...
   */
  @Test
  @DisplayName("Test findEntityTimeseriesAndAttributesKeysByQuery(EntityDataQuery, boolean, boolean, String); when 'https://example.org/example'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "org.springframework.web.context.request.async.DeferredResult EntityQueryController.findEntityTimeseriesAndAttributesKeysByQuery(EntityDataQuery, boolean, boolean, String)"})
  void testFindEntityTimeseriesAndAttributesKeysByQuery_whenHttpsExampleOrgExample() throws Exception {
    // Arrange
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder paramResult = MockMvcRequestBuilders.post("/api/entitiesQuery/find/keys")
