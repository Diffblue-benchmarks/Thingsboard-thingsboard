...
class AuthControllerDiffblueTest {
   ...
   * <p>
   * Method under test: {@link AuthController#changePassword(ChangePasswordRequest)}
   */
  @Test
  ...
  void testChangePassword() throws Exception {
    // Arrange
    MockHttpServletRequestBuilder postResult = MockMvcRequestBuilders.post("/api/auth/changePassword");
   ...
   * </ul>
   * <p>
   * Method under test: {@link AuthController#getUserPasswordPolicy()}
   */
  @Test
  ...
  void testGetUserPasswordPolicy_thenStatusFourHundredSix() throws Exception {
    ...
    MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/noauth/userPasswordPolicy");
   ...
   * Test {@link AuthController#getUserPasswordPolicy()}.
   * <ul>
   *   <li>When {@link MockMvcRequestBuilders#get(String, Object[])} {@code /api/noauth/userPasswordPolicy}.</li>
   ...
   */
  @Test
  @DisplayName("Test getUserPasswordPolicy(); when get(String, Object[]) '/api/noauth/userPasswordPolicy'; then status isOk()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"UserPasswordPolicy AuthController.getUserPasswordPolicy()"})
  void testGetUserPasswordPolicy_whenGetApiNoauthUserPasswordPolicy_thenStatusIsOk() throws Exception {
    // Arrange
    UserPasswordPolicy passwordPolicy = new UserPasswordPolicy();
    passwordPolicy.setAllowWhitespaces(true);
    passwordPolicy.setForceUserToResetPasswordIfNotValid(true);
  ...
  /**
   * Test {@link AuthController#requestResetPasswordByEmail(ResetPasswordEmailRequest, HttpServletRequest)}.
   * <ul>
   *   <li>Then status four hundred fifteen.</li>
   * </ul>
   * <p>
   * Method under test: {@link AuthController#requestResetPasswordByEmail(ResetPasswordEmailRequest, HttpServletRequest)}
   */
  @Test
  @DisplayName("Test requestResetPasswordByEmail(ResetPasswordEmailRequest, HttpServletRequest); then status four hundred fifteen")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AuthController.requestResetPasswordByEmail(ResetPasswordEmailRequest, HttpServletRequest)"})
  void testRequestResetPasswordByEmail_thenStatusFourHundredFifteen() throws Exception {
    // Arrange
    MockHttpServletRequestBuilder postResult = MockMvcRequestBuilders.post("/api/noauth/resetPasswordByEmail");
    postResult.characterEncoding("https://example.org/example");
   ...
   */
  @Test
  @DisplayName("Test requestResetPasswordByEmail(ResetPasswordEmailRequest, HttpServletRequest); then status isOk()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AuthController.requestResetPasswordByEmail(ResetPasswordEmailRequest, HttpServletRequest)"})
  void testRequestResetPasswordByEmail_thenStatusIsOk() throws Exception {
    ...
    resetPasswordEmailRequest.setEmail("jane.doe@example.org");
    String content = (new ObjectMapper()).writeValueAsString(resetPasswordEmailRequest);
    MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post("/api/noauth/resetPasswordByEmail")
   ...
   * <p>
   * Method under test: {@link AuthController#resetPassword(ResetPasswordRequest, HttpServletRequest)}
   */
  @Test
  ...
  void testResetPassword() throws Exception {
    // Arrange
    MockHttpServletRequestBuilder postResult = MockMvcRequestBuilders.post("/api/noauth/resetPassword");
    postResult.characterEncoding("https://example.org/example");
