...
class EdgeControllerDiffblueTest {
  ...
  void testIsEdgesSupportEnabled_thenStatusFourHundredSix() throws Exception {
    ...
    MockHttpServletRequestBuilder requestBuilder =
        MockMvcRequestBuilders.get("/api/edges/enabled", "Uri Variables");
  ...
  @Test
  @DisplayName(
      "Test saveEdge(Edge); given 'https://example.org/example'; then status four hundred fifteen")
  @Tag("MaintainedByDiffblue")
  ...
  void testGetEdges() throws Exception {
    ...
    MockHttpServletRequestBuilder paramResult =
        MockMvcRequestBuilders.get("/api/edges").param("page", "https://example.org/example");
  ...
  void testGetTenantEdges() throws Exception {
    // Arrange
    MockHttpServletRequestBuilder paramResult =
        MockMvcRequestBuilders.get("/api/tenant/edges")
  ...
  void testGetTenantEdgeInfos() throws Exception {
    // Arrange
    MockHttpServletRequestBuilder paramResult =
        MockMvcRequestBuilders.get("/api/tenant/edgeInfos")
            .param("page", "https://example.org/example");
    MockHttpServletRequestBuilder requestBuilder = paramResult.param("pageSize", String.valueOf(1));
   ...
   */
  @Test
  @DisplayName("Test getCustomerEdges(String, int, int, String, String, String, String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testGetCustomerEdges() throws Exception {
    // Arrange
    MockHttpServletRequestBuilder paramResult =
        MockMvcRequestBuilders.get("/api/customer/{customerId}/edges", "42")
            .param("page", "https://example.org/example");
    MockHttpServletRequestBuilder requestBuilder = paramResult.param("pageSize", String.valueOf(1));
   ...
   */
  @Test
  @DisplayName("Test getCustomerEdgeInfos(String, int, int, String, String, String, String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testGetCustomerEdgeInfos() throws Exception {
    // Arrange
    MockHttpServletRequestBuilder paramResult =
        MockMvcRequestBuilders.get("/api/customer/{customerId}/edgeInfos", "42")
            .param("page", "https://example.org/example");
    MockHttpServletRequestBuilder requestBuilder = paramResult.param("pageSize", String.valueOf(1));
    ...
    assertThrows(
        ...
        () ->
            new EdgeController(
                    ...
                    edgeInstallServiceOpt,
                    edgeUpgradeServiceOpt)
                .getEdgeUpgradeInstructions("1.0.2", "Method"));
  }
