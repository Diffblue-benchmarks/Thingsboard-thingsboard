...
class TelemetryControllerDiffblueTest {
   ...
   * <p>
   * Method under test: {@link TelemetryController#getAttributeKeys(String, String)}
   */
  @Test
  ...
  void testGetAttributeKeys() throws Exception {
    ...
    MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
        .get("/api/plugins/telemetry/{entityType}/{entityId}/keys/attributes", "Entity Type", "42");
   ...
   * <p>
   * Method under test: {@link TelemetryController#getAttributeKeysByScope(String, String, AttributeScope)}
   */
  @Test
  ...
  void testGetAttributeKeysByScope() throws Exception {
    ...
    MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get(
        "/api/plugins/telemetry/{entityType}/{entityId}/keys/attributes/{scope}", "Entity Type", "42",
   ...
   * <p>
   * Method under test: {@link TelemetryController#getAttributes(String, String, String)}
   */
  @Test
  ...
  void testGetAttributes() throws Exception {
    ...
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
        .get("/api/plugins/telemetry/{entityType}/{entityId}/values/attributes", "Entity Type", "42");
   ...
   * <p>
   * Method under test: {@link TelemetryController#getAttributesByScope(String, String, AttributeScope, String)}
   */
  @Test
  ...
  void testGetAttributesByScope() throws Exception {
    ...
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get(
        "/api/plugins/telemetry/{entityType}/{entityId}/values/attributes/{scope}", "Entity Type", "42",
        AttributeScope.CLIENT_SCOPE);
   ...
   * <p>
   * Method under test: {@link TelemetryController#getTimeseriesKeys(String, String)}
   */
  @Test
  ...
  void testGetTimeseriesKeys() throws Exception {
    ...
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
        .get("/api/plugins/telemetry/{entityType}/{entityId}/keys/timeseries", "Entity Type", "42");
   ...
   * <p>
   * Method under test: {@link TelemetryController#getLatestTimeseries(String, String, String, Boolean)}
   */
  @Test
  ...
  void testGetLatestTimeseries() throws Exception {
    ...
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
        .get("/api/plugins/telemetry/{entityType}/{entityId}/values/timeseries", "Entity Type", "42");
  ...
  /**
   * Test {@link TelemetryController#getTimeseries(String, String, String, Long, Long, IntervalType, Long, String, Integer, String, String, Boolean)}.
   * <p>
   * Method under test: {@link TelemetryController#getTimeseries(String, String, String, Long, Long, IntervalType, Long, String, Integer, String, String, Boolean)}
   */
  @Test
  @DisplayName("Test getTimeseries(String, String, String, Long, Long, IntervalType, Long, String, Integer, String, String, Boolean)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testGetTimeseries() throws Exception {
    ...
    MockHttpServletRequestBuilder paramResult3 = paramResult2.param("interval", String.valueOf(1L))
        .param("keys", "foo");
    MockHttpServletRequestBuilder paramResult4 = paramResult3.param("limit", String.valueOf(1)).param("orderBy", "foo");
    MockHttpServletRequestBuilder requestBuilder = paramResult4.param("startTs", String.valueOf(1L));
   ...
   */
  @Test
  @DisplayName("Test getTimeseries(String, String, String, Long, Long, IntervalType, Long, String, Integer, String, String, Boolean); when empty string")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "org.springframework.web.context.request.async.DeferredResult TelemetryController.getTimeseries(String, String, String, Long, Long, IntervalType, Long, String, Integer, String, String, Boolean)"})
  void testGetTimeseries_whenEmptyString() throws Exception {
    // Arrange
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder paramResult = MockMvcRequestBuilders
        ...
        .param("agg", "foo")
        .param("endTs", "");
    MockHttpServletRequestBuilder paramResult2 = paramResult.param("interval", String.valueOf(1L)).param("keys", "foo");
    MockHttpServletRequestBuilder paramResult3 = paramResult2.param("limit", String.valueOf(1)).param("orderBy", "foo");
    MockHttpServletRequestBuilder requestBuilder = paramResult3.param("startTs", String.valueOf(1L));
   ...
   */
  @Test
  @DisplayName("Test getTimeseries(String, String, String, Long, Long, IntervalType, Long, String, Integer, String, String, Boolean); when 'https://example.org/example'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "org.springframework.web.context.request.async.DeferredResult TelemetryController.getTimeseries(String, String, String, Long, Long, IntervalType, Long, String, Integer, String, String, Boolean)"})
  void testGetTimeseries_whenHttpsExampleOrgExample() throws Exception {
    // Arrange
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder paramResult = MockMvcRequestBuilders
   ...
   * <p>
   * Method under test: {@link TelemetryController#saveDeviceAttributes(String, AttributeScope, JsonNode)}
   */
  @Test
  ...
  void testSaveDeviceAttributes() throws Exception {
    ...
    MockHttpServletRequestBuilder contentTypeResult = MockMvcRequestBuilders
        .post("/api/plugins/telemetry/{deviceId}/{scope}", "42", AttributeScope.CLIENT_SCOPE)
   ...
   */
  @Test
  @DisplayName("Test saveDeviceAttributes(String, AttributeScope, JsonNode); then status four hundred")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "org.springframework.web.context.request.async.DeferredResult TelemetryController.saveDeviceAttributes(String, AttributeScope, JsonNode)"})
  void testSaveDeviceAttributes_thenStatusFourHundred() throws Exception {
    // Arrange
    doThrow(new IllegalArgumentException("foo")).when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder contentTypeResult = MockMvcRequestBuilders
        .post("/api/plugins/telemetry/{deviceId}/{scope}", "Uri Variables", "Uri Variables", "Uri Variables")
        .contentType(MediaType.APPLICATION_JSON);
  ...
  /**
   * Test {@link TelemetryController#saveEntityAttributesV1(String, String, AttributeScope, JsonNode)}.
   * <ul>
   *   <li>Then status four hundred fifteen.</li>
   * </ul>
   * <p>
   * Method under test: {@link TelemetryController#saveEntityAttributesV1(String, String, AttributeScope, JsonNode)}
   */
  @Test
  @DisplayName("Test saveEntityAttributesV1(String, String, AttributeScope, JsonNode); then status four hundred fifteen")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testSaveEntityAttributesV1_thenStatusFourHundredFifteen() throws Exception {
    ...
    MockHttpServletRequestBuilder postResult = MockMvcRequestBuilders.post(
        "/api/plugins/telemetry/{entityType}/{entityId}/{scope}", "Entity Type", "42", AttributeScope.CLIENT_SCOPE);
   ...
   */
  @Test
  @DisplayName("Test saveEntityAttributesV1(String, String, AttributeScope, JsonNode); then status isOk()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "org.springframework.web.context.request.async.DeferredResult TelemetryController.saveEntityAttributesV1(String, String, AttributeScope, JsonNode)"})
  void testSaveEntityAttributesV1_thenStatusIsOk() throws Exception {
    ...
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder contentTypeResult = MockMvcRequestBuilders
        .post("/api/plugins/telemetry/{entityType}/{entityId}/{scope}", "Entity Type", "42",
            AttributeScope.CLIENT_SCOPE)
        .contentType(MediaType.APPLICATION_JSON);
  ...
  /**
   * Test {@link TelemetryController#saveEntityAttributesV2(String, String, AttributeScope, JsonNode)}.
   * <ul>
   *   <li>Then status four hundred fifteen.</li>
   * </ul>
   * <p>
   * Method under test: {@link TelemetryController#saveEntityAttributesV2(String, String, AttributeScope, JsonNode)}
   */
  @Test
  @DisplayName("Test saveEntityAttributesV2(String, String, AttributeScope, JsonNode); then status four hundred fifteen")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testSaveEntityAttributesV2_thenStatusFourHundredFifteen() throws Exception {
    ...
    doThrow(new IllegalArgumentException("foo")).when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder postResult = MockMvcRequestBuilders.post(
        "/api/plugins/telemetry/{entityType}/{entityId}/attributes/{scope}", "Entity Type", "42",
        AttributeScope.CLIENT_SCOPE);
    postResult.characterEncoding("https://example.org/example");
    MockHttpServletRequestBuilder contentTypeResult = postResult.contentType(MediaType.APPLICATION_JSON);
   ...
   */
  @Test
  @DisplayName("Test saveEntityAttributesV2(String, String, AttributeScope, JsonNode); then status isOk()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "org.springframework.web.context.request.async.DeferredResult TelemetryController.saveEntityAttributesV2(String, String, AttributeScope, JsonNode)"})
  void testSaveEntityAttributesV2_thenStatusIsOk() throws Exception {
    ...
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder contentTypeResult = MockMvcRequestBuilders
        .post("/api/plugins/telemetry/{entityType}/{entityId}/attributes/{scope}", "Entity Type", "42",
            AttributeScope.CLIENT_SCOPE)
        .contentType(MediaType.APPLICATION_JSON);
   ...
   * </ul>
   * <p>
   * Method under test: {@link TelemetryController#saveEntityTelemetry(String, String, String, String)}
   */
  @Test
  @DisplayName("Test saveEntityTelemetry(String, String, String, String); then status four hundred fifteen")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testSaveEntityTelemetry_thenStatusFourHundredFifteen() throws Exception {
    ...
    MockHttpServletRequestBuilder postResult = MockMvcRequestBuilders
        .post("/api/plugins/telemetry/{entityType}/{entityId}/timeseries/{scope}", "Entity Type", "42", "Scope");
    postResult.characterEncoding("https://example.org/example");
    MockHttpServletRequestBuilder contentTypeResult = postResult.contentType(MediaType.APPLICATION_JSON);
    MockHttpServletRequestBuilder requestBuilder = contentTypeResult
  ...
  /**
   * Test {@link TelemetryController#saveEntityTelemetryWithTTL(String, String, String, Long, String)}.
   * <ul>
   *   <li>Then status four hundred fifteen.</li>
   * </ul>
   * <p>
   * Method under test: {@link TelemetryController#saveEntityTelemetryWithTTL(String, String, String, Long, String)}
   */
  @Test
  @DisplayName("Test saveEntityTelemetryWithTTL(String, String, String, Long, String); then status four hundred fifteen")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testSaveEntityTelemetryWithTTL_thenStatusFourHundredFifteen() throws Exception {
    ...
    doThrow(new IllegalArgumentException("foo")).when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder postResult = MockMvcRequestBuilders.post(
        "/api/plugins/telemetry/{entityType}/{entityId}/timeseries/{scope}/{ttl}", "Entity Type", "42", "Scope", 1L);
    postResult.characterEncoding("https://example.org/example");
    MockHttpServletRequestBuilder contentTypeResult = postResult.contentType(MediaType.APPLICATION_JSON);
    MockHttpServletRequestBuilder requestBuilder = contentTypeResult
        .content((new ObjectMapper()).writeValueAsString("foo"));
   ...
   */
  @Test
  @DisplayName("Test saveEntityTelemetryWithTTL(String, String, String, Long, String); then status isOk()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "org.springframework.web.context.request.async.DeferredResult TelemetryController.saveEntityTelemetryWithTTL(String, String, String, Long, String)"})
  void testSaveEntityTelemetryWithTTL_thenStatusIsOk() throws Exception {
    ...
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder contentTypeResult = MockMvcRequestBuilders
        .post("/api/plugins/telemetry/{entityType}/{entityId}/timeseries/{scope}/{ttl}", "Entity Type", "42", "Scope",
            1L)
        .contentType(MediaType.APPLICATION_JSON);
    MockHttpServletRequestBuilder requestBuilder = contentTypeResult
        .content((new ObjectMapper()).writeValueAsString("foo"));
  ...
  /**
   * Test {@link TelemetryController#deleteEntityTimeseries(String, String, String, boolean, Long, Long, boolean, boolean)}.
   * <p>
   * Method under test: {@link TelemetryController#deleteEntityTimeseries(String, String, String, boolean, Long, Long, boolean, boolean)}
   */
  @Test
  @DisplayName("Test deleteEntityTimeseries(String, String, String, boolean, Long, Long, boolean, boolean)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testDeleteEntityTimeseries() throws Exception {
    ...
    MockHttpServletRequestBuilder deleteResult = MockMvcRequestBuilders
        .delete("/api/plugins/telemetry/{entityType}/{entityId}/timeseries/delete", "Entity Type", "42");
    MockHttpServletRequestBuilder paramResult = deleteResult.param("deleteAllDataForKeys", String.valueOf(true))
        .param("keys", "foo");
    MockHttpServletRequestBuilder requestBuilder = paramResult.param("rewriteLatestIfDeleted", String.valueOf(true));
  ...
  @MethodsUnderTest({
      "org.springframework.web.context.request.async.DeferredResult TelemetryController.deleteEntityTimeseries(String, String, String, boolean, Long, Long, boolean, boolean)"})
  void testDeleteEntityTimeseries2() throws Exception {
    // Arrange
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder paramResult = MockMvcRequestBuilders
   ...
   * <p>
   * Method under test: {@link TelemetryController#deleteDeviceAttributes(String, AttributeScope, String)}
   */
  @Test
  ...
  void testDeleteDeviceAttributes() throws Exception {
    ...
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
        .delete("/api/plugins/telemetry/{deviceId}/{scope}", "42", AttributeScope.CLIENT_SCOPE)
        .param("keys", "foo");
  ...
  void testDeleteDeviceAttributes_givenClientScope() throws Exception {
    ...
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
        .delete("/api/plugins/telemetry/{deviceId}/{scope}", "Uri Variables", "Uri Variables", "Uri Variables")
        .param("keys", "foo");
  ...
  /**
   * Test {@link TelemetryController#deleteEntityAttributes(String, String, AttributeScope, String)}.
   * <p>
   * Method under test: {@link TelemetryController#deleteEntityAttributes(String, String, AttributeScope, String)}
   */
  @Test
  ...
  void testDeleteEntityAttributes() throws Exception {
    ...
    doNothing().when(thingsboardErrorResponseHandler)
        .handle(Mockito.<Exception>any(), Mockito.<HttpServletResponse>any());
    MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
        .delete("/api/plugins/telemetry/{entityType}/{entityId}/{scope}", "Entity Type", "42",
            AttributeScope.CLIENT_SCOPE)
        .param("keys", "foo");
