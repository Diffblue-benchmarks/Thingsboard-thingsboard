...
class OAuth2ControllerDiffblueTest {
   ...
   * <p>
   * Method under test: {@link OAuth2Controller#findTenantOAuth2ClientInfos(int, int, String, String, String)}
   */
  @Test
  ...
  void testFindTenantOAuth2ClientInfos() throws Exception {
    // Arrange
    MockHttpServletRequestBuilder paramResult = MockMvcRequestBuilders.get("/api/oauth2/client/infos")
   ...
   * <p>
   * Method under test: {@link OAuth2Controller#findTenantOAuth2ClientInfosByIds(UUID[])}
   */
  @Test
  ...
  void testFindTenantOAuth2ClientInfosByIds() throws Exception {
    // Arrange
    MockHttpServletRequestBuilder getResult = MockMvcRequestBuilders.get("/api/oauth2/client/infos");
    MockHttpServletRequestBuilder requestBuilder = getResult.param("clientIds",
